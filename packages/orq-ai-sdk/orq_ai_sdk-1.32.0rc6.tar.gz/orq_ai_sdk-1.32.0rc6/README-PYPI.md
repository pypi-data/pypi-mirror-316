...
### [prompt](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompt/README.md)


#### [prompt.snippets](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/snippets/README.md)

* [find_one](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/snippets/README.md#find_one) - Get one prompt snippet

#### [prompt.templates](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/templates/README.md)

* [get_all](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/templates/README.md#get_all) - Get all prompt templates

### [prompts](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md)

* [create](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#create) - Create a new prompt
* [create_version](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#create_version) - Create a new prompt version
* [delete](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#delete) - Delete a prompt
* [get_one](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#get_one) - Get one prompt
* [update](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#update) - Update a prompt
* [duplicate](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#duplicate) - Duplicate a prompt
* [get_all](https://github.com/orq-ai/orq-python/blob/master/docs/sdks/prompts/README.md#get_all) - Get all prompts
