...
def minivisionai(query):
    return visionai(query, max_urls=5, k=2, temperature=0.2, max_retries=3, animation=False,
                    genai_query_k=3, query_k=5)


def deepvisionai(query):
    return visionai(query, max_urls=20, k=5, temperature=0.05, max_retries=10,
