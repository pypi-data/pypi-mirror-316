...
logger = logging.getLogger("imgbedding")
    ...
    def __post_init__(self):
        ...
        if self.model_path is None:
            ...
            config_file_url = hf_hub_url(
                repo_id="minimaxir/imgbedding", filename=model_filename
            )
        ...
        if self.pca:
            ...
            logging.info(
                ...
                + f"will transform imgbedding to {self.pca.mean_.shape[0]}D."
            )
    ...
    def pca_fit(self, embeddings, out_dim=128, save_path="pca.npz"):
        ...
        if save_path:
            ...
            logging.info(
                ...
                + "provide this as `pca` to imgbedding() to reload."
            )
