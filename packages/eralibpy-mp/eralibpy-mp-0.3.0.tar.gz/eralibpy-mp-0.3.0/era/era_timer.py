...
class Timer(object):
    ...
    def register(era, *args, **kwargs):
        ...
        class Deco(object):
            def __init__(self, func):
                ...
                Timer.timers["{}_{}".format(len(list(Timer.timers.keys())), era._get_func_name(func))] = _timer
    ...
    def run(self):
        ...
        # if not timers_intervals and getattr(self, 'no_timers_err', False):
