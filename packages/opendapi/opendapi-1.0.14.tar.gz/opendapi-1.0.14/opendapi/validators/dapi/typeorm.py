...
from opendapi.validators.dapi.base import PackageScopedDapiValidatorBase
...
class Table:
    ...
    def is_in_allowlist(self) -> bool:
        ...
        return is_model_in_allowlist(
            self.name,
            self.filename,
            self.project.override.model_allowlist,
        )
    ...
    def construct_datastores(self) -> List[str]:
        ...
        playbooks = self.project.override.playbooks
        return (
...
class TypeOrmDapiValidator(PackageScopedDapiValidatorBase):
    """
        ...
        for table in processed_tables:
            ...
            result[dapi_location] = {
                ...
                "context": {
                    ...
                    "integration": "typeorm",
                    "rel_model_path": os.path.relpath(table.filename, dapi_location),
                },
            }
