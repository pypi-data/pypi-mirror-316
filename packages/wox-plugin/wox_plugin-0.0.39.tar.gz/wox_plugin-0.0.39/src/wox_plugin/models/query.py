...
class Query:
    ...
    def from_json(cls, json_str: str) -> "Query":
        ...
        return cls(
            ...
            selection=Selection.from_json(json.dumps(data["Selection"])),
            env=QueryEnv.from_json(json.dumps(data["Env"])),
...
class ChangeQueryParam:
    ...
    def from_json(cls, json_str: str) -> "ChangeQueryParam":
        ...
        if "QuerySelection" in data:
            query_selection = Selection.from_json(json.dumps(data["QuerySelection"]))
        return cls(
