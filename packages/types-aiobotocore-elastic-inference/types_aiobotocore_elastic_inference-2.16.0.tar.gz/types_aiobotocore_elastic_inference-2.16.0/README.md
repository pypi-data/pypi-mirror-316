...
[![PyPI - Downloads](https://static.pepy.tech/badge/types-aiobotocore-elastic-inference)](https://pypistats.org/packages/types-aiobotocore-elastic-inference)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[aiobotocore ElasticInference 2.16.0](https://pypi.org/project/aiobotocore/)
...
3. Add `ElasticInference` service.
...
`types-aiobotocore-elastic-inference` dependency in production. However, there
