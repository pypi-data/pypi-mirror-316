...
setup(
    ...
    description="Type annotations for aiobotocore ElasticInference 2.16.0 service generated with mypy-boto3-builder 8.6.4",
    classifiers=[
    ...
    keywords="aiobotocore elastic-inference aiobotocore-stubs type-annotations mypy typeshed autocomplete",
