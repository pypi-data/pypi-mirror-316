...
class ResourceListWithHistogramOfAccessEvaluationLog(BaseModel):
    ...
    values: conlist(AccessEvaluationLog) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListWithHistogramOfAccessEvaluationLog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListWithHistogramOfAccessEvaluationLog:
        """Create an instance of ResourceListWithHistogramOfAccessEvaluationLog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListWithHistogramOfAccessEvaluationLog.parse_obj(obj)

        _obj = ResourceListWithHistogramOfAccessEvaluationLog.parse_obj({
            "histogram": Histogram.from_dict(obj.get("histogram")) if obj.get("histogram") is not None else None,
            "values": [AccessEvaluationLog.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
