...
class Request(BaseModel):
    ...
    method: constr(strict=True) = Field(None,alias="method", description="Method called by the request") 
    url: constr(strict=True) = Field(None,alias="url", description="URL of the request") 
