...
from pydantic.v1 import BaseModel, Field, StrictFloat, StrictInt, StrictStr, conlist, constr, Field
...
class RequestLog(BaseModel):
    ...
    application: constr(strict=True) = Field(...,alias="application", description="The name of the application that the request was made to.") 
    id: constr(strict=True) = Field(...,alias="id", description="The identifier of the request.") 
    ...
    verb: constr(strict=True) = Field(...,alias="verb", description="The HTTP verb of the request.") 
    url: constr(strict=True) = Field(...,alias="url", description="The URL of the request.") 
    domain: constr(strict=True) = Field(None,alias="domain", description="The domain of the request.") 
    ...
    operation: constr(strict=True) = Field(None,alias="operation", description="The API operation invoked by the request.") 
    outcome: constr(strict=True) = Field(...,alias="outcome", description="The outcome of the request: Success, Failure or Error.") 
    ...
    error_code: constr(strict=True) = Field(None,alias="errorCode", description="Error code, if the request had a failure or error.") 
    sdk_language: constr(strict=True) = Field(None,alias="sdkLanguage", description="The language of the SDK used.") 
    sdk_version: constr(strict=True) = Field(None,alias="sdkVersion", description="The version of the SDK used.") 
    source_application: constr(strict=True) = Field(None,alias="sourceApplication", description="The name of the application that made the request.") 
    ...
    impersonating_user: constr(strict=True) = Field(None,alias="impersonatingUser", description="The impersonating user. Only present if the request is an impersonated one") 
