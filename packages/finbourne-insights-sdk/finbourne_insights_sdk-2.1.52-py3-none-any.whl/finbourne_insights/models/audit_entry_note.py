...
class AuditEntryNote(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditEntryNote:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuditEntryNote:
        """Create an instance of AuditEntryNote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditEntryNote.parse_obj(obj)

        _obj = AuditEntryNote.parse_obj({
