...
class ResourceListWithHistogramOfRequestLog(BaseModel):
    ...
    values: conlist(RequestLog) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListWithHistogramOfRequestLog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListWithHistogramOfRequestLog:
        """Create an instance of ResourceListWithHistogramOfRequestLog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListWithHistogramOfRequestLog.parse_obj(obj)

        _obj = ResourceListWithHistogramOfRequestLog.parse_obj({
            "histogram": Histogram.from_dict(obj.get("histogram")) if obj.get("histogram") is not None else None,
            "values": [RequestLog.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
