...
class ResourceListWithHistogramOfVendorLog(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListWithHistogramOfVendorLog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListWithHistogramOfVendorLog:
        """Create an instance of ResourceListWithHistogramOfVendorLog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListWithHistogramOfVendorLog.parse_obj(obj)

        _obj = ResourceListWithHistogramOfVendorLog.parse_obj({
