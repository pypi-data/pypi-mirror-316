...
from shellsmartpayapi.models.device_detail import DeviceDetail
from shellsmartpayapi.models.loyalty_details import LoyaltyDetails
from shellsmartpayapi.models.payment_details import PaymentDetails
...
class PrepareFuelingRequest(object):
    ...
    Attributes:
        ...
        payment_details (PaymentDetails): Object containing Payment details
        device_details (List[DeviceDetail]): Object containing device details
    ...
    def from_dictionary(cls,
        ...
        payment_details = PaymentDetails.from_dictionary(dictionary.get('paymentDetails')) if dictionary.get('paymentDetails') else None
        ...
        if dictionary.get('deviceDetails') is not None:
            device_details = [DeviceDetail.from_dictionary(x) for x in dictionary.get('deviceDetails')]
        else:
            device_details = APIHelper.SKIP
