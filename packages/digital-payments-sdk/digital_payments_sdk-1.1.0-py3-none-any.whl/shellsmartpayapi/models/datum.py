...
from shellsmartpayapi.models.loc import Loc
from shellsmartpayapi.models.opening_hour import OpeningHour
...
class Datum(object):
    ...
    Attributes:
        ...
        loc (Loc): Object containing address details/elements
        ...
        opening_hours (List[OpeningHour]): An Array of the station’s opening
            hours. This may have opening and closing times in hours, minutes
    ...
    def __init__(self,
        ...
        if name is not APIHelper.SKIP:
            self.name = name 
        if addr is not APIHelper.SKIP:
            self.addr = addr 
        if lat is not APIHelper.SKIP:
            self.lat = lat 
        if lon is not APIHelper.SKIP:
            self.lon = lon 
        if amen is not APIHelper.SKIP:
            self.amen = amen 
        if fuel is not APIHelper.SKIP:
            self.fuel = fuel 
        if loc is not APIHelper.SKIP:
            self.loc = loc 
        if mpp_station_id is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        addr = dictionary.get("addr") if dictionary.get("addr") else APIHelper.SKIP
        ...
        amen = dictionary.get("amen") if dictionary.get("amen") else APIHelper.SKIP
        fuel = dictionary.get("fuel") if dictionary.get("fuel") else APIHelper.SKIP
        loc = Loc.from_dictionary(dictionary.get('loc')) if 'loc' in dictionary.keys() else APIHelper.SKIP
        mpp_station_id = dictionary.get("mpp_station_id") if dictionary.get("mpp_station_id") else APIHelper.SKIP
        ...
        if dictionary.get('opening_hours') is not None:
            opening_hours = [OpeningHour.from_dictionary(x) for x in dictionary.get('opening_hours')]
        else:
            opening_hours = APIHelper.SKIP
