...
def test_api_enum():
    dv = "https://moa.rpm.kr-st-midasit.com/backend/wgsd/dbase/sections/"
    pr = "https://moa.midasit.com/backend/wgsd/dbase/sections/"
    en_H_EN10365 = create_enum_class('en_H_EN10365', do_section_names_from_api(dv, "EN 10365:2017", "H_Section"))
    en_H_AISC05_US = create_enum_class('en_H_AISC05_US', do_section_names_from_api(dv, "AISC05(US)", "H_Section"))
    en_H_AISC10_US = create_enum_class('en_H_AISC10_US', do_section_names_from_api(dv, "AISC10(US)", "H_Section"))
    en_H_AISC10_SI = create_enum_class('en_H_AISC10_SI', do_section_names_from_api(dv, "AISC10(SI)", "H_Section"))
