...
# - API spec : https://moa.midasit.com/backend/gpt/swagger
# - to use api you need to get access token
#   - 1. open browser and login to https://moa.midasit.com/gpt
...
#   - create function-knowledge : POST https://moa.midasit.com/backend/gpt/function-knowledges
#   - get function-knowledge id : GET https://moa.midasit.com/backend/gpt/function-knowledges
...
# url_create_function_knowledge = "https://moa.midasit.com/backend/gpt/function-knowledges"
# function_knowledge = {
#     "title": title,
...
# url_get_function_knowledge = "https://moa.midasit.com/backend/gpt/function-knowledges"
...
# - save the function code and schema : POST https://moa.midasit.com/backend/gpt/function-knowledges/{function_knowledge_id}/functions
...
url_get_function_item = "https://moa.midasit.com/backend/gpt/function-knowledges/" + function_knowledge_id + "/functions"
...
url_function_execute = "https://moa.midasit.com/backend/function-executor/function-execute"
