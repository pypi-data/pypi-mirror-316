...
def span(
    ...
    trace_id: Optional[str] or Optional[Callable] = None,
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if actual_trace_id is None:
                actual_trace_id = current_trace().id
            if actual_trace_id is None:
