...
class FunctionCall(BaseApi):
    ...
    @classmethod
    def create_tool(cls,tool_name: str,api_key: str = None) -> Union[Dict,None]:
        ...
        if api_reponse.status_code != 200:
            ...
            result["tool_func"] = cls._create_function(tool_name,result["tool_args"])
    ...
    def _get_args_name(cls, input_parameters: str)-> List[str]:
        ...
        return args_list
    @classmethod
    def _create_function(cls, tool_name: str, tool_args: List[str]):
        ...
        for item in args_names:
            input_args[item] = None

        args_types = [Union[str,Dict[str,str]]]
