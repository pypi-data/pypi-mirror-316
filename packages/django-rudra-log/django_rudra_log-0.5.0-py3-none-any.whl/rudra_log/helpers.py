...
def _format_django_traceback(exc_value, exc_tb, project_folder="/backend/", prefix=""):
    ...
    while tb:
        ...
        file_text = "" if not is_project_code else "Project File: "
        output.append(
            f"\n{prefix}{file_text}{filename}, Line: {lineno}, Function: {funcname}\n"
        )
        ...
        if is_project_code:
            ...
            code = traceback.extract_tb(tb, limit=1)[0].line
            output.append(f"{prefix}{code}\n")
