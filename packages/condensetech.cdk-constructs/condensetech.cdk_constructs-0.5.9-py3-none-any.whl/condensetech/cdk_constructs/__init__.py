...
class INetworking(typing_extensions.Protocol):
    ...
    def bastion_host(
        self,
    ) -> typing.Optional[_aws_cdk_aws_ec2_ceddda9d.BastionHostLinux]:
...
class _INetworkingProxy:
    ...
    def bastion_host(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_aws_cdk_aws_ec2_ceddda9d.BastionHostLinux], jsii.get(self, "bastionHost"))
