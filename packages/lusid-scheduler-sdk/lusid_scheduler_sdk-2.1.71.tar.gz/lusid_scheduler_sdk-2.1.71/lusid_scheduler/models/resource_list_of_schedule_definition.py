...
class ResourceListOfScheduleDefinition(BaseModel):
    """
    ResourceListOfScheduleDefinition
    """
    values: conlist(ScheduleDefinition) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfScheduleDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfScheduleDefinition:
        """Create an instance of ResourceListOfScheduleDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfScheduleDefinition.parse_obj(obj)

        _obj = ResourceListOfScheduleDefinition.parse_obj({
            "values": [ScheduleDefinition.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
