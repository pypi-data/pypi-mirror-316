...
class ResourceListOfJobDefinition(BaseModel):
    """
    ResourceListOfJobDefinition
    """
    values: conlist(JobDefinition) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfJobDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfJobDefinition:
        """Create an instance of ResourceListOfJobDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfJobDefinition.parse_obj(obj)

        _obj = ResourceListOfJobDefinition.parse_obj({
            "values": [JobDefinition.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
