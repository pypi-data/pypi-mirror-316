...
class JobRunResult(BaseModel):
    ...
    """
    console_output_url: constr(strict=True) = Field(None,alias="consoleOutputUrl", description="The URL for the console output of the job run") 
    run_id: constr(strict=True) = Field(None,alias="runId", description="Unique id of the job run") 
    ...
    job_status: constr(strict=True) = Field(None,alias="jobStatus", description="Current job status") 
    job_result: constr(strict=True) = Field(None,alias="jobResult", description="Description of the job result") 
    description: constr(strict=True) = Field(None,alias="description", description="Description of the job") 
    schedule_id: Optional[ResourceId] = Field(None, alias="scheduleId")
    result_url: constr(strict=True) = Field(None,alias="resultUrl", description="URI to results. Defaults to null if not available") 
    manually_triggered_by: constr(strict=True) = Field(None,alias="manuallyTriggeredBy", description="UserId of the user that triggered the job.  Defaults to null if job was ran on a Schedule") 
    message: constr(strict=True) = Field(None,alias="message", description="Output message generated by the job runner  Value will be null when the job is in a &#x60;Running&#x60; or &#x60;Pending&#x60; status") 
