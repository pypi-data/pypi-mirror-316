...
class ResourceListOfJobHistory(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfJobHistory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfJobHistory:
        """Create an instance of ResourceListOfJobHistory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfJobHistory.parse_obj(obj)

        _obj = ResourceListOfJobHistory.parse_obj({
            "values": [JobHistory.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
