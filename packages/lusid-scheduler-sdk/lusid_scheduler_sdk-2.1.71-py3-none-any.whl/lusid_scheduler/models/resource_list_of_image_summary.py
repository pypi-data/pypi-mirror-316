...
class ResourceListOfImageSummary(BaseModel):
    """
    ResourceListOfImageSummary
    """
    values: conlist(ImageSummary) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfImageSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfImageSummary:
        """Create an instance of ResourceListOfImageSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfImageSummary.parse_obj(obj)

        _obj = ResourceListOfImageSummary.parse_obj({
            "values": [ImageSummary.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
