...
class ResourceListOfRepository(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfRepository:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfRepository:
        """Create an instance of ResourceListOfRepository from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfRepository.parse_obj(obj)

        _obj = ResourceListOfRepository.parse_obj({
            "values": [Repository.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
