...
class Feeder(_message.Message):
    __slots__ = ["ec", "normalHeadTerminalMRID", "normalEnergizingSubstationMRID", "normalEnergizedLvFeederMRIDs"]
    ...
    def __init__(self, ec: _Optional[_Union[_EquipmentContainer_pb2.EquipmentContainer, _Mapping]] = ..., normalHeadTerminalMRID: _Optional[str] = ..., normalEnergizingSubstationMRID: _Optional[str] = ..., normalEnergizedLvFeederMRIDs: _Optional[_Iterable[str]] = ...) -> None: ...
