...
class LvFeeder(_message.Message):
    __slots__ = ["ec", "normalHeadTerminalMRID", "normalEnergizingFeederMRIDs"]
    ...
    def __init__(self, ec: _Optional[_Union[_EquipmentContainer_pb2.EquipmentContainer, _Mapping]] = ..., normalHeadTerminalMRID: _Optional[str] = ..., normalEnergizingFeederMRIDs: _Optional[_Iterable[str]] = ...) -> None: ...
