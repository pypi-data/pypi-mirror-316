...
class RCBImage(RCallback):
    ...
    def cbZoom(self, zoom_index: int = -1):
        ...
        # When the annotation mode is a polyline-related mode, zooming does not scale the slide bar properly.
        # So we just transiently set the annotation mode to none before zooming, and then revert back to the
        # annotation mode that was selected.
        tmp_annotation_mode = self.pjs.annotation_mode
        ...
        self.pjs.annotation_mode = tmp_annotation_mode
