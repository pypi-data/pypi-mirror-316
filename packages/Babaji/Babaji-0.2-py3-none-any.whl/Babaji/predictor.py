...
class HeightPredictor:
    def __init__(self):
        ...
        self.scaler_url ='https://raw.githubusercontent.com/PyBabaji/Babaji_Weight_height/blob/main/Scalar.pkl'
        self.model_url = 'https://raw.githubusercontent.com/PyBabaji/Babaji_Weight_height/blob/main/Regrassor.pkl'
