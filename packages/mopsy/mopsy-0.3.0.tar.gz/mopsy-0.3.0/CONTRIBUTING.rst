...
Welcome to ``mopsy`` contributor's guide.
...
If you experience bugs or general issues with ``mopsy``, please have a look
...
You can help improve ``mopsy`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``mopsy`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``mopsy``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n mopsy python=3 six virtualenv pytest pytest-cov
    conda activate mopsy
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/mopsy.git
    cd mopsy
...
#. Install |pre-commit|_::
   ...
   ``mopsy`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/mopsy
.. _issue tracker: https://github.com/<USERNAME>/mopsy/issues
.. <-- end -->
