...
module_dir = os.path.join(__location__, "../src/mopsy")
try:
...
try:
    from mopsy import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "mopsy Documentation", "jkanche", "manual")
]
