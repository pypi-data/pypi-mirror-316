...
from django33.db.models import JSONField
...
try:
    from django33.contrib.postgres.fields import HStoreField

    POSTGRES_AVAILABLE = True
except ImportError:
    # psycopg2 is not available, cannot import from django33.contrib.postgres.
