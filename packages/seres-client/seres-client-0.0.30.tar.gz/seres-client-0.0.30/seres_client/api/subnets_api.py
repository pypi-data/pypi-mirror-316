...
class SubnetsApi:
    ...
    def get_subnet(
        ...
        _param = self._get_subnet_serialize(
            subnet_id=subnet_id,
    ...
    @validate_call
    def get_subnet_without_preload_content(
        self,
        subnet_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_subnet_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/subnets/{subnet_id}',
    ...
    def get_subnets(
        ...
        List subnets permitted via subnet memberships
