...
class ResourcesApi:
    ...
    def get_resources(
        self,
        resource_group_id: Annotated[Optional[StrictInt], Field(description="Filter resources that are members of the given resource group")] = None,
        ...
        :param resource_group_id: Filter resources that are members of the given resource group
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResponseSchemaResourceSchema",
            '401': None,
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
    ...
    def get_resources_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResponseSchemaResourceSchema]:
        """Get Resources
