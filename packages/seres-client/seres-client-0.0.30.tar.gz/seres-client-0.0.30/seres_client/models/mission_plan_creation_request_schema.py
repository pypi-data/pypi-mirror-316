...
class MissionPlanCreationRequestSchema(BaseModel):
    """
    ...
    meta_critical_leg_datetime: Optional[Any] = None
    meta_critical_leg_id: Optional[StrictInt] = None
    meta_landing_datetime: Optional[Any] = None
    meta_launch_datetime: Optional[Any] = None
    ...
    id: StrictInt
    created: StrictStr
    status: MissionPlanCreationRequestStatusEnum
    mission_plan_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["mission_template_id", "reference", "future_id", "meta_launch_now", "meta_critical_leg_datetime", "meta_critical_leg_id", "meta_landing_datetime", "meta_launch_datetime", "parent_mission_plan_creation_request_id", "primary_bot_id", "primary_bot_schema_id", "primary_payload_id", "primary_payload_schema_id", "resource_assembly_schema_id", "created_by_id", "account_id", "id", "created", "status", "mission_plan_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MissionPlanCreationRequestSchema from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if mission_plan_id (nullable) is None
        # and model_fields_set contains the field
        if self.mission_plan_id is None and "mission_plan_id" in self.model_fields_set:
            _dict['mission_plan_id'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MissionPlanCreationRequestSchema from a dict"""
        if obj is None:
            return None
