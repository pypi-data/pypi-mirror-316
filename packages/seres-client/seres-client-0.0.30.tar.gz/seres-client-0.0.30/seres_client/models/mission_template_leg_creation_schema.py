...
class MissionTemplateLegCreationSchema(BaseModel):
    """
    MissionTemplateLegCreationSchema
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["meta_order", "critical", "average_speed", "duration_seconds", "movement_domain_type", "resource_schema_action_schema_ids", "origin_waypoint_id", "mission_template_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MissionTemplateLegCreationSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MissionTemplateLegCreationSchema from a dict"""
        if obj is None:
            return None
