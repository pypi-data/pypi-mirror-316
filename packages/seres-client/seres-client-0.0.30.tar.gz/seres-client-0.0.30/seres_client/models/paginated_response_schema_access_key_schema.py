...
class PaginatedResponseSchemaAccessKeySchema(BaseModel):
    """
    PaginatedResponseSchemaAccessKeySchema
    """ # noqa: E501
    items: List[AccessKeySchema]
    has_next: StrictBool
    has_prev: StrictBool
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedResponseSchemaAccessKeySchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedResponseSchemaAccessKeySchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [AccessKeySchema.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
