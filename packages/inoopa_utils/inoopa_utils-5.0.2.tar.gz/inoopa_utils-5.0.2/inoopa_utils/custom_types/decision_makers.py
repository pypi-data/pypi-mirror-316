...
responsabilities_level_mapper: dict[int, str] = {
    1: "C-Layer / Director / Board / Chief / Owner / Founder",
...
class DecisionMaker:
    ...
    responsability_level_code: int | None = None
    responsability_level_formatted: str | None = None
