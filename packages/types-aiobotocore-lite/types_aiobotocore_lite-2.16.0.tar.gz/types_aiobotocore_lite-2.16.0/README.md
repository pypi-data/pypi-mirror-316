...
[aiobotocore 2.16.0](https://pypi.org/project/aiobotocore/) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 404 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 404 services in
  separate packages.
