...
if TYPE_CHECKING:
    ...
    from ..models.debug_llm_validate_request_metadata_type_0 import DebugLLMValidateRequestMetadataType0
...
class DebugLLMValidateRequest:
    ...
    Attributes:
        ...
        metadata (Union['DebugLLMValidateRequestMetadataType0', None, Unset]):
    """
    ...
    metadata: Union["DebugLLMValidateRequestMetadataType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, DebugLLMValidateRequestMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> Union["DebugLLMValidateRequestMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = DebugLLMValidateRequestMetadataType0.from_dict(data)

                return metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DebugLLMValidateRequestMetadataType0", None, Unset], data)
        ...
        debug_llm_validate_request.additional_properties = d
