...
print("\033[32m cdbg:cutils.py@6. \033[0m\n")
...
import colorama
print("\033[32m cdbg:cutils.py@16. \033[0m\n")
...
print("\033[32m cdbg:cutils.py@46. \033[0m\n")
...
print("\033[32m cdbg:cutils.py@276. \033[0m\n")
class StatDict():
...
def get_longest_appendix(str_list):
    ...
    return result
print("\033[32m cdbg:cutils.py@346. \033[0m\n")
from colorama import init, Fore, Back, Style
print("\033[32m cdbg:cutils.py@348. \033[0m\n")
init(autoreset=False)
print("\033[32m cdbg:cutils.py@350. \033[0m\n")
class Color(object):
    def red(s):
...
print("\033[32m cdbg:cutils.py@371. \033[0m\n")
class ZipFile:
...
print("\033[32m cdbg:cutils.py@409. \033[0m\n")
...
print("\033[32m cdbg:cutils.py@476. \033[0m\n")