...
class TestIcosaBalancer(unittest.TestCase):
    def test_balance_client_latencies(self):
        ...
        # Check that non-extreme values have minimal adjustments
        tolerance_latency = 0.05 * IcosaBalancer.IN_LATENCY_TARGET
        tolerance_byte_size = 0.1 * IcosaBalancer.BYTE_SIZE_TARGET
        extreme_clients = ["extreme_client_in", "extreme_client_out", "extreme_client_byte_size"]
