...
def fStr_ConvertToString(in_var, str_DateFormat=None):
    ...
    # --------------------------------------------------------------------------
        ...
        logger.warning(
            ' WARNING fStr_ConvToStr: the in Var is a DATETIME but u didnt define a format to convert it to STRING')
        logger.warning(in_var)
        return fStr_DateToString(in_var, '%Y-%m-%d')
    elif isinstance(in_var, dt.date):
        logger.warning(
            ' WARNING fStr_ConvToStr: the in Var is a DATE but u didnt define a format to convert it to STRING')
        logger.warning(in_var)
        return fStr_DateToString(in_var, '%Y-%m-%d')
