...
class ModuleControl:
    def __init__(self, module_type:Optional[ModuleType]=None, unit_system:Optional[UnitSystem]=None, solnt:Optional[int]=None,
    ...
    def from_block(cls, block_lines):
        ...
        for line in block_lines:
            ...
            if line.startswith('#'):
                ...
                ctl.module_type = ModuleType[line.split()[1].upper()]
