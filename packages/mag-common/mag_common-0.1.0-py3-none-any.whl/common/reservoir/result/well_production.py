...
from common.reservoir.result.well_product_record import WellProductRecord
# from common.conf.config import Config
from common.model.reservoir.product_column_name import ProductColumnName
...
class WellProduction:
    ...
    def to_block(self):
        ...
        for record in self.product_records:
            block_lines.append(record.to_line(column_names, '\t', 12, Config.get_decimal_places()))
