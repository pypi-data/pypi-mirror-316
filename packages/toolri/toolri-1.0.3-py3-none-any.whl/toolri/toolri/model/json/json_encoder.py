...
class ToolRIJSONEncoder(json.JSONEncoder):
...
def _custom_make_iterencode(
    ...
    def _iterencode_list(lst, _current_indent_level):
        ...
        buf = "["
        has_iterables = any(
            isinstance(i, collections.abc.Iterable) and not isinstance(i, str)
            for i in lst
        )
        if has_iterables and _indent is not None:
