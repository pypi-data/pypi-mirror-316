...
class IoTSiteWiseClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iotsitewise/client/close.html)
    ...
    async def create_dataset(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#create_dataset)
        """
    ...
    async def delete_dataset(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#delete_dataset)
        """
    ...
    async def describe_dataset(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#describe_dataset)
        """
    ...
    async def invoke_assistant(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#invoke_assistant)
        """
    ...
    async def list_datasets(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#list_datasets)
        """
    ...
    async def update_dataset(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iotsitewise/client/#update_dataset)
        """
