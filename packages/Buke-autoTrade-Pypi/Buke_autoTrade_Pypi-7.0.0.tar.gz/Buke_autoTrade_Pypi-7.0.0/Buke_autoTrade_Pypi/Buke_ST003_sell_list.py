...
from Buke_autoTrade_Pypi.indicator import sma, pivot_standard, stochastic_fast_k, stochastic_fast_d
                ...
                for ticker in basket:
                    ...
                    if holding_condition1:
                        ...
                        try:
                            ...
                            tomorrow_sell_price = float(day_price[ticker]['매도가격'].loc[trading_days_list[i - 1]])
