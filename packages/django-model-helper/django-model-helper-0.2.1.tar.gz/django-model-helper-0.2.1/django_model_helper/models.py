...
class WithUserFields(models.Model):
    ...
    def get_user(self, user_field, user_info_field):
    ...
    def set_user(self, user_field, user_info_field, user, save=True):
        UserSchema = self.get_user_schema()
...
class WithPublishStatusFields(models.Model):
    ...
    def published_display(self):
        return self.published and "已发布" or "未发布"

    published_display.short_description = "发布状态"
