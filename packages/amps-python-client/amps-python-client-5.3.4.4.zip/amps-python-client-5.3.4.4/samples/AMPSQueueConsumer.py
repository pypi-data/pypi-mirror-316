...
# for the previous message ach time the MessageStream returns a new
# message. (See the Developer Guide for full details.)
#
...
try:
    ...
    # create a subscription and loop forever, printing each message
    # as it arrives.    

    for msg in client.subscribe(topic="sample-queue", timeout=5000):
       print(msg.get_data())
       msg.ack()
