...
#########################################################################
# AMPSNVFIXShredderSubscriber
#
# This sample subscribes to a topic and prints
# nvfix messages as they are received.

# The program flow is simple:
#
# * Connect to AMPS
# * Subscribe to a topic
# * Print the content of each nvfix message as it is received.
#
...
client = AMPS.Client("ExampleNVFIXSubscriber-%s" % os.getpid())
