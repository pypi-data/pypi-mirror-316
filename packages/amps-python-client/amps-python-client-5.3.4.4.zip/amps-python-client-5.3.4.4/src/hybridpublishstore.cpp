...
//    def __init__(self, name):
    static void* __ctor(obj* self, PyObject* args, PyObject* kwds)
    {
      ...
      PyObject* value = NULL;
      if (!PyArg_ParseTuple(args, "sk|O!", &filename, &maxMemoryCapacity, &PyBool_Type, &value))
      {
        return NULL;
      }
      ...
      {
        UNLOCKGIL;
        self->impl = new Store(new HybridPublishStore(fileName, (size_t)maxMemoryCapacity, errorOnPublishGap));
      } DISPATCH_EXCEPTION;
