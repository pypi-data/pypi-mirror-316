...
namespace ampspy
{
  namespace recoverypoint
  {
    ...
    static const char* recoverypoint_class_doc = "\n"
    ...
    void add_types(PyObject* module_)
    {
      ...
      .addMethod("get_sub_id", get_sub_id, "returns the subId of this RecoveryPoint")
      .addMethod("get_bookmark", get_bookmark, "returns the bookmark for this RecoveryPoint")
      .createType()
