from profiler.compare_tools.compare_backend.utils.common_func import calculate_diff_ratio
from profiler.compare_tools.compare_backend.utils.excel_config import ExcelConfig
