...
class Integration:
    ...
    def __init__(
        ...
        *,
        ...
        self.capability_description: dict[CapabilityName, str | None] = {}
    ...
    def register_capability(
        ...
        def decorator(
            ...
            self.capability_description[name] = description
            return func
    ...
    def register_capabilities(
        ...
        capabilities: dict[
            CapabilityName,
            CapabilityCallableProto[t.Any] | tuple[CapabilityCallableProto[t.Any], str],
        ],
    ):
        """
        ...
        You can pass a tuple of (capability, description) to register a capability with a custom description.

        eg.
        ```
        integration.register_capabilities({
            CapabilityName.VALIDATE_CREDENTIALS: (validate_credentials, "Test"),
            CapabilityName.LIST_ACCOUNTS: list_accounts,
        })
        ```
        """
        for name, capability in capabilities.items():
            if isinstance(capability, tuple):
                func, description = capability
                self.register_capability(name, description)(func)
            else:
