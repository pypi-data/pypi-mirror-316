...
class Info(BaseModel):
    ...
    capabilities: List[CapabilityName] = Field(description="All capabilities provided by this connector.")
    ...
    oauth_scopes: Optional[Dict[str, StrictStr]] = Field(default=None, description="OAuth scopes for this connector per capability, eg. dict[CapabilityName, string]")
