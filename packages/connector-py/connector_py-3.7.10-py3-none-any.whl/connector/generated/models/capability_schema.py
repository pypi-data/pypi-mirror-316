...
class CapabilitySchema(BaseModel):
    """
    The schema for a capability, including its input arguments and output.
    """ # noqa: E501
    argument: Dict[str, Any] = Field(description="JSON schema for the input arguments of the capability.")
    output: Dict[str, Any] = Field(description="JSON schema for the output of the capability.")
    description: Optional[StrictStr] = Field(default=None, description="An optional 1-2 sentence description of any unusual behaviors of the capability, rendered for the end user.")
    __properties: ClassVar[List[str]] = ["argument", "output", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapabilitySchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapabilitySchema from a dict"""
        if obj is None:
            return None
