...
class AuthorizationUrl(BaseModel):
    ...
    """ # noqa: E501
    authorization_url: StrictStr = Field(description="The authorization URL to redirect the user to.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthorizationUrl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthorizationUrl from a dict"""
        if obj is None:
            return None
