...
""",
    ...
    optimize_parser.add_argument(
        ...
        type=str,
        default=None,
        help="Your DockerHub username to fetch digests from DockerHub (alternatively, set the DOCKERHUB_USERNAME environment variable)",
    )
    optimize_parser.add_argument(
        "--dockerhub-password",
        type=str,
        default=None,
        help="Your DockerHub password to fetch digests from DockerHub (alternatively, set the DOCKERHUB_PASSWORD environment variable)",
    )
