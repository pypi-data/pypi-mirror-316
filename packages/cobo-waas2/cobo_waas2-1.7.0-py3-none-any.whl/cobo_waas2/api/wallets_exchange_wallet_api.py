...
class WalletsExchangeWalletApi:
    ...
    def list_asset_balances_for_exchange_wallet(
        ...
        trading_account_types: Annotated[Optional[StrictStr], Field(description="A list of trading account types, separated by comma. You can get the the supported trading account types of an exchange by calling [List supported exchanges](/v2/api-references/wallets--exchange-wallet/list-supported-exchanges).")] = None,
        ...
        :type wallet_id: str
        :param trading_account_types: A list of trading account types, separated by comma. You can get the the supported trading account types of an exchange by calling [List supported exchanges](/v2/api-references/wallets--exchange-wallet/list-supported-exchanges).
