...
class BoardStackupLayer(google.protobuf.message.Message):
    ...
    COPPER_FIELD_NUMBER: builtins.int
    ...
    @property
    def copper(self) -> global___BoardStackupCopperLayer:
        ...

    def __init__(self, *, thickness: common.types.base_types_pb2.Distance | None=..., layer: board.board_types_pb2.BoardLayer.ValueType=..., enabled: builtins.bool=..., copper: global___BoardStackupCopperLayer | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['copper', b'copper', 'item', b'item', 'thickness', b'thickness']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['copper', b'copper', 'enabled', b'enabled', 'item', b'item', 'layer', b'layer', 'thickness', b'thickness']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['item', b'item']) -> typing.Literal['copper'] | None:
        ...
