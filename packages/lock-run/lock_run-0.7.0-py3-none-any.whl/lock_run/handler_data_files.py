...
class CipherFile(HandleFiles):
    ...
    def handler_with_path(self):
        ...
        return self.handler(path_to_save=root_dir)

    def handler(self, path_to_save: str) -> tuple[str, str]:
        error_files = self.can_be_cipher()

        root_dir = path_to_save
        ...
        return super().handler(new_text="test", key=key, path=root_dir)
