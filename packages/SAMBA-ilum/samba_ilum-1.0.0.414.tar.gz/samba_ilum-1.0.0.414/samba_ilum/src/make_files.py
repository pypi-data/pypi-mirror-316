...
#----------------------------------------------------------------------------
# Verificando se os arquivos POSCAR estão escritos em coordenadas diretas ---
#----------------------------------------------------------------------------
...
for i in range(len(files)):
    ...
    if (test == 0):
       ...
       print(f'-----------------------------------------------')
       print(f'Devem estar escritos em coordenadas diretas ---')
       print(f'tag "Selective dynamics" não suportada --------')
       print(f'===============================================')
       print(f' ')
       #==========
       sys.exit()   
...
if (os.path.getsize(dir_out + '/correspondence.txt') == 0): os.remove(dir_out + '/correspondence.txt')
#-----------------------------------------------------------------------------------------------------
    ...
    for j in range(len(task)):
        ...
        if (task[j][:5] != 'bader'):
           ...
           if (task[j][:5] == 'relax'):
              ...
              shutil.copyfile(dir_incar, dir_output)
              with open(dir_output, "r") as file:  content = file.read()
              content = content.replace('NSW = 999', 'NSW = 0')
              with open(dir_output, "w") as file: file.write(content)
        #------------------------------------------------------------
