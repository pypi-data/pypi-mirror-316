...
class HistogramChart:
    ...
    def list2more_histogram(data: List[dict], title: str = "", unit: str = "",
                            x_name: str = "", y_name: str = "", x_key="key", y_key="value", chart_type="bar", **kwargs):
        """
        多柱状图
        :param way: 扩展属性
    ...
    def list2histogram(data: List[dict], title: str = "",
                       ...
                       x_order: Union[bool, type(None)] = False, **kwargs):
        """
        单/多柱状图
            ...
            for i, _ in enumerate(data):
                ...
                if isinstance(_data, dict):
                    for _i in x:
                        ...
                        tmp.append(_value)
                    series.append(
                        {"name": name, "unit": unit, "type": chart_type, "data": tmp, "index": i})
