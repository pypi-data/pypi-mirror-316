...
class TouchStampC:
    ...
    def search_note(self):
        with Session(ENGINE) as session:
            search=Prompt.__init2__(None,func=FormBuilderMkText,ptext="What are looking for?",helpText="search term",data="string")
            if search in ['d',None]:
                return
            ...
            for num,i in enumerate(results):
                ...
                msg=f'{color}{num}/{num+1} of {ct} - {i.Note} - {i.Timestamp}{Style.reset}'
                print(msg)
            ...
            while True:
                ...
                for i in process:
                    ...
                    if ct > 0:
                        ...
                        for num,i in enumerate(results):
                            try:
                                msg=f"{num}/{num+1} of {ct} -> {i.LastName},{i.FirstName}"
                                htext.append(msg)
                            except Exception as e:
                                print(e,repr(e))
                        htext='\n'.join(htext)
