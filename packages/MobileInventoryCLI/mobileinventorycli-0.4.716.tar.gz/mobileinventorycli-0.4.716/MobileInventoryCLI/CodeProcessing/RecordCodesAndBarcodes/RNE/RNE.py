			...
			while True:
				...
				try:
					...
					for num,i in enumerate(dates):
						...
						print(f"{Fore.light_green}{num}/{Fore.light_yellow}{num+1} of {Fore.light_red}{ct}{Fore.dark_goldenrod} -> {Fore.light_magenta}{i.Name}|{Fore.plum_2}{i.Barcode}|{Fore.cyan}{bb}|{Fore.medium_violet_red}{doe}{Style.reset}")
		...
		with Session(ENGINE) as session:
			while True:
				...
				for num,i in enumerate(dates):
					bb=i.BB_Expiry.strftime("%m/%d/%Y")
					doe=i.BB_Expiry.strftime("%m/%d/%Y")
					m=f"{Fore.light_green}{num}/{Fore.light_yellow}{num+1} of {Fore.light_red}{ct}{Fore.dark_goldenrod} -> {Fore.light_magenta}{i.Name}|{Fore.plum_2}{i.Barcode}|{Fore.cyan}{bb}|{Fore.medium_violet_red}{doe}{Style.reset}"
					print(m)
				msg=f"{Fore.light_green}Zero-Index/{Fore.light_yellow}Number of {Fore.light_red}Total{Fore.dark_goldenrod} -> {Fore.light_magenta}Name|{Fore.plum_2}Barcode|{Fore.cyan}BB_Expiry|{Fore.medium_violet_red}DTOE{Style.reset}"
				print(msg)
		...
		with Session(ENGINE) as session:
			while True:
				...
				if ct == 0:
					...
					for num,entry in enumerate(results):
						msg=f'''{Fore.light_yellow}{num}/{Fore.dark_goldenrod}{num+1}/{Fore.light_red}{ct}{Fore.light_magenta} -> {Fore.light_green}{entry.Barcode}|{Fore.green_yellow}{entry.Name}|{entry.Note}|{Fore.orange_red_1}{Style.bold}{entry.BB_Expiry}|{Fore.medium_violet_red}{Style.bold}{entry.DTOE}{Style.reset}'''
						print(msg)
