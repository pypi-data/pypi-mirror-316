...
def evaluateFIM(benchmark_path, candidate_paths, gdf, folder, method, shapefile=None):
...
def EvaluateFIM(main_dir, PWD_dir, method_name, shapefile_dir=None):
    main_dir = Path(main_dir)

    # Read the permanent water bodies
    gdf = gpd.read_file(PWD_dir)
