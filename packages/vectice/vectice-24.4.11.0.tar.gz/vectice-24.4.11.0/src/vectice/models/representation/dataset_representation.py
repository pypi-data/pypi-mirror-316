...
class DatasetRepresentation:
    ...
    @deprecate(
        ...
        fail_at="24.4.1",
        remove_at="25.1.1",
        reason="versions_list is deprecated. Use list_versions instead",
    )
    def versions_list(
        ...
        convert_origins = process_versions_origins(clean_version_list)
        converted_version_list = [
            convert_keys_to_snake_case(versions) for versions in convert_origins  # pyright: ignore[reportArgumentType]
        ]
