...
class CommissionAgreementVersionsApi(object):
    ...
    def create_commission_agreement_version(
        ...
        **kwargs
        ...
        This will create the commission agreement version.  # noqa: E501
    ...
    def delete_commission_agreement_version(
        ...
        **kwargs
        ...
        Permanently deletes the commission agreement version. Supply the unique code that was returned when you created the commission agreement version and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_commission_agreement_version(
        ...
        **kwargs
        ...
        Retrieves the details of the commission agreement version that was previously created. Supply the unique commission agreement version code      that was returned when you created it and Emil Api will return the corresponding commission agreement version information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_commission_agreement_versions(
        ...
        **kwargs
        ...
        Returns a list of commission agreement versions you have previously created.          The commission agreement versions are returned in sorted order, with the oldest one appearing first.          For more information about pagination, read the Pagination documentation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
