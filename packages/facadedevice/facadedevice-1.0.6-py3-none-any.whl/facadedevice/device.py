...
from tango import DevFailed, DevState, DispLevel, EventData, EventType
from tango.server import command

from facadedevice.exception import context, to_dev_failed
from facadedevice.graph import INVALID, Graph, triplet
...
class Facade(_Facade):
    ...
    - :class:`facadedevice.local_attribute`
    - :class:`facadedevice.logical_attribute`
    - :class:`facadedevice.proxy_attribute`
    - :class:`facadedevice.combined_attribute`
    - `:class:`facadedevice.state_attribute`
    - :class:`facadedevice.proxy_command`
