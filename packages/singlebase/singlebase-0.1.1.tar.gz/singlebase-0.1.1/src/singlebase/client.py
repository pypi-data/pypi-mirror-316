...
class Client(object):
    ...
    def _make_db_factory(self, is_async: bool = False):
        ...
        """
        request_method = self.dispatch_async if is_async else self.dispatch
    ...
    def dispatch(self, payload: dict, headers: dict = {}) -> Result:
        """
    ...
    async def dispatch_async(self, payload: dict, headers: dict = {}) -> Result:
        """
