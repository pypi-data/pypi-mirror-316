...
import PyMVPA
from PyMVPA.base import cfg
from PyMVPA.misc.data_generators import *
from PyMVPA.clfs.knn import kNN
from PyMVPA.misc.plot import *

PyMVPA.seed(0)                            # to reproduce the plot
