...
class DynamoDbOnlineStore(_message.Message):
    ...
    enabled: bool
    def __init__(self, cross_account_role_arn: _Optional[str] = ..., cross_account_external_id: _Optional[str] = ..., cross_account_intermediate_role_arn: _Optional[str] = ..., enabled: bool = ..., dbfs_credentials_path: _Optional[str] = ...) -> None: ...
...
class RealtimeFeatureView(_message.Message):
    __slots__ = ["attributes", "calculations", "no_op", "supported_environments"]
    ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, no_op: bool = ..., supported_environments: _Optional[_Iterable[_Union[_realtime_compute__client_pb2.RemoteFunctionComputeConfig, _Mapping]]] = ..., attributes: _Optional[_Iterable[_Union[Attribute, _Mapping]]] = ..., calculations: _Optional[_Iterable[_Union[Calculation, _Mapping]]] = ...) -> None: ...
