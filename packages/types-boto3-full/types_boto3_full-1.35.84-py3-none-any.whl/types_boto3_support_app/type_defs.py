...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_support_app/type_defs/)

Usage::

    ```python
    from types_boto3_support_app.type_defs import CreateSlackChannelConfigurationRequestRequestTypeDef
