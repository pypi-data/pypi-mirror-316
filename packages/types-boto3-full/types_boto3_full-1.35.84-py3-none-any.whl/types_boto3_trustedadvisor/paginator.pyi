...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/)
...
class ListChecksPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/#listcheckspaginator)
    """
    def paginate(
...
class ListOrganizationRecommendationAccountsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/#listorganizationrecommendationaccountspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListOrganizationRecommendationResourcesPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/#listorganizationrecommendationresourcespaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListOrganizationRecommendationsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/#listorganizationrecommendationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListRecommendationsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_trustedadvisor/paginators/#listrecommendationspaginator)
    """
    def paginate(
