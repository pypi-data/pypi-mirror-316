...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/)
...
Usage::
    ...
    from types_boto3_schemas.paginator import (
...
class ListDiscoverersPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/#listdiscovererspaginator)
    """
    def paginate(
...
class ListRegistriesPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/#listregistriespaginator)
    """
    def paginate(
...
class ListSchemaVersionsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/#listschemaversionspaginator)
    """
    def paginate(
...
class ListSchemasPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/#listschemaspaginator)
    """
    def paginate(
...
class SearchSchemasPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_schemas/paginators/#searchschemaspaginator)
    """
    def paginate(
