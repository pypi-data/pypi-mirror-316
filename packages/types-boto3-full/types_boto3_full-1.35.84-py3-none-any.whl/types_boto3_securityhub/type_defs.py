...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_securityhub/type_defs/)

Usage::

    ```python
    from types_boto3_securityhub.type_defs import AcceptAdministratorInvitationRequestRequestTypeDef
...
class ListConfigurationPolicyAssociationsRequestListConfigurationPolicyAssociationsPaginateTypeDef(
    TypedDict
):
    Filters: NotRequired[AssociationFiltersTypeDef]
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
...
SignalTypeDef = TypedDict(
    "SignalTypeDef",
    {
        ...
        "SignalIndicators": NotRequired[Sequence[IndicatorUnionTypeDef]],
        "Name": NotRequired[str],
        "CreatedAt": NotRequired[int],
        "UpdatedAt": NotRequired[int],
        "FirstSeenAt": NotRequired[int],
...
class SequenceTypeDef(TypedDict):
    ...
    SequenceIndicators: NotRequired[Sequence[IndicatorTypeDef]]
