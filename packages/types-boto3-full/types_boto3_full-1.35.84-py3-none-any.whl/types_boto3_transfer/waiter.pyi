...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_transfer/waiters/)
...
Usage::
    ...
    from types_boto3_transfer.waiter import (
        ServerOfflineWaiter,
        ServerOnlineWaiter,
    )
...
class ServerOfflineWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_transfer/waiters/#serverofflinewaiter)
    """
...
class ServerOnlineWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_transfer/waiters/#serveronlinewaiter)
    """
