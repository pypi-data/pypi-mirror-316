...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/)
...
class MigrationHubConfigClient(BaseClient):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/migrationhub-config.html#MigrationHubConfig.Client)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#generate_presigned_url)
        """
    ...
    def close(self) -> None:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#close)
        """
    ...
    def create_home_region_control(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#create_home_region_control)
        """
    ...
    def delete_home_region_control(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#delete_home_region_control)
        """
    ...
    def describe_home_region_controls(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#describe_home_region_controls)
        """
    ...
    def get_home_region(self) -> GetHomeRegionResultTypeDef:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_migrationhub_config/client/#get_home_region)
        """
