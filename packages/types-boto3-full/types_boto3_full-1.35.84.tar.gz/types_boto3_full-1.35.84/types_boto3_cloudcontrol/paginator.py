...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_cloudcontrol/paginators/)
...
Usage::
    ...
    from types_boto3_cloudcontrol.paginator import (
...
class ListResourceRequestsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_cloudcontrol/paginators/#listresourcerequestspaginator)
    """
...
class ListResourcesPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_cloudcontrol/paginators/#listresourcespaginator)
    """
