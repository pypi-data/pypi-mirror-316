...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/)
...
class SSOClient(BaseClient):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sso.html#SSO.Client)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#generate_presigned_url)
        """

    def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sso/client/close.html)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#close)
        """
    ...
    def get_role_credentials(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#get_role_credentials)
        """
    ...
    def list_account_roles(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#list_account_roles)
        """
    ...
    def list_accounts(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#list_accounts)
        """
    ...
    def logout(self, **kwargs: Unpack[LogoutRequestRequestTypeDef]) -> EmptyResponseMetadataTypeDef:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#logout)
        """
    ...
    def get_paginator(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sso/client/#get_paginator)
        """
