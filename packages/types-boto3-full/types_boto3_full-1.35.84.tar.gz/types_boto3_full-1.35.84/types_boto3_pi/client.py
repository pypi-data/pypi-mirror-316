...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pi/client/)
...
class PIClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pi/client/#close)
        """
