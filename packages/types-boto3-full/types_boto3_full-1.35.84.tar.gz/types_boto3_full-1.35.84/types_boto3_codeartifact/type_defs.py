...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_codeartifact/type_defs/)
...
class ListAllowedRepositoriesForGroupRequestListAllowedRepositoriesForGroupPaginateTypeDef(
    TypedDict
):
    domain: str
    packageGroup: str
