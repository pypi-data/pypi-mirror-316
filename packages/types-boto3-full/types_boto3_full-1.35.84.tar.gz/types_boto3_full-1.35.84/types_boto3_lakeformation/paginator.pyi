...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/)
...
Usage::
    ...
    from types_boto3_lakeformation.paginator import (
...
class GetWorkUnitsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#getworkunitspaginator)
    """
    def paginate(
...
class ListDataCellsFilterPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#listdatacellsfilterpaginator)
    """
    def paginate(
...
class ListLFTagExpressionsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#listlftagexpressionspaginator)
    """
    def paginate(
...
class ListLFTagsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#listlftagspaginator)
    """
    def paginate(
...
class SearchDatabasesByLFTagsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#searchdatabasesbylftagspaginator)
    """
    def paginate(
...
class SearchTablesByLFTagsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_lakeformation/paginators/#searchtablesbylftagspaginator)
    """
    def paginate(
