...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/)
...
class Route53RecoveryClusterClient(BaseClient):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53-recovery-cluster.html#Route53RecoveryCluster.Client)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#generate_presigned_url)
        """
    ...
    def close(self) -> None:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#close)
        """
    ...
    def get_routing_control_state(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#get_routing_control_state)
        """
    ...
    def list_routing_controls(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#list_routing_controls)
        """
    ...
    def update_routing_control_state(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#update_routing_control_state)
        """
    ...
    def update_routing_control_states(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#update_routing_control_states)
        """
    ...
    def get_paginator(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_cluster/client/#get_paginator)
        """
