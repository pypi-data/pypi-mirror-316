...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/)
...
Usage::
    ...
    from types_boto3_opsworks.waiter import (
        AppExistsWaiter,
...
class AppExistsWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#appexistswaiter)
    """
...
class DeploymentSuccessfulWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#deploymentsuccessfulwaiter)
    """
    def wait(
...
class InstanceOnlineWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#instanceonlinewaiter)
    """
...
class InstanceRegisteredWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#instanceregisteredwaiter)
    """
...
class InstanceStoppedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#instancestoppedwaiter)
    """
...
class InstanceTerminatedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opsworks/waiters/#instanceterminatedwaiter)
    """
