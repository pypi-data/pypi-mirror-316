...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_pca_connector_ad/type_defs/)
...
class ListTemplateGroupAccessControlEntriesRequestListTemplateGroupAccessControlEntriesPaginateTypeDef(
    TypedDict
):
    TemplateArn: str
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
