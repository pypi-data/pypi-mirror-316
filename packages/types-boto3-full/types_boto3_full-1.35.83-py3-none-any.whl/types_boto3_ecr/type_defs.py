...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_ecr/type_defs/)
...
class DescribeRepositoryCreationTemplatesRequestDescribeRepositoryCreationTemplatesPaginateTypeDef(
    TypedDict
):
    prefixes: NotRequired[Sequence[str]]
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
