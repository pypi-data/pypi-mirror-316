...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_detective/type_defs/)

Usage::

    ```python
    from types_boto3_detective.type_defs import AcceptInvitationRequestRequestTypeDef
