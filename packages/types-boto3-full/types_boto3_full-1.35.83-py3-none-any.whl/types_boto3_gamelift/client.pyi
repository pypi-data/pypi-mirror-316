...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_gamelift/client/)
...
class GameLiftClient(BaseClient):
    ...
    def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/gamelift/client/close.html)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_gamelift/client/#close)
        """
    ...
    def create_container_fleet(
        self, **kwargs: Unpack[CreateContainerFleetInputRequestTypeDef]
    ) -> CreateContainerFleetOutputTypeDef:
        """
    ...
    def delete_container_fleet(
        self, **kwargs: Unpack[DeleteContainerFleetInputRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    def describe_container_fleet(
        self, **kwargs: Unpack[DescribeContainerFleetInputRequestTypeDef]
    ) -> DescribeContainerFleetOutputTypeDef:
        """
    ...
    def describe_fleet_deployment(
        self, **kwargs: Unpack[DescribeFleetDeploymentInputRequestTypeDef]
    ) -> DescribeFleetDeploymentOutputTypeDef:
        """
    ...
    def list_container_fleets(
        self, **kwargs: Unpack[ListContainerFleetsInputRequestTypeDef]
    ) -> ListContainerFleetsOutputTypeDef:
        """
    ...
    def list_container_group_definition_versions(
        self, **kwargs: Unpack[ListContainerGroupDefinitionVersionsInputRequestTypeDef]
    ) -> ListContainerGroupDefinitionVersionsOutputTypeDef:
        """
    ...
    def list_fleet_deployments(
        self, **kwargs: Unpack[ListFleetDeploymentsInputRequestTypeDef]
    ) -> ListFleetDeploymentsOutputTypeDef:
        """
    ...
    def update_container_fleet(
        self, **kwargs: Unpack[UpdateContainerFleetInputRequestTypeDef]
    ) -> UpdateContainerFleetOutputTypeDef:
        """
    ...
    def update_container_group_definition(
        self, **kwargs: Unpack[UpdateContainerGroupDefinitionInputRequestTypeDef]
    ) -> UpdateContainerGroupDefinitionOutputTypeDef:
        """
