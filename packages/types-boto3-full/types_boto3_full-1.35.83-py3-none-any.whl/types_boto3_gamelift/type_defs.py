...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_gamelift/type_defs/)

Usage::

    ```python
    from types_boto3_gamelift.type_defs import AcceptMatchInputRequestTypeDef
...
class DescribeMatchmakingConfigurationsInputDescribeMatchmakingConfigurationsPaginateTypeDef(
    TypedDict
):
    Names: NotRequired[Sequence[str]]
    RuleSetName: NotRequired[str]
...
class ListContainerGroupDefinitionVersionsInputListContainerGroupDefinitionVersionsPaginateTypeDef(
    TypedDict
):
    Name: str
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
