...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/type_defs/)

Usage::

    ```python
    from types_boto3_elasticbeanstalk.type_defs import AbortEnvironmentUpdateMessageRequestTypeDef
...
class DescribeEnvironmentManagedActionHistoryRequestDescribeEnvironmentManagedActionHistoryPaginateTypeDef(
    TypedDict
):
    EnvironmentId: NotRequired[str]
    EnvironmentName: NotRequired[str]
