...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_compute_optimizer/type_defs/)
...
class DescribeRecommendationExportJobsRequestDescribeRecommendationExportJobsPaginateTypeDef(
    TypedDict
):
    jobIds: NotRequired[Sequence[str]]
    filters: NotRequired[Sequence[JobFilterTypeDef]]
...
class GetEnrollmentStatusesForOrganizationRequestGetEnrollmentStatusesForOrganizationPaginateTypeDef(
    TypedDict
):
...
class GetLambdaFunctionRecommendationsRequestGetLambdaFunctionRecommendationsPaginateTypeDef(
    TypedDict
):
