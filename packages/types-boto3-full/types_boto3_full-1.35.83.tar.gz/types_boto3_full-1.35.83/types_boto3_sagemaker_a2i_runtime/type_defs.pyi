...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sagemaker_a2i_runtime/type_defs/)

Usage::

    ```python
    from types_boto3_sagemaker_a2i_runtime.type_defs import DeleteHumanLoopRequestRequestTypeDef
