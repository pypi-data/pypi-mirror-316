...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_launch_wizard/type_defs/)

Usage::

    ```python
    from types_boto3_launch_wizard.type_defs import CreateDeploymentInputRequestTypeDef
