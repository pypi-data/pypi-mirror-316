...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/)
...
class STSClient(BaseClient):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sts.html#STS.Client)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#generate_presigned_url)
        """

    def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sts/client/close.html)
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#close)
        """
    ...
    def assume_role(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#assume_role)
        """
    ...
    def assume_role_with_saml(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#assume_role_with_saml)
        """
    ...
    def assume_role_with_web_identity(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#assume_role_with_web_identity)
        """
    ...
    def assume_root(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#assume_root)
        """
    ...
    def decode_authorization_message(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#decode_authorization_message)
        """
    ...
    def get_access_key_info(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#get_access_key_info)
        """
    ...
    def get_caller_identity(self) -> GetCallerIdentityResponseTypeDef:
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#get_caller_identity)
        """
    ...
    def get_federation_token(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#get_federation_token)
        """
    ...
    def get_session_token(
        ...
        [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_sts/client/#get_session_token)
        """
