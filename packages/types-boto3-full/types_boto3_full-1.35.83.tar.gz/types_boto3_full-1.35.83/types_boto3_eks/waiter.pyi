...
class AddonActiveWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#addonactivewaiter)
    """
...
class AddonDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#addondeletedwaiter)
    """
...
class ClusterActiveWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#clusteractivewaiter)
    """
...
class ClusterDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#clusterdeletedwaiter)
    """
...
class FargateProfileActiveWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#fargateprofileactivewaiter)
    """
    def wait(
...
class FargateProfileDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#fargateprofiledeletedwaiter)
    """
    def wait(
...
class NodegroupActiveWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#nodegroupactivewaiter)
    """
...
class NodegroupDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_eks/waiters/#nodegroupdeletedwaiter)
    """
