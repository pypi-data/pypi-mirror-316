...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_greengrass/type_defs/)

Usage::

    ```python
    from types_boto3_greengrass.type_defs import AssociateRoleToGroupRequestRequestTypeDef
