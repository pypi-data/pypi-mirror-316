...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/type_defs/)
...
class DescribeOrderableReplicationInstancesMessageDescribeOrderableReplicationInstancesPaginateTypeDef(
    TypedDict
):
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
...
class DescribeReplicationSubnetGroupsMessageDescribeReplicationSubnetGroupsPaginateTypeDef(
    TypedDict
):
    Filters: NotRequired[Sequence[FilterTypeDef]]
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]

class DescribeReplicationTaskAssessmentResultsMessageDescribeReplicationTaskAssessmentResultsPaginateTypeDef(
    TypedDict
):
    ReplicationTaskArn: NotRequired[str]
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
