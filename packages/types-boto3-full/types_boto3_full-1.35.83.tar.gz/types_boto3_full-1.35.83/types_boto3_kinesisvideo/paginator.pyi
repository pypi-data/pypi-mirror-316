...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesisvideo/paginators/)
...
Usage::
    ...
    from types_boto3_kinesisvideo.paginator import (
...
class DescribeMappedResourceConfigurationPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesisvideo/paginators/#describemappedresourceconfigurationpaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListEdgeAgentConfigurationsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesisvideo/paginators/#listedgeagentconfigurationspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
...
class ListSignalingChannelsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesisvideo/paginators/#listsignalingchannelspaginator)
    """
    def paginate(
...
class ListStreamsPaginator(Paginator):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_kinesisvideo/paginators/#liststreamspaginator)
    """
    def paginate(
