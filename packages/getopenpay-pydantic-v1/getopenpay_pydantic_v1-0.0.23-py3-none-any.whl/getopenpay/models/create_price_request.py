...
class CreatePriceRequest(BaseModel):
  ...
  listed_exclusively_for_customers: Optional[conlist(StrictStr)] = None
  ...
  unit_amount_atom: Optional[StrictInt] = Field(...)
  ...
  price_tiers: Optional[conlist(PriceTierParams)] = None
  price_type: PriceTypeEnum = Field(...)
  ...
  trial_period_days: Optional[StrictInt] = Field(
    0, description='Number of trail days for this Price.'
  )
  ...
  can_only_be_purchased_with: Optional[conlist(StrictStr)] = None
  meta: Optional[Dict[str, Any]] = None
  meter_id: Optional[StrictStr] = None
  product_id: StrictStr = Field(..., description='Unique identifier of the product.')
  is_default: Optional[StrictBool] = None
  __properties = [
    'is_exclusive', 'listed_exclusively_for_customers', 'is_active', 'name', 'internal_description',
    'pricing_model', 'unit_amount_atom', 'transform_quantity_divide_by', 'currency', 'price_tiers',
    'price_type', 'billing_interval', 'billing_interval_count', 'contract_term_multiple',
    'contract_auto_renew', 'trial_period_days', 'usage_type', 'aggregate_usage', 'default_net_d',
    'can_only_be_purchased_with', 'meta', 'meter_id', 'product_id', 'is_default'
  ]
