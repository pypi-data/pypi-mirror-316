...
class TokenizedCreditCardExternal(BaseModel):
  ...
  display_name: StrictStr = Field(
    ..., description='Display name for the payment method to show on the UI.'
  )
  ...
  is_full_details_known: StrictBool = Field(
    ..., description='Indicates if full details of the card are known'
  )
  cde_external_id: Optional[StrictStr] = None
  __properties = [
    'id', 'object', 'created_at', 'updated_at', 'is_deleted', 'customer_id', 'billing_address',
    'metadata', 'provider', 'card_type', 'last_four', 'display_name', 'expiry_date',
    'card_fingerprint', 'card_iin', 'card_country', 'card_brand', 'card_issuer',
    'is_full_details_known', 'cde_external_id'
  ]
