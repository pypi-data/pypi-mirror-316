from typing import Any, Required, List, Literal, Union, TypedDict
...
class CheckConfig(TypedDict, total=False):
    ...
    region_schedule_mode: "_CheckConfigRegionScheduleMode"
...
_CheckConfigRegionScheduleMode = Union[Literal['round_robin']]
""" Defines how we'll schedule checks based on other active regions. """
_CHECKCONFIGREGIONSCHEDULEMODE_ROUND_ROBIN: Literal['round_robin'] = "round_robin"
"""The values for the 'Defines how we'll schedule checks based on other active regions' enum"""
