...
parser.add_argument('-gced', '--groupchatdocker', action='store_true', dest='groupchatdocker', help="group chat feature; execute code in docker")
parser.add_argument('-gcet', '--groupchatexecutiontimeout', action='store', dest='groupchatexecutiontimeout', type=int, help="group chat feature; timeout for each code execution in seconds")
...
def main(chat: bool = False, defaultTool=None, chatSystem=None):
    ...
    if args.information or args.models or args.viewconfigs:
        ...
        data = {
            ...
            "groupchatdocker": True if args.groupchatdocker else False,
            "groupchatexecutiontimeout": args.groupchatexecutiontimeout,
