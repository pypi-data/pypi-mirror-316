...
class State(object):
    ...
    def position(self) -> np.ndarray:
        ...
        Shorthand to :attr:`State.pose.translation`.
        """
...
class DeviceState(State):
    ...
    Generated by calling the :meth:`state<Device.state>` property of a :class:`Device`.
    ...
    def transmit_state(
        ...
        Args:
            ...
            selected_digital_transmit_ports (Sequence[int], optional):
    ...
    def receive_state(
        ...
        Args:
            ...
            selected_digital_receive_ports (Sequence[int], optional):
    ...
    def Basic(
        ...
        Args:
            ...
            num_digital_transmit_ports (int, optional):
                Number of digital transmit streams feeding into the device's signal encoding layer.
                This is the number of streams expected to be generated by transmit DSP algorithms by default.

            num_digital_receive_ports (int, optional):
                Number of digital receive streams emerging from the device's signal decoding layer.
                This the number of streams expected to be feeding into receive DSP algorithms by default.
