...
constexpr int API_polar_static_intra_32bit<B,R,F,G,G0,H,XO,FI,GI,G0I,HI,XOI>
::get_n_frames()
{
	return 1;
}
...
template <typename B, typename R, proto_f  <R> F , proto_g  <B,R> G , proto_g0  <R> G0 , proto_h  <B,R> H , proto_xo  <B> XO,
                                  proto_f_i<R> FI, proto_g_i<B,R> GI, proto_g0_i<R> G0I, proto_h_i<B,R> HI, proto_xo_i<B> XOI>
template <typename T>
bool API_polar_static_intra_32bit<B,R,F,G,G0,H,XO,FI,GI,G0I,HI,XOI>
...
void API_polar_static_intra_32bit<B,R,F,G,G0,H,XO,FI,GI,G0I,HI,XOI>
::f(const R * l_a, const R * l_b, R * l_c, const int n_elmts)
{
	f_intra_32bit<R, F, FI, N_ELMTS>::apply(l_a, l_b, l_c, n_elmts);
}
...
{
	g_intra_32bit<B, R, G, GI, N_ELMTS>::apply(l_a, l_b, s_a, l_c, n_elmts);
}
...
{
	g0_intra_32bit<R, G0, G0I, N_ELMTS>::apply(l_a, l_b, l_c, n_elmts);
}
...
::gr(const R * l_a, const R * l_b, const B * s_a, R * l_c,
     const int n_elmts)
{
	gr_intra_32bit<B, R, G, GI, N_ELMTS>::apply(l_a, l_b, s_a, l_c, n_elmts);
}
...
{
	h_intra_32bit<B, R, H, HI, N_ELMTS>::apply(l_a, s_a, n_elmts);
}
...
{
	rep_intra_32bit<B, R, H, HI, N_ELMTS>::apply(l_a, s_a, n_elmts);
}
...
{
	return spc_intra_32bit<B, R, H, HI, N_ELMTS>::apply(l_a, s_a, n_elmts);
}
...
{
	xo_intra_32bit<B, XO, XOI, N_ELMTS>::apply(s_a, s_b, s_c, n_elmts);
}
...
{
	xo0_intra_32bit<B, N_ELMTS>::apply(s_b, s_c, n_elmts);
}
