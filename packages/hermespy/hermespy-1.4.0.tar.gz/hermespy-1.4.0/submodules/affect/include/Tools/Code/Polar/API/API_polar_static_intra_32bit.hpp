/*!
 * \file
 * \brief Class tools::API_polar_static_intra_32bit.
 */
...
class API_polar_static_intra_32bit : public API_polar
{
public:
	...
	template <int N_ELMTS = 0>
	static void gr(const R * l_a, const R * l_b, const B * s_a, R * l_c, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static bool spc(const R * l_a, B * s_a, const int n_elmts = 0);
...
#include "Tools/Code/Polar/API/API_polar_static_intra_32bit.hxx"
#endif

#endif /* API_POLAR_INTRA_STATIC_32BIT_HPP_ */
