...
public:
	...
	template <int N_ELMTS = 0>
	static void g(const R * l_a, const R * l_b, const B * s_a, R * l_c, const int init_shift, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static void gr(const R * l_a, const R * l_b, const B * s_a, R * l_c, const int init_shift, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static void h(const R * l_a, B * s_a, const int init_shift, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static void h0(B * s_a, const int init_shift, const int n_elmts = 0);

	template <int N_ELMTS = 0, class A = std::allocator<B>>
	static void h0(std::vector<B,A> &s, const int off_s_a, const int n_elmts = 0);

	template <int N_ELMTS = 0>
	static void rep(const R * l_a, B * s_a, const int init_shift, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static void spc(const R * l_a, B * s_a, const int init_shift, const int n_elmts = 0);
	...
	template <int N_ELMTS = 0>
	static void xo(const B * s_a, const B * s_b, B * s_c, const int init_shift, const int n_elmts = 0);

	template <int N_ELMTS = 0, class A = std::allocator<B>>
	static void xo(std::vector<B,A> &s, const int off_s_a, const int off_s_b, const int off_s_c, const int n_elmts = 0);

	template <int N_ELMTS = 0>
	static void xo0(const B * s_b, B * s_c, const int init_shift, const int n_elmts = 0);
...
#include "Tools/Code/Polar/API/API_polar_dynamic_inter_8bit_bitpacking.hxx"
#endif
