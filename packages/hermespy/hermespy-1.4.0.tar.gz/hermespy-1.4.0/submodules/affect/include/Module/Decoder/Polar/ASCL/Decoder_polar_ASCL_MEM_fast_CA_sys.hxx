...
{
	Decoder_polar_SCL_MEM_fast_CA_sys<B,R,API_polar>::set_frozen_bits(frozen_bits);
	sc_decoder->set_frozen_bits(frozen_bits);
}

template <typename B, typename R, class API_polar>
const std::vector<bool>& Decoder_polar_ASCL_MEM_fast_CA_sys<B,R,API_polar>
...
template <typename B, typename R, class API_polar>
int Decoder_polar_ASCL_MEM_fast_CA_sys<B,R,API_polar>
