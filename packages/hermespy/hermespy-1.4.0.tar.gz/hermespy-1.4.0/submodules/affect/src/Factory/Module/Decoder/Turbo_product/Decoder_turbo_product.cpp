...
::Decoder_turbo_product(const std::string &prefix)
...
Decoder_turbo_product* Decoder_turbo_product
::clone() const
{
	return new Decoder_turbo_product(*this);
}

std::vector<std::string> Decoder_turbo_product
::get_names() const
{
...
template aff3ct::module::Decoder_SIHO<B_8 ,Q_8 >* aff3ct::factory::Decoder_turbo_product::build<B_8 ,Q_8 >(const aff3ct::module::Decoder_chase_pyndiah<B_8 ,Q_8 > &, const aff3ct::module::Decoder_chase_pyndiah<B_8 ,Q_8 > &, const aff3ct::module::Interleaver<Q_8 >&, module::Encoder<B_8 >*) const;
template aff3ct::module::Decoder_SIHO<B_16,Q_16>* aff3ct::factory::Decoder_turbo_product::build<B_16,Q_16>(const aff3ct::module::Decoder_chase_pyndiah<B_16,Q_16> &, const aff3ct::module::Decoder_chase_pyndiah<B_16,Q_16> &, const aff3ct::module::Interleaver<Q_16>&, module::Encoder<B_16>*) const;
template aff3ct::module::Decoder_SIHO<B_32,Q_32>* aff3ct::factory::Decoder_turbo_product::build<B_32,Q_32>(const aff3ct::module::Decoder_chase_pyndiah<B_32,Q_32> &, const aff3ct::module::Decoder_chase_pyndiah<B_32,Q_32> &, const aff3ct::module::Interleaver<Q_32>&, module::Encoder<B_32>*) const;
template aff3ct::module::Decoder_SIHO<B_64,Q_64>* aff3ct::factory::Decoder_turbo_product::build<B_64,Q_64>(const aff3ct::module::Decoder_chase_pyndiah<B_64,Q_64> &, const aff3ct::module::Decoder_chase_pyndiah<B_64,Q_64> &, const aff3ct::module::Interleaver<Q_64>&, module::Encoder<B_64>*) const;
#else
template aff3ct::module::Decoder_SIHO<B,Q>* aff3ct::factory::Decoder_turbo_product::build<B,Q>(const aff3ct::module::Decoder_chase_pyndiah<B,Q> &, const aff3ct::module::Decoder_chase_pyndiah<B,Q> &, const aff3ct::module::Interleaver<Q>&, module::Encoder<B>*) const;
#endif

#ifdef AFF3CT_MULTI_PREC
template aff3ct::module::Decoder_SISO<B_8 ,Q_8 >* aff3ct::factory::Decoder_turbo_product::build_siso<B_8 ,Q_8 >(const aff3ct::module::Decoder_chase_pyndiah<B_8 ,Q_8 > &, const aff3ct::module::Decoder_chase_pyndiah<B_8 ,Q_8 > &, const aff3ct::module::Interleaver<Q_8 >&, module::Encoder<B_8 >*) const;
template aff3ct::module::Decoder_SISO<B_16,Q_16>* aff3ct::factory::Decoder_turbo_product::build_siso<B_16,Q_16>(const aff3ct::module::Decoder_chase_pyndiah<B_16,Q_16> &, const aff3ct::module::Decoder_chase_pyndiah<B_16,Q_16> &, const aff3ct::module::Interleaver<Q_16>&, module::Encoder<B_16>*) const;
template aff3ct::module::Decoder_SISO<B_32,Q_32>* aff3ct::factory::Decoder_turbo_product::build_siso<B_32,Q_32>(const aff3ct::module::Decoder_chase_pyndiah<B_32,Q_32> &, const aff3ct::module::Decoder_chase_pyndiah<B_32,Q_32> &, const aff3ct::module::Interleaver<Q_32>&, module::Encoder<B_32>*) const;
template aff3ct::module::Decoder_SISO<B_64,Q_64>* aff3ct::factory::Decoder_turbo_product::build_siso<B_64,Q_64>(const aff3ct::module::Decoder_chase_pyndiah<B_64,Q_64> &, const aff3ct::module::Decoder_chase_pyndiah<B_64,Q_64> &, const aff3ct::module::Interleaver<Q_64>&, module::Encoder<B_64>*) const;
#else
template aff3ct::module::Decoder_SISO<B,Q>* aff3ct::factory::Decoder_turbo_product::build_siso<B,Q>(const aff3ct::module::Decoder_chase_pyndiah<B,Q> &, const aff3ct::module::Decoder_chase_pyndiah<B,Q> &, const aff3ct::module::Interleaver<Q>&, module::Encoder<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
