...
::build(const module::Encoder_BCH<B> &enc_r,
...
template aff3ct::module::Encoder_turbo_product<B_8 >* aff3ct::factory::Encoder_turbo_product::build<B_8 >(const aff3ct::module::Encoder_BCH<B_8 >&, const aff3ct::module::Encoder_BCH<B_8 >&, const aff3ct::module::Interleaver<B_8 >&) const;
template aff3ct::module::Encoder_turbo_product<B_16>* aff3ct::factory::Encoder_turbo_product::build<B_16>(const aff3ct::module::Encoder_BCH<B_16>&, const aff3ct::module::Encoder_BCH<B_16>&, const aff3ct::module::Interleaver<B_16>&) const;
template aff3ct::module::Encoder_turbo_product<B_32>* aff3ct::factory::Encoder_turbo_product::build<B_32>(const aff3ct::module::Encoder_BCH<B_32>&, const aff3ct::module::Encoder_BCH<B_32>&, const aff3ct::module::Interleaver<B_32>&) const;
template aff3ct::module::Encoder_turbo_product<B_64>* aff3ct::factory::Encoder_turbo_product::build<B_64>(const aff3ct::module::Encoder_BCH<B_64>&, const aff3ct::module::Encoder_BCH<B_64>&, const aff3ct::module::Interleaver<B_64>&) const;
#else
template aff3ct::module::Encoder_turbo_product<B>* aff3ct::factory::Encoder_turbo_product::build<B>(const aff3ct::module::Encoder_BCH<B>&, const aff3ct::module::Encoder_BCH<B>&, const aff3ct::module::Interleaver<B>&) const;
#endif
// ==================================================================================== explicit template instantiation
