...
class TestDocuments(test_utils.TmpFilesTestBase, cmptest.TestCase):
    ...
    def test_process_documents(self):
        ...
        # Check entries.
        expected_entries, _, __ = loader.load_string(
            textwrap.dedent("""
          option "plugin_processing_mode" "raw"
        ...
        self.assertEqualEntries(
            expected_entries,
            [entry for entry in entries if isinstance(entry, data.Document)],
        )
    ...
    def test_find_documents(self):
        ...
        entries5, errors5 = documents.find_documents(self.tempdir, "/tmp/input.beancount")
...
class TestDocumentsConstraints(test_utils.TmpFilesTestBase, cmptest.TestCase):
    ...
    def test_find_documents__with_leaf_constraints(self):
        ...
        entries, errors = documents.find_documents(
            self.root,
            "/tmp/input.beancount",
            {"Assets:US:Bank:Checking", "Assets:US:Bank:Savings"},
            True,
        )
