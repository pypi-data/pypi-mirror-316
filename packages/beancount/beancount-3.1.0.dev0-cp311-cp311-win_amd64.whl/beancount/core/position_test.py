...
class TestCost(unittest.TestCase):
    ...
    def test_cost_to_str__detail(self):
        ...
        self.assertEqual(
            '101.23 USD, 2015-09-06, "f4412439c31b"',
            position.cost_to_str(cost, self.dformat),
        )

        cost = position.Cost(D("101.23"), "USD", datetime.date(2015, 9, 6), None)
        self.assertEqual("101.23 USD, 2015-09-06", position.cost_to_str(cost, self.dformat))

        cost = position.Cost(D("101.23"), "USD", None, None)
        self.assertEqual("101.23 USD", position.cost_to_str(cost, self.dformat))
...
class TestCostSpec(unittest.TestCase):
    ...
    def test_cost_to_str__detail(self):
        ...
        self.assertEqual(
            '101.23 # 202.46 USD, 2015-09-06, "f4412439c31b", *',
            position.cost_to_str(cost, self.dformat),
        )
        ...
        cost = position.CostSpec(
            D("101.23"), None, "USD", datetime.date(2015, 9, 6), None, True
        )
        self.assertEqual(
            "101.23 USD, 2015-09-06, *", position.cost_to_str(cost, self.dformat)
        )

        cost = position.CostSpec(D("101.23"), D("202.46"), "USD", None, None, False)
        self.assertEqual("101.23 # 202.46 USD", position.cost_to_str(cost, self.dformat))
    ...
    def test_cost_to_str__simple(self):
        ...
        self.assertEqual(
            "101.23 # 202.46 USD", position.cost_to_str(cost, self.dformat, False)
        )
...
class TestPosition(unittest.TestCase):
    ...
    def test_from_amounts(self):
        ...
        self.assertEqual(Position(A("10 HOOL"), Cost(D("510"), "USD", None, None)), pos)
    ...
    def test_mul(self):
        ...
        pos2 = pos * D("3")
        self.assertEqual(position.from_string("6 HOOL {100.00 USD}"), pos2)
    ...
    def test_currency_pair(self):
        self.assertEqual(("USD", None), Position(A("100 USD"), None).currency_pair())
        self.assertEqual(
            ("AAPL", "USD"),
            Position(A("100 AAPL"), Cost("43.23", "USD", None, None)).currency_pair(),
        )
