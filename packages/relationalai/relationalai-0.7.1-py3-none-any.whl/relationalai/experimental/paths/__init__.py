...
from relationalai.dsl import Graph, Instance, Type, create_vars, get_graph, next_id
...
def enable_on(edge: Type, filter_attrs: List[Tuple[Type, Set[str]]]):  # noqa: F821
...
def _get_pathfinder_source():
    ...
    with zipfile.ZipFile(zip_path, 'r') as zip_ref:
        with zip_ref.open('relationalai/experimental/pathfinder.rel') as file:
