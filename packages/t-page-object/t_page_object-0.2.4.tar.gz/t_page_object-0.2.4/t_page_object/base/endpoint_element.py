...
class EndpointElement(metaclass=BugCatcherMeta):
    ...
    def __update_session_with_browser_cookies(self):
        ...
        try:
            ...
            logger.warning("No browser open, did not update session cookies.")
    ...
    def __request(self, method: str, **kwargs) -> dict[str, Any]:
        ...
        logger.info(f"Initiating {method.upper()} request to URL: {self.url}.")
    ...
    def patch(
        ...
        Returns:
            The response content if the request is successful.
        """
        return self.__request("PATCH", data=data, json=json, headers=headers, cookies=cookies, params=params)
    ...
    def post(
        ...
        Returns:
            The response content if the request is successful.
        """
        return self.__request("POST", data=data, json=json, headers=headers, cookies=cookies, params=params)
