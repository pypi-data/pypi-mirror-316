...
class MT5TransactionHelper:
        ...
        try:
            ...
            if result is False:
                ...
                if error[1] == MT5Manager.EnMTAPIRetcode.MT_RET_TRADE_MAX_MONEY:
                    raise MT5ConnectionError("Amount exceeds maximum allowed")
                elif error[1] == MT5Manager.EnMTAPIRetcode.MT_RET_REQUEST_NO_MONEY:
                    raise MT5ConnectionError("Insufficient funds")
                raise MT5ConnectionError(f"Deposit failed: {error}")
        ...
        try:
            ...
            if result is False:
                ...
                if error[1] == MT5Manager.EnMTAPIRetcode.MT_RET_TRADE_MAX_MONEY:
                    ...
                    raise MT5ConnectionError("Insufficient funds")
                raise MT5ConnectionError(f"Withdrawal failed: {error}")
    ...
    async def credit_in(
        ...
        try:
            ...
            if result is False:
                ...
                if error[1] == MT5Manager.EnMTAPIRetcode.MT_RET_TRADE_MAX_MONEY:
                    raise MT5ConnectionError("Amount exceeds maximum allowed")
                raise MT5ConnectionError(f"Credit addition failed: {error}")
        ...
        try:
            ...
            if result is False:
                ...
                if error[1] == MT5Manager.EnMTAPIRetcode.MT_RET_REQUEST_NO_MONEY:
                    raise MT5ConnectionError("Insufficient credit funds")
                raise MT5ConnectionError(f"Credit removal failed: {error}")
    ...
    async def charge_in(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Charge addition failed: {error}")
    ...
    async def charge_out(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Charge removal failed: {error}")
    ...
    async def correction(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Correction failed: {error}")
    ...
    async def bonus_in(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Bonus addition failed: {error}")
    ...
    async def bonus_out(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Bonus removal failed: {error}")
    ...
    async def add_commission(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Commission addition failed: {error}")
    ...
    async def add_rebate(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Rebate addition failed: {error}")
    ...
    async def compensation(
        ...
        try:
            ...
            if result is False:
                error = MT5Manager.LastError()
                raise MT5ConnectionError(f"Compensation addition failed: {error}")
