export class MarkdownRenderer {
  ...
  init() {
    ...
    //   // remove all p tags from list items
    //   let parsed_text = marked.parse(result.text);
    //   parsed_text = parsed_text.replace(/<p>/g, "");
    //   parsed_text = parsed_text.replace(/<\/p>/g, "");

    //   console.log("parsed_text", parsed_text);

    //   return `<li class="msglist">${result.text}</li>`; // remove <p> tag
    // };
