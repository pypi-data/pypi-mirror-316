...
class BoardManager:
    ...
    @staticmethod
    def update_board(
        board: dict, current_card_id: str, role: str, message: str, attachments: Optional[Dict[str, Dict[str, str]]] = None
    ) -> dict:
        ...
        if role == ChatbotRoles.USER.value:
            ...
            if attachments is not None:
                ...
                BoardManager.logger.debug("Added attachments to card.")
