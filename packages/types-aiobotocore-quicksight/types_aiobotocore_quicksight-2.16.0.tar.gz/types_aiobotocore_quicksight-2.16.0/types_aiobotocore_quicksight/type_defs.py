...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_quicksight/type_defs/)
...
class SearchTopicsRequestSearchTopicsPaginateTypeDef(TypedDict):
    AwsAccountId: str
    Filters: Sequence[TopicSearchFilterTypeDef]
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
