...
!!! info
    This recommendation is work in progress. A description
    of why these choices will hopefully appear as a
...
""",
    ...
    detail_title={
        ...
        "firefish": "| attributedTo | files | Ex. |",
    },
    support_table=True,
    ...
    support_result={
        ...
        "firefish": misskey_has_attachment,
    },
)
