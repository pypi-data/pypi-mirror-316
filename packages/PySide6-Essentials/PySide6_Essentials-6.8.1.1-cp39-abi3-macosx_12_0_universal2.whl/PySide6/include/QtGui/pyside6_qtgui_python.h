...
enum [[deprecated]] : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 962,
    ...
    SBK_QGLYPHRUN_GLYPHRUNFLAG_IDX                           = 264,
    SBK_QFLAGS_QGLYPHRUN_GLYPHRUNFLAG_IDX                    = 162,
    SBK_QGLYPHRUN_IDX                                        = 262,
    SBK_QGRADIENT_TYPE_IDX                                   = 276,
    SBK_QGRADIENT_SPREAD_IDX                                 = 274,
    SBK_QGRADIENT_COORDINATEMODE_IDX                         = 268,
    SBK_QGRADIENT_INTERPOLATIONMODE_IDX                      = 270,
    SBK_QGRADIENT_PRESET_IDX                                 = 272,
    SBK_QGRADIENT_IDX                                        = 266,
    SBK_QGUIAPPLICATION_IDX                                  = 278,
    SBK_QHELPEVENT_IDX                                       = 280,
    SBK_QHIDEEVENT_IDX                                       = 282,
    SBK_QHOVEREVENT_IDX                                      = 284,
    SBK_QICON_MODE_IDX                                       = 288,
    SBK_QICON_STATE_IDX                                      = 290,
    SBK_QICON_THEMEICON_IDX                                  = 292,
    SBK_QICON_IDX                                            = 286,
    SBK_QICONDRAGEVENT_IDX                                   = 294,
    SBK_QICONENGINE_ICONENGINEHOOK_IDX                       = 298,
    SBK_QICONENGINE_IDX                                      = 296,
    SBK_QICONENGINE_SCALEDPIXMAPARGUMENT_IDX                 = 300,
    SBK_QIMAGE_INVERTMODE_IDX                                = 306,
    SBK_QIMAGE_FORMAT_IDX                                    = 304,
    SBK_QIMAGE_IDX                                           = 302,
    SBK_QIMAGEIOHANDLER_IMAGEOPTION_IDX                      = 310,
    SBK_QIMAGEIOHANDLER_TRANSFORMATION_IDX                   = 312,
    SBK_QFLAGS_QIMAGEIOHANDLER_TRANSFORMATION_IDX            = 164,
    SBK_QIMAGEIOHANDLER_IDX                                  = 308,
    SBK_QIMAGEREADER_IMAGEREADERERROR_IDX                    = 316,
    SBK_QIMAGEREADER_IDX                                     = 314,
    SBK_QIMAGEWRITER_IMAGEWRITERERROR_IDX                    = 320,
    SBK_QIMAGEWRITER_IDX                                     = 318,
    SBK_QINPUTDEVICE_DEVICETYPE_IDX                          = 326,
    SBK_QFLAGS_QINPUTDEVICE_DEVICETYPE_IDX                   = 168,
    SBK_QINPUTDEVICE_CAPABILITY_IDX                          = 324,
    SBK_QFLAGS_QINPUTDEVICE_CAPABILITY_IDX                   = 166,
    SBK_QINPUTDEVICE_IDX                                     = 322,
    SBK_QINPUTEVENT_IDX                                      = 328,
    SBK_QINPUTMETHOD_ACTION_IDX                              = 332,
    SBK_QINPUTMETHOD_IDX                                     = 330,
    SBK_QINPUTMETHODEVENT_ATTRIBUTETYPE_IDX                  = 338,
    SBK_QINPUTMETHODEVENT_IDX                                = 334,
    SBK_QINPUTMETHODEVENT_ATTRIBUTE_IDX                      = 336,
    SBK_QINPUTMETHODQUERYEVENT_IDX                           = 340,
    SBK_QINTVALIDATOR_IDX                                    = 342,
    SBK_QKEYEVENT_IDX                                        = 344,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 352,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 348,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 350,
    SBK_QKEYSEQUENCE_IDX                                     = 346,
    SBK_QLINEARGRADIENT_IDX                                  = 354,
    SBK_QMATRIX2X2_IDX                                       = 356,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 356,
    SBK_QMATRIX2X3_IDX                                       = 358,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 358,
    SBK_QMATRIX2X4_IDX                                       = 360,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 360,
    SBK_QMATRIX3X2_IDX                                       = 362,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 362,
    SBK_QMATRIX3X3_IDX                                       = 364,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 364,
    SBK_QMATRIX3X4_IDX                                       = 366,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 366,
    SBK_QMATRIX4X2_IDX                                       = 368,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 368,
    SBK_QMATRIX4X3_IDX                                       = 370,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 370,
    SBK_QMATRIX4X4_FLAG_IDX                                  = 374,
    SBK_QFLAGS_QMATRIX4X4_FLAG_IDX                           = 170,
    SBK_QMATRIX4X4_IDX                                       = 372,
    SBK_QMOUSEEVENT_IDX                                      = 376,
    SBK_QMOVEEVENT_IDX                                       = 378,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 384,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 382,
    SBK_QMOVIE_IDX                                           = 380,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 386,
    SBK_QTGUIQNATIVEINTERFACE_IDX                            = 388,
    SBK_QOFFSCREENSURFACE_IDX                                = 394,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 398,
    SBK_QOPENGLCONTEXT_IDX                                   = 396,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 400,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 402,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 406,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 172,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 404,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 416,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 412,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 410,
    SBK_QPAGELAYOUT_OUTOFBOUNDSPOLICY_IDX                    = 414,
    SBK_QPAGELAYOUT_IDX                                      = 408,
    SBK_QPAGERANGES_IDX                                      = 418,
    SBK_QPAGERANGES_RANGE_IDX                                = 420,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 424,
    SBK_QPAGESIZE_UNIT_IDX                                   = 428,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 426,
    SBK_QPAGESIZE_IDX                                        = 422,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 432,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 430,
    SBK_QPAINTDEVICE_PAINTDEVICEMETRIC_IDX                   = 436,
    SBK_QPAINTDEVICE_IDX                                     = 434,
    SBK_QPAINTDEVICEWINDOW_IDX                               = 438,
    SBK_QPAINTENGINE_PAINTENGINEFEATURE_IDX                  = 444,
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 176,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 442,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 174,
    SBK_QPAINTENGINE_POLYGONDRAWMODE_IDX                     = 446,
    SBK_QPAINTENGINE_TYPE_IDX                                = 448,
    SBK_QPAINTENGINE_IDX                                     = 440,
    SBK_QPAINTENGINESTATE_IDX                                = 450,
    SBK_QPAINTEVENT_IDX                                      = 452,
    SBK_QPAINTER_RENDERHINT_IDX                              = 462,
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 180,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 460,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 178,
    SBK_QPAINTER_COMPOSITIONMODE_IDX                         = 456,
    SBK_QPAINTER_IDX                                         = 454,
    SBK_QPAINTER_PIXMAPFRAGMENT_IDX                          = 458,
    SBK_QPAINTERPATH_ELEMENTTYPE_IDX                         = 468,
    SBK_QPAINTERPATH_IDX                                     = 464,
    SBK_QPAINTERPATH_ELEMENT_IDX                             = 466,
    SBK_QPAINTERPATHSTROKER_IDX                              = 470,
    SBK_QPALETTE_COLORGROUP_IDX                              = 474,
    SBK_QPALETTE_COLORROLE_IDX                               = 476,
    SBK_QPALETTE_IDX                                         = 472,
    SBK_QPDFWRITER_COLORMODEL_IDX                            = 480,
    SBK_QPDFWRITER_IDX                                       = 478,
    SBK_QPEN_IDX                                             = 482,
    SBK_QPICTURE_IDX                                         = 484,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 496,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 492,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 488,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 490,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 498,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 500,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 494,
    SBK_QPIXELFORMAT_IDX                                     = 486,
    SBK_QPIXMAP_IDX                                          = 502,
    SBK_QPIXMAPCACHE_IDX                                     = 504,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 506,
    SBK_QPLATFORMSURFACEEVENT_SURFACEEVENTTYPE_IDX           = 510,
    SBK_QPLATFORMSURFACEEVENT_IDX                            = 508,
    SBK_QPOINTEREVENT_IDX                                    = 512,
    SBK_QPOINTINGDEVICE_POINTERTYPE_IDX                      = 518,
    SBK_QFLAGS_QPOINTINGDEVICE_POINTERTYPE_IDX               = 182,
    SBK_QPOINTINGDEVICE_GRABTRANSITION_IDX                   = 516,
    SBK_QPOINTINGDEVICE_IDX                                  = 514,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 520,
    SBK_QPOLYGON_IDX                                         = 522,
    SBK_QPOLYGONF_IDX                                        = 524,
    SBK_QPYTEXTOBJECT_IDX                                    = 526,
    SBK_QQUATERNION_IDX                                      = 528,
    SBK_QRADIALGRADIENT_IDX                                  = 530,
    SBK_QRASTERWINDOW_IDX                                    = 532,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 536,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 538,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 184,
    SBK_QRAWFONT_IDX                                         = 534,
    SBK_QREGION_REGIONTYPE_IDX                               = 542,
    SBK_QREGION_IDX                                          = 540,
    SBK_QREGULAREXPRESSIONVALIDATOR_IDX                      = 544,
    SBK_QRESIZEEVENT_IDX                                     = 546,
    SBK_QRGBA64_IDX                                          = 548,
    SBK_QRHI_IMPLEMENTATION_IDX                              = 562,
    SBK_QRHI_FLAG_IDX                                        = 558,
    SBK_QFLAGS_QRHI_FLAG_IDX                                 = 190,
    SBK_QRHI_FRAMEOPRESULT_IDX                               = 560,
    SBK_QRHI_FEATURE_IDX                                     = 556,
    SBK_QRHI_BEGINFRAMEFLAG_IDX                              = 552,
    SBK_QFLAGS_QRHI_BEGINFRAMEFLAG_IDX                       = 186,
    SBK_QRHI_ENDFRAMEFLAG_IDX                                = 554,
    SBK_QFLAGS_QRHI_ENDFRAMEFLAG_IDX                         = 188,
    SBK_QRHI_RESOURCELIMIT_IDX                               = 564,
    SBK_QRHI_IDX                                             = 550,
    SBK_QRHIBUFFER_TYPE_IDX                                  = 568,
    SBK_QRHIBUFFER_USAGEFLAG_IDX                             = 570,
    SBK_QFLAGS_QRHIBUFFER_USAGEFLAG_IDX                      = 192,
    SBK_QRHIBUFFER_IDX                                       = 566,
    SBK_QRHICOLORATTACHMENT_IDX                              = 572,
    SBK_QRHICOMMANDBUFFER_INDEXFORMAT_IDX                    = 578,
    SBK_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX                  = 576,
    SBK_QFLAGS_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX           = 194,
    SBK_QRHICOMMANDBUFFER_IDX                                = 574,
    SBK_QRHICOMPUTEPIPELINE_FLAG_IDX                         = 582,
    SBK_QFLAGS_QRHICOMPUTEPIPELINE_FLAG_IDX                  = 196,
    SBK_QRHICOMPUTEPIPELINE_IDX                              = 580,
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 584,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 588,
    SBK_QRHIDRIVERINFO_IDX                                   = 586,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 590,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 592,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 606,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 200,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 618,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 604,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 608,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 600,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 198,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 596,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 598,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 602,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 612,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 610,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 594,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 614,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 616,
    SBK_QRHIINITPARAMS_IDX                                   = 620,
    SBK_QRHIMETALINITPARAMS_IDX                              = 622,
    SBK_QRHINATIVEHANDLES_IDX                                = 624,
    SBK_QRHINULLINITPARAMS_IDX                               = 626,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 628,
    SBK_QRHIREADBACKRESULT_IDX                               = 630,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 636,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 634,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 202,
    SBK_QRHIRENDERBUFFER_IDX                                 = 632,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 638,
    SBK_QRHIRENDERTARGET_IDX                                 = 640,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 644,
    SBK_QRHIRESOURCE_IDX                                     = 642,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 646,
    SBK_QRHISAMPLER_FILTER_IDX                               = 654,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 650,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 652,
    SBK_QRHISAMPLER_IDX                                      = 648,
    SBK_QRHISCISSOR_IDX                                      = 656,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 670,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 666,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 204,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 658,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 660,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 662,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 664,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 668,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 674,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 206,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 672,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 678,
    SBK_QRHISHADERSTAGE_IDX                                  = 676,
    SBK_QRHISTATS_IDX                                        = 680,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 684,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 208,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 686,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 688,
    SBK_QRHISWAPCHAIN_IDX                                    = 682,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 690,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 694,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 210,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 696,
    SBK_QRHITEXTURE_IDX                                      = 692,
    SBK_QRHITEXTURE_VIEWFORMAT_IDX                           = 698,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 700,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 704,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 212,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 702,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 706,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 708,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 710,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 712,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 716,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 714,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 720,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 718,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 722,
    SBK_QRHIVIEWPORT_IDX                                     = 724,
    SBK_QSCREEN_IDX                                          = 726,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 730,
    SBK_QSCROLLEVENT_IDX                                     = 728,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 732,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 736,
    SBK_QSESSIONMANAGER_IDX                                  = 734,
    SBK_QSHADER_STAGE_IDX                                    = 744,
    SBK_QSHADER_SOURCE_IDX                                   = 742,
    SBK_QSHADER_VARIANT_IDX                                  = 746,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 740,
    SBK_QSHADER_IDX                                          = 738,
    SBK_QSHADERCODE_IDX                                      = 748,
    SBK_QSHADERKEY_IDX                                       = 750,
    SBK_QSHADERVERSION_FLAG_IDX                              = 754,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 214,
    SBK_QSHADERVERSION_IDX                                   = 752,
    SBK_QSHORTCUT_IDX                                        = 756,
    SBK_QSHORTCUTEVENT_IDX                                   = 758,
    SBK_QSHOWEVENT_IDX                                       = 760,
    SBK_QSINGLEPOINTEVENT_IDX                                = 762,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 766,
    SBK_QSTANDARDITEM_IDX                                    = 764,
    SBK_QSTANDARDITEMMODEL_IDX                               = 768,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 772,
    SBK_QSTATICTEXT_IDX                                      = 770,
    SBK_QSTATUSTIPEVENT_IDX                                  = 774,
    SBK_QSTYLEHINTS_IDX                                      = 776,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 780,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 782,
    SBK_QSURFACE_IDX                                         = 778,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 788,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 216,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 794,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 792,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 790,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 786,
    SBK_QSURFACEFORMAT_IDX                                   = 784,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 796,
    SBK_QTABLETEVENT_IDX                                     = 798,
    SBK_QTEXTBLOCK_IDX                                       = 800,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 802,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 964,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 806,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 804,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 808,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 810,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 818,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 816,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 814,
    SBK_QTEXTCHARFORMAT_IDX                                  = 812,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 822,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 824,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 826,
    SBK_QTEXTCURSOR_IDX                                      = 820,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 834,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 832,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 220,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 830,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 218,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 836,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 838,
    SBK_QTEXTDOCUMENT_IDX                                    = 828,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 840,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 842,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 846,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 852,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 848,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 850,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 222,
    SBK_QTEXTFORMAT_IDX                                      = 844,
    SBK_QTEXTFRAGMENT_IDX                                    = 854,
    SBK_QTEXTFRAME_IDX                                       = 856,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 858,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 864,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 862,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 860,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 866,
    SBK_QTEXTINLINEOBJECT_IDX                                = 868,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 872,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 224,
    SBK_QTEXTITEM_IDX                                        = 870,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 880,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 226,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 876,
    SBK_QTEXTLAYOUT_IDX                                      = 874,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 878,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 884,
    SBK_QTEXTLENGTH_IDX                                      = 882,
    SBK_QTEXTLINE_EDGE_IDX                                   = 890,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 888,
    SBK_QTEXTLINE_IDX                                        = 886,
    SBK_QTEXTLIST_IDX                                        = 892,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 896,
    SBK_QTEXTLISTFORMAT_IDX                                  = 894,
    SBK_QTEXTOBJECT_IDX                                      = 898,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 900,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 908,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 910,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 904,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 228,
    SBK_QTEXTOPTION_IDX                                      = 902,
    SBK_QTEXTOPTION_TAB_IDX                                  = 906,
    SBK_QTEXTTABLE_IDX                                       = 912,
    SBK_QTEXTTABLECELL_IDX                                   = 914,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 916,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 918,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 920,
    SBK_QTOUCHEVENT_IDX                                      = 922,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 926,
    SBK_QTRANSFORM_IDX                                       = 924,
    SBK_QUNDOCOMMAND_IDX                                     = 928,
    SBK_QUNDOGROUP_IDX                                       = 930,
    SBK_QUNDOSTACK_IDX                                       = 932,
    SBK_QVALIDATOR_STATE_IDX                                 = 936,
    SBK_QVALIDATOR_IDX                                       = 934,
    SBK_QVECTOR2D_IDX                                        = 938,
    SBK_QVECTOR3D_IDX                                        = 940,
    SBK_QVECTOR4D_IDX                                        = 942,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 944,
    SBK_QWHEELEVENT_IDX                                      = 946,
    SBK_QWINDOW_VISIBILITY_IDX                               = 952,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 950,
    SBK_QWINDOW_IDX                                          = 948,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 954,
    SBK_QTGUIQT_IDX                                          = 956,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 960,
    SBK_QTGUI_IDX_COUNT                                      = 966,
};
...
enum : int {
    ...
    SBK_QFont_HintingPreference_IDX                          = 481,
    ...
    SBK_QGlyphRun_GlyphRunFlag_IDX                           = 132,
    SBK_QFlags_QGlyphRun_GlyphRunFlag_IDX                    = 81,
    SBK_QGlyphRun_IDX                                        = 131,
    SBK_QGradient_Type_IDX                                   = 138,
    SBK_QGradient_Spread_IDX                                 = 137,
    SBK_QGradient_CoordinateMode_IDX                         = 134,
    SBK_QGradient_InterpolationMode_IDX                      = 135,
    SBK_QGradient_Preset_IDX                                 = 136,
    SBK_QGradient_IDX                                        = 133,
    SBK_QGuiApplication_IDX                                  = 139,
    SBK_QHelpEvent_IDX                                       = 140,
    SBK_QHideEvent_IDX                                       = 141,
    SBK_QHoverEvent_IDX                                      = 142,
    SBK_QIcon_Mode_IDX                                       = 144,
    SBK_QIcon_State_IDX                                      = 145,
    SBK_QIcon_ThemeIcon_IDX                                  = 146,
    SBK_QIcon_IDX                                            = 143,
    SBK_QIconDragEvent_IDX                                   = 147,
    SBK_QIconEngine_IconEngineHook_IDX                       = 149,
    SBK_QIconEngine_IDX                                      = 148,
    SBK_QIconEngine_ScaledPixmapArgument_IDX                 = 150,
    SBK_QImage_InvertMode_IDX                                = 153,
    SBK_QImage_Format_IDX                                    = 152,
    SBK_QImage_IDX                                           = 151,
    SBK_QImageIOHandler_ImageOption_IDX                      = 155,
    SBK_QImageIOHandler_Transformation_IDX                   = 156,
    SBK_QFlags_QImageIOHandler_Transformation_IDX            = 82,
    SBK_QImageIOHandler_IDX                                  = 154,
    SBK_QImageReader_ImageReaderError_IDX                    = 158,
    SBK_QImageReader_IDX                                     = 157,
    SBK_QImageWriter_ImageWriterError_IDX                    = 160,
    SBK_QImageWriter_IDX                                     = 159,
    SBK_QInputDevice_DeviceType_IDX                          = 163,
    SBK_QFlags_QInputDevice_DeviceType_IDX                   = 84,
    SBK_QInputDevice_Capability_IDX                          = 162,
    SBK_QFlags_QInputDevice_Capability_IDX                   = 83,
    SBK_QInputDevice_IDX                                     = 161,
    SBK_QInputEvent_IDX                                      = 164,
    SBK_QInputMethod_Action_IDX                              = 166,
    SBK_QInputMethod_IDX                                     = 165,
    SBK_QInputMethodEvent_AttributeType_IDX                  = 169,
    SBK_QInputMethodEvent_IDX                                = 167,
    SBK_QInputMethodEvent_Attribute_IDX                      = 168,
    SBK_QInputMethodQueryEvent_IDX                           = 170,
    SBK_QIntValidator_IDX                                    = 171,
    SBK_QKeyEvent_IDX                                        = 172,
    SBK_QKeySequence_StandardKey_IDX                         = 176,
    SBK_QKeySequence_SequenceFormat_IDX                      = 174,
    SBK_QKeySequence_SequenceMatch_IDX                       = 175,
    SBK_QKeySequence_IDX                                     = 173,
    SBK_QLinearGradient_IDX                                  = 177,
    SBK_QMatrix2x2_IDX                                       = 178,
    SBK_QGenericMatrix_2_2_float_IDX                         = 178,
    SBK_QMatrix2x3_IDX                                       = 179,
    SBK_QGenericMatrix_2_3_float_IDX                         = 179,
    SBK_QMatrix2x4_IDX                                       = 180,
    SBK_QGenericMatrix_2_4_float_IDX                         = 180,
    SBK_QMatrix3x2_IDX                                       = 181,
    SBK_QGenericMatrix_3_2_float_IDX                         = 181,
    SBK_QMatrix3x3_IDX                                       = 182,
    SBK_QGenericMatrix_3_3_float_IDX                         = 182,
    SBK_QMatrix3x4_IDX                                       = 183,
    SBK_QGenericMatrix_3_4_float_IDX                         = 183,
    SBK_QMatrix4x2_IDX                                       = 184,
    SBK_QGenericMatrix_4_2_float_IDX                         = 184,
    SBK_QMatrix4x3_IDX                                       = 185,
    SBK_QGenericMatrix_4_3_float_IDX                         = 185,
    SBK_QMatrix4x4_Flag_IDX                                  = 187,
    SBK_QFlags_QMatrix4x4_Flag_IDX                           = 85,
    SBK_QMatrix4x4_IDX                                       = 186,
    SBK_QMouseEvent_IDX                                      = 188,
    SBK_QMoveEvent_IDX                                       = 189,
    SBK_QMovie_MovieState_IDX                                = 192,
    SBK_QMovie_CacheMode_IDX                                 = 191,
    SBK_QMovie_IDX                                           = 190,
    SBK_QNativeGestureEvent_IDX                              = 193,
    SBK_QtGuiQNativeInterface_IDX                            = 194,
    SBK_QOffscreenSurface_IDX                                = 197,
    SBK_QOpenGLContext_OpenGLModuleType_IDX                  = 199,
    SBK_QOpenGLContext_IDX                                   = 198,
    SBK_QOpenGLContextGroup_IDX                              = 200,
    SBK_QOpenGLExtraFunctions_IDX                            = 201,
    SBK_QOpenGLFunctions_OpenGLFeature_IDX                   = 203,
    SBK_QFlags_QOpenGLFunctions_OpenGLFeature_IDX            = 86,
    SBK_QOpenGLFunctions_IDX                                 = 202,
    SBK_QPageLayout_Unit_IDX                                 = 208,
    SBK_QPageLayout_Orientation_IDX                          = 206,
    SBK_QPageLayout_Mode_IDX                                 = 205,
    SBK_QPageLayout_OutOfBoundsPolicy_IDX                    = 207,
    SBK_QPageLayout_IDX                                      = 204,
    SBK_QPageRanges_IDX                                      = 209,
    SBK_QPageRanges_Range_IDX                                = 210,
    SBK_QPageSize_PageSizeId_IDX                             = 212,
    SBK_QPageSize_Unit_IDX                                   = 214,
    SBK_QPageSize_SizeMatchPolicy_IDX                        = 213,
    SBK_QPageSize_IDX                                        = 211,
    SBK_QPagedPaintDevice_PdfVersion_IDX                     = 216,
    SBK_QPagedPaintDevice_IDX                                = 215,
    SBK_QPaintDevice_PaintDeviceMetric_IDX                   = 218,
    SBK_QPaintDevice_IDX                                     = 217,
    SBK_QPaintDeviceWindow_IDX                               = 219,
    SBK_QPaintEngine_PaintEngineFeature_IDX                  = 222,
    SBK_QFlags_QPaintEngine_PaintEngineFeature_IDX           = 88,
    SBK_QPaintEngine_DirtyFlag_IDX                           = 221,
    SBK_QFlags_QPaintEngine_DirtyFlag_IDX                    = 87,
    SBK_QPaintEngine_PolygonDrawMode_IDX                     = 223,
    SBK_QPaintEngine_Type_IDX                                = 224,
    SBK_QPaintEngine_IDX                                     = 220,
    SBK_QPaintEngineState_IDX                                = 225,
    SBK_QPaintEvent_IDX                                      = 226,
    SBK_QPainter_RenderHint_IDX                              = 231,
    SBK_QFlags_QPainter_RenderHint_IDX                       = 90,
    SBK_QPainter_PixmapFragmentHint_IDX                      = 230,
    SBK_QFlags_QPainter_PixmapFragmentHint_IDX               = 89,
    SBK_QPainter_CompositionMode_IDX                         = 228,
    SBK_QPainter_IDX                                         = 227,
    SBK_QPainter_PixmapFragment_IDX                          = 229,
    SBK_QPainterPath_ElementType_IDX                         = 234,
    SBK_QPainterPath_IDX                                     = 232,
    SBK_QPainterPath_Element_IDX                             = 233,
    SBK_QPainterPathStroker_IDX                              = 235,
    SBK_QPalette_ColorGroup_IDX                              = 237,
    SBK_QPalette_ColorRole_IDX                               = 238,
    SBK_QPalette_IDX                                         = 236,
    SBK_QPdfWriter_ColorModel_IDX                            = 240,
    SBK_QPdfWriter_IDX                                       = 239,
    SBK_QPen_IDX                                             = 241,
    SBK_QPicture_IDX                                         = 242,
    SBK_QPixelFormat_ColorModel_IDX                          = 248,
    SBK_QPixelFormat_AlphaUsage_IDX                          = 246,
    SBK_QPixelFormat_AlphaPosition_IDX                       = 244,
    SBK_QPixelFormat_AlphaPremultiplied_IDX                  = 245,
    SBK_QPixelFormat_TypeInterpretation_IDX                  = 249,
    SBK_QPixelFormat_YUVLayout_IDX                           = 250,
    SBK_QPixelFormat_ByteOrder_IDX                           = 247,
    SBK_QPixelFormat_IDX                                     = 243,
    SBK_QPixmap_IDX                                          = 251,
    SBK_QPixmapCache_IDX                                     = 252,
    SBK_QPixmapCache_Key_IDX                                 = 253,
    SBK_QPlatformSurfaceEvent_SurfaceEventType_IDX           = 255,
    SBK_QPlatformSurfaceEvent_IDX                            = 254,
    SBK_QPointerEvent_IDX                                    = 256,
    SBK_QPointingDevice_PointerType_IDX                      = 259,
    SBK_QFlags_QPointingDevice_PointerType_IDX               = 91,
    SBK_QPointingDevice_GrabTransition_IDX                   = 258,
    SBK_QPointingDevice_IDX                                  = 257,
    SBK_QPointingDeviceUniqueId_IDX                          = 260,
    SBK_QPolygon_IDX                                         = 261,
    SBK_QPolygonF_IDX                                        = 262,
    SBK_QPyTextObject_IDX                                    = 263,
    SBK_QQuaternion_IDX                                      = 264,
    SBK_QRadialGradient_IDX                                  = 265,
    SBK_QRasterWindow_IDX                                    = 266,
    SBK_QRawFont_AntialiasingType_IDX                        = 268,
    SBK_QRawFont_LayoutFlag_IDX                              = 269,
    SBK_QFlags_QRawFont_LayoutFlag_IDX                       = 92,
    SBK_QRawFont_IDX                                         = 267,
    SBK_QRegion_RegionType_IDX                               = 271,
    SBK_QRegion_IDX                                          = 270,
    SBK_QRegularExpressionValidator_IDX                      = 272,
    SBK_QResizeEvent_IDX                                     = 273,
    SBK_QRgba64_IDX                                          = 274,
    SBK_QRhi_Implementation_IDX                              = 281,
    SBK_QRhi_Flag_IDX                                        = 279,
    SBK_QFlags_QRhi_Flag_IDX                                 = 95,
    SBK_QRhi_FrameOpResult_IDX                               = 280,
    SBK_QRhi_Feature_IDX                                     = 278,
    SBK_QRhi_BeginFrameFlag_IDX                              = 276,
    SBK_QFlags_QRhi_BeginFrameFlag_IDX                       = 93,
    SBK_QRhi_EndFrameFlag_IDX                                = 277,
    SBK_QFlags_QRhi_EndFrameFlag_IDX                         = 94,
    SBK_QRhi_ResourceLimit_IDX                               = 282,
    SBK_QRhi_IDX                                             = 275,
    SBK_QRhiBuffer_Type_IDX                                  = 284,
    SBK_QRhiBuffer_UsageFlag_IDX                             = 285,
    SBK_QFlags_QRhiBuffer_UsageFlag_IDX                      = 96,
    SBK_QRhiBuffer_IDX                                       = 283,
    SBK_QRhiColorAttachment_IDX                              = 286,
    SBK_QRhiCommandBuffer_IndexFormat_IDX                    = 289,
    SBK_QRhiCommandBuffer_BeginPassFlag_IDX                  = 288,
    SBK_QFlags_QRhiCommandBuffer_BeginPassFlag_IDX           = 97,
    SBK_QRhiCommandBuffer_IDX                                = 287,
    SBK_QRhiComputePipeline_Flag_IDX                         = 291,
    SBK_QFlags_QRhiComputePipeline_Flag_IDX                  = 98,
    SBK_QRhiComputePipeline_IDX                              = 290,
    SBK_QRhiDepthStencilClearValue_IDX                       = 292,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 294,
    SBK_QRhiDriverInfo_IDX                                   = 293,
    SBK_QRhiGles2InitParams_IDX                              = 295,
    SBK_QRhiGles2NativeHandles_IDX                           = 296,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 303,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 100,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 309,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 302,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 304,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 300,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 99,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 298,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 299,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 301,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 306,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 305,
    SBK_QRhiGraphicsPipeline_IDX                             = 297,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 307,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 308,
    SBK_QRhiInitParams_IDX                                   = 310,
    SBK_QRhiMetalInitParams_IDX                              = 311,
    SBK_QRhiNativeHandles_IDX                                = 312,
    SBK_QRhiNullInitParams_IDX                               = 313,
    SBK_QRhiReadbackDescription_IDX                          = 314,
    SBK_QRhiReadbackResult_IDX                               = 315,
    SBK_QRhiRenderBuffer_Type_IDX                            = 318,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 317,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 101,
    SBK_QRhiRenderBuffer_IDX                                 = 316,
    SBK_QRhiRenderPassDescriptor_IDX                         = 319,
    SBK_QRhiRenderTarget_IDX                                 = 320,
    SBK_QRhiResource_Type_IDX                                = 322,
    SBK_QRhiResource_IDX                                     = 321,
    SBK_QRhiResourceUpdateBatch_IDX                          = 323,
    SBK_QRhiSampler_Filter_IDX                               = 327,
    SBK_QRhiSampler_AddressMode_IDX                          = 325,
    SBK_QRhiSampler_CompareOp_IDX                            = 326,
    SBK_QRhiSampler_IDX                                      = 324,
    SBK_QRhiScissor_IDX                                      = 328,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 335,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 333,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 102,
    SBK_QRhiShaderResourceBinding_IDX                        = 329,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 330,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 331,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 332,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 334,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 337,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 103,
    SBK_QRhiShaderResourceBindings_IDX                       = 336,
    SBK_QRhiShaderStage_Type_IDX                             = 339,
    SBK_QRhiShaderStage_IDX                                  = 338,
    SBK_QRhiStats_IDX                                        = 340,
    SBK_QRhiSwapChain_Flag_IDX                               = 342,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 104,
    SBK_QRhiSwapChain_Format_IDX                             = 343,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 344,
    SBK_QRhiSwapChain_IDX                                    = 341,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 345,
    SBK_QRhiTexture_Flag_IDX                                 = 347,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 105,
    SBK_QRhiTexture_Format_IDX                               = 348,
    SBK_QRhiTexture_IDX                                      = 346,
    SBK_QRhiTexture_ViewFormat_IDX                           = 349,
    SBK_QRhiTextureCopyDescription_IDX                       = 350,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 352,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 106,
    SBK_QRhiTextureRenderTarget_IDX                          = 351,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 353,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 354,
    SBK_QRhiTextureUploadDescription_IDX                     = 355,
    SBK_QRhiTextureUploadEntry_IDX                           = 356,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 358,
    SBK_QRhiVertexInputAttribute_IDX                         = 357,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 360,
    SBK_QRhiVertexInputBinding_IDX                           = 359,
    SBK_QRhiVertexInputLayout_IDX                            = 361,
    SBK_QRhiViewport_IDX                                     = 362,
    SBK_QScreen_IDX                                          = 363,
    SBK_QScrollEvent_ScrollState_IDX                         = 365,
    SBK_QScrollEvent_IDX                                     = 364,
    SBK_QScrollPrepareEvent_IDX                              = 366,
    SBK_QSessionManager_RestartHint_IDX                      = 368,
    SBK_QSessionManager_IDX                                  = 367,
    SBK_QShader_Stage_IDX                                    = 372,
    SBK_QShader_Source_IDX                                   = 371,
    SBK_QShader_Variant_IDX                                  = 373,
    SBK_QShader_SerializedFormatVersion_IDX                  = 370,
    SBK_QShader_IDX                                          = 369,
    SBK_QShaderCode_IDX                                      = 374,
    SBK_QShaderKey_IDX                                       = 375,
    SBK_QShaderVersion_Flag_IDX                              = 377,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 107,
    SBK_QShaderVersion_IDX                                   = 376,
    SBK_QShortcut_IDX                                        = 378,
    SBK_QShortcutEvent_IDX                                   = 379,
    SBK_QShowEvent_IDX                                       = 380,
    SBK_QSinglePointEvent_IDX                                = 381,
    SBK_QStandardItem_ItemType_IDX                           = 383,
    SBK_QStandardItem_IDX                                    = 382,
    SBK_QStandardItemModel_IDX                               = 384,
    SBK_QStaticText_PerformanceHint_IDX                      = 386,
    SBK_QStaticText_IDX                                      = 385,
    SBK_QStatusTipEvent_IDX                                  = 387,
    SBK_QStyleHints_IDX                                      = 388,
    SBK_QSurface_SurfaceClass_IDX                            = 390,
    SBK_QSurface_SurfaceType_IDX                             = 391,
    SBK_QSurface_IDX                                         = 389,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 394,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 108,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 397,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 396,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 395,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 393,
    SBK_QSurfaceFormat_IDX                                   = 392,
    SBK_QSyntaxHighlighter_IDX                               = 398,
    SBK_QTabletEvent_IDX                                     = 399,
    SBK_QTextBlock_IDX                                       = 400,
    SBK_QTextBlock_iterator_IDX                              = 401,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 482,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 403,
    SBK_QTextBlockFormat_IDX                                 = 402,
    SBK_QTextBlockGroup_IDX                                  = 404,
    SBK_QTextBlockUserData_IDX                               = 405,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 409,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 408,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 407,
    SBK_QTextCharFormat_IDX                                  = 406,
    SBK_QTextCursor_MoveMode_IDX                             = 411,
    SBK_QTextCursor_MoveOperation_IDX                        = 412,
    SBK_QTextCursor_SelectionType_IDX                        = 413,
    SBK_QTextCursor_IDX                                      = 410,
    SBK_QTextDocument_MetaInformation_IDX                    = 417,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 416,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 110,
    SBK_QTextDocument_FindFlag_IDX                           = 415,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 109,
    SBK_QTextDocument_ResourceType_IDX                       = 418,
    SBK_QTextDocument_Stacks_IDX                             = 419,
    SBK_QTextDocument_IDX                                    = 414,
    SBK_QTextDocumentFragment_IDX                            = 420,
    SBK_QTextDocumentWriter_IDX                              = 421,
    SBK_QTextFormat_FormatType_IDX                           = 423,
    SBK_QTextFormat_Property_IDX                             = 426,
    SBK_QTextFormat_ObjectTypes_IDX                          = 424,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 425,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 111,
    SBK_QTextFormat_IDX                                      = 422,
    SBK_QTextFragment_IDX                                    = 427,
    SBK_QTextFrame_IDX                                       = 428,
    SBK_QTextFrame_iterator_IDX                              = 429,
    SBK_QTextFrameFormat_Position_IDX                        = 432,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 431,
    SBK_QTextFrameFormat_IDX                                 = 430,
    SBK_QTextImageFormat_IDX                                 = 433,
    SBK_QTextInlineObject_IDX                                = 434,
    SBK_QTextItem_RenderFlag_IDX                             = 436,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 112,
    SBK_QTextItem_IDX                                        = 435,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 440,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 113,
    SBK_QTextLayout_CursorMode_IDX                           = 438,
    SBK_QTextLayout_IDX                                      = 437,
    SBK_QTextLayout_FormatRange_IDX                          = 439,
    SBK_QTextLength_Type_IDX                                 = 442,
    SBK_QTextLength_IDX                                      = 441,
    SBK_QTextLine_Edge_IDX                                   = 445,
    SBK_QTextLine_CursorPosition_IDX                         = 444,
    SBK_QTextLine_IDX                                        = 443,
    SBK_QTextList_IDX                                        = 446,
    SBK_QTextListFormat_Style_IDX                            = 448,
    SBK_QTextListFormat_IDX                                  = 447,
    SBK_QTextObject_IDX                                      = 449,
    SBK_QTextObjectInterface_IDX                             = 450,
    SBK_QTextOption_TabType_IDX                              = 454,
    SBK_QTextOption_WrapMode_IDX                             = 455,
    SBK_QTextOption_Flag_IDX                                 = 452,
    SBK_QFlags_QTextOption_Flag_IDX                          = 114,
    SBK_QTextOption_IDX                                      = 451,
    SBK_QTextOption_Tab_IDX                                  = 453,
    SBK_QTextTable_IDX                                       = 456,
    SBK_QTextTableCell_IDX                                   = 457,
    SBK_QTextTableCellFormat_IDX                             = 458,
    SBK_QTextTableFormat_IDX                                 = 459,
    SBK_QToolBarChangeEvent_IDX                              = 460,
    SBK_QTouchEvent_IDX                                      = 461,
    SBK_QTransform_TransformationType_IDX                    = 463,
    SBK_QTransform_IDX                                       = 462,
    SBK_QUndoCommand_IDX                                     = 464,
    SBK_QUndoGroup_IDX                                       = 465,
    SBK_QUndoStack_IDX                                       = 466,
    SBK_QValidator_State_IDX                                 = 468,
    SBK_QValidator_IDX                                       = 467,
    SBK_QVector2D_IDX                                        = 469,
    SBK_QVector3D_IDX                                        = 470,
    SBK_QVector4D_IDX                                        = 471,
    SBK_QWhatsThisClickedEvent_IDX                           = 472,
    SBK_QWheelEvent_IDX                                      = 473,
    SBK_QWindow_Visibility_IDX                               = 476,
    SBK_QWindow_AncestorMode_IDX                             = 475,
    SBK_QWindow_IDX                                          = 474,
    SBK_QWindowStateChangeEvent_IDX                          = 477,
    SBK_QtGuiQt_IDX                                          = 478,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 480,
    SBK_QtGui_IDX_COUNT                                      = 483,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTGUI_QLIST_QACCESSIBLE_ATTRIBUTE_IDX                = 74, // QList<QAccessible::Attribute>
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 76, // QList<unsigned int>
    SBK_QTGUI_QLIST_QLINE_IDX                                = 78, // QList<QLine>
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 80, // QList<QLineF>
    SBK_QTGUI_QLIST_QRECT_IDX                                = 82, // QList<QRect>
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 84, // QList<QRectF>
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 86, // QList<QKeySequence>
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 88, // QList<QObject*>
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 90, // QList<QByteArray>
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 92, // QList<QUndoStack*>
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 94, // QList<QTextFrame*>
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 96, // QList<QTextBlock>
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 98, // QList<QTextFormat>
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 100, // QList<QScreen*>
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 102, // QList<QOpenGLContext*>
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 104, // QSet<QByteArray>
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 106, // QList<const QInputDevice*>
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 108, // QList<QAction*>
    ...
    SBK_QTGUI_QLIST_QRHISHADERRESOURCEBINDING_IDX            = 118, // QList<QRhiShaderResourceBinding>
    SBK_QTGUI_QLIST_QRHISHADERSTAGE_IDX                      = 120, // QList<QRhiShaderStage>
    SBK_QTGUI_QLIST_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX     = 122, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QTGUI_STD_PAIR_INT_UNSIGNEDINT_IDX                   = 124, // std::pair<int,unsigned int>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX             = 126, // std::pair<QRhiBuffer*,quint32>
    SBK_QTGUI_QLIST_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX       = 128, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_UNSIGNEDINT_IDX         = 130, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 132, // QList<QModelIndex>
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 134, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 136, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 138, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 140, // QMap<QString,QVariant>
    SBK_QTGUI_CONVERTERS_IDX_COUNT                           = 142,
};
...
enum : int {
    ...
    SBK_QtGui_QList_QAccessible_Attribute_IDX                = 37, // QList<QAccessible::Attribute>
    SBK_QtGui_QList_unsignedint_IDX                          = 38, // QList<unsigned int>
    SBK_QtGui_QList_QLine_IDX                                = 39, // QList<QLine>
    SBK_QtGui_QList_QLineF_IDX                               = 40, // QList<QLineF>
    SBK_QtGui_QList_QRect_IDX                                = 41, // QList<QRect>
    SBK_QtGui_QList_QRectF_IDX                               = 42, // QList<QRectF>
    SBK_QtGui_QList_QKeySequence_IDX                         = 43, // QList<QKeySequence>
    SBK_QtGui_QList_QObjectPTR_IDX                           = 44, // QList<QObject*>
    SBK_QtGui_QList_QByteArray_IDX                           = 45, // QList<QByteArray>
    SBK_QtGui_QList_QUndoStackPTR_IDX                        = 46, // QList<QUndoStack*>
    SBK_QtGui_QList_QTextFramePTR_IDX                        = 47, // QList<QTextFrame*>
    SBK_QtGui_QList_QTextBlock_IDX                           = 48, // QList<QTextBlock>
    SBK_QtGui_QList_QTextFormat_IDX                          = 49, // QList<QTextFormat>
    SBK_QtGui_QList_QScreenPTR_IDX                           = 50, // QList<QScreen*>
    SBK_QtGui_QList_QOpenGLContextPTR_IDX                    = 51, // QList<QOpenGLContext*>
    SBK_QtGui_QSet_QByteArray_IDX                            = 52, // QSet<QByteArray>
    SBK_QtGui_QList_constQInputDevicePTR_IDX                 = 53, // QList<const QInputDevice*>
    SBK_QtGui_QList_QActionPTR_IDX                           = 54, // QList<QAction*>
    ...
    SBK_QtGui_QList_QRhiShaderResourceBinding_IDX            = 59, // QList<QRhiShaderResourceBinding>
    SBK_QtGui_QList_QRhiShaderStage_IDX                      = 60, // QList<QRhiShaderStage>
    SBK_QtGui_QList_QRhiGraphicsPipeline_TargetBlend_IDX     = 61, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QtGui_std_pair_int_unsignedint_IDX                   = 62, // std::pair<int,unsigned int>
    SBK_QtGui_std_pair_QRhiBufferPTR_quint32_IDX             = 63, // std::pair<QRhiBuffer*,quint32>
    SBK_QtGui_QList_std_pair_QRhiBufferPTR_quint32_IDX       = 64, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QtGui_std_pair_QRhiBufferPTR_unsignedint_IDX         = 65, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QtGui_QList_QModelIndex_IDX                          = 66, // QList<QModelIndex>
    SBK_QtGui_QHash_int_QByteArray_IDX                       = 67, // QHash<int,QByteArray>
    SBK_QtGui_QList_QVariant_IDX                             = 68, // QList<QVariant>
    SBK_QtGui_QList_QString_IDX                              = 69, // QList<QString>
    SBK_QtGui_QMap_QString_QVariant_IDX                      = 70, // QMap<QString,QVariant>
    SBK_QtGui_CONVERTERS_IDX_COUNT                           = 71,
};
