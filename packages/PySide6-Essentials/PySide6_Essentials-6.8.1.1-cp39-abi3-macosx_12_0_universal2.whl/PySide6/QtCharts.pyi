...
class QAbstractAxis(PySide6.QtCore.QObject):
    ...
    def setLabelsFont(self, font: PySide6.QtGui.QFont | str | typing.Sequence[str]) -> None: ...
    ...
    def setTitleFont(self, font: PySide6.QtGui.QFont | str | typing.Sequence[str]) -> None: ...
...
class QAbstractBarSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def append(self, sets: typing.Sequence[PySide6.QtCharts.QBarSet]) -> bool: ...
...
class QAreaSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def __init__(self, upperSeries: PySide6.QtCharts.QLineSeries, lowerSeries: PySide6.QtCharts.QLineSeries | None= ...) -> None: ...
    @typing.overload
    ...
    def setPointLabelsFont(self, font: PySide6.QtGui.QFont | str | typing.Sequence[str]) -> None: ...
...
class QBarSet(PySide6.QtCore.QObject):
    ...
    def deselectBars(self, indexes: typing.Sequence[int]) -> None: ...
    ...
    def selectBars(self, indexes: typing.Sequence[int]) -> None: ...
    ...
    def setLabelFont(self, font: PySide6.QtGui.QFont | str | typing.Sequence[str]) -> None: ...
    def setPen(self, pen: PySide6.QtGui.QPen | PySide6.QtCore.Qt.PenStyle | PySide6.QtGui.QColor) -> None: ...
    ...
    def sum(self) -> float: ...
    def toggleSelection(self, indexes: typing.Sequence[int]) -> None: ...
...
class QBoxPlotSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def append(self, boxes: typing.Sequence[PySide6.QtCharts.QBoxSet]) -> bool: ...
...
class QBoxSet(PySide6.QtCore.QObject):
    ...
    def __init__(self, label: str = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, le: float, lq: float, m: float, uq: float, ue: float, label: str = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QCandlestickSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def append(self, sets: typing.Sequence[PySide6.QtCharts.QCandlestickSet]) -> bool: ...
    ...
    @typing.overload
    def remove(self, sets: typing.Sequence[PySide6.QtCharts.QCandlestickSet]) -> bool: ...
...
class QCandlestickSet(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, timestamp: float = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, open: float, high: float, low: float, close: float, timestamp: float = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QLegend(PySide6.QtWidgets.QGraphicsWidget):
    ...
    def setBrush(self, brush: PySide6.QtGui.QBrush | PySide6.QtCore.Qt.BrushStyle | PySide6.QtCore.Qt.GlobalColor | PySide6.QtGui.QColor | PySide6.QtGui.QGradient | PySide6.QtGui.QImage | PySide6.QtGui.QPixmap) -> None: ...
    def setColor(self, color: PySide6.QtGui.QColor | str | PySide6.QtGui.QRgba64 | typing.Any | PySide6.QtCore.Qt.GlobalColor | int) -> None: ...
    def setFont(self, font: PySide6.QtGui.QFont | str | typing.Sequence[str]) -> None: ...
...
class QPieSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def append(self, slices: typing.Sequence[PySide6.QtCharts.QPieSlice]) -> bool: ...
    def clear(self) -> None: ...
    def count(self) -> int: ...
...
class QPieSlice(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, label: str, value: float, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QXYSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    @typing.overload
    def __lshift__(self, points: typing.Sequence[PySide6.QtCore.QPointF]) -> PySide6.QtCharts.QXYSeries: ...
    @typing.overload
    def append(self, point: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element) -> None: ...
    @typing.overload
    def append(self, points: typing.Sequence[PySide6.QtCore.QPointF]) -> None: ...
    @typing.overload
    def append(self, x: float, y: float) -> None: ...
    def appendNp(self, x: typing.Sequence[typing.Any], y: typing.Sequence[typing.Any]) -> None: ...
    ...
    def color(self) -> PySide6.QtGui.QColor: ...
    def colorBy(self, sourceData: typing.Sequence[float], gradient: PySide6.QtGui.QLinearGradient = ...) -> None: ...
    def count(self) -> int: ...
    def deselectAllPoints(self) -> None: ...
    def deselectPoint(self, index: int) -> None: ...
    def deselectPoints(self, indexes: typing.Sequence[int]) -> None: ...
    ...
    @typing.overload
    def replace(self, points: typing.Sequence[PySide6.QtCore.QPointF]) -> None: ...
    @typing.overload
    ...
    def replaceNp(self, x: typing.Sequence[typing.Any], y: typing.Sequence[typing.Any]) -> None: ...
    def selectAllPoints(self) -> None: ...
    def selectPoint(self, index: int) -> None: ...
    def selectPoints(self, indexes: typing.Sequence[int]) -> None: ...
    def selectedColor(self) -> PySide6.QtGui.QColor: ...
    ...
    def sizeBy(self, sourceData: typing.Sequence[float], minSize: float, maxSize: float) -> None: ...
    def toggleSelection(self, indexes: typing.Sequence[int]) -> None: ...
