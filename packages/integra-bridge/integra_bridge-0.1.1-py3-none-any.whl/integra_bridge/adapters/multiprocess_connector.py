...
class MultiprocessInputConnectorAdapter(BaseInputConnectorAdapter, ABC):
    ...
    async def deploy_input_flow(self, exchange: Exchange, connector_title: str, *args: Any, **kwargs: Any) -> int:
        ...
        url = f"{connector_to_block_view.url_integra_service}/api/external/connector/input/{connector_to_block_id}?connectorTitle={connector_to_block_view.connector_title}"
    ...
    async def redeploy_input_flow(self, connector_params: dict, connector_title: str, *args: Any, **kwargs: Any):
        ...
        connection_auth = connector_params.get('auth', {})
