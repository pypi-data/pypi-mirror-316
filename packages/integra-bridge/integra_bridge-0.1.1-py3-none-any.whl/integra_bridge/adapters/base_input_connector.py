...
class BaseInputConnectorAdapter(BaseAdapter, ABC):
    ...
    @abstractmethod
    async def on_after_deploy(self, connection_id: str, connection_params: dict, url: str | None = None,
                              auth: dict | None = None, *args: Any, **kwargs: Any) -> None:
        ...

    async def on_after_redeploy(self, connection_id: str, connection_params: dict, url: str | None = None,
                                auth: dict | None = None, *args: Any, **kwargs: Any) -> None:
        ...

    @abstractmethod
    async def on_after_destroy(self, connection_id: str, connector_params: dict, *args: Any, **kwargs: Any) -> None:
        ...
    ...
    @classmethod
    async def _send(cls, exchange: Exchange, url: str) -> int:
