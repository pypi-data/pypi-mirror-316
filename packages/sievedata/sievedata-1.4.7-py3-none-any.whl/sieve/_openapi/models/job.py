...
class Job(BaseModel):
    ...
    inputs: Dict[str, Any] = Field(description="Show child attributes")
    outputs: Optional[List[JobOutputsInner]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "function": FunctionApp.from_dict(obj["function"]) if obj.get("function") is not None else None,
            "status": obj.get("status"),
            "created_at": obj.get("created_at"),
            "started_at": obj.get("started_at"),
            "completed_at": obj.get("completed_at"),
            "inputs": obj.get("inputs"),
            "outputs": [JobOutputsInner.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None,
            "error": obj.get("error"),
