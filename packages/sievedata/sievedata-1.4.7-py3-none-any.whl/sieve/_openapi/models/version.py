...
class Version(BaseModel):
    ...
    scale_up_damper: Optional[Union[StrictFloat, StrictInt]]
    scale_down_damper: Optional[Union[StrictFloat, StrictInt]]
    scaling_constant: Optional[Union[StrictFloat, StrictInt]]
    samples_keep_alive_seconds: Optional[Union[StrictFloat, StrictInt]]
    ...
    __properties: ClassVar[List[str]] = ["id", "build_status", "queued_at", "built_at", "ready_at", "compute_type", "python_packages", "system_packages", "cuda_version", "gpu", "split", "minimum_replicas", "maximum_replicas", "scale_up_damper", "scale_down_damper", "scaling_constant", "samples_keep_alive_seconds", "inputs", "outputs", "current_workers", "environment_variables", "stream_output", "function_dependencies"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if scale_up_damper (nullable) is None
        # and model_fields_set contains the field
        if self.scale_up_damper is None and "scale_up_damper" in self.model_fields_set:
            _dict['scale_up_damper'] = None

        # set to None if scale_down_damper (nullable) is None
        # and model_fields_set contains the field
        if self.scale_down_damper is None and "scale_down_damper" in self.model_fields_set:
            _dict['scale_down_damper'] = None

        # set to None if scaling_constant (nullable) is None
        # and model_fields_set contains the field
        if self.scaling_constant is None and "scaling_constant" in self.model_fields_set:
            _dict['scaling_constant'] = None

        # set to None if samples_keep_alive_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.samples_keep_alive_seconds is None and "samples_keep_alive_seconds" in self.model_fields_set:
            _dict['samples_keep_alive_seconds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scale_up_damper": obj.get("scale_up_damper"),
            "scale_down_damper": obj.get("scale_down_damper"),
            "scaling_constant": obj.get("scaling_constant"),
            "samples_keep_alive_seconds": obj.get("samples_keep_alive_seconds"),
