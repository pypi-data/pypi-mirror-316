...
class FunctionApp(BaseModel):
    ...
    visibility: StrictStr = Field(description="The visibility of the function")
    searchable: Optional[StrictBool]
    title: StrictStr = Field(description="The title of the function")
    code_url: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    cover_image_url: Optional[StrictStr] = None
    examples: Optional[List[StrictStr]] = Field(default=None, description="An array of job ids that the function playground will use as an example")
    readme: Optional[StrictStr] = None
    latest_version: Version
    featured_key: Optional[StrictInt] = None
    function_type: Optional[StrictStr] = None
    webhooks: Optional[List[WebhookModel]] = None
    restart_on_error: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "owner_name", "visibility", "searchable", "title", "code_url", "description", "tags", "cover_image_url", "examples", "readme", "latest_version", "featured_key", "function_type", "webhooks", "restart_on_error"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if searchable (nullable) is None
        # and model_fields_set contains the field
        if self.searchable is None and "searchable" in self.model_fields_set:
            _dict['searchable'] = None
        ...
        # set to None if featured_key (nullable) is None
        # and model_fields_set contains the field
        if self.featured_key is None and "featured_key" in self.model_fields_set:
            _dict['featured_key'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "featured_key": obj.get("featured_key"),
