...
class MacroImageGenerator:
    """A class for generating images using Macro's advanced AI technology."""
    ...
    def __init__(self, output_dir: str = "generated_images"):
        ...
        self.base_url = "https://chat.mistral.ai/api/chat"  # Internal API endpoint
        self._init_headers()
    ...
    def generate_image(self, prompt: str, filename: Optional[str] = None, 
        ...
        json_data = {
            'chatId': 'a10ee6a7-c04e-4649-98c6-20650cc3bb50',  # Internal chat ID
            'mode': 'append',
            'model': 'mistral-small',  # Internal model name
            'messageInput': prompt,
    ...
    def batch_generate(self, prompts: List[str], prefix: str = "") -> List[str]:
        ...
        for i, prompt in enumerate(prompts):
            filename = f"{prefix}{i+1:03d}_{prompt[:20].replace(' ', '_')}.png"
