...
class TestInstanceFields(unittest.TestCase):
    """InstanceFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceFields:
        """Test InstanceFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceFields`
        """
        model = InstanceFields()
        if include_optional:
