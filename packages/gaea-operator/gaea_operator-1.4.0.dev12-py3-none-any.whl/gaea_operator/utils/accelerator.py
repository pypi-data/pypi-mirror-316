...
class Accelerator(metaclass=ABCMeta):
    ...
    def get_names(self, filter_names: List = None):
        ...
        """
        names = \
            [self.T4, self.R200, self.V100, self.A100, self.A10, self.A40, self.A800, self.Atlas310P, self.Ascend910B]
    ...
    def get_kind(self):
        ...
        if self._kind is None:
            ...
            if len(name_list) > 1:
                ...
                elif self.name in [self.Atlas310P, self.Ascend910B]:
...
def get_accelerator(name: str = Accelerator.T4, kind: str = None) -> Accelerator:
    ...
    elif name in (Accelerator.Atlas310P, Accelerator.Ascend910B):
