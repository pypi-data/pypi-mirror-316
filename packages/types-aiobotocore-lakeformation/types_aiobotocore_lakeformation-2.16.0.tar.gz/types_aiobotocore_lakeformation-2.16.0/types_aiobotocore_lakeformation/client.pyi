...
class LakeFormationClient(AioBaseClient):
    ...
    async def create_lf_tag_expression(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client/#create_lf_tag_expression)
        """
    ...
    async def delete_lf_tag_expression(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client/#delete_lf_tag_expression)
        """
    ...
    async def get_lf_tag_expression(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client/#get_lf_tag_expression)
        """
    ...
    async def list_lf_tag_expressions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client/#list_lf_tag_expressions)
        """
    ...
    async def update_lf_tag_expression(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lakeformation/client/#update_lf_tag_expression)
        """
