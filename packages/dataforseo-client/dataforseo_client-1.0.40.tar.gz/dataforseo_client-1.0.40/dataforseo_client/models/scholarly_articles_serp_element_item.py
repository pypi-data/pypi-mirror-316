...
class ScholarlyArticlesSerpElementItem(BaseSerpElementItem):
    """
    ...
    items: Optional[List[ScholarlyArticlesElement]] = Field(default=None, description="contains arrays of specific images")
