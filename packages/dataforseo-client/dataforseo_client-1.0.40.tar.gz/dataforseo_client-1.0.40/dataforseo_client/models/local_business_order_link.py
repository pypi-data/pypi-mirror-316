    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.delivery_services:
            ...
            _dict['delivery_services'] = _items
        # set to None if type (nullable) is None
        # and model_fields_set contains the field
        if self.type is None and "type" in self.model_fields_set:
            _dict['type'] = None

        # set to None if delivery_services (nullable) is None
        # and model_fields_set contains the field
        if self.delivery_services is None and "delivery_services" in self.model_fields_set:
            _dict['delivery_services'] = None
