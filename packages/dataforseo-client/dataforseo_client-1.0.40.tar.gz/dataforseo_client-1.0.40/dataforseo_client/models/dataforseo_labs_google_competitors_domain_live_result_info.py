...
class DataforseoLabsGoogleCompetitorsDomainLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsCompetitorsDomainLiveItem]] = Field(default=None, description="contains data related to the target and competitor domains")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsCompetitorsDomainLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
