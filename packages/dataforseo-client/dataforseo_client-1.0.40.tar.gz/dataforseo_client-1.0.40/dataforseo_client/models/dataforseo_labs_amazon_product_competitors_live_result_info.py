...
class DataforseoLabsAmazonProductCompetitorsLiveResultInfo(BaseModel):
    """
    DataforseoLabsAmazonProductCompetitorsLiveResultInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    asin: Optional[StrictStr] = Field(default=None, description="ASIN in a POST array")
    ...
    items: Optional[List[DataforseoLabsAmazonProductCompetitorsLiveItem]] = Field(default=None, description="contains detected Amazon product competitors and related data")
    __properties: ClassVar[List[str]] = ["se_type", "asin", "location_code", "language_code", "total_count", "items_count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsAmazonProductCompetitorsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
