...
class DomainAnalyticsTechnologiesTechnologyStatsLiveItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "date", "domains_count", "countries", "languages", "domains_rank"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if domains_count (nullable) is None
        # and model_fields_set contains the field
        if self.domains_count is None and "domains_count" in self.model_fields_set:
            _dict['domains_count'] = None
        ...
        # set to None if domains_rank (nullable) is None
        # and model_fields_set contains the field
        if self.domains_rank is None and "domains_rank" in self.model_fields_set:
            _dict['domains_rank'] = None
