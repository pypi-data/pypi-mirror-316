...
class SerpNaverOrganicTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "url", "priority", "depth", "max_crawl_pages", "device", "os", "se_domain", "search_param", "tag", "postback_url", "postback_data", "pingback_url"]
