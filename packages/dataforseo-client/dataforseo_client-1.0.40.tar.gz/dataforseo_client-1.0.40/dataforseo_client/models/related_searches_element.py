...
class RelatedSearchesElement(BaseModel):
    """
    ...
    image_alt: Optional[StrictStr] = Field(default=None, description="the alt tag of the product image featured in the results")
    image_url: Optional[StrictStr] = Field(default=None, description="URL of the product image featured in the results")
    __properties: ClassVar[List[str]] = ["type", "title", "url", "image_alt", "image_url"]
