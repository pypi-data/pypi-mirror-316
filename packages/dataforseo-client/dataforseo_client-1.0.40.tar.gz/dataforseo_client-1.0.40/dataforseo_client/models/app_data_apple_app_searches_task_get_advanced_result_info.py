...
class AppDataAppleAppSearchesTaskGetAdvancedResultInfo(BaseModel):
    """
    AppDataAppleAppSearchesTaskGetAdvancedResultInfo
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="keyword received in a POST request")
    ...
    check_url: Optional[StrictStr] = Field(default=None, description="direct URL to search engine results in this case, the value will be null")
    ...
    items_count: Optional[StrictInt] = Field(default=None, description="the number of items in the results array")
