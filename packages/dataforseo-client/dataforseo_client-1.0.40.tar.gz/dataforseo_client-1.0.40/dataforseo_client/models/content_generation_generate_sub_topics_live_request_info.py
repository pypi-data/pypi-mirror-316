...
class ContentGenerationGenerateSubTopicsLiveRequestInfo(BaseModel):
    """
    ContentGenerationGenerateSubTopicsLiveRequestInfo
    """ # noqa: E501
    topic: Optional[StrictStr] = Field(default=None, description="main topic of the content to generate required field main topic for content generation; can contain from 1 to 50 tokens")
    ...
    __properties: ClassVar[List[str]] = ["topic", "creativity_index", "tag"]
