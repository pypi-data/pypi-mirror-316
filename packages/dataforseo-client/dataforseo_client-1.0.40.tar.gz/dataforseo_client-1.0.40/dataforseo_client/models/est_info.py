...
class EstInfo(BaseModel):
    """
    EstInfo
    """ # noqa: E501
    high: Optional[StrictInt] = Field(default=None, description="indicates the upper bound of the range result")
    low: Optional[StrictInt] = Field(default=None, description="indicates the lower bound of the range result")
