...
class KeywordsDataBingKeywordsForSiteLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "keywords_negative", "device", "date_from", "date_to", "sort_by", "search_partners", "tag"]
