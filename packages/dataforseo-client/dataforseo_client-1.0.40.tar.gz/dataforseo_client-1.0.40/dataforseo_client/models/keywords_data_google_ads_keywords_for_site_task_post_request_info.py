...
class KeywordsDataGoogleAdsKeywordsForSiteTaskPostRequestInfo(BaseModel):
    """
    ...
    target_type: Optional[StrictStr] = Field(default=None, description="search keywords for site or url optional field possible values: site, page; default value: page if set to site, keywords will be provided for the entire site; if set to page, keywords will be provided for the specified webpage")
    ...
    __properties: ClassVar[List[str]] = ["target", "target_type", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "search_partners", "date_from", "date_to", "include_adult_keywords", "sort_by", "postback_url", "pingback_url", "tag"]
