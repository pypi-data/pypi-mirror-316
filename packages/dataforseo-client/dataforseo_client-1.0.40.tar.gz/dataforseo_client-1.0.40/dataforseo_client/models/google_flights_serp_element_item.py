...
class GoogleFlightsSerpElementItem(BaseSerpElementItem):
    """
    ...
    items: Optional[List[GoogleFlightsElement]] = Field(default=None, description="contains arrays of specific images")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "url": obj.get("url"),
            "items": [GoogleFlightsElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
