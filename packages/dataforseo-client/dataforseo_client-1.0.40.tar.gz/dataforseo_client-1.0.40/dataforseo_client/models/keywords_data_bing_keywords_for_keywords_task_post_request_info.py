...
class KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "sort_by", "keywords_negative", "device", "date_from", "date_to", "search_partners", "postback_url", "pingback_url", "tag"]
