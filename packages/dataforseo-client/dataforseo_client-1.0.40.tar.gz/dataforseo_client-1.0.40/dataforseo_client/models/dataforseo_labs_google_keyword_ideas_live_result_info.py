...
class DataforseoLabsGoogleKeywordIdeasLiveResultInfo(BaseModel):
    """
    DataforseoLabsGoogleKeywordIdeasLiveResultInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    seed_keywords: Optional[List[Optional[StrictStr]]] = Field(default=None, description="keywords in a POST array keywords are returned with decoded %## (plus character ‘+’ will be decoded to a space character)")
    location_code: Optional[StrictInt] = Field(default=None, description="location code in a POST array")
    language_code: Optional[StrictStr] = Field(default=None, description="language code in a POST array")
    total_count: Optional[StrictInt] = Field(default=None, description="total number of results relevant to your request in our database")
    ...
    __properties: ClassVar[List[str]] = ["se_type", "seed_keywords", "location_code", "language_code", "total_count", "items_count", "offset", "offset_token", "items"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if seed_keywords (nullable) is None
        # and model_fields_set contains the field
        if self.seed_keywords is None and "seed_keywords" in self.model_fields_set:
            _dict['seed_keywords'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seed_keywords": obj.get("seed_keywords"),
