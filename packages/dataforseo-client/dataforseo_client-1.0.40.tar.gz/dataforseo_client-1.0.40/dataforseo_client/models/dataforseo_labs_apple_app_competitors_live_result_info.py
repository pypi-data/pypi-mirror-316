...
class DataforseoLabsAppleAppCompetitorsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsAppleAppCompetitorsLiveItem]] = Field(default=None, description="contains data related to the app_id and competitor applications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsAppleAppCompetitorsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
