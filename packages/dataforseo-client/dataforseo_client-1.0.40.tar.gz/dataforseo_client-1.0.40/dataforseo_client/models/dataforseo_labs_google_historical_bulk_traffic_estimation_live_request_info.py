...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    targets: Optional[List[StrictStr]] = Field(default=None, description="target domains and subdomains required field you can specify domains and subdomains in this field; domains and subdomains should be specified without https:// and www.; you can set up to 1000 domains or subdomains")
    ...
    __properties: ClassVar[List[str]] = ["targets", "location_name", "location_code", "language_name", "language_code", "date_from", "date_to", "ignore_synonyms", "item_types", "tag"]
