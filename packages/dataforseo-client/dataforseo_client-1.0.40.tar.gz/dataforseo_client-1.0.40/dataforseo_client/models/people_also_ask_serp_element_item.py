...
class PeopleAlsoAskSerpElementItem(BaseSerpElementItem):
    """
    PeopleAlsoAskSerpElementItem
    """ # noqa: E501
    items: Optional[List[PeopleAlsoAskElement]] = Field(default=None, description="contains arrays of specific images")
