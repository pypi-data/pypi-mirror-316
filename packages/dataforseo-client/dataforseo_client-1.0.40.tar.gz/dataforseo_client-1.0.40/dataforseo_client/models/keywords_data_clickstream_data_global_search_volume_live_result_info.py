...
class KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo(BaseModel):
    """
    KeywordsDataClickstreamDataGlobalSearchVolumeLiveResultInfo
    """ # noqa: E501
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[KeywordsDataClickstreamDataGlobalSearchVolumeLiveItem]] = Field(default=None, description="contains keywords and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [KeywordsDataClickstreamDataGlobalSearchVolumeLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
