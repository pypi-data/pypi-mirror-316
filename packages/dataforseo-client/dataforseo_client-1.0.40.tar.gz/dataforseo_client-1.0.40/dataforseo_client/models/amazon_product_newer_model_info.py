...
class AmazonProductNewerModelInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "newer_model_asin"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if newer_model_asin (nullable) is None
        # and model_fields_set contains the field
        if self.newer_model_asin is None and "newer_model_asin" in self.model_fields_set:
            _dict['newer_model_asin'] = None
