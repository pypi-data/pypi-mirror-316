...
class DataforseoLabsGoogleDomainMetricsByCategoriesLiveResultInfo(BaseModel):
    """
    DataforseoLabsGoogleDomainMetricsByCategoriesLiveResultInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    categories: Optional[List[StrictInt]] = Field(default=None, description="categories in a POST array")
    ...
    items: Optional[List[DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem]] = Field(default=None, description="contains historical ranking and traffic data")
    __properties: ClassVar[List[str]] = ["se_type", "categories", "location_code", "language_code", "total_count", "items_count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleDomainMetricsByCategoriesLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
