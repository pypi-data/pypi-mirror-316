...
class DataAmazonRelatedSearchesSerpElementItem(BaseAmazonSerpElementItem):
    """
    ...
    items: Optional[List[RelatedSearchesElement]] = Field(default=None, description="Amazon product items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RelatedSearchesElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
