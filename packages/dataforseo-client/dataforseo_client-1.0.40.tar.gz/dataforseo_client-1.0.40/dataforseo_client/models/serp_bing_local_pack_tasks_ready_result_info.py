...
class SerpBingLocalPackTasksReadyResultInfo(BaseModel):
    """
    ...
    se_type: Optional[StrictStr] = Field(default=None, description="type of search engine example: local_pack")
