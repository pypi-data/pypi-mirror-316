...
class AppendixDayStatisticsMoneyData(BaseModel):
    ...
    reviews: Optional[AppendixDayLimitsRatesDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviews": AppendixDayLimitsRatesDataInfo.from_dict(obj["reviews"]) if obj.get("reviews") is not None else None
        })
        return _obj
