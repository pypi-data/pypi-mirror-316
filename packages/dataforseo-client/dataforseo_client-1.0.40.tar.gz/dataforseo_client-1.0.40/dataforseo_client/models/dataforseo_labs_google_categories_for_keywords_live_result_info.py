...
class DataforseoLabsGoogleCategoriesForKeywordsLiveResultInfo(BaseModel):
    ...
    items: Optional[List[DataforseoLabsGoogleCategoriesForKeywordsLiveItem]] = Field(default=None, description="contains keywords and related keyword difficulty scores")
