...
class AppDataGoogleAppListingsSearchLiveItem(BaseModel):
    """
    ...
    item: Optional[DataAppGooglePlayInfoOrganicSerpElementItem] = None
    __properties: ClassVar[List[str]] = ["app_id", "se_domain", "location_code", "language_code", "check_url", "time_update", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": DataAppGooglePlayInfoOrganicSerpElementItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
