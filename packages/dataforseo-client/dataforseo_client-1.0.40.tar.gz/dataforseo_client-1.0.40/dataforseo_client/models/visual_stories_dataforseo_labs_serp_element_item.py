...
class VisualStoriesDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    """
    VisualStoriesDataforseoLabsSerpElementItem
    """ # noqa: E501
    items: Optional[List[LicensesElement]] = Field(default=None, description="elements of search results found in SERP")
