...
class SerpGoogleSearchByImageTaskGetAdvancedResultInfo(BaseModel):
    """
    SerpGoogleSearchByImageTaskGetAdvancedResultInfo
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="URL specified in a POST array")
    keyword: Optional[StrictStr] = Field(default=None, description="keyword Google associated with the specified image")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="types of search results in SERP contains types of search results (items) found in SERP. possible item types: organic, images")
    ...
    __properties: ClassVar[List[str]] = ["image_url", "keyword", "type", "se_domain", "location_code", "language_code", "check_url", "datetime", "spell", "refinement_chips", "item_types", "se_results_count", "items_count", "items"]
