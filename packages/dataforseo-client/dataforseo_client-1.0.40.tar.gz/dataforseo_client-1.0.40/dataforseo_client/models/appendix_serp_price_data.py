...
class AppendixSerpPriceData(BaseModel):
    ...
    screenshot: Optional[AppendixTaskKeywordsDataPriceDataInfo] = None
    task_get: Optional[AppendixSerpPriceDataInfo] = None
    ...
    __properties: ClassVar[List[str]] = ["tasks_fixed", "errors", "jobs", "languages", "live", "locations", "screenshot", "task_get", "task_post", "tasks_ready"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tasks_fixed
        if self.tasks_fixed:
            _dict['tasks_fixed'] = self.tasks_fixed.to_dict()
