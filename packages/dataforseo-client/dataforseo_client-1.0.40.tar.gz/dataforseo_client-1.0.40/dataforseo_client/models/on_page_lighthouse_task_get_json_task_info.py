...
class OnPageLighthouseTaskGetJsonTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[Optional[Dict[str, Any]]]] = Field(default=None, description="results of Lighthouse audit this array will include data according to the parameters specified in the POST request; description of the fields in the result array is available in the official documentation")
