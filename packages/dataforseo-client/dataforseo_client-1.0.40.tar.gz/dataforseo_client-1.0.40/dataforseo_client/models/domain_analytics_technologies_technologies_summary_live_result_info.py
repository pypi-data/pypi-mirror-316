...
class DomainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if content_languages (nullable) is None
        # and model_fields_set contains the field
        if self.content_languages is None and "content_languages" in self.model_fields_set:
            _dict['content_languages'] = None
