...
class AppDataleAppListingsSearchLiveItem(BaseModel):
    """
    ...
    item: Optional[BaseAppDataSerpElementItem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": BaseAppDataSerpElementItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
