...
class BacklinksPageIntersectionLiveResultInfo(BaseModel):
    """
    BacklinksPageIntersectionLiveResultInfo
    """ # noqa: E501
    targets: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description="targets from a POST array")
    ...
    items: Optional[List[BacklinksPageIntersectionLiveItem]] = Field(default=None, description="contains relevant backlinks and referring domains data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BacklinksPageIntersectionLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
