...
class SerpGoogleNewsTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyword", "url", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "os", "calculate_rectangles", "browser_screen_width", "browser_screen_height", "browser_screen_resolution_ratio", "se_domain", "depth", "max_crawl_pages", "search_param", "tag", "postback_url", "postback_data", "pingback_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleNewsTaskPostRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleNewsTaskPostRequestInfo from a dict"""
        if obj is None:
            return None
