...
class AppendixHotelInfoGoogleBusinessDataPriceData(BaseModel):
    """
    AppendixHotelInfoGoogleBusinessDataPriceData
    """ # noqa: E501
    live: Optional[AppendixTaskGetProductGoogleMerchantPriceDataInfo] = None
    task_get: Optional[AppendixTaskGetProductGoogleMerchantPriceDataInfo] = None
    ...
    __properties: ClassVar[List[str]] = ["live", "task_get", "task_post", "tasks_ready"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "live": AppendixTaskGetProductGoogleMerchantPriceDataInfo.from_dict(obj["live"]) if obj.get("live") is not None else None,
