...
class DataforseoLabsGoogleKeywordIdeasLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "language_name", "language_code", "closely_variants", "ignore_synonyms", "include_serp_info", "include_clickstream_data", "limit", "offset", "offset_token", "filters", "order_by", "tag"]
