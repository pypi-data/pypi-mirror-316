...
class AppendixGoogleBusinessDataPriceDataInfo(BaseModel):
    """
    AppendixGoogleBusinessDataPriceDataInfo
    """ # noqa: E501
    live: Optional[AppendixTaskKeywordsDataPriceDataInfo] = None
    task_get: Optional[AppendixTaskKeywordsDataPriceDataInfo] = None
