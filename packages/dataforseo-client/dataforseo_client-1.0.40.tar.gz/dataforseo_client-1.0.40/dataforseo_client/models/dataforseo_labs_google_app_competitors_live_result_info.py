...
class DataforseoLabsGoogleAppCompetitorsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsGoogleAppCompetitorsLiveItem]] = Field(default=None, description="contains data related to the app_id and competitor applications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleAppCompetitorsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
