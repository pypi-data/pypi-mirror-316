...
class SerpBingOrganicTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "device", "os", "depth", "max_crawl_pages", "calculate_rectangles", "browser_screen_width", "browser_screen_height", "browser_screen_resolution_ratio", "search_param", "tag", "postback_url", "postback_data", "pingback_url"]
