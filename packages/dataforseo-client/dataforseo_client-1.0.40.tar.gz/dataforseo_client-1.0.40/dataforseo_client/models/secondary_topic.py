...
class SecondaryTopic(BaseModel):
    ...
    primary_content: Optional[StrictStr] = Field(default=None, description="primary content on the page you can find more information about content priority calculation in this help center article")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "level": obj.get("level"),
            "primary_content": obj.get("primary_content"),
