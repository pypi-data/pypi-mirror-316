...
class ResourceMetaInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if original_width (nullable) is None
        # and model_fields_set contains the field
        if self.original_width is None and "original_width" in self.model_fields_set:
            _dict['original_width'] = None

        # set to None if original_height (nullable) is None
        # and model_fields_set contains the field
        if self.original_height is None and "original_height" in self.model_fields_set:
            _dict['original_height'] = None
