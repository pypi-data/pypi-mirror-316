...
class PodcastsSerpElementItem(BaseSerpElementItem):
    """
    PodcastsSerpElementItem
    """ # noqa: E501
    items: Optional[List[PodcastsElement]] = Field(default=None, description="contains arrays of specific images")
