...
class AppendixApi:
    ...
    def appendix_errors(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AppendixErrorsResponseInfo",
        }
    ...
    def _appendix_errors_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appendix/errors',
    ...
    def appendix_status(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AppendixStatusResponseInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def appendix_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def appendix_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _appendix_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appendix/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def user_data(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AppendixUserDataResponseInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def user_data_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _user_data_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/appendix/user_data',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def webhook_resend(
        self,
        appendix_webhook_resend_request_info: Optional[List[AppendixWebhookResendRequestInfo]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param appendix_webhook_resend_request_info:
        :type appendix_webhook_resend_request_info: List[AppendixWebhookResendRequestInfo]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhook_resend_serialize(
            appendix_webhook_resend_request_info=appendix_webhook_resend_request_info,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AppendixWebhookResendResponseInfo",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _webhook_resend_serialize(
        self,
        appendix_webhook_resend_request_info,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if appendix_webhook_resend_request_info is not None:
            _body_params = appendix_webhook_resend_request_info
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/appendix/webhook_resend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
