...
class BacklinksBacklinksLiveRequestInfo(BaseModel):
    ...
    var_field: Optional[StrictStr] = Field(default=None, description="response field required field if you choose to specify custom_mode possible values: anchor domain_from domain_from_country tld_from page_from_encoding page_from_language item_type page_from_status_code semantic_location", alias="field")
