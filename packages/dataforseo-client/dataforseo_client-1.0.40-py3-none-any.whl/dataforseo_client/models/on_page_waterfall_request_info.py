...
class OnPageWaterfallRequestInfo(BaseModel):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description="page URL required field specify the pages you want to receive timing for")
