...
class KnowledgeGraphImagesItemSerpElementItem(BaseSerpElementItem):
    """
    KnowledgeGraphImagesItemSerpElementItem
    """ # noqa: E501
    link: Optional[LinkElement] = None
    items: Optional[List[KnowledgeGraphImagesElement]] = Field(default=None, description="items featured in the faq_box")
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "link", "items", "rectangle"]
