...
class MultiCarouselDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    """
    MultiCarouselDataforseoLabsSerpElementItem
    """ # noqa: E501
    items: Optional[List[MultiCarouselElement]] = Field(default=None, description="contains results featured in the ‘hotels_pack’ element of SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "items": [MultiCarouselElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
