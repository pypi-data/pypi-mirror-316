...
class BacklinksAnchorsLiveTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[BacklinksAnchorsLiveResultInfo]] = Field(default=None, description="array of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "data": obj.get("data"),
            "result": [BacklinksAnchorsLiveResultInfo.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
