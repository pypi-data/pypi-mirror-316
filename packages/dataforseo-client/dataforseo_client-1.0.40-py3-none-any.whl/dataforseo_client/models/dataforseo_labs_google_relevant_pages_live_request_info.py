...
class DataforseoLabsGoogleRelevantPagesLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "item_types", "include_clickstream_data", "limit", "offset", "historical_serp_mode", "filters", "order_by", "tag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleRelevantPagesLiveRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataforseoLabsGoogleRelevantPagesLiveRequestInfo from a dict"""
        if obj is None:
            return None
