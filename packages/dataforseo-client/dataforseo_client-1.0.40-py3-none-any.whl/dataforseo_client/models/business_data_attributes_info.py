    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.available_attributes is None and "available_attributes" in self.model_fields_set:
            _dict['available_attributes'] = None

        # set to None if unavailable_attributes (nullable) is None
        # and model_fields_set contains the field
        if self.unavailable_attributes is None and "unavailable_attributes" in self.model_fields_set:
            _dict['unavailable_attributes'] = None
