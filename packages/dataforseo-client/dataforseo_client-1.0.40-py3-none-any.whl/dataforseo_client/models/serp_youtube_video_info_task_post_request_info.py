...
class SerpYoutubeVideoInfoTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["video_id", "priority", "location_name", "location_code", "language_name", "language_code", "device", "os", "tag", "postback_url", "postback_data", "pingback_url"]
