...
class BusinessDataGoogleExtendedReviewsTaskGetResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BusinessDataGoogleExtendedReviewsTaskGetItem]] = Field(default=None, description="found reviews you can get more results by using the depth parameter when setting a task")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BusinessDataGoogleExtendedReviewsTaskGetItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
