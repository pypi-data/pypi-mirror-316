...
class KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo from a JSON string"""
