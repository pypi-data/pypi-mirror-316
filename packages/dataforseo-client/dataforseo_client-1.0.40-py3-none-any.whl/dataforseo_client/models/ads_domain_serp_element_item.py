...
class AdsDomainSerpElementItem(BaseGoogleAdsAdvertisersSerpElementItem):
    """
    AdsDomainSerpElementItem
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="domain in SERP")
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "domain"]
