...
class AmazonRankedSerpElement(BaseModel):
    ...
    serp_item: Optional[BaseAmazonSerpElementItem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serp_item": BaseAmazonSerpElementItem.from_dict(obj["serp_item"]) if obj.get("serp_item") is not None else None,
