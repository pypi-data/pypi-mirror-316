...
class SerpYoutubeVideoCommentsTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["video_id", "priority", "location_name", "location_code", "language_name", "language_code", "device", "os", "depth", "tag", "postback_url", "postback_data", "pingback_url"]
