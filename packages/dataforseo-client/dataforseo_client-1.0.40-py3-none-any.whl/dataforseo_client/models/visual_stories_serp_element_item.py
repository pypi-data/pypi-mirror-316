...
class VisualStoriesSerpElementItem(BaseSerpElementItem):
    """
    VisualStoriesSerpElementItem
    """ # noqa: E501
    items: Optional[List[LicensesElement]] = Field(default=None, description="contains arrays of specific images")
