...
class StocksBoxSerpElementItem(BaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "title", "source", "snippet", "price", "url", "domain", "rectangle", "table", "graph"]
