...
class DataforseoLabsBingRelevantPagesLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "item_types", "limit", "offset", "historical_serp_mode", "filters", "order_by", "tag"]
