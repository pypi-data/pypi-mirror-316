...
class AppDataAppleAppListingsSearchLiveItem(BaseModel):
    ...
    item: Optional[DataAppAppStoreInfoOrganicSerpElementItem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": DataAppAppStoreInfoOrganicSerpElementItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
