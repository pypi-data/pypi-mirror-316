...
class Subtitles(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["language", "is_translatable", "is_auto_generated"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_translatable (nullable) is None
        # and model_fields_set contains the field
        if self.is_translatable is None and "is_translatable" in self.model_fields_set:
            _dict['is_translatable'] = None

        # set to None if is_auto_generated (nullable) is None
        # and model_fields_set contains the field
        if self.is_auto_generated is None and "is_auto_generated" in self.model_fields_set:
            _dict['is_auto_generated'] = None
