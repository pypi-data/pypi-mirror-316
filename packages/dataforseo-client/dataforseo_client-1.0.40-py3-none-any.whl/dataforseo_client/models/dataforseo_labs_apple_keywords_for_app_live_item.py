...
class DataforseoLabsAppleKeywordsForAppLiveItem(BaseModel):
    ...
    ranked_serp_element: Optional[ItemsRankedSerpElement] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ranked_serp_element": ItemsRankedSerpElement.from_dict(obj["ranked_serp_element"]) if obj.get("ranked_serp_element") is not None else None
        })
        return _obj
