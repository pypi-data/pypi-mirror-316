...
class DataforseoLabsGoogleRelevantPagesLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsRelevantPagesLiveItem]] = Field(default=None, description="relevant pages and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsRelevantPagesLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
