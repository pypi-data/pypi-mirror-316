...
class DataforseoLabsAmazonRankedKeywordsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsAmazonRankedKeywordsLiveItem]] = Field(default=None, description="contains detected Amazon product competitors and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsAmazonRankedKeywordsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
