...
class SerpYoutubeVideoCommentsTasksReadyResultInfo(BaseModel):
    """
    ...
    se_type: Optional[StrictStr] = Field(default=None, description="type of search engine example: video_comments")
