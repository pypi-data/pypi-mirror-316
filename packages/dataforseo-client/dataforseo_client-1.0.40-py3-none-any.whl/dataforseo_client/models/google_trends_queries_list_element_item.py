...
class GoogleTrendsQueriesListElementItem(BaseGoogleTrendsItem):
    """
    GoogleTrendsQueriesListElementItem
    """ # noqa: E501
    data: Optional[QueriesListDataInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": QueriesListDataInfo.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
