...
class MerchantAmazonReviewsTaskGetAdvancedTaskInfo(BaseModel):
    """
    ...
    result: Optional[List[MerchantAmazonReviewsTaskGetAdvancedResultInfo]] = Field(default=None, description="array of results")
