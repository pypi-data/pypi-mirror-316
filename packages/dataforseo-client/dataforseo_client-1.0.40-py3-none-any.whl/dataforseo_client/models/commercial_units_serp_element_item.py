...
class CommercialUnitsSerpElementItem(BaseSerpElementItem):
    """
    CommercialUnitsSerpElementItem
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="title of the row")
    items: Optional[List[CommercialUnitsElement]] = Field(default=None, description="contains arrays of specific images")
