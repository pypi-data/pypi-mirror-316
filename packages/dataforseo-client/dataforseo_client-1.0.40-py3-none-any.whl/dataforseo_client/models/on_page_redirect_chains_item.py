...
class OnPageRedirectChainsItem(BaseModel):
    ...
    chain: Optional[List[BaseOnPageLinkItemInfo]] = Field(default=None, description="contains links that form a chain")
    __properties: ClassVar[List[str]] = ["is_redirect_loop", "chain"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.chain:
            for _item_chain in self.chain:
                if _item_chain:
                    _items.append(_item_chain.to_dict())
            _dict['chain'] = _items
        # set to None if is_redirect_loop (nullable) is None
        # and model_fields_set contains the field
        if self.is_redirect_loop is None and "is_redirect_loop" in self.model_fields_set:
            _dict['is_redirect_loop'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chain": [BaseOnPageLinkItemInfo.from_dict(_item) for _item in obj["chain"]] if obj.get("chain") is not None else None
        })
        return _obj
