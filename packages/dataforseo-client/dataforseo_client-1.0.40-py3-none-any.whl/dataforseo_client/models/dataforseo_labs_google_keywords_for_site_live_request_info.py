...
class DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo(BaseModel):
    """
    DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="target domain required field the domain name of the target website the domain should be specified without https://")
