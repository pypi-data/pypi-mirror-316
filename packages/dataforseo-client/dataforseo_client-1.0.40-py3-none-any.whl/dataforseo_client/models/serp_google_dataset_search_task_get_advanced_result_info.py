...
class SerpGoogleDatasetSearchTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[SerpGoogleDatasetAdvancedItem]] = Field(default=None, description="items of the element")
