...
class SerpGoogleImagesTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="types of search results in SERP contains types of search results (items) found in SERP. possible item types: carousel, images_search, related_searches")
    se_results_count: Optional[StrictInt] = Field(default=None, description="total number of results in SERP")
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[BaseGoogleImagesSerpElementItem]] = Field(default=None, description="elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseGoogleImagesSerpElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
