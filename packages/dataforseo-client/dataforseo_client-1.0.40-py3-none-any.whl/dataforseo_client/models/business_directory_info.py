...
class BusinessDirectoryInfo(BaseModel):
    """
    BusinessDirectoryInfo
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="title of the element domain of the online menu system")
    ...
    __properties: ClassVar[List[str]] = ["title", "items"]
