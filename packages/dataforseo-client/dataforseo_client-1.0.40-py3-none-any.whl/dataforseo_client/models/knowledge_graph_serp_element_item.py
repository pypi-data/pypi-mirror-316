...
class KnowledgeGraphSerpElementItem(BaseSerpElementItem):
    """
    ...
    items: Optional[List[BaseSerpElementItem]] = Field(default=None, description="contains results featured in the ‘hotels_pack’ element of SERP")
    rectangle: Optional[Rectangle] = None
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "title", "subtitle", "description", "card_id", "url", "image_url", "logo_url", "cid", "items", "rectangle"]
