...
class MerchantAmazonProductsTasksReadyResultInfo(BaseModel):
    """
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of the Amazon Products Advanced task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of the Amazon Products HTML task")
