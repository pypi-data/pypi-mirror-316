...
class MerchantGoogleSellersTasksReadyResultInfo(BaseModel):
    """
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of Google Shopping Sellers Advanced task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of Google Shopping Sellers HTML task")
