...
class BusinessDataSocialMediaPinterestLiveResultInfo(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pins_count (nullable) is None
        # and model_fields_set contains the field
        if self.pins_count is None and "pins_count" in self.model_fields_set:
            _dict['pins_count'] = None
