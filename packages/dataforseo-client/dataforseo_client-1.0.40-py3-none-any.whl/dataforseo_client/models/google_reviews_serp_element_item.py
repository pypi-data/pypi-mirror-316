...
class GoogleReviewsSerpElementItem(BaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "reviews_count", "rating", "place_id", "feature", "cid", "rectangle"]
