...
class SerpGoogleOrganicTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BaseSerpElementItem]] = Field(default=None, description="items present in the element")
