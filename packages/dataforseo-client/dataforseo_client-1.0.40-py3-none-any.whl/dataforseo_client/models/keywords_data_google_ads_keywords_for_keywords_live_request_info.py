...
class KeywordsDataGoogleAdsKeywordsForKeywordsLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "search_partners", "date_from", "date_to", "sort_by", "include_adult_keywords", "tag"]
