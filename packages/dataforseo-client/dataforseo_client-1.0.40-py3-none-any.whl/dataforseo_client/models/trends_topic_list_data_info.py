...
class TrendsTopicListDataInfo(BaseModel):
    ...
    """ # noqa: E501
    top: Optional[List[TopicListDataItemInfo]] = Field(default=None, description="the most popular related topics represents the list of the most popular related topics")
    rising: Optional[List[TopicListDataItemInfo]] = Field(default=None, description="emerging related topics represents the list of related topics with the biggest increase in search frequency since the last time period")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.rising:
            for _item_rising in self.rising:
                if _item_rising:
                    _items.append(_item_rising.to_dict())
            _dict['rising'] = _items
