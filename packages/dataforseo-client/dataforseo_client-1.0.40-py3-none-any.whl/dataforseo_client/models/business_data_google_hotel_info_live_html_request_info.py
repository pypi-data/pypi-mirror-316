...
class BusinessDataGoogleHotelInfoLiveHtmlRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hotel_identifier", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "check_in", "check_out", "currency", "adults", "children", "tag"]
