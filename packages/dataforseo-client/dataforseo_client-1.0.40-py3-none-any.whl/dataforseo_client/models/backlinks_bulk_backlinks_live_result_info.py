...
class BacklinksBulkBacklinksLiveResultInfo(BaseModel):
    """
    BacklinksBulkBacklinksLiveResultInfo
    """ # noqa: E501
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[BacklinksBulkBacklinksLiveItem]] = Field(default=None, description="contains relevant backlink data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BacklinksBulkBacklinksLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
