...
class ProductVariation(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description="name of the product seller")
    url: Optional[StrictStr] = Field(default=None, description="seller url url of the webpage on the seller’s website where the product is sold")
    __properties: ClassVar[List[str]] = ["type", "product_id", "title", "url"]
