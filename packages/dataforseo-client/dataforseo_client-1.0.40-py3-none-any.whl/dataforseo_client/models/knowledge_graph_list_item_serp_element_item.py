...
class KnowledgeGraphListItemSerpElementItem(BaseSerpElementItem):
    """
    KnowledgeGraphListItemSerpElementItem
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="title of the link element")
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "title", "data_attrid", "link", "items", "rectangle"]
