...
class MerchantGoogleProductSpecTasksReadyResultInfo(BaseModel):
    """
    ...
    endpoint_html: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of the Google Shopping Product Specifications HTML task")
