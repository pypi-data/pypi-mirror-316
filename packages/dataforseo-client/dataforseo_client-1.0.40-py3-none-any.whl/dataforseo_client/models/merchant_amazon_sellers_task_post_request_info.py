...
class MerchantAmazonSellersTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asin", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "se_domain", "tag", "postback_url", "postback_data", "pingback_url"]
