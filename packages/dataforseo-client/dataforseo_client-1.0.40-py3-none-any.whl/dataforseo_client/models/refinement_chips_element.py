...
class RefinementChipsElement(BaseModel):
    ...
    options: Optional[List[LicensesElement]] = Field(default=None, description="further search refinement options")
    __properties: ClassVar[List[str]] = ["type", "title", "url", "domain", "options"]
