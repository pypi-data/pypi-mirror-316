...
class KeywordKpi(BaseModel):
    ...
    KeywordKpi
    """ # noqa: E501
    desktop: Optional[List[KeywordKpiInfo]] = Field(default=None, description="keyword data aggregated for desktop devices if there is no data, then the value is null")
    mobile: Optional[List[KeywordKpiInfo]] = Field(default=None, description="keyword data aggregated for mobile devices if there is no data, then the value is null")
