...
class DataforseoLabsGoogleRankedKeywordsLiveRequestInfo(BaseModel):
    ...
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="domain name or page url required field the domain name of the target website or URL of the target webpage; the domain name must be specified without https:// or www.; the webpage URL must be specified with https:// or www.")
    ...
    __properties: ClassVar[List[str]] = ["target", "location_name", "location_code", "language_name", "language_code", "ignore_synonyms", "item_types", "include_clickstream_data", "limit", "offset", "load_rank_absolute", "historical_serp_mode", "filters", "order_by", "tag"]
