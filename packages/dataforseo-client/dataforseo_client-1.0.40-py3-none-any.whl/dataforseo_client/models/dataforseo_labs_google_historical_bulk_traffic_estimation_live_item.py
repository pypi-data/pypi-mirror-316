...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem(BaseModel):
    """
    ...
    metrics: Optional[HistoricalMetricsBundleInfo] = None
    __properties: ClassVar[List[str]] = ["se_type", "target", "metrics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": HistoricalMetricsBundleInfo.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj
