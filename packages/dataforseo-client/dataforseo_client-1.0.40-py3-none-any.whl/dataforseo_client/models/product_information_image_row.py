...
class ProductInformationImageRow(BaseProductInformationRowItem):
    """
    ProductInformationImageRow
    """ # noqa: E501
    alt: Optional[StrictStr] = Field(default=None, description="alternative text of the related product image")
    url: Optional[StrictStr] = Field(default=None, description="URL of the image")
    __properties: ClassVar[List[str]] = ["type", "alt", "url"]
