...
class BusinessDataGoogleMyBusinessInfoLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyword", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "tag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleMyBusinessInfoLiveRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessDataGoogleMyBusinessInfoLiveRequestInfo from a dict"""
        if obj is None:
            return None
