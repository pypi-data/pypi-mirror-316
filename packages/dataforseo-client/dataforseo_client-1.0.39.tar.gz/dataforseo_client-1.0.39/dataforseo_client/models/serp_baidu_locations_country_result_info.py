...
class SerpBaiduLocationsCountryResultInfo(BaseModel):
    """
    ...
    location_type: Optional[StrictStr] = Field(default=None, description="location type only City is supported for all countries except China (where Country is also supported)")
