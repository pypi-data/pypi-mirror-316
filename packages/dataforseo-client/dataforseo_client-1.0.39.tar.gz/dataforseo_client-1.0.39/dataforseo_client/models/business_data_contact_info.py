...
class BusinessDataContactInfo(BaseModel):
    """
    BusinessDataContactInfo
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    value: Optional[StrictStr] = Field(default=None, description="contact displayed in SERP  example: \"+119797979736\"")
    source: Optional[StrictStr] = Field(default=None, description="data source")
    __properties: ClassVar[List[str]] = ["type", "value", "source"]
