...
class KnowledgeGraphShoppingItemSerpElementItem(BaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "title", "data_attrid", "items", "rectangle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [KnowledgeGraphShoppingElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
