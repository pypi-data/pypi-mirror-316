...
class SerpGoogleNewsLiveAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BaseGoogleNewsSerpElementItem]] = Field(default=None, description="items of the element")
