...
class KeywordsDataBingSearchVolumeLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "device", "sort_by", "date_from", "date_to", "search_partners", "tag"]
