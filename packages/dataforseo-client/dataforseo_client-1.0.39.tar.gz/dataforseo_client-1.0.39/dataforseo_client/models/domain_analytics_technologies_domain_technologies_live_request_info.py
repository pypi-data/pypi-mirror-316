...
class DomainAnalyticsTechnologiesDomainTechnologiesLiveRequestInfo(BaseModel):
    """
    DomainAnalyticsTechnologiesDomainTechnologiesLiveRequestInfo
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="target domain required field domain name of the website to analyze Note: results will be returned for the specified domain only")
