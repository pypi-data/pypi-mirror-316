...
class MultiCarouselElement(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if multi_carousel_snippets (nullable) is None
        # and model_fields_set contains the field
        if self.multi_carousel_snippets is None and "multi_carousel_snippets" in self.model_fields_set:
            _dict['multi_carousel_snippets'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "title": obj.get("title"),
            "multi_carousel_snippets": [CarouselElement.from_dict(_item) for _item in obj["multi_carousel_snippets"]] if obj.get("multi_carousel_snippets") is not None else None
        })
        return _obj
