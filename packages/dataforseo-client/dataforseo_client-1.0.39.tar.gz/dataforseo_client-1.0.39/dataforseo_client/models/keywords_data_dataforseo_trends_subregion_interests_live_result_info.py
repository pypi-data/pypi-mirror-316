...
class KeywordsDataDataforseoTrendsSubregionInterestsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BaseDataforseoTrendsItem]] = Field(default=None, description="keyword popularity values per location values in this array represent percentages relative to the maximum value within each region")
    __properties: ClassVar[List[str]] = ["keywords", "type", "location_code", "language_code", "datetime", "items_count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BaseDataforseoTrendsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
