...
class ScholarlyArticlesDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    """
    ...
    items: Optional[List[ScholarlyArticlesElement]] = Field(default=None, description="elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "url": obj.get("url"),
            "items": [ScholarlyArticlesElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
