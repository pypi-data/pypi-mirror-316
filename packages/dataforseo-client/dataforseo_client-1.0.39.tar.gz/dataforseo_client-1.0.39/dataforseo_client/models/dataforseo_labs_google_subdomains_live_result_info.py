...
class DataforseoLabsGoogleSubdomainsLiveResultInfo(BaseModel):
    """
    DataforseoLabsGoogleSubdomainsLiveResultInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    target: Optional[StrictStr] = Field(default=None, description="domain in a POST array")
    ...
    items: Optional[List[DataforseoLabsSubdomainsLiveItem]] = Field(default=None, description="contains subdomains and related data")
