...
class BacklinksBulkNewLostBacklinksLiveResultInfo(BaseModel):
    """
    BacklinksBulkNewLostBacklinksLiveResultInfo
    """ # noqa: E501
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[BacklinksBulkNewLostBacklinksLiveItem]] = Field(default=None, description="contains relevant backlinks and referring domains data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BacklinksBulkNewLostBacklinksLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
