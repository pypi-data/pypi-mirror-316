...
class AppDataGoogleCategoriesResultInfo(BaseModel):
    """
    AppDataGoogleCategoriesResultInfo
    """ # noqa: E501
    categories: Optional[List[Optional[StrictStr]]] = Field(default=None, description="contains full list of supported app categories")
