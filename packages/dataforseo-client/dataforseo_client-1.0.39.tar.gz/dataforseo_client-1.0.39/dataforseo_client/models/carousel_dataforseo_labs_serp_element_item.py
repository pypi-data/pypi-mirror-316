...
class CarouselDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    """
    CarouselDataforseoLabsSerpElementItem
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="title of the result in SERP")
    items: Optional[List[CarouselElement]] = Field(default=None, description="contains results featured in the ‘hotels_pack’ element of SERP")
