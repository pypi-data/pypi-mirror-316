...
class MerchantAmazonAsinTaskGetAdvancedResultInfo(BaseModel):
    """
    MerchantAmazonAsinTaskGetAdvancedResultInfo
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description="ASIN received in a POST array the unique product identifier in Amazon (ASIN) received in a POST array learn more about the identified in this help center guide")
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    se_domain: Optional[StrictStr] = Field(default=None, description="Amazon domain in a POST array")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="types of search results found on Amazon contains types of all search results (items) found in the returned SERP possible item types: amazon_product_info")
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[BaseAmazonSerpElementItem]] = Field(default=None, description="Amazon product info items")
    __properties: ClassVar[List[str]] = ["asin", "type", "se_domain", "location_code", "language_code", "check_url", "datetime", "item_types", "items_count", "items"]
