...
class MathSolverElement(BaseModel):
    """
    MathSolverElement
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    title: Optional[StrictStr] = Field(default=None, description="title of a given link element")
    expanded_element: Optional[List[MathSolverExpandedElement]] = Field(default=None, description="expanded element")
    __properties: ClassVar[List[str]] = ["type", "title", "expanded_element"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "title": obj.get("title"),
            "expanded_element": [MathSolverExpandedElement.from_dict(_item) for _item in obj["expanded_element"]] if obj.get("expanded_element") is not None else None
        })
        return _obj
