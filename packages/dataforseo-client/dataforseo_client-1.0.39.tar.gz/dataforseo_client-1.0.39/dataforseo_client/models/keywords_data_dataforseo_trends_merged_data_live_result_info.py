...
class KeywordsDataDataforseoTrendsMergedDataLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BaseDataforseoTrendsItem]] = Field(default=None, description="contains keyword popularity and related data")
