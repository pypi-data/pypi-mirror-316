...
class LocalBusinessReservationLink(BaseLocalBusinessLink):
    """
    LocalBusinessReservationLink
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="title of the element domain of the reservation software")
    url: Optional[StrictStr] = Field(default=None, description="URL to make a reservation")
