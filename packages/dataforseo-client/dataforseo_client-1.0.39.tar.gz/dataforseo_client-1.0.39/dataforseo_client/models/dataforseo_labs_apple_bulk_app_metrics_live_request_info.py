...
class DataforseoLabsAppleBulkAppMetricsLiveRequestInfo(BaseModel):
    """
    DataforseoLabsAppleBulkAppMetricsLiveRequestInfo
    """ # noqa: E501
    app_ids: Optional[List[StrictStr]] = Field(default=None, description="ids of the apps required field IDs of mobile applications on App Store; you can find the ID in the URL of every app listed on App Store; example: in the URL https://apps.apple.com/us/app/id835599320 the id is 835599320; the maximum number of IDs you can specify in this field is 1000")
