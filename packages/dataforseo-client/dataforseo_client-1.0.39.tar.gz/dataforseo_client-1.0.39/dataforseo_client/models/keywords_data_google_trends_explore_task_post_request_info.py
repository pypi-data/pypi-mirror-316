...
class KeywordsDataGoogleTrendsExploreTaskPostRequestInfo(BaseModel):
    """
    KeywordsDataGoogleTrendsExploreTaskPostRequestInfo
    """ # noqa: E501
    keywords: Optional[List[StrictStr]] = Field(default=None, description="keywords required field The maximum number of keywords you can specify: 5 Note: the comma characters (,) in the specified keywords will be unset and ignored learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article")
    ...
    __properties: ClassVar[List[str]] = ["keywords", "location_name", "location_code", "language_name", "language_code", "type", "category_code", "date_from", "date_to", "time_range", "item_types", "postback_url", "pingback_url", "tag"]
