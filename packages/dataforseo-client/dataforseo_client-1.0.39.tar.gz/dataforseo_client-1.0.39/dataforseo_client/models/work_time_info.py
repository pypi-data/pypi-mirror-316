...
class WorkTimeInfo(BaseModel):
    """
    WorkTimeInfo
    """ # noqa: E501
    hour: Optional[StrictInt] = Field(default=None, description="hours in the 24-hour format")
    minute: Optional[StrictInt] = Field(default=None, description="minutes")
