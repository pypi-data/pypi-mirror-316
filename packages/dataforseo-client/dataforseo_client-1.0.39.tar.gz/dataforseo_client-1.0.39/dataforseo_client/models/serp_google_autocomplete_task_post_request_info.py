...
class SerpGoogleAutocompleteTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "language_name", "language_code", "cursor_pointer", "client", "tag", "postback_url", "postback_data", "pingback_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cursor_pointer (nullable) is None
        # and model_fields_set contains the field
        if self.cursor_pointer is None and "cursor_pointer" in self.model_fields_set:
            _dict['cursor_pointer'] = None
