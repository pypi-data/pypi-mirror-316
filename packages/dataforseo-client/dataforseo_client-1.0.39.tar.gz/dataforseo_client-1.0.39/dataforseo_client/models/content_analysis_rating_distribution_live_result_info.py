...
class ContentAnalysisRatingDistributionLiveResultInfo(BaseModel):
    ...
    min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="min rating on a distribution scale")
    max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="max rating on a distribution scale")
    metrics: Optional[ContentAnalysisSummaryInfo] = None
    __properties: ClassVar[List[str]] = ["type", "min", "max", "metrics"]
