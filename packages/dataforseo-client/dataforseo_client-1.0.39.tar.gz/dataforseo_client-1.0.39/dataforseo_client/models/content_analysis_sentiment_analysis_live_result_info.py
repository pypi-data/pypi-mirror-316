...
class ContentAnalysisSentimentAnalysisLiveResultInfo(BaseModel):
    ...
    positive_connotation_distribution: Optional[PositiveConnotationDistribution] = None
    sentiment_connotation_distribution: Optional[SentimentConnotationDistribution] = None
    __properties: ClassVar[List[str]] = ["type", "positive_connotation_distribution", "sentiment_connotation_distribution"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of positive_connotation_distribution
        if self.positive_connotation_distribution:
            _dict['positive_connotation_distribution'] = self.positive_connotation_distribution.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sentiment_connotation_distribution
        if self.sentiment_connotation_distribution:
            _dict['sentiment_connotation_distribution'] = self.sentiment_connotation_distribution.to_dict()
