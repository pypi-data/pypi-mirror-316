...
class VideoSerpElementItem(BaseSerpElementItem):
    """
    VideoSerpElementItem
    """ # noqa: E501
    items: Optional[List[VideoElement]] = Field(default=None, description="contains arrays of specific images")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "items": [VideoElement.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
