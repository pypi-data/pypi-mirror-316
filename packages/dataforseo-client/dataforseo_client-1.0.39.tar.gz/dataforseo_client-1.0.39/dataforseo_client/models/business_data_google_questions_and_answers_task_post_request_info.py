...
class BusinessDataGoogleQuestionsAndAnswersTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "depth", "tag", "postback_url", "pingback_url"]
