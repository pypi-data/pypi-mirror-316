...
class DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem]] = Field(default=None, description="array of items with relevant traffic estimation data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleHistoricalBulkTrafficEstimationLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
