...
class OnPagePagesByResourceRequestInfo(BaseModel):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description="resource URL required field you can get this URL in the response of the Resources endpoint example: https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js")
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "limit", "offset", "filters", "order_by", "tag"]
