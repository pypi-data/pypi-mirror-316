...
class OnPageRawHtmlResultInfo(BaseModel):
    """
    ...
    items: Optional[OnPageRawHtmlItem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": OnPageRawHtmlItem.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
