...
class DataforseoLabsRelevantPagesLiveItem(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if page_address (nullable) is None
        # and model_fields_set contains the field
        if self.page_address is None and "page_address" in self.model_fields_set:
            _dict['page_address'] = None
