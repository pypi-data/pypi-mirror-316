...
class PopularProductsDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    """
    PopularProductsDataforseoLabsSerpElementItem
    """ # noqa: E501
    items: Optional[List[PopularProductsElement]] = Field(default=None, description="elements of search results found in SERP")
