...
class DataforseoLabsBingDomainIntersectionLiveRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["target1", "target2", "location_name", "location_code", "language_name", "language_code", "intersections", "item_types", "include_serp_info", "limit", "offset", "filters", "order_by", "tag"]
