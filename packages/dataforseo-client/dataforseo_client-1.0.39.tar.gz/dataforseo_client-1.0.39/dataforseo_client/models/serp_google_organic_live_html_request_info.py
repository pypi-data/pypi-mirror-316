...
class SerpGoogleOrganicLiveHtmlRequestInfo(BaseModel):
    ...
    expand_ai_overview: Optional[StrictBool] = Field(default=None, description="expand ai overview optional field set to true to expand the ai_overview item; default value: false")
    tag: Optional[StrictStr] = Field(default=None, description="user-defined task identifier optional field the character limit is 255 you can use this parameter to identify the task and match it with the result you will find the specified tag value in the data object of the response")
    __properties: ClassVar[List[str]] = ["url", "keyword", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "device", "os", "se_domain", "depth", "max_crawl_pages", "search_param", "load_async_ai_overview", "expand_ai_overview", "tag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerpGoogleOrganicLiveHtmlRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerpGoogleOrganicLiveHtmlRequestInfo from a dict"""
        if obj is None:
            return None
