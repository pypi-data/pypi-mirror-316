...
class AppendixPriorityTasksReadyKeywordsDataPriceDataInfo(BaseModel):
    ...
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="cost, USD")
    __properties: ClassVar[List[str]] = ["cost_type", "cost"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cost_type (nullable) is None
        # and model_fields_set contains the field
        if self.cost_type is None and "cost_type" in self.model_fields_set:
            _dict['cost_type'] = None
