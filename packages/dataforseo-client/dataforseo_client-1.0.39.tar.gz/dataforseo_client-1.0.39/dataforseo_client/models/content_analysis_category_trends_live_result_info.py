...
class ContentAnalysisCategoryTrendsLiveResultInfo(BaseModel):
    """
    ...
    top_domains: Optional[List[TopDomainInfo]] = Field(default=None, description="top domains citing the target keyword contains objects with top domains citing the target category and citation count per each domain")
    ...
    connotation_types: Optional[Dict[str, Optional[StrictInt]]] = Field(default=None, description="connotation types contains types of sentiments (sentiment polarity) related to the category citation and citation count per each sentiment type possible connotation types: \"positive\", \"negative\", \"neutral\"")
