...
class AppendixWebhookResendTaskInfo(BaseModel):
    """
    ...
    result: Optional[Dict[str, Any]] = Field(default=None, description="array of results the value of this array is always null; you can get the results by the preferred method of results delivery (pingback or postback) you specified when setting a task")
