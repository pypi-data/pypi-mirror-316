...
class DataforseoLabsGoogleBulkAppMetricsLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsleBulkAppMetricsLiveItem]] = Field(default=None, description="contains data related to the ranking app metrics of the specified application")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsleBulkAppMetricsLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
