...
class DataforseoLabsAmazonProductRankOverviewLiveRequestInfo(BaseModel):
    """
    DataforseoLabsAmazonProductRankOverviewLiveRequestInfo
    """ # noqa: E501
    asins: Optional[List[StrictStr]] = Field(default=None, description="product IDs to compare required field product IDs to receive ranking data for; the maximum number of ASINs you can specify in this array is 1000; you can receive the asin parameter by making a separate request to the Amazon Products endpoint Note: all letters in ASIN code must be specified in uppercase format; example: B01LW2SL7R")
    ...
    __properties: ClassVar[List[str]] = ["asins", "location_name", "location_code", "language_name", "language_code", "tag"]
