...
class DataforseoLabsAppleAppIntersectionLiveRequestInfo(BaseModel):
    """
    DataforseoLabsAppleAppIntersectionLiveRequestInfo
    """ # noqa: E501
    app_ids: Optional[Dict[str, Optional[StrictStr]]] = Field(default=None, description="ids of the target apps required field IDs of the target mobile applications on App Store; you can find the ID in the URL of every app listed on App Store; example: in the URL https://apps.apple.com/us/app/id835599320 the id is 835599320; the ids should be specified the following way: \"app_ids\": { \"1\": \"686449807\", \"2\": \"382617920\" } if you specify a single ID here, the API will return results only for one application; the maximum number of app IDs you can specify in this object is 20")
    ...
    __properties: ClassVar[List[str]] = ["app_ids", "location_name", "location_code", "language_name", "language_code", "filters", "order_by", "limit", "offset", "tag"]
