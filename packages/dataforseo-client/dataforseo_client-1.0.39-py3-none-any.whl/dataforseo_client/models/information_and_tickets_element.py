...
class InformationAndTicketsElement(BaseModel):
    """
    InformationAndTicketsElement
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="type of element")
    title: Optional[StrictStr] = Field(default=None, description="title of the element")
    description: Optional[StrictStr] = Field(default=None, description="description of the element")
    ...
    __properties: ClassVar[List[str]] = ["type", "title", "description", "url", "domain"]
