...
class AppendixSellersGoogleMerchantPriceData(BaseModel):
    ...
    """ # noqa: E501
    ad_url: Optional[AppendixTaskKeywordsDataPriceDataInfo] = None
    ...
    __properties: ClassVar[List[str]] = ["ad_url", "task_get", "task_post", "tasks_ready"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ad_url
        if self.ad_url:
            _dict['ad_url'] = self.ad_url.to_dict()
