...
class KeywordsDataBingKeywordPerformanceLiveRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keywords", "device", "match", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "tag"]
