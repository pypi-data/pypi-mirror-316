...
class GoogleShoppingPaidMerchantSerpElementItem(BaseMerchantSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "rank_group", "rank_absolute", "position", "xpath", "domain", "title", "description", "url", "shop_ad_aclk"]
