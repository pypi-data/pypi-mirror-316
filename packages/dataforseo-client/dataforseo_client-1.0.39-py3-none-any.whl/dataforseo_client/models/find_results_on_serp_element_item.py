...
class FindResultsOnSerpElementItem(BaseSerpElementItem):
    """
    FindResultsOnSerpElementItem
    """ # noqa: E501
    items: Optional[List[ShortVideosElement]] = Field(default=None, description="contains arrays of specific images")
