...
class ContentGenerationGenerateMetaTagsLiveRequestInfo(BaseModel):
    """
    ContentGenerationGenerateMetaTagsLiveRequestInfo
    """ # noqa: E501
    text: Optional[StrictStr] = Field(default=None, description="initial target text required field text input for generating content; can contain from 1 to 500 tokens learn more about tokens on our help center")
