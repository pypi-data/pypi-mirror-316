...
class BusinessDataGoogleHotelInfoLiveHtmlResultInfo(BaseModel):
    """
    BusinessDataGoogleHotelInfoLiveHtmlResultInfo
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="unique hotel identifier specified as \"hotel_id:$\"")
