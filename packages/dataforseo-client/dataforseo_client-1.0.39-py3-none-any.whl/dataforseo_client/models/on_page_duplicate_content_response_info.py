...
class OnPageDuplicateContentResponseInfo(BaseModel):
    """
    ...
    tasks: Optional[List[OnPageDuplicateContentTaskInfo]] = Field(default=None, description="array of tasks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [OnPageDuplicateContentTaskInfo.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
