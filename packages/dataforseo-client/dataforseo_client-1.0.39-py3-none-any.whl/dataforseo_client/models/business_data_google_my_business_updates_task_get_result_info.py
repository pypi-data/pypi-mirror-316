...
class BusinessDataGoogleMyBusinessUpdatesTaskGetResultInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if business_updates_id (nullable) is None
        # and model_fields_set contains the field
        if self.business_updates_id is None and "business_updates_id" in self.model_fields_set:
            _dict['business_updates_id'] = None
