...
class EstCInfo(BaseModel):
    """
    EstCInfo
    """ # noqa: E501
    high: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the upper bound of the range result")
    low: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="indicates the lower bound of the range result")
