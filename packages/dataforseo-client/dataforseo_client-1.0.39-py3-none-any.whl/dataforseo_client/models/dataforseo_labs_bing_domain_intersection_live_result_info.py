...
class DataforseoLabsBingDomainIntersectionLiveResultInfo(BaseModel):
    """
    ...
    target1: Optional[StrictStr] = Field(default=None, description="target specified in a POST array")
    target2: Optional[StrictStr] = Field(default=None, description="target specified in a POST array")
    ...
    items: Optional[List[DataforseoLabsDomainIntersectionLiveItem]] = Field(default=None, description="contains keywords, relevant SERP elements and related data")
