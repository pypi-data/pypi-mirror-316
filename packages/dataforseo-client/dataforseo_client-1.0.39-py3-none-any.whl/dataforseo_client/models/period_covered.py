...
class PeriodCovered(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["start_date", "end_date", "displayed_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if displayed_date (nullable) is None
        # and model_fields_set contains the field
        if self.displayed_date is None and "displayed_date" in self.model_fields_set:
            _dict['displayed_date'] = None
