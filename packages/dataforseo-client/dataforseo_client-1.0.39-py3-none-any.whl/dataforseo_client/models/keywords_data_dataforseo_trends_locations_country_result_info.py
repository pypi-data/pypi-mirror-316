...
class KeywordsDataDataforseoTrendsLocationsCountryResultInfo(BaseModel):
    """
    ...
    geo_name: Optional[StrictStr] = Field(default=None, description="DataForSEO trends location name you can use this field for matching obtained results with the location_name parameter specified in the request")
    geo_id: Optional[StrictStr] = Field(default=None, description="DataForSEO trends location identifier you can use this field for matching obtained results with the location_code parameter specified in the request")
