...
class DataforseoLabsGoogleCategoriesForDomainLiveResultInfo(BaseModel):
    """
    DataforseoLabsGoogleCategoriesForDomainLiveResultInfo
    """ # noqa: E501
    se_type: Optional[StrictStr] = Field(default=None, description="search engine type")
    target: Optional[StrictStr] = Field(default=None, description="target domain or subdomain in a POST array")
    ...
    items: Optional[List[DataforseoLabsGoogleCategoriesForDomainLiveItem]] = Field(default=None, description="contains relevant categories and related ranking data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DataforseoLabsGoogleCategoriesForDomainLiveItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
