...
class MerchantAmazonSellersTasksReadyResultInfo(BaseModel):
    """
    ...
    endpoint_advanced: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of Amazon Sellers Advanced task")
    endpoint_html: Optional[StrictStr] = Field(default=None, description="URL for collecting the results of Amazon Sellers HTML task")
