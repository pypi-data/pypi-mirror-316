...
class KeywordAnnotations(BaseModel):
    """
    KeywordAnnotations
    """ # noqa: E501
    concepts: Optional[List[ConceptInfo]] = Field(default=None, description="the list of concepts for the keyword")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "concepts": [ConceptInfo.from_dict(_item) for _item in obj["concepts"]] if obj.get("concepts") is not None else None
        })
        return _obj
