...
class BacklinksAnchorsLiveRequestInfo(BaseModel):
    """
    BacklinksAnchorsLiveRequestInfo
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="domain, subdomain or webpage to get anchors for required field a domain or a subdomain should be specified without https:// and www. a page should be specified with absolute URL (including http:// or https://)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BacklinksAnchorsLiveRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BacklinksAnchorsLiveRequestInfo from a dict"""
        if obj is None:
            return None
