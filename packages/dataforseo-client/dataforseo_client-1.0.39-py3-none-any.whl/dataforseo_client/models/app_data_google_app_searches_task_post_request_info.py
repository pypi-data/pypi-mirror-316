...
class AppDataGoogleAppSearchesTaskPostRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyword", "location_name", "location_code", "language_name", "language_code", "priority", "depth", "tag", "postback_url", "postback_data", "pingback_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppDataGoogleAppSearchesTaskPostRequestInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppDataGoogleAppSearchesTaskPostRequestInfo from a dict"""
        if obj is None:
            return None
