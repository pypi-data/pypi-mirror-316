...
class SerpGoogleNewsTasksFixedResultInfo(BaseModel):
    """
    ...
    se_type: Optional[StrictStr] = Field(default=None, description="type of search engine can take the following values: news")
