...
class BacklinksReferringNetworksLiveRequestInfo(BaseModel):
    """
    BacklinksReferringNetworksLiveRequestInfo
    """ # noqa: E501
    target: Optional[StrictStr] = Field(default=None, description="domain, subdomain or webpage to get referring networks for required field a domain or a subdomain should be specified without https:// and www. a page should be specified with absolute URL (including http:// or https://)")
    network_address_type: Optional[StrictStr] = Field(default=None, description="indicates the type of network to get data for optional field possible values: ip, subnet default value: ip")
    limit: Optional[StrictInt] = Field(default=None, description="the maximum number of returned networks optional field default value: 100 maximum value: 1000")
    offset: Optional[StrictInt] = Field(default=None, description="offset in the results array of returned networks optional field default value: 0 if you specify the 10 value, the first ten domains in the results array will be omitted and the data will be provided for the successive pages")
    ...
    __properties: ClassVar[List[str]] = ["target", "network_address_type", "limit", "offset", "internal_list_limit", "backlinks_status_type", "filters", "order_by", "backlinks_filters", "include_subdomains", "include_indirect_links", "exclude_internal_backlinks", "tag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if network_address_type (nullable) is None
        # and model_fields_set contains the field
        if self.network_address_type is None and "network_address_type" in self.model_fields_set:
            _dict['network_address_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "network_address_type": obj.get("network_address_type"),
            "limit": obj.get("limit"),
