...
class TrendsMapDataInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["geo_id", "geo_name", "values", "max_value_index"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if max_value_index (nullable) is None
        # and model_fields_set contains the field
        if self.max_value_index is None and "max_value_index" in self.model_fields_set:
            _dict['max_value_index'] = None
