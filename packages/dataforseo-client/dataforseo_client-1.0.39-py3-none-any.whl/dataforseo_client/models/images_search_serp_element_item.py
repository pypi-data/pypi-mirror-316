...
class ImagesSearchSerpElementItem(BaseGoogleImagesSerpElementItem):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if encoded_url (nullable) is None
        # and model_fields_set contains the field
        if self.encoded_url is None and "encoded_url" in self.model_fields_set:
            _dict['encoded_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "encoded_url": obj.get("encoded_url")
        })
        return _obj
