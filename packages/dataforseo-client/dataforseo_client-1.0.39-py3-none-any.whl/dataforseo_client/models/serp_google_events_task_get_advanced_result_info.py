...
class SerpGoogleEventsTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    language_code: Optional[StrictStr] = Field(default=None, description="language code in this case, the value will be null")
    check_url: Optional[StrictStr] = Field(default=None, description="direct URL to search engine results")
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="types of search results found in SERP possible item types: event_item")
    se_results_count: Optional[StrictInt] = Field(default=None, description="total number of results in SERP in this case, the value will be 0 this search engine does not indicate the total number of results")
    items_count: Optional[StrictInt] = Field(default=None, description="the number of results returned in the items array")
    items: Optional[List[BaseSerpElementItem]] = Field(default=None, description="items of the element")
