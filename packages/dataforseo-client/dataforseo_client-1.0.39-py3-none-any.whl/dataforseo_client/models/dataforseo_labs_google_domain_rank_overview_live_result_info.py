...
class DataforseoLabsGoogleDomainRankOverviewLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsDomainRankOverviewLiveItem]] = Field(default=None, description="contains ranking and traffic data")
