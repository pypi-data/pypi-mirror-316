...
class IntersectionSummaryInfo(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if intersections_count (nullable) is None
        # and model_fields_set contains the field
        if self.intersections_count is None and "intersections_count" in self.model_fields_set:
            _dict['intersections_count'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "intersections_count": obj.get("intersections_count")
        })
        return _obj
