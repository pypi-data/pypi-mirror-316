...
class SerpBingLocalPackLiveRegularRequestInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "keyword", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "os", "depth", "max_crawl_pages", "search_param", "tag"]
