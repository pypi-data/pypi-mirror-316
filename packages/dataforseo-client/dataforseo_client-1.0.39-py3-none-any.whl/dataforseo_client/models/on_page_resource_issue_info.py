...
class OnPageResourceIssueInfo(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[OnPageResourceIssueItemInfo]] = Field(default=None, description="resource errors")
    warnings: Optional[List[OnPageResourceIssueItemInfo]] = Field(default=None, description="resource warnings")
