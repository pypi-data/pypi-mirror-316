...
class OnPageLighthouseTasksReadyResultInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "tag", "endpoint_json"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if endpoint_json (nullable) is None
        # and model_fields_set contains the field
        if self.endpoint_json is None and "endpoint_json" in self.model_fields_set:
            _dict['endpoint_json'] = None
