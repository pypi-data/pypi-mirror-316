...
class AppDataAppleAppListTaskGetAdvancedResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BaseAppDataSerpElementItem]] = Field(default=None, description="found apps you can get more results by using the depth parameter when setting a task")
