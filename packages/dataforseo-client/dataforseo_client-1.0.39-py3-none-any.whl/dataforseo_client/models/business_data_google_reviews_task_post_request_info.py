...
class BusinessDataGoogleReviewsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "cid", "place_id", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "depth", "sort_by", "tag", "postback_url", "pingback_url"]
