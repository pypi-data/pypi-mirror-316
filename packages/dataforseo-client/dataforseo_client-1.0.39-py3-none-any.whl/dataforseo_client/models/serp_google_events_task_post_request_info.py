...
class SerpGoogleEventsTaskPostRequestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keyword", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "date_range", "os", "se_domain", "depth", "max_crawl_pages", "tag", "postback_url", "postback_data", "pingback_url"]
