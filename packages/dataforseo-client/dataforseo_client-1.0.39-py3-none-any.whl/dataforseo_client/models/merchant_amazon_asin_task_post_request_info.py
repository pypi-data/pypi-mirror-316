...
class MerchantAmazonAsinTaskPostRequestInfo(BaseModel):
    """
    MerchantAmazonAsinTaskPostRequestInfo
    """ # noqa: E501
    asin: Optional[StrictStr] = Field(default=None, description="product ID required field unique product identifier (ASIN) in Amazon you can receive the asin parameter by making a separate request to the Amazon Products endpoint")
    ...
    load_more_local_reviews: Optional[StrictBool] = Field(default=None, description="load more local reviews optional field if set to true, additional local reviews will be loaded in the top_local_reviews array of the Task GET response; Note: you will be charged double the price for using this parameter")
    local_reviews_sort: Optional[StrictStr] = Field(default=None, description="sort local reviews optional field reviews in the top_local_reviews array of the Task GET response can be sorted by most helpful or most recent first; possible values: helpful, recent default value: helpful")
    ...
    __properties: ClassVar[List[str]] = ["asin", "priority", "location_name", "location_code", "location_coordinate", "language_name", "language_code", "se_domain", "load_more_local_reviews", "local_reviews_sort", "tag", "postback_url", "postback_data", "pingback_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if load_more_local_reviews (nullable) is None
        # and model_fields_set contains the field
        if self.load_more_local_reviews is None and "load_more_local_reviews" in self.model_fields_set:
            _dict['load_more_local_reviews'] = None

        # set to None if local_reviews_sort (nullable) is None
        # and model_fields_set contains the field
        if self.local_reviews_sort is None and "local_reviews_sort" in self.model_fields_set:
            _dict['local_reviews_sort'] = None
