...
class AppendixClickstreamDataKeywordsDataLimitsRatesDataInfo(BaseModel):
    """
    ...
    global_search_volume: Optional[AppendixInfo] = None
    __properties: ClassVar[List[str]] = ["dataforseo_search_volume", "locations_and_languages", "bulk_search_volume", "global_search_volume"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "global_search_volume": AppendixInfo.from_dict(obj["global_search_volume"]) if obj.get("global_search_volume") is not None else None
        })
        return _obj
