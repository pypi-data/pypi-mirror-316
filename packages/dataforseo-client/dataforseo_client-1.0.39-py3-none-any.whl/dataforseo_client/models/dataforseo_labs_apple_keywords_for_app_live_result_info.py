...
class DataforseoLabsAppleKeywordsForAppLiveResultInfo(BaseModel):
    """
    ...
    items: Optional[List[DataforseoLabsLiveItem]] = Field(default=None, description="contains data related to the ranking keywords for the app specified in the app_id field")
