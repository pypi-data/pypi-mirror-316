...
class MerchantAmazonSellersTaskGetHtmlResultInfo(BaseModel):
    """
    ...
    items: Optional[List[HtmlItem]] = Field(default=None, description="elements of search results found on Amazon")
    __properties: ClassVar[List[str]] = ["asin", "type", "se_domain", "location_code", "language_code", "datetime", "items_count", "items"]
