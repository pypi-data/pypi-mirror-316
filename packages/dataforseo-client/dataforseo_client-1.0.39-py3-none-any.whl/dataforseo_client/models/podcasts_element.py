...
class PodcastsElement(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "title", "url", "description", "timestamp", "time_to_play"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if time_to_play (nullable) is None
        # and model_fields_set contains the field
        if self.time_to_play is None and "time_to_play" in self.model_fields_set:
            _dict['time_to_play'] = None
