...
class AppendixLimitsRatesData(BaseModel):
    """
    AppendixLimitsRatesData
    """ # noqa: E501
    day: Optional[AppendixDayLimitsRatesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "day": AppendixDayLimitsRatesData.from_dict(obj["day"]) if obj.get("day") is not None else None,
