...
class DataforseoLabsGoogleTopSearchesLiveResultInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["se_type", "location_code", "language_code", "total_count", "items_count", "offset", "offset_token", "items"]
