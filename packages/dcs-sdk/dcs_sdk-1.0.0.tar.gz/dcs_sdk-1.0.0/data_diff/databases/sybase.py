...
class Dialect(BaseDialect):
    ...
    def limit_select(
        ...
        # sybase requires that subquery columns are all aliased, so
...
class Sybase(ThreadedDatabase):
    ...
    def select_table_schema(self, path: DbPath) -> str:
        ...
        return (
            f"SELECT c.name AS column_name, t.name AS data_type, c.length AS character_maximum_length, "
            ...
            f"WHERE o.name = '{name}' AND o.type = 'U'"
        )
    ...
    def _query_cursor(self, c, sql_code: str):
        ...
        except self._sybase.DatabaseError as e:
            raise QueryError(e)
