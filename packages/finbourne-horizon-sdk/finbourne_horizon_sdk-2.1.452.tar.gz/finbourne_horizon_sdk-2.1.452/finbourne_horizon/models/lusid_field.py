...
class LusidField(BaseModel):
    ...
    """
    field_name: constr(strict=True) = Field(...,alias="fieldName", description="The name of the LUSID field.") 
    default_value: constr(strict=True) = Field(None,alias="defaultValue", description="The default value for the field.") 
    ...
    transformation_description: constr(strict=True) = Field(None,alias="transformationDescription", description="A description of how the vendor package&#39;s field(s) get mapped to the LUSID field") 
    entity_type: constr(strict=True) = Field(...,alias="entityType", description="LUSID Entity this refers to (e.g. Instrument)") 
    entity_sub_type: constr(strict=True) = Field(None,alias="entitySubType", description="Sub-Entity this field refers to (e.g. Equity)") 
