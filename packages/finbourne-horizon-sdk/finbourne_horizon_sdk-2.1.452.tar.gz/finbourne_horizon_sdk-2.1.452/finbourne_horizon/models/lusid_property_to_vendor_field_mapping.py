...
class LusidPropertyToVendorFieldMapping(BaseModel):
    ...
    vendor_field: constr(strict=True) = Field(...,alias="vendorField") 
    vendor_package: constr(strict=True) = Field(...,alias="vendorPackage") 
    vendor_namespace: constr(strict=True) = Field(...,alias="vendorNamespace") 
