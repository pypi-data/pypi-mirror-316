...
class IntegrationDescription(BaseModel):
    ...
    """
    type: constr(strict=True) = Field(...,alias="type", description="Unique identifier of the integration e.g. \&quot;copp-clark\&quot;.") 
    name: constr(strict=True) = Field(...,alias="name", description="Readable name of the integration e.g. \&quot;Copp Clark\&quot;.") 
    description: constr(strict=True) = Field(...,alias="description", description="Describes the purpose of the integration.") 
