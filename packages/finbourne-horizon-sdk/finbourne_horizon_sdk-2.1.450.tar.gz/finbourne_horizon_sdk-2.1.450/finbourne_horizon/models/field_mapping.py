...
class FieldMapping(BaseModel):
    ...
    """
    field_name: constr(strict=True) = Field(...,alias="fieldName", description="The LUSID core entity field") 
    default_value: constr(strict=True) = Field(None,alias="defaultValue", description="Default value if needed") 
