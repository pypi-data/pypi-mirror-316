...
from superlinked.server.util.open_api_description_util import OpenApiDescriptionUtil
...
def setup_application(app: FastAPI) -> None:
    ...
    ClassHelper.import_module(app_config.APP_MODULE_PATH, recursive=True, ignore_missing_modules=["superlinked.batch"])
