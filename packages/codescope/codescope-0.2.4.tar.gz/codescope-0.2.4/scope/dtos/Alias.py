...
from scope.utils import get_containing_def_for_ref
...
class Alias(object):
        ...
        for alias_refs in self.root_reference_candidates:
            ...
            for alias_ref in alias_refs:
                ...
                if valid:
                    ...
                    if containing_def:
                        ref_dto = Reference.from_lsp_ref(
                            alias_ref_range, containing_def
                        )
    ...
    def _resolve(self, lsp_client: SyncLanguageServer):
        try:
            ...
            self.references = lsp_client.request_references(
