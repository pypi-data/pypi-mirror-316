...
# Local
from scope.enums import LSPSymbolType
from scope.constants import SYMBOL_PERMISSION_TO_SYMBOL_TYPES
from scope.dtos.Range import Range
from scope.dtos.Definition import Definition
from scope.utils import root_contains_path, stable_hash
...
class Symbol(object):
    ...
    def valid(self, valid_config: CallGraphBuilderConfig = None):
        valid_symbol_set = SYMBOL_PERMISSION_TO_SYMBOL_TYPES[valid_config.allowed_symbols.value]
