...
from scope.utils import stable_hash
...
class Definition(object):
    def __init__(self, defn: DefinitionLSP | DefinitionSerde, **kwargs):
        ...
        # LSP specific
        self.lsp_references: List[Dict[str, Any]] = []

        # for traversing the CG
        self.referenced_by = defn.referenced_by
        self.referencing = defn.referencing
    ...
    def resolve_references(self, lsp_client: SyncLanguageServer):
        try:
            ...
            self.lsp_references = lsp_client.request_references(
