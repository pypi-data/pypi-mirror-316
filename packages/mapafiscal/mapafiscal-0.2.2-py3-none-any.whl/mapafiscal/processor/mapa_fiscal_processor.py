from mapafiscal.contexto import ContextoFiscal, PautaFiscal
from mapafiscal.common import *
from mapafiscal.model import *


class RegraFiscalProcessor():
    ...
    def calculate_ipi(self, ncm: str, fabricante: bool = True) -> IPI: 
        ...
        if excecao:
            return IPI(
                ...
                descricao_tipi=excecao.descricao_tipi,
                aliquota=excecao.aliquota,
                fundamento_legal=excecao.fundamento_legal
            )    
        else:
            ...
            return IPI(
                ...
                aliquota=aliquota.aliquota, 
                descricao_tipi=aliquota.descricao_tipi,
                fundamento_legal=aliquota.descricao_tipi
            )
