...
from mapafiscal.model import *
from mapafiscal.contexto import ContextoFiscal
...
class MapaFiscalBuilder:
    ...
    def __init__(self, cliente: str, contexto: ContextoFiscal):
        self._regra_processor = RegraFiscalProcessor(contexto)
    ...
    def build_classe_fiscal(self, 
        ...
        produto = self._regra_processor.process_classe_fiscal(codigo, ncm, descricao, origem, cest, segmento, fabricante_equiparado)        
    ...
    def build_classes_st(self, classe_fiscal: ClasseFiscal) -> dict[ClasseST]:    
        ...
        for pauta_fiscal in pautas_fiscais:
            classes_st[pauta_fiscal.uf_destino] = self._regra_processor.process_classe_st(classe_fiscal, pauta_fiscal)
    ...
    def build_cenario(self, 
        ...
        cenario = self._regra_processor.process_cenario_fiscal(grupo, 
    ...
    def build_operacao(self, cenario: CenarioFiscal) -> OperacaoFiscal:
        operacao_fiscal = self._regra_processor.process_operacao_fiscal(cenario)           
