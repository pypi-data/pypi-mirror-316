...
class ExcelExporter():    
    ...
    def to_excel(self, file_path: str):
        ...
        arquivo = openpyxl.load_workbook(f'{path}\\etc\\template.xlsx')
        ...
        for classe_st in self.mapa_fiscal.classes_st:
            ...
            values = ["v1.0",
                      ...
                      classe_st.mva_ajustada / 100.0,
                      classe_st.aliq_icms_operacao / 100.0,
                      classe_st.aliq_icms_uf_destino / 100.0,
                      classe_st.aliq_fcp_uf_destino / 100.0,
        ...
        for operacao in self.mapa_fiscal.operacoes:
            values = ["v1.0",
                      operacao.cenario,
                      operacao.natureza_operacao.descricao,
                      operacao.uf_origem,
                      operacao.uf_destino,
                      operacao.classe_fiscal.descricao,
                      operacao.classe_fiscal.origem,
                      operacao.ncm,
                      operacao.cest,
                      operacao.finalidade.descricao,
                      operacao.tipo_cliente.descricao,
                      'ICMS',
                      operacao.cfop_saida,
                      operacao.cfop_entrada,
                      operacao.cst_icms.codigo,
                      ...
                      "IPI",
                      operacao.cst_ipi.codigo,
                      operacao.aliq_ipi / 100.0,
                      "PIS",
                      operacao.cst_pis.codigo,
                      operacao.aliq_pis / 100.0,
                      "COFINS",
                      operacao.cst_cofins.codigo,
