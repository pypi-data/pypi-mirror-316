...
class CloudRouterPostRequestPackage(BaseModel):
    """
    Fabric Cloud Router Package Type
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="Fabric Cloud Router URI")
    type: Optional[CloudRouterPostRequestPackageType] = None
    code: CloudRouterPostRequestPackageCode
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["href", "type", "code"]
