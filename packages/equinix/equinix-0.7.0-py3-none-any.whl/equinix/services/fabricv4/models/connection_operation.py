...
class ConnectionOperation(BaseModel):
    ...
    """ # noqa: E501
    provider_status: Optional[ProviderStatus] = Field(default=None, alias="providerStatus")
    equinix_status: Optional[EquinixStatus] = Field(default=None, alias="equinixStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providerStatus": obj.get("providerStatus"),
