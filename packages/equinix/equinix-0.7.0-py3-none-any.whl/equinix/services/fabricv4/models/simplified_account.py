...
class SimplifiedAccount(BaseModel):
    """
    SimplifiedAccount
    """ # noqa: E501
    ...
    org_id: Optional[StrictInt] = Field(default=None, description="Customer organization identifier", alias="orgId")
    ...
    reseller_account_number: Optional[StrictInt] = Field(default=None, description="Reseller account number", alias="resellerAccountNumber")
    ...
    reseller_org_id: Optional[StrictInt] = Field(default=None, description="Reseller customer organization identifier", alias="resellerOrgId")
