...
class GetAllConnectionRouteFiltersResponse(BaseModel):
    """
    GetAllConnectionRouteFiltersResponse
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[ConnectionRouteFilterData]] = Field(default=None, description="List of Route Filters attached to a Connection")
