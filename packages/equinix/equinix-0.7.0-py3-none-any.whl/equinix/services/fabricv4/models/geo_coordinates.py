...
class GeoCoordinates(BaseModel):
    ...
    """ # noqa: E501
    latitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Latitude of a Fabric Metro")
    longitude: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Longitude of a Fabric Metro")
