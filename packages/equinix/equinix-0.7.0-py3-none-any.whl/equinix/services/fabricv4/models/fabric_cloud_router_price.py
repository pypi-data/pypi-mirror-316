...
class FabricCloudRouterPrice(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uuid", "location", "package"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "package": FabricCloudRouterPackages.from_dict(obj["package"]) if obj.get("package") is not None else None
        })
