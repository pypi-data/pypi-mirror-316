...
class Expression(BaseModel):
    ...
    Expression
    """ # noqa: E501
    var_and: Optional[List[Expression]] = Field(default=None, alias="and")
    var_or: Optional[List[Expression]] = Field(default=None, alias="or")
    var_property: Optional[SearchFieldName] = Field(default=None, alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [Expression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None,
            "or": [Expression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None,
