...
class PriceCharge(BaseModel):
    """
    Price  Charge
    """ # noqa: E501
    type: Optional[PriceChargeType] = None
    price: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Offering price")
