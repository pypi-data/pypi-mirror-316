...
class SearchExpression(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [SearchExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None,
            "or": [SearchExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None,
...
SearchExpression.model_rebuild(raise_errors=False)
