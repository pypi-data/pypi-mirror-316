...
class ConnectionRouteEntryOrFilter(BaseModel):
    """
    ConnectionRouteEntryOrFilter
    """ # noqa: E501
    var_or: Optional[Annotated[List[ConnectionRouteEntrySimpleExpression], Field(max_length=3)]] = Field(default=None, alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [ConnectionRouteEntrySimpleExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
