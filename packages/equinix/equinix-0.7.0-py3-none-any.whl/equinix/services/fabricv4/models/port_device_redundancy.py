...
class PortDeviceRedundancy(BaseModel):
    """
    Device redundancy
    """ # noqa: E501
    group: Optional[StrictStr] = Field(default=None, description="Device redundancy group")
    priority: Optional[PortDeviceRedundancyPriority] = None
