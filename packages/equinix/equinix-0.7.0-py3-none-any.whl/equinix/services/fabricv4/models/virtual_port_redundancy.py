...
class VirtualPortRedundancy(BaseModel):
    """
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=False, description="Parameter showing whether redundancy is mandatory. The default is false.")
