...
class SimplifiedMetadataEntity(BaseModel):
    """
    ...
    port_name: Optional[StrictStr] = Field(default=None, description="Port Name", alias="portName")
    encapsulation_protocol_type: Optional[StrictStr] = Field(default=None, description="Port Encapsulation", alias="encapsulationProtocolType")
    account_name: Optional[StrictStr] = Field(default=None, description="Account Name", alias="accountName")
    priority: Optional[StrictStr] = Field(default=None, description="Port Priority")
    location: Optional[SimplifiedLocation] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["href", "uuid", "type", "cvpId", "bandwidth", "portName", "encapsulationProtocolType", "accountName", "priority", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "encapsulationProtocolType": obj.get("encapsulationProtocolType"),
