...
class ConnectionSearchResponse(BaseModel):
    ...
    sort: Optional[List[SortCriteriaResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [SortCriteriaResponse.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [Connection.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
