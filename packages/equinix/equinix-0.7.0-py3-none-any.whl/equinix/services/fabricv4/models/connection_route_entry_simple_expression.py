...
class ConnectionRouteEntrySimpleExpression(BaseModel):
    """
    ConnectionRouteEntrySimpleExpression
    """ # noqa: E501
    var_property: Optional[StrictStr] = Field(default=None, description="Possible field names to use on filters:  * `/type` - Route table entry type  * `/state` - Route table entry state  * `/prefix` - Route table entry prefix  * `/nextHop` - Route table entry nextHop  * `/*` - all-category search ", alias="property")
