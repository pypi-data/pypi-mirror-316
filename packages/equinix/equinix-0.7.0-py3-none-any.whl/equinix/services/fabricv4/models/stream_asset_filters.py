...
class StreamAssetFilters(BaseModel):
    """
    StreamAssetFilters
    """ # noqa: E501
    var_and: Optional[Annotated[List[StreamAssetFilter], Field(max_length=8)]] = Field(default=None, alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [StreamAssetFilter.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
