...
class ServiceProfileAccessPointTypeVD(BaseModel):
    """
    ...
    allow_remote_connections: Optional[StrictBool] = Field(default=None, description="Allow remote connections to Service Profile", alias="allowRemoteConnections")
    allow_custom_bandwidth: Optional[StrictBool] = Field(default=None, alias="allowCustomBandwidth")
    __properties: ClassVar[List[str]] = ["uuid", "type", "supportedBandwidths", "allowRemoteConnections", "allowCustomBandwidth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowRemoteConnections": obj.get("allowRemoteConnections"),
            "allowCustomBandwidth": obj.get("allowCustomBandwidth")
        })
        return _obj
