...
class BGPConnectionOperation(BaseModel):
    """
    BGP IPv4 or IPv6 Connection State operational data
    """ # noqa: E501
    operational_status: Optional[BGPConnectionOperationOperationalStatus] = Field(default=None, alias="operationalStatus")
    op_status_changed_at: Optional[datetime] = Field(default=None, description="Last BGP State Update by Date and Time", alias="opStatusChangedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["operationalStatus", "opStatusChangedAt"]
