...
class ConnectionRoutingProtocolPostRequest(BaseModel):
    """
    Create connection routing protocolpost request
    """ # noqa: E501
    data: Optional[List[RoutingProtocolBase]] = Field(default=None, description="Connection routing protocol configuration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RoutingProtocolBase.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
