...
class RouteFiltersSearchBase(BaseModel):
    """
    RouteFiltersSearchBase
    """ # noqa: E501
    filter: Optional[RouteFiltersSearchBaseFilter] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": RouteFiltersSearchBaseFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
