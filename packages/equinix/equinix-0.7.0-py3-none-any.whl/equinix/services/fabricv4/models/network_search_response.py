...
class NetworkSearchResponse(BaseModel):
    ...
    sort: Optional[List[NetworkSortCriteriaResponse]] = None
    data: Optional[List[Network]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pagination", "sort", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [NetworkSortCriteriaResponse.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [Network.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
