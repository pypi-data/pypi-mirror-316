...
class SubscriptionAsset(BaseModel):
    ...
    Asset information
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of the subscription asset ( XF_ROUTER ,IP_VC, IPWAN_VC )")
    package: Optional[SubscriptionRouterPackageType] = None
    bandwidth: Optional[StrictInt] = Field(default=None, description="Bandwidth of the asset in Mbps")
