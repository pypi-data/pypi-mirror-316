...
class ConnectionResponse(BaseModel):
    ...
    ValidateResponse
    """ # noqa: E501
    additional_info: Optional[List[ConnectionSideAdditionalInfo]] = Field(default=None, description="Additional information", alias="additionalInfo")
    data: Optional[List[ValidateConnectionResponse]] = Field(default=None, description="Connection response data")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["additionalInfo", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ValidateConnectionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
