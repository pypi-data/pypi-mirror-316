...
class ConnectionRouteTableEntrySearchResponse(BaseModel):
    """
    ConnectionRouteTableEntrySearchResponse
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[ConnectionRouteTableEntry]] = Field(default=None, description="Data returned from the API call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ConnectionRouteTableEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
