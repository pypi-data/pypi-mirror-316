...
class BGPConnectionIpv6(BaseModel):
    """
    BGPConnectionIpv6
    """ # noqa: E501
    customer_peer_ip: StrictStr = Field(description="Customer side peering ip", alias="customerPeerIp")
    ...
    outbound_med: Optional[StrictInt] = Field(default=None, description="Outbound Multi Exit Discriminator attribute", alias="outboundMED")
    routes_max: Optional[StrictInt] = Field(default=None, description="Maximum learnt prefixes limit", alias="routesMax")
    operation: Optional[BGPConnectionOperation] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["customerPeerIp", "equinixPeerIp", "enabled", "outboundASPrependCount", "inboundMED", "outboundMED", "routesMax", "operation"]
