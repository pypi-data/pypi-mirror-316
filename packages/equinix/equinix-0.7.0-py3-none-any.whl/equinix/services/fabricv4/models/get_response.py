...
class GetResponse(BaseModel):
    ...
    data: Optional[List[RoutingProtocolData]] = Field(default=None, description="List of Routing Protocols")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [RoutingProtocolData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
