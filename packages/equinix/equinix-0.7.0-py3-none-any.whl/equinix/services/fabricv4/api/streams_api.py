...
class StreamsApi:
    ...
    @validate_call
    def get_subscriptions_in_stream(
        self,
        stream_id: Annotated[StrictStr, Field(description="Stream UUID")],
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="number of records to fetch")] = None,
        ...
        _param = self._get_subscriptions_in_stream_serialize(
            stream_id=stream_id,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSubscriptionsInStreamResponse",
            '401': "List[Error]",
            '403': "List[Error]",
            '404': "List[Error]",
            '500': "List[Error]",
    ...
    @validate_call
    def get_subscriptions_in_stream_with_http_info(
        self,
        stream_id: Annotated[StrictStr, Field(description="Stream UUID")],
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="number of records to fetch")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSubscriptionsInStreamResponse]:
        """Get Stream's Subs
    ...
    @validate_call
    def get_subscriptions_in_stream_without_preload_content(
        self,
        stream_id: Annotated[StrictStr, Field(description="Stream UUID")],
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="number of records to fetch")] = None,
    ...
    def _get_subscriptions_in_stream_serialize(
        self,
        stream_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fabric/v4/streams/{streamId}/streamSubscriptions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
