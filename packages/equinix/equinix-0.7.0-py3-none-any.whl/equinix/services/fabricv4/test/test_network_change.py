...
class TestNetworkChange(unittest.TestCase):
    """NetworkChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkChange:
        """Test NetworkChange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkChange`
        """
        model = NetworkChange()
        if include_optional:
