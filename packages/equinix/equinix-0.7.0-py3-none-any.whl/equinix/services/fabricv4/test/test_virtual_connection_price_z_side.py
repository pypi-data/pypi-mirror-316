...
class TestVirtualConnectionPriceZSide(unittest.TestCase):
    """VirtualConnectionPriceZSide unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualConnectionPriceZSide:
        """Test VirtualConnectionPriceZSide
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualConnectionPriceZSide`
        """
        model = VirtualConnectionPriceZSide()
        if include_optional:
            return VirtualConnectionPriceZSide(
    ...
    def testVirtualConnectionPriceZSide(self):
        """Test VirtualConnectionPriceZSide"""
