...
class TestPortRequest(unittest.TestCase):
    """PortRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortRequest:
        """Test PortRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortRequest`
        """
        model = PortRequest()
        if include_optional:
            return PortRequest(
                ...
                encapsulation = equinix.services.fabricv4.models.port_encapsulation.PortEncapsulation(
                    ...
                    tag_protocol_id = '', ),
                lag_enabled = True,
                lag = equinix.services.fabricv4.models.port_lag.PortLag(
                    id = '', 
                    enabled = True, 
                    name = '', 
                    member_status = '', ),
