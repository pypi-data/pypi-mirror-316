...
class TestRoutingProtocolBGPData(unittest.TestCase):
    """RoutingProtocolBGPData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutingProtocolBGPData:
        """Test RoutingProtocolBGPData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutingProtocolBGPData`
        """
        model = RoutingProtocolBGPData()
        if include_optional:
            return RoutingProtocolBGPData(
                type = 'BGP',
                name = 'My-BGP-route-1',
    ...
    def testRoutingProtocolBGPData(self):
        """Test RoutingProtocolBGPData"""
