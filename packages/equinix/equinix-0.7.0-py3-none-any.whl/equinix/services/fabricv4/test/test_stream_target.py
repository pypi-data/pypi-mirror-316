...
class TestStreamTarget(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StreamTarget:
        """Test StreamTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamTarget`
        """
        model = StreamTarget()
        if include_optional:
            return StreamTarget(
