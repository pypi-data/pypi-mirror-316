...
class TestRouteFilterChangeDataResponse(unittest.TestCase):
    """RouteFilterChangeDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RouteFilterChangeDataResponse:
        """Test RouteFilterChangeDataResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RouteFilterChangeDataResponse`
        """
        model = RouteFilterChangeDataResponse()
        if include_optional:
            return RouteFilterChangeDataResponse(
                pagination = equinix.services.fabricv4.models.pagination.Pagination(
                    ...
                    previous = '', ),
                data = [
                    equinix.services.fabricv4.models.route_filter_change_data.RouteFilterChangeData(
                        status = 'COMPLETED', 
                        created_by = '', 
    ...
    def testRouteFilterChangeDataResponse(self):
        """Test RouteFilterChangeDataResponse"""
