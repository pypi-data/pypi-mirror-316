...
class TestVirtualConnectionSide(unittest.TestCase):
    """VirtualConnectionSide unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualConnectionSide:
        """Test VirtualConnectionSide
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualConnectionSide`
        """
        model = VirtualConnectionSide()
        if include_optional:
            return VirtualConnectionSide(
    ...
    def testVirtualConnectionSide(self):
        """Test VirtualConnectionSide"""
