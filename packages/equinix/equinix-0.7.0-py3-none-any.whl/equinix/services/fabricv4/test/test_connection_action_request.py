...
class TestConnectionActionRequest(unittest.TestCase):
    """ConnectionActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionActionRequest:
        """Test ConnectionActionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionActionRequest`
        """
        model = ConnectionActionRequest()
        if include_optional:
    ...
    def testConnectionActionRequest(self):
        """Test ConnectionActionRequest"""
