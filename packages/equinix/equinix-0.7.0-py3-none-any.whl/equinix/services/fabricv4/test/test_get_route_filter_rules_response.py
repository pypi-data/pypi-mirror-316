...
class TestGetRouteFilterRulesResponse(unittest.TestCase):
    """GetRouteFilterRulesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRouteFilterRulesResponse:
        """Test GetRouteFilterRulesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRouteFilterRulesResponse`
        """
        model = GetRouteFilterRulesResponse()
        if include_optional:
            return GetRouteFilterRulesResponse(
                pagination = equinix.services.fabricv4.models.pagination.Pagination(
                    ...
                    previous = '', ),
                data = [
                    equinix.services.fabricv4.models.route_filter_rules_data.RouteFilterRulesData(
    ...
    def testGetRouteFilterRulesResponse(self):
        """Test GetRouteFilterRulesResponse"""
