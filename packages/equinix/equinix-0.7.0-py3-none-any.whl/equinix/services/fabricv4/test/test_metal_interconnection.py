...
class TestMetalInterconnection(unittest.TestCase):
    """MetalInterconnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetalInterconnection:
        ...
        """
        model = MetalInterconnection()
        if include_optional:
            return MetalInterconnection(
                uuid = ''
            )
        else:
            return MetalInterconnection(
    ...
    def testMetalInterconnection(self):
        """Test MetalInterconnection"""
