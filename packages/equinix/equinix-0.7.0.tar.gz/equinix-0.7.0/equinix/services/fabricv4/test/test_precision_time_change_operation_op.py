...
class TestPrecisionTimeChangeOperationOp(unittest.TestCase):
    """PrecisionTimeChangeOperationOp unit test stubs"""
    ...
    def testPrecisionTimeChangeOperationOp(self):
        """Test PrecisionTimeChangeOperationOp"""
