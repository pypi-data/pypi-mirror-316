...
class TestRouteTableEntrySearchResponse(unittest.TestCase):
    """RouteTableEntrySearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RouteTableEntrySearchResponse:
        """Test RouteTableEntrySearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RouteTableEntrySearchResponse`
        """
        model = RouteTableEntrySearchResponse()
        if include_optional:
            return RouteTableEntrySearchResponse(
                pagination = equinix.services.fabricv4.models.pagination.Pagination(
                    ...
                    previous = '', ),
                data = [
                    equinix.services.fabricv4.models.route_table_entry.RouteTableEntry(
                        type = 'IPv4_BGP_ROUTE', 
                        protocol_type = 'BGP', 
                        state = 'ACTIVE', 
                        age = 'PT5M30S', 
    ...
    def testRouteTableEntrySearchResponse(self):
        """Test RouteTableEntrySearchResponse"""
