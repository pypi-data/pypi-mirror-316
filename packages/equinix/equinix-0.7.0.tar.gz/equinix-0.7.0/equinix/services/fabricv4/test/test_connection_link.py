...
class TestConnectionLink(unittest.TestCase):
    """ConnectionLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionLink:
        """Test ConnectionLink
