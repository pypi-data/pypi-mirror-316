...
class TestVirtualConnectionTimeServiceResponse(unittest.TestCase):
    """VirtualConnectionTimeServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualConnectionTimeServiceResponse:
        """Test VirtualConnectionTimeServiceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualConnectionTimeServiceResponse`
        """
        model = VirtualConnectionTimeServiceResponse()
        if include_optional:
            return VirtualConnectionTimeServiceResponse(
                href = '',
                type = '',
                uuid = '',
    ...
    def testVirtualConnectionTimeServiceResponse(self):
        """Test VirtualConnectionTimeServiceResponse"""
