...
class TestBGPActionData(unittest.TestCase):
    """BGPActionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BGPActionData:
        """Test BGPActionData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BGPActionData`
        """
        model = BGPActionData()
        if include_optional:
