...
class TestRouteTableEntry(unittest.TestCase):
    """RouteTableEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RouteTableEntry:
        """Test RouteTableEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RouteTableEntry`
        """
