...
class TestConnectionAction(unittest.TestCase):
    """ConnectionAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionAction:
        """Test ConnectionAction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionAction`
        """
