...
class TestServiceProfileRequest(unittest.TestCase):
    """ServiceProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceProfileRequest:
        """Test ServiceProfileRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceProfileRequest`
        """
        model = ServiceProfileRequest()
        if include_optional:
    ...
    def testServiceProfileRequest(self):
        """Test ServiceProfileRequest"""
