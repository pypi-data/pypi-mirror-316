...
class TestCloudRouterActionResponse(unittest.TestCase):
    """CloudRouterActionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudRouterActionResponse:
        ...
        # uncomment below to create an instance of `CloudRouterActionResponse`
        """
        model = CloudRouterActionResponse()
        if include_optional:
    ...
    def testCloudRouterActionResponse(self):
        """Test CloudRouterActionResponse"""
