...
class TestConnectionRouteTableEntry(unittest.TestCase):
    """ConnectionRouteTableEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionRouteTableEntry:
        """Test ConnectionRouteTableEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionRouteTableEntry`
        """
        model = ConnectionRouteTableEntry()
        if include_optional:
            return ConnectionRouteTableEntry(
                type = 'IPv4_BGP_ROUTE',
                protocol_type = 'BGP',
                state = 'ACTIVE',
                age = 'PT5M30S',
    ...
    def testConnectionRouteTableEntry(self):
        """Test ConnectionRouteTableEntry"""
