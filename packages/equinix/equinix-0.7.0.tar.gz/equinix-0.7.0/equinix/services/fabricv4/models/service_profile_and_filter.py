...
class ServiceProfileAndFilter(BaseModel):
    """
    ServiceProfileAndFilter
    """ # noqa: E501
    var_and: Optional[List[ServiceProfileSimpleExpression]] = Field(default=None, alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [ServiceProfileSimpleExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
