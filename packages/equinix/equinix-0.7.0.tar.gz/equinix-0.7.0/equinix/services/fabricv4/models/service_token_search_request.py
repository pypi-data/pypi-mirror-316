...
class ServiceTokenSearchRequest(BaseModel):
    """
    Search requests containing criteria
    """ # noqa: E501
    filter: Optional[ServiceTokenSearchExpression] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": ServiceTokenSearchExpression.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
