...
class BGPActionsBulkData(BaseModel):
    """
    List of BGP Actions
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[BGPActionData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [BGPActionData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
