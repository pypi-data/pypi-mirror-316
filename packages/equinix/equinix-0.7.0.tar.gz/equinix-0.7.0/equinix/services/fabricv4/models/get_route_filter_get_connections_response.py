...
class GetRouteFilterGetConnectionsResponse(BaseModel):
    """
    GetRouteFilterGetConnectionsResponse
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[RouteFilterConnectionsData]] = Field(default=None, description="List of Connections using a Route Filter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [RouteFilterConnectionsData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
