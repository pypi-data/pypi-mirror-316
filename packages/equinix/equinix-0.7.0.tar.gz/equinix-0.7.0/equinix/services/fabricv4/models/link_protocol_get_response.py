...
class LinkProtocolGetResponse(BaseModel):
    """
    List of Vlans
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[LinkProtocolResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [LinkProtocolResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
