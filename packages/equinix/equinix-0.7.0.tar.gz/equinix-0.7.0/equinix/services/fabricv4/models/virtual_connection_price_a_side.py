...
class VirtualConnectionPriceASide(BaseModel):
    """
    VirtualConnectionPriceASide
    """ # noqa: E501
    access_point: Optional[VirtualConnectionPriceASideAccessPoint] = Field(default=None, alias="accessPoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessPoint": VirtualConnectionPriceASideAccessPoint.from_dict(obj["accessPoint"]) if obj.get("accessPoint") is not None else None
        })
