...
class RouteFilterRulesPostRequest(BaseModel):
    """
    Create Route Filter Rule POST request
    """ # noqa: E501
    data: Optional[List[RouteFilterRulesBase]] = Field(default=None, description="Route Filter Rule configuration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RouteFilterRulesBase.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
