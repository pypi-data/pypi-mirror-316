...
class Stream(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="Stream enabled status")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "name", "description", "project", "enabled"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['PROVISIONING', 'PROVISIONED', 'DEPROVISIONING', 'DEPROVISIONED', 'FAILED']):
            raise ValueError("must be one of enum values ('PROVISIONING', 'PROVISIONED', 'DEPROVISIONING', 'DEPROVISIONED', 'FAILED')")
        return value
