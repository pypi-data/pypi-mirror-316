...
class VirtualConnectionPriceASideAccessPointPort(BaseModel):
    """
    VirtualConnectionPriceASideAccessPointPort
    """ # noqa: E501
    settings: Optional[VirtualConnectionPriceASideAccessPointPortSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": VirtualConnectionPriceASideAccessPointPortSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
