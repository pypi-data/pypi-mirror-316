...
class PortEncapsulation(BaseModel):
    """
    Port encapsulation configuration
    """ # noqa: E501
    type: Optional[PortEncapsulationType] = None
    tag_protocol_id: Optional[StrictStr] = Field(default=None, description="Port encapsulation tag protocol identifier", alias="tagProtocolId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "tagProtocolId"]
