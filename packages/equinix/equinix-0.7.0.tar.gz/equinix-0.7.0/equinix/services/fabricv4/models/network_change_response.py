...
class NetworkChangeResponse(BaseModel):
    """
    List of network changes
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[NetworkChange]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [NetworkChange.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
