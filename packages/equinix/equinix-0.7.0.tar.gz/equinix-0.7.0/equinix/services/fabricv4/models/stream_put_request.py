...
class StreamPutRequest(BaseModel):
    """
    Update Stream
    """ # noqa: E501
    ...
    enabled: Optional[StrictBool] = Field(default=None, description="stream state")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "enabled"]
