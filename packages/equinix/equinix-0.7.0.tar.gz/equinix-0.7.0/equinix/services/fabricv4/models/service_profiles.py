...
class ServiceProfiles(BaseModel):
    """
    Service Profiles
    """ # noqa: E501
    data: Optional[List[ServiceProfile]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ServiceProfile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
