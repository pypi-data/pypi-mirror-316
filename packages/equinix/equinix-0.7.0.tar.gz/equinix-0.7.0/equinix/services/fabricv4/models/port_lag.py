...
class PortLag(BaseModel):
    ...
    member_status: Optional[StrictStr] = Field(default=None, description="member status", alias="memberStatus")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "enabled", "name", "memberStatus"]
