...
class StreamGetSubscriptions(BaseModel):
    """
    Stream object
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="Stream Get Stream Subscriptions URI")
    uuid: Optional[StrictStr] = Field(default=None, description="Equinix-assigned access point identifier")
    type: Optional[StreamGetSubscriptionsType] = None
