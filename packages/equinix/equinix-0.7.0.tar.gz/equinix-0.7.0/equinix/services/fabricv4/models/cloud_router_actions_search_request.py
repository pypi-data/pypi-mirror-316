...
class CloudRouterActionsSearchRequest(BaseModel):
    """
    Search requests containing criteria
    """ # noqa: E501
    filter: Optional[CloudRouterActionsSearchFilters] = None
    pagination: Optional[PaginationRequest] = None
    sort: Optional[List[CloudRouterActionsSearchSortCriteria]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": CloudRouterActionsSearchFilters.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "pagination": PaginationRequest.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "sort": [CloudRouterActionsSearchSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None
        })
