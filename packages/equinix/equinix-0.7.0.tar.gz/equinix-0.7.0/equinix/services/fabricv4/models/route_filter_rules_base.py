...
class RouteFilterRulesBase(BaseModel):
    """
    ...
    prefix: StrictStr
    prefix_match: Optional[StrictStr] = Field(default='orlonger', alias="prefixMatch")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "prefix", "prefixMatch"]
