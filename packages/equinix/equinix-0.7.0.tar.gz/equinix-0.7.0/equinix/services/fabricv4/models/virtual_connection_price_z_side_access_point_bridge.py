...
class VirtualConnectionPriceZSideAccessPointBridge(BaseModel):
    """
    VirtualConnectionPriceZSideAccessPointBridge
    """ # noqa: E501
    package: Optional[VirtualConnectionPriceZSideAccessPointBridgePackage] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["package"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "package": VirtualConnectionPriceZSideAccessPointBridgePackage.from_dict(obj["package"]) if obj.get("package") is not None else None
        })
