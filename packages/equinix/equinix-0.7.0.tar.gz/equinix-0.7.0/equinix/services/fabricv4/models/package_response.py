...
class PackageResponse(BaseModel):
    ...
    data: Optional[List[CloudRouterPackage]] = Field(default=None, description="Data returned from the API call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CloudRouterPackage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
