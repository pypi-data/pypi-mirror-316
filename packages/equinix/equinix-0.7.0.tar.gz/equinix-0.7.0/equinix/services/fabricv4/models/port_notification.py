...
class PortNotification(BaseModel):
    """
    PortNotification
    """ # noqa: E501
    type: PortNotificationType
    registered_users: List[StrictStr] = Field(description="Array of registered users", alias="registeredUsers")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "registeredUsers"]
