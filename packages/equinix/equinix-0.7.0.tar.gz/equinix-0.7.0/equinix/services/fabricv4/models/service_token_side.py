...
class ServiceTokenSide(BaseModel):
    """
    Connection link protocol,virtual device or network configuration
    """ # noqa: E501
    access_point_selectors: Optional[List[AccessPointSelector]] = Field(default=None, description="List of AccessPointSelectors", alias="accessPointSelectors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accessPointSelectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessPointSelectors": [AccessPointSelector.from_dict(_item) for _item in obj["accessPointSelectors"]] if obj.get("accessPointSelectors") is not None else None
        })
