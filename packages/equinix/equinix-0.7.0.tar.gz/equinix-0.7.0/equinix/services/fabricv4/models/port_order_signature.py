...
class PortOrderSignature(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["signatory", "delegate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signatory": obj.get("signatory"),
            "delegate": PortOrderSignatureDelegate.from_dict(obj["delegate"]) if obj.get("delegate") is not None else None
        })
