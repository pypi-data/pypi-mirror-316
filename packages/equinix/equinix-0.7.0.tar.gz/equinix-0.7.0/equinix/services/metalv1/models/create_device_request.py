...
class CreateDeviceRequest(BaseModel):
    ...
    actual_instance: Optional[Union[DeviceCreateInFacilityInput, DeviceCreateInMetroInput]] = None
    one_of_schemas: List[str] = Field(default=Literal["DeviceCreateInFacilityInput", "DeviceCreateInMetroInput"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateDeviceRequest.model_construct()
        error_messages = []
        match = 0
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DeviceCreateInFacilityInput, DeviceCreateInMetroInput]]:
