from torch_model_hub.model import TextCNN, RotaryAttention, attention, ClassSelfAttention, MultiHeadClassSelfAttention, \
    ...
    TextCNN2D, RNNAttention2D, CNNRNNAttention2D, RNNCNNAttention2D, ResRNNCNNAttention2D
