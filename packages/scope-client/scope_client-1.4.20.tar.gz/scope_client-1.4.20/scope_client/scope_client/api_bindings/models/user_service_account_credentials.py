...
class UserServiceAccountCredentials(BaseModel):
    ...
    name: StrictStr = Field(description="The user's full name.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "email", "picture", "user_type", "realm", "data_plane_id", "client_id", "created_at", "updated_at", "organization_id", "credentials"]
