...
def plotNWMStreamflowData(dischargedata, feature_ids, output_dir, start_date, end_date):
    ...
    if plotted_ids:
        ...
        print("\033[1m****No valid data found for any provided feature IDs. Plot not generated.****\033[0m")

    if missing_ids:
        print(f"\033[1m****Data not found for the following NWM feature IDs: {', '.join(map(str, missing_ids))}****\033[0m")
