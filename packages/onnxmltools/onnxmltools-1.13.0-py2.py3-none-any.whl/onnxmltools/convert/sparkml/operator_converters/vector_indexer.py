...
def convert_sparkml_vector_indexer(scope, operator, container):
    ...
    split_output_names = [
        scope.get_unique_variable_name("split_tensor_%d" % i)
...
register_converter(
    "pyspark.ml.feature.VectorIndexerModel", convert_sparkml_vector_indexer
)
...
register_shape_calculator(
    "pyspark.ml.feature.VectorIndexerModel", calculate_vector_indexer_shapes
)
