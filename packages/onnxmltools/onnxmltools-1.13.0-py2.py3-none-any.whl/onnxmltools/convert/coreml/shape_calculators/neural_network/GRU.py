...
def calculate_gru_output_shapes(operator):
    ...
    """
    check_input_and_output_numbers(
        operator, input_count_range=[1, 2], output_count_range=[1, 2]
    )
    ...
    # if params.params.sequenceOutput else [2, params.outputVectorSize]
    output_shape = [
        input_shape[0] if params.sequenceOutput else "None",
