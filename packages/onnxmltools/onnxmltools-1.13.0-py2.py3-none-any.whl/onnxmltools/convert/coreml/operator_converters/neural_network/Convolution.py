...
def convert_convolution(scope, operator, container):
    ...
    container.add_initializer(
        name_w, onnx_proto.TensorProto.FLOAT, shape_w, params.weights.floatValue
    )
    ...
    if params.hasBias:
        ...
        container.add_initializer(
            name_b, onnx_proto.TensorProto.FLOAT, shape_b, params.bias.floatValue
        )
