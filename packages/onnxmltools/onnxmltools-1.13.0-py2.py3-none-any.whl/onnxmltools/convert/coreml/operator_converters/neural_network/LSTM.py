...
def convert_unidirectional_lstm(scope, operator, container):
    ...
    matrices_w = np.concatenate(
        [
            lstm_weights.inputGateWeightMatrix.floatValue,
    ...
    matrices_r = np.concatenate(
        [
            lstm_weights.inputGateRecursionMatrix.floatValue,
    ...
    if lstm_params.hasPeepholeVectors:
        vectors_p = np.concatenate(
            [
                lstm_weights.inputGatePeepholeVector.floatValue,
