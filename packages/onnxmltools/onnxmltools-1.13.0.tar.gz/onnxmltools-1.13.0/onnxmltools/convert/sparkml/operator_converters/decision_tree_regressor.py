...
from ...sparkml.operator_converters.tree_ensemble_common import (
...
def convert_decision_tree_regressor(scope, operator, container):
    ...
    add_tree_to_attribute_pairs(attrs, False, tree, 0, 1.0, 0, False)
...
register_converter(
    "pyspark.ml.regression.DecisionTreeRegressionModel", convert_decision_tree_regressor
)
