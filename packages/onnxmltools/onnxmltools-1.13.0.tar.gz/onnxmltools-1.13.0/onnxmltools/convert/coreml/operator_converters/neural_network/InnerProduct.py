...
def convert_inner_product(scope, operator, container):
    ...
    container.add_initializer(
        name_b, onnx_proto.TensorProto.FLOAT, shape_b, params.weights.floatValue
    )
    ...
    if params.hasBias:
        container.add_initializer(
            name_c, onnx_proto.TensorProto.FLOAT, shape_c, params.bias.floatValue
        )
    else:
        container.add_initializer(
