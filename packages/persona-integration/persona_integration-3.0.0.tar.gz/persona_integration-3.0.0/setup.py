#!/usr/bin/env python
"""
Package metadata for persona_integration.
"""
import os
import re
import sys
...
VERSION = get_version('persona_integration', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""This repo contains the backend plugin that implements the Persona integration to be used for id
    verification.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='2U, Inc.',
    author_email='team-cosmonauts@edx.org',
    url='https://github.com/edx/persona-integration',
    packages=find_packages(
        include=['persona_integration', 'persona_integration.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "persona_integration = persona_integration.apps:PersonaIntegrationConfig",
        ],
    },
)
