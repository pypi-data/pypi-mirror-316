...
def load_airpassengers(as_series=False, dtype=np.float64):
    ...
    Examples
    --------
    >>> from perlib.perlib import datasets
    >>> datasets.load_airpassengers()  # doctest: +SKIP
    np.array([
    ...
    >>> datasets.load_airpassengers(True).head()
    0    112.0
    1    118.0
    2    132.0
    3    129.0
