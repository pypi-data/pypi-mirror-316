...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-connectparticipant)](https://pypistats.org/packages/mypy-boto3-connectparticipant)
...
`mypy-boto3-connectparticipant` dependency in production. However, there is an
