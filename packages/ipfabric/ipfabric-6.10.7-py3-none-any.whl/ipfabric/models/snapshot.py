...
def create_snapshot(
    ...
    **kwargs,
    ...
    dt_now = int((datetime.now(timezone.utc).timestamp() - 5) * 1000)  # TODO: IPF-1515/IPF-810
    resp = raise_for_status(ipf.post("snapshots", json=snapshot.params)).json()
    return _parse_snapshot_creation(ipf, resp, snapshot, dt_now)
