...
class NIST(Client):
    def __init__(self, nvd_api_key: str, timeout: TimeoutTypes = 60, proxies: Optional[ProxiesTypes] = None):
        """
    ...
    def _query_cve(self, cpe: CPE) -> CVEs:
        try:
    ...
    def _query_cpe(self, params) -> List[CPE]:
        try:
            sleep(0.3)  # NIST Rate Limit: 50 requests/30 seconds
            ...
            return [CPE(cpeName="", cpeNameId="", deprecated=False, created="", lastModified="", error="HTTP Error")]
