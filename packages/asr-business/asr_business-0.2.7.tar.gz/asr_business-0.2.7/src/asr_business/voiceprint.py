...
class Voiceprint:
    def __init__(self, voiceprint_model_path, sample_rate=16000, window_size=512, hop_size=160, mel_bins=64, fmin=50,
                 fmax=8000, freeze_base=False, device="cuda:0", batch_size=32, threshold_prob=0.78):
        """
        ...
        :param fmin: fmin, 50
        :param fmax: fmax, 8000
        :param freeze_base: 是否冻结base网络层，否
        :param device: 模型推理设备，默认为cuda:0
        :param batch_size: 单次batch识别的数量，默认为32
        :param threshold_prob: 概率阈值，默认0.78
        """
