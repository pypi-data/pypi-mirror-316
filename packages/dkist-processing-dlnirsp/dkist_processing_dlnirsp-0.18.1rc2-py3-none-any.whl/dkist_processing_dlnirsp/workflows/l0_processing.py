...
l0_pipeline.add_node(
    ...
    upstreams=IfuDriftCalibration,
)
l0_pipeline.add_node(
    task=ScienceCalibration, upstreams=[InstrumentPolarizationCalibration, SolarCalibration]
)
l0_pipeline.add_node(task=DlnirspWriteL1Frame, upstreams=ScienceCalibration)
...
l0_pipeline.add_node(
    task=SubmitDatasetMetadata, upstreams=[DlnirspWriteL1Frame, DlnirspAssembleQualityData]
)
l0_pipeline.add_node(
