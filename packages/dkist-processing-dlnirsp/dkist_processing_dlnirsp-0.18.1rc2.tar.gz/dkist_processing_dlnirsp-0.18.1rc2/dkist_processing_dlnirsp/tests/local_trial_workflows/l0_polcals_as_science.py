...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import SetCadenceConstants
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import SetDitherModeOff
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import (
    SetObserveExpTimeToPolcal,
)
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import (
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_dev_mockers import TagPolcasAsScience
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_helpers import LoadIfuDriftCal
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_helpers import LoadPolCalAsScience
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_helpers import SaveIfuDriftCal
...
from dkist_processing_dlnirsp.tests.local_trial_workflows.e2e_helpers import SavePolCalAsScience
...
def main(
    ...
    with ManualProcessing(
        ...
        manual_processing_run.run_task(task=SetObserveExpTimeToPolcal)
