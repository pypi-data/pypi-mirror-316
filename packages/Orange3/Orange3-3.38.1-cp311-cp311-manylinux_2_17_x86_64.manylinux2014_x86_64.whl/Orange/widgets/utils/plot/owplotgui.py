    ...
    def paint(self, painter, option, index):
        ...
        if option.state & QStyle.State_MouseOver:
            if not full_selection or (full_selection and is_selected):
                txt = [_tr.m[3295, " Add "], _tr.m[3296, " Remove "]][is_selected]
...
class OWPlotGUI:
    ...
    def __init__(self, master):
        ...
        self.color_model = DomainModel(
            placeholder=_tr.m[3297, "(Same color)"], valid_types=DomainModel.PRIMITIVE)
        self.shape_model = DomainModel(
            placeholder=_tr.m[3298, "(Same shape)"], valid_types=DiscreteVariable)
        self.size_model = DomainModel(
            placeholder=_tr.m[3299, "(Same size)"], valid_types=ContinuousVariable)
        self.label_model = DomainModel(placeholder=_tr.m[3300, "(No labels)"])
    ...
    _buttons = {
        Zoom: (_tr.m[3301, 'Zoom'], 'state', ZOOMING, None, 'Dlg_zoom'),
        ZoomReset: (_tr.m[3302, 'Reset zoom'], None, None, None, 'Dlg_zoom_reset'),
        Pan: (_tr.m[3303, 'Pan'], 'state', PANNING, None, 'Dlg_pan_hand'),
        SimpleSelect: (_tr.m[3304, 'Select'], 'state', SELECT, None, 'Dlg_arrow'),
        Select: (_tr.m[3305, 'Select'], 'state', SELECT, None, 'Dlg_arrow'),
        SelectionAdd: (_tr.m[3306, 'Add to selection'], 'selection_behavior', SELECTION_ADD, None,
                       'Dlg_select_add'),
        SelectionRemove: (_tr.m[3307, 'Remove from selection'], 'selection_behavior', SELECTION_REMOVE, None,
                          'Dlg_select_remove'),
        SelectionToggle: (_tr.m[3308, 'Toggle selection'], 'selection_behavior', SELECTION_TOGGLE, None,
                          'Dlg_select_toggle'),
        SelectionOne: (_tr.m[3309, 'Replace selection'], 'selection_behavior', SELECTION_REPLACE, None,
                       'Dlg_arrow'),
        SendSelection: (_tr.m[3310, 'Send selection'], None, None, 'send_selection', 'Dlg_send'),
        ClearSelection: (_tr.m[3311, 'Clear selection'], None, None, 'clear_selection', 'Dlg_clear'),
        ShufflePoints: (_tr.m[3312, 'ShufflePoints'], None, None, 'shuffle_points', 'Dlg_sort')
    }

    _check_boxes = {
        AnimatePlot : (_tr.m[3313, 'Animate plot'], 'animate_plot', 'update_animations'),
        AnimatePoints : (_tr.m[3314, 'Animate points'], 'animate_points', 'update_animations'),
        AntialiasPlot : (_tr.m[3315, 'Antialias plot'], 'antialias_plot', 'update_antialiasing'),
        AntialiasPoints : (_tr.m[3316, 'Antialias points'], 'antialias_points', 'update_antialiasing'),
        AntialiasLines : (_tr.m[3317, 'Antialias lines'], 'antialias_lines', 'update_antialiasing'),
        AutoAdjustPerformance : (_tr.m[3318, 'Disable effects for large datasets'], 'auto_adjust_performance',
                                 'update_performance')
    }
    ...
    def antialiasing_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'use_antialiasing', _tr.m[3319, 'Use antialiasing'], 'update_antialiasing')

    def jitter_size_slider(self, widget, label=_tr.m[3320, "Jittering: "]):
    ...
    def jitter_numeric_check_box(self, widget):
        self._check_box(
            widget=widget,
            value="jitter_continuous", label=_tr.m[3321, "Jitter numeric values"],
    ...
    def show_legend_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'show_legend', _tr.m[3322, 'Show legend'],
    ...
    def regression_line_check_box(self, widget):
        self._master.cb_reg_line = \
            self._check_box(widget=widget, value="show_reg_line",
                            label=_tr.m[3325, "Show regression line"],
    ...
    def label_only_selected_check_box(self, widget):
        self._check_box(widget=widget, value="label_only_selected",
                        label=_tr.m[3326, "Label only selection and subset"],
                        cb_name=self._plot.update_labels)

    def filled_symbols_check_box(self, widget):
        self._check_box(widget, 'show_filled_symbols', _tr.m[3327, 'Show filled symbols'],
                        'update_filled_symbols')

    def grid_lines_check_box(self, widget):
        self._check_box(widget, 'show_grid', _tr.m[3328, 'Show gridlines'],
    ...
    def animations_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'use_animations', _tr.m[3329, 'Use animations'], 'update_animations')
    ...
    def point_size_slider(self, widget, label=_tr.m[3330, "Symbol size: "]):
        '''
            Creates a slider that controls point size
        '''
        return self._slider(widget, 'point_width', label, 1, 20, 1, 'sizes_changed')

    def alpha_value_slider(self, widget, label=_tr.m[3331, "Opacity: "]):
        '''
    ...
    def point_properties_box(self, widget, box=_tr.m[3336, 'Attributes']):
        '''
    ...
    def zoom_select_toolbar(self, widget, text=_tr.m[3337, 'Zoom / Select'], orientation=Qt.Horizontal,
    ...
    def theme_combo_box(self, widget):
        c = gui.comboBox(widget, self._plot, "theme_name", _tr.m[3338, "Theme"],
                         callback=self._plot.update_theme, sendSelectedValue=1)
        c.addItem(_tr.m[3339, 'Default'])
        c.addItem(_tr.m[3340, 'Light'])
        c.addItem(_tr.m[3341, 'Dark'])
        return c

    def box_zoom_select(self, parent):
        box_zoom_select = gui.vBox(parent, _tr.m[3342, "Zoom/Select"])
