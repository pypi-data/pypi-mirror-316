...
class OWNaiveBayes(OWBaseLearner):
    name = _tr.m[2259, "Naive Bayes"]
    description = (_tr.m[2260, "A fast and simple probabilistic classifier based on "] + _tr.m[2261, "Bayes' theorem with the assumption of feature independence."])
    icon = "icons/NaiveBayes.svg"
    replaces = [
        "Orange.widgets.classify.ownaivebayes.OWNaiveBayes",
    ]
    priority = 70
    keywords = _tr.m[2262, "naive bayes"]
