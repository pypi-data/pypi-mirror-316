...
class DiscretePalette(IndexedPalette):
    ...
    def from_colors(cls, palette):
        ...
        """
        return cls(_tr.m[3118, "Custom"], _tr.m[3119, "Custom"], palette)
...
class LimitedDiscretePalette(DiscretePalette):
    ...
    def __init__(self, number_of_colors, nan_color=NAN_COLOR,
        ...
        if force_hsv is not None:
            warnings.warn(
                ("LimitedDiscretePalette: argument 'force_hsv' is deprecated; " + "use 'force_glasbey' instead"), DeprecationWarning,
                stacklevel=2)
...
class ContinuousPalette(Palette):
    ...
    def from_colors(cls, color1, color2, pass_through=False):
        ...
        if pass_through is True:
            ...
            xf = [0, 255]
        name = repr(colors)
        friendly_name = _tr.m[3120, "Custom"]
        x = np.arange(256)
...
DefaultRGBColors = DiscretePalette(_tr.m[3121, "Default"], _tr.m[3122, "Default"], [
...
Dark2Colors = DiscretePalette(_tr.m[3123, "Dark"], _tr.m[3124, "Dark"], [
...
ContinuousPalettes = {
    'linear_bgyw_20_98_c66': ContinuousPalette(
        _tr.m[3125, 'Blue-Green-Yellow'], 'linear_bgyw_20_98_c66',
    ...
    'linear_bmy_10_95_c78': ContinuousPalette(
        _tr.m[3126, 'Blue-Magenta-Yellow'], 'linear_bmy_10_95_c78',
    ...
    'linear_grey_10_95_c0': ContinuousPalette(
        _tr.m[3127, 'Dim gray'], 'linear_grey_10_95_c0',
    ...
    'diverging_bwr_40_95_c42': ContinuousPalette(
        _tr.m[3128, 'Coolwarm'], 'diverging_bwr_40_95_c42',
    ...
    'diverging_gkr_60_10_c40': ContinuousPalette(
        _tr.m[3129, 'Green-Red'], 'diverging_gkr_60_10_c40',
    ...
    'diverging_protanopic_deuteranopic_bwy_60_95_c32': ContinuousPalette(
        _tr.m[3130, 'Diverging protanopic'], 'diverging_protanopic_deuteranopic_bwy_60_95_c32',
        ...
        category=_tr.m[3131, "Color-blind friendly"], flags=Palette.ColorBlindSafe | Palette.Diverging
    ),
    'diverging_tritanopic_cwr_75_98_c20': ContinuousPalette(
        _tr.m[3132, 'Diverging tritanopic'], 'diverging_tritanopic_cwr_75_98_c20',
        ...
        category=_tr.m[3133, "Color-blind friendly"], flags=Palette.ColorBlindSafe | Palette.Diverging
    ),
    'linear_protanopic_deuteranopic_kbw_5_98_c40': ContinuousPalette(
        _tr.m[3134, 'Linear protanopic'], 'linear_protanopic_deuteranopic_kbw_5_98_c40',
        ...
        category=_tr.m[3135, "Color-blind friendly"], flags=Palette.ColorBlindSafe
    ),
    'linear_tritanopic_krjcw_5_95_c24': ContinuousPalette(
        _tr.m[3136, 'Linear tritanopic'], 'linear_tritanopic_krjcw_5_95_c24',
        ...
        category=_tr.m[3137, "Color-blind friendly"], flags=Palette.ColorBlindSafe
    ),
    'isoluminant_cgo_80_c38': ContinuousPalette(
        _tr.m[3138, 'Isoluminant'], 'isoluminant_cgo_80_c38',
        ...
        category=_tr.m[3139, "Other"]
    ),
    'rainbow_bgyr_35_85_c73': ContinuousPalette(
        _tr.m[3140, 'Rainbow'], 'rainbow_bgyr_35_85_c73',
...
def patch_variable_colors():
    ...
    def continuous_get_colors(var):
        warnings.warn(("ContinuousVariable.color is deprecated; " + "use ContinuousVariable.palette"),
