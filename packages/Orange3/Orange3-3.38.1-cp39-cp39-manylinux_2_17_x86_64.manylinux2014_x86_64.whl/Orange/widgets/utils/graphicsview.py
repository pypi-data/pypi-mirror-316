...
class GraphicsWidgetView(QGraphicsView):
    ...
    def __init__(self, *args, widgetResizable=False, **kwargs):
        ...
        zoomin = QAction(
            _tr.m[3159, "Zoom in"], self, objectName="zoom-in-action",
            shortcut=QKeySequence.ZoomIn,
        )
        zoomout = QAction(
            _tr.m[3160, "Zoom out"], self, objectName="zoom-out-action",
            shortcut=QKeySequence.ZoomOut,
        )
        zoomreset = QAction(
            _tr.m[3161, "Actual Size"], self, objectName="zoom-reset-action",
            shortcut=QKeySequence(Qt.ControlModifier | Qt.Key_0),
        )
        fit = QAction(
            _tr.m[3162, "Zoom to fit"], self, objectName="zoom-to-fit-action",
