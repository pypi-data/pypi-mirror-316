...
from ...models.paginated_response_user_response import PaginatedResponseUserResponse
...
) -> Optional[Union[HTTPValidationError, PaginatedResponseUserResponse]]:
    if response.status_code == 200:
        response_200 = PaginatedResponseUserResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, PaginatedResponseUserResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, PaginatedResponseUserResponse]
    """
