...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ParticipantResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (ParticipantCreate): Schema for adding a participant to chat. Example: {'chat_uuid':
            '123e4567-e89b-12d3-a456-426614174000', 'client_uuid':
            '123e4567-e89b-12d3-a456-426614174000', 'participant_type': 'client'}.
