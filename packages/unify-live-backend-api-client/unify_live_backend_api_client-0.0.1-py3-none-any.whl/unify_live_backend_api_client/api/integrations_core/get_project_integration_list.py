...
from ...models.paginated_response_integration_response import PaginatedResponseIntegrationResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/integrations/project/{project_uuid}",
        "params": params,
    }
...
) -> Optional[Union[Any, HTTPValidationError, PaginatedResponseIntegrationResponse]]:
    if response.status_code == 200:
        response_200 = PaginatedResponseIntegrationResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PaginatedResponseIntegrationResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PaginatedResponseIntegrationResponse]
    """
