...
T = TypeVar("T", bound="TelegramIntegrationResponse")


@_attrs_define
class TelegramIntegrationResponse:
    ...
    Attributes:
        ...
        config (Any): Telegram configuration
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        telegram_integration_response = cls(
            name=name,
            type_=type_,
            uuid=uuid,
            project_uuid=project_uuid,
        ...
        telegram_integration_response.additional_properties = d
        return telegram_integration_response
