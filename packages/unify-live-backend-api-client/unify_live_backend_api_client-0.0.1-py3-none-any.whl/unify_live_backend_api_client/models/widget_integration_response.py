...
T = TypeVar("T", bound="WidgetIntegrationResponse")


@_attrs_define
class WidgetIntegrationResponse:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        widget_integration_response = cls(
            name=name,
            type_=type_,
            uuid=uuid,
            project_uuid=project_uuid,
        ...
        widget_integration_response.additional_properties = d
        return widget_integration_response
