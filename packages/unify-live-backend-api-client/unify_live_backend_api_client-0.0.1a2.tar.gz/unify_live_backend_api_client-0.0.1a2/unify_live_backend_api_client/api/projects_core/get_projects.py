...
from ...models.paginated_response_project_response import PaginatedResponseProjectResponse
...
) -> Optional[Union[Any, HTTPValidationError, PaginatedResponseProjectResponse]]:
    if response.status_code == 200:
        response_200 = PaginatedResponseProjectResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PaginatedResponseProjectResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PaginatedResponseProjectResponse]
    """
