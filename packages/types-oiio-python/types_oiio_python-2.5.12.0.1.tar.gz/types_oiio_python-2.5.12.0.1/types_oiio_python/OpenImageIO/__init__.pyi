from typing import Any, ClassVar, Iterator, Type, Union, overload, TYPE_CHECKING
...
class ImageCache:
    ...
    @overload
    def attribute(self, arg0: str, arg1: Union[int, float]) -> None: ...
    @overload
...
@overload
def attribute(arg0: str, arg1: Union[int, float]) -> None: ...
@overload
