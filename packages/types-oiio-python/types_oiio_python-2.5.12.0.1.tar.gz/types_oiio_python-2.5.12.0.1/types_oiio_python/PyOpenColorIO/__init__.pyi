...
from typing import Any, Callable, ClassVar, Iterable, Iterator, overload, TYPE_CHECKING
...
class AllocationTransform(Transform):
    ...
    def setVars(self, vars: list[float]) -> None: ...
...
class BuiltinTransform(Transform):
    ...
    @overload
    def __init__(
        self, style: str = ..., direction: TransformDirection = ...
    ) -> None: ...
...
class CPUProcessor:
    ...
    @overload
    def applyRGB(self, data: list[float]) -> list[float]: ...
    @overload
    def applyRGBA(self, data: Buffer) -> None: ...
    @overload
    def applyRGBA(self, data: list[float]) -> list[float]: ...
...
class ColorSpace:
    ...
    def setAllocation(self, allocation: Allocation) -> None: ...
    def setAllocationVars(self, vars: list[float]) -> None: ...
    ...
    def setTransform(
        self, transform: Transform, direction: ColorSpaceDirection
    ) -> None: ...
...
class ColorSpaceMenuHelper:
    ...
    def getHierarchyLevels(
        self, index: int
    ) -> ColorSpaceMenuHelper.ColorSpaceLevelIterator: ...
...
class ColorSpaceMenuParameters:
    ...
    def __init__(
        ...
        config: Config,
        role: str = ...,
        includeColorSpaces: bool = ...,
        searchReferenceSpaceType: SearchReferenceSpaceType = ...,
        includeNamedTransforms: bool = ...,
        appCategories: str = ...,
        encodings: str = ...,
        userCategories: str = ...,
        includeRoles: bool = ...,
    ...
    def getAddedColorSpaces(
        self,
    ) -> ColorSpaceMenuParameters.AddedColorSpaceIterator: ...
    ...
    def setSearchReferenceSpaceType(
        self, searchReferenceSpaceType: SearchReferenceSpaceType
    ) -> None: ...
...
class Config:
    ...
    @staticmethod
    def GetProcessorFromBuiltinColorSpace(
        builtinColorSpaceName: str, srcConfig: Config, srcColorSpaceName: str
    ) -> Processor: ...
    @overload
    @staticmethod
    def GetProcessorFromConfigs(
        srcConfig: Config,
        srcColorSpaceName: str,
        dstConfig: Config,
        dstColorSpaceName: str,
    ) -> Processor: ...
    @overload
    @staticmethod
    def GetProcessorFromConfigs(
    ...
    def GetProcessorFromConfigs(
        srcConfig: Config,
        srcColorSpaceName: str,
        srcInterchangeName: str,
        dstConfig: Config,
        dstColorSpaceName: str,
        dstInterchangeName: str,
    ) -> Processor: ...
    @overload
    @staticmethod
    def GetProcessorFromConfigs(
    ...
    @staticmethod
    def GetProcessorToBuiltinColorSpace(
        srcConfig: Config, srcColorSpaceName: str, builtinColorSpaceName: str
    ) -> Processor: ...
    def addColorSpace(self, colorSpace: ColorSpace) -> None: ...
    def addDisplaySharedView(self, display: str, view: str) -> None: ...
    @overload
    def addDisplayView(
        self, display: str, view: str, colorSpaceName: str, looks: str = ...
    ) -> None: ...
    @overload
    def addDisplayView(
        self,
    ...
    def getColorSpaceNames(
        self,
        searchReferenceType: SearchReferenceSpaceType,
        visibility: ColorSpaceVisibility,
    ) -> Config.ColorSpaceNameIterator: ...
    @overload
    ...
    @overload
    def getNamedTransformNames(
        self, visibility: NamedTransformVisibility
    ) -> Config.NamedTransformNameIterator: ...
    @overload
    def getNamedTransformNames(self) -> Config.ActiveNamedTransformNameIterator: ...
    @overload
    def getNamedTransforms(
        self, visibility: NamedTransformVisibility
    ) -> Config.NamedTransformIterator: ...
    @overload
    def getNamedTransforms(self) -> Config.ActiveNamedTransformIterator: ...
    @overload
    def getProcessor(
        self, srcColorSpace: ColorSpace, dstColorSpace: ColorSpace
    ) -> Processor: ...
    @overload
    def getProcessor(
        self, context: Context, srcColorSpace: ColorSpace, dstColorSpace: ColorSpace
    ) -> Processor: ...
    @overload
    def getProcessor(
        self, srcColorSpaceName: str, dstColorSpaceName: str
    ) -> Processor: ...
    @overload
    def getProcessor(
        self, context: Context, srcColorSpaceName: str, dstColorSpaceName: str
    ) -> Processor: ...
    @overload
    def getProcessor(
        self,
    ...
    @overload
    def getProcessor(
        self, namedTransform: NamedTransform, direction: TransformDirection
    ) -> Processor: ...
    @overload
    def getProcessor(
        self,
    ...
    @overload
    def getProcessor(
        self, namedTransformName: str, direction: TransformDirection
    ) -> Processor: ...
    @overload
    def getProcessor(
        self, context: Context, namedTransformName: str, direction: TransformDirection
    ) -> Processor: ...
    @overload
    def getProcessor(self, transform: Transform) -> Processor: ...
    @overload
    def getProcessor(
        self, transform: Transform, direction: TransformDirection
    ) -> Processor: ...
    @overload
    def getProcessor(
        self, context: Context, transform: Transform, direction: TransformDirection
    ) -> Processor: ...
    ...
    @overload
    def getViews(
        self, type: ViewType, display: str
    ) -> Config.ViewForViewTypeIterator: ...
    @overload
    def getViews(
        self, display: str, colorSpaceName: str
    ) -> Config.ViewForColorSpaceIterator: ...
    ...
    def getVirtualDisplayViews(
        self, display: ViewType
    ) -> Config.VirtualViewIterator: ...
    ...
    def isColorSpaceLinear(
        self, colorSpace: str, referenceSpaceType: ReferenceSpaceType
    ) -> bool: ...
...
class ExposureContrastTransform(Transform):
    ...
    def __init__(
        ...
        gamma: float = ...,
        pivot: float = ...,
        logExposureStep: float = ...,
        logMidGray: float = ...,
        dynamicExposure: bool = ...,
        dynamicContrast: bool = ...,
        dynamicGamma: bool = ...,
        direction: TransformDirection = ...,
    ) -> None: ...
...
class FileRules:
    ...
    @overload
    def insertRule(
        self, ruleIndex: int, name: str, colorSpace: str, pattern: str, extension: str
    ) -> None: ...
    @overload
    def insertRule(
        self, ruleIndex: int, name: str, colorSpace: str, regex: str
    ) -> None: ...
...
class FixedFunctionTransform(Transform):
    ...
    def setParams(self, params: list[float]) -> None: ...
...
class GpuShaderCreator:
    ...
    def createShaderText(
        self,
        shaderDeclarations: str,
        shaderHelperMethods: str,
        shaderFunctionHeader: str,
        shaderFunctionBody: str,
        shaderFunctionFooter: str,
    ) -> None: ...
    def end(self) -> None: ...
...
class GpuShaderDesc(GpuShaderCreator):
    ...
    def addTexture(
        ...
        width: int,
        height: int,
        channel: GpuShaderCreator.TextureType,
        interpolation: Interpolation,
        values: Buffer,
    ) -> None: ...
    def clone(self) -> GpuShaderCreator: ...
...
class GradingRGBM:
    ...
    @overload
    def __init__(
        self, red: float, green: float, blue: float, master: float
    ) -> None: ...
...
class GroupTransform(Transform):
    ...
    @overload
    def __init__(
        self, transforms: list[Transform] = ..., direction: TransformDirection = ...
    ) -> None: ...
    @staticmethod
...
class LogTransform(Transform):
    ...
    @overload
    def __init__(
        self, base: float = ..., direction: TransformDirection = ...
    ) -> None: ...
...
class Lut3DTransform(Transform):
    ...
    def setInterpolation(self, interpolation: Interpolation) -> None: ...
    def setValue(
        self, indexR: int, indexG: int, indexB: int, r: float, g: float, b: float
    ) -> None: ...
...
class MatrixTransform(Transform):
    ...
    @overload
    def __init__(
        self, matrix=..., offset=..., direction: TransformDirection = ...
    ) -> None: ...
    @staticmethod
...
class MixingColorSpaceManager:
    ...
    @overload
    def getSlider(
        self, sliderMixingMinEdge: float, sliderMixingMaxEdge: float
    ) -> MixingSlider: ...
...
class NamedTransform:
    ...
    @staticmethod
    def GetTransform(
        transform: NamedTransform, direction: TransformDirection
    ) -> Transform: ...
    def addAlias(self, alias: str) -> None: ...
    def addCategory(self, category: str) -> None: ...
    def clearAliases(self) -> None: ...
...
class PackedImageDesc(ImageDesc):
    @overload
    def __init__(
        self, data: Buffer, width: int, height: int, numChannels: int
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def __init__(
        self, data: Buffer, width: int, height: int, chanOrder: ChannelOrdering
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class PlanarImageDesc(ImageDesc):
    @overload
    def __init__(
        self, rData: Buffer, gData: Buffer, bData: Buffer, width: int, height: int
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Processor:
    ...
    def getOptimizedCPUProcessor(
        self, inBitDepth: BitDepth, outBitDepth: BitDepth, oFlags: OptimizationFlags
    ) -> CPUProcessor: ...
    ...
    def getTransformFormatMetadata(
        self,
    ) -> Processor.TransformFormatMetadataIterator: ...
    def hasChannelCrosstalk(self) -> bool: ...
    def hasDynamicProperty(self, type: DynamicPropertyType) -> bool: ...
    def isDynamic(self) -> bool: ...
    def isNoOp(self) -> bool: ...
...
class ViewTransform:
    ...
    def setName(self, name: str) -> None: ...
    def setTransform(
        self, transform: Transform, direction: ViewTransformDirection
    ) -> None: ...
...
class ViewingRules:
    ...
    def getColorSpaces(
        self, ruleIndex: int
    ) -> ViewingRules.ViewingRuleColorSpaceIterator: ...
    def getCustomKeyName(self, ruleIndex: int, key: int) -> str: ...
    def getCustomKeyValue(self, ruleIndex: int, key: int) -> str: ...
    def getEncodings(
        self, ruleIndex: int
    ) -> ViewingRules.ViewingRuleEncodingIterator: ...
    def getIndexForRule(self, ruleName: str) -> int: ...
    def getName(self, ruleIndex: int) -> str: ...
    def getNumCustomKeys(self, ruleIndex: int) -> int: ...
    def getNumEntries(self) -> int: ...
...
def CombineTransformDirections(
    direction1: TransformDirection, direction2: TransformDirection
) -> TransformDirection: ...
...
def GetInverseTransformDirection(
    direction: TransformDirection,
) -> TransformDirection: ...
