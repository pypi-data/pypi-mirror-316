...
from bitfount.types import _JSONDict, _ResourceUsageAndLimitJSON, _StrAnyDict

if TYPE_CHECKING:
    from bitfount.hub.api import BitfountHub, PodPublicMetadata
...
class AccessCheckResult(TypedDict):
    ...
    limits: Optional[list[_ResourceUsageAndLimitJSON]]
