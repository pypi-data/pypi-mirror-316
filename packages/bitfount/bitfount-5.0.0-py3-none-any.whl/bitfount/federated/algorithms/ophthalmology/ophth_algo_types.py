...
DISTANCE_METRIC_COL: Final = "distance_metric"
...
DEFAULT_COLUMNS_TO_RENAME = {
    ...
    TOTAL_GA_AREA_COL_PREFIX: "Total GA area (mm²)",
    SMALLEST_LEGION_SIZE_COL: "Smallest lesion size (mm²)",
    LARGEST_LEGION_SIZE_COL_PREFIX: "Largest lesion size (mm²)",
...
DICOM_COLUMNS_TO_RENAME = {
    ...
    "Patient's Birth Date": "Patient's DOB",
...
@dataclass
class SLOSegmentationLocationPrefix:
...
class GAMetricsWithFovea(GAMetrics):
    ...
    Attributes:
        ...
        distance_metric: The final distance metric used for trial inclusion.
