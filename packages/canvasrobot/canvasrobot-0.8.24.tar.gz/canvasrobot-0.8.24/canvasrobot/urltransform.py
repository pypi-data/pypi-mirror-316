...
def show_result(html: str):
    ...
    <body>
      <h2>Pagina's met Mediasite urls:</h2>
      <p>Klik op de link(s) om de pagina's of video's te openen.</p>
      <hr/>
      {}
      <hr/>
    ...
    def mediasite2panopto(self, text: str, dryrun=True) -> (str, bool, int):
        ...
        for match in matches:
            ...
            if pn_id:
                ...
                msg += (f"<p><a href={self.current_page_url} target='_blank'>{self.current_page}</a>"
