...
class RegeditUtils:
    @staticmethod
    def queryRegeditContent(path=None):
    ...
    def addLeftKeyClickItem(self, name, path, iconPath=None):
    ...
    def addFileLeftKeyClickItem(self, name, path, iconPath=None, args=False):
    ...
    def addAutoBootItem(self, name, startPath, addToCurrentUser=False):
    ...
    def removeAutoBootItem(self, name, delToCurrentUser=False):
