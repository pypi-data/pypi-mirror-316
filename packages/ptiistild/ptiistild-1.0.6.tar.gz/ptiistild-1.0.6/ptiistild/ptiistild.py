...
def parse_args():
    ...
    parser.add_argument("-m", "--methods",     type=str.upper, nargs="+",
        default=["GET","DELETE", "PUT", "POST", "PATCH", "TRACE", "DEBUG", "HEAD", "OPTIONS"],
        choices=["GET","DELETE", "PUT", "POST", "PATCH", "TRACE", "DEBUG", "HEAD", "OPTIONS"]
        )
