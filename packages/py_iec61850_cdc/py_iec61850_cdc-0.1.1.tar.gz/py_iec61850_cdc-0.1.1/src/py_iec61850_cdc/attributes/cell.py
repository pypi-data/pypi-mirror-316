# py_iec61850_cdc attributes/cell.py
...
# IEC 61850-7-3 6.9 Cell
class Cell(BaseModel, validate_assignment = True):
    x_start: FLOAT32           = Field(default = 0.0,  serialization_alias = "xStart")
    x_end:   Optional[FLOAT32] = Field(default = None, serialization_alias = "xEnd")
    y_start: Optional[FLOAT32] = Field(default = None, serialization_alias = "yStart")
    y_end:   Optional[FLOAT32] = Field(default = None, serialization_alias = "yEnd")
