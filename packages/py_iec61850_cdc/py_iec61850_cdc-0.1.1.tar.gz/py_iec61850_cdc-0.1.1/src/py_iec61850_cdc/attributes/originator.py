# py_iec61850_cdc attributes/originator.py
...
# IEC 61850-7-2 6.2.3.17 Originator
class Originator(BaseModel, validate_assignment = True):
    or_cat:   OriginatorCategoryKind = Field(default = OriginatorCategoryKind.process, serialization_alias = "orCat")
    or_ident: Octet64                = Field(default = "",                             serialization_alias = "orIdent")
