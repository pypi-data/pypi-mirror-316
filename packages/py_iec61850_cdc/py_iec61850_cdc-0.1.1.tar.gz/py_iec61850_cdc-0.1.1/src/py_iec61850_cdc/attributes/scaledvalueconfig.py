# py_iec61850_cdc attributes/scaledvalueconfig.py
...
from py_iec61850_cdc.basetypes import FLOAT32


# IEC 61850-7-3 6.2 ScaledValueConfig
class ScaledValueConfig(BaseModel, validate_assignment = True):
    scale_factor: FLOAT32 = Field(default = 1.0, serialization_alias = "scaleFactor")
    offset:       FLOAT32 = Field(default = 0.0, serialization_alias = "offset")
