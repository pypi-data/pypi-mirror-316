...
from py_iec61850_cdc.abstracts import BaseComposedCDC, BasePrimitiveCDC, HarmonicMeasurandCDC, SubstitutionCDC
...
class HWYE(HarmonicMeasurandCDC):
    ...
    phs_b_har: Optional[list[CMV]]               = None
    phs_c_har: Optional[list[CMV]]               = None
    neut_har:  Optional[list[CMV]]               = None
    net_har:   Optional[list[CMV]]               = None
    res_har:   Optional[list[CMV]]               = None
    ang_ref:   Optional[PhaseAngleReferenceKind] = Field(default = None,
                                                         serialization_alias = "angRef")
...
class HDEL(HarmonicMeasurandCDC):
    ...
    phs_bc_har: Optional[list[CMV]]               = None
    phs_ca_har: Optional[list[CMV]]               = None
    ang_ref:    Optional[PhaseAngleReferenceKind] = Field(default = None,
                                                          serialization_alias = "angRef")
