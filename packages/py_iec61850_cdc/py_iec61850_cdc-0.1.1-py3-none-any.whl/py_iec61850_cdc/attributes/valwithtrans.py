...
# IEC 61850-7-3 6.4 ValWithTrans
class ValWithTrans(BaseModel, validate_assignment = True):
    pos_val:   INT8              = Field(default = 0,    serialization_alias = "posVal")
    trans_ind: Optional[BOOLEAN] = Field(default = None, serialization_alias = "transInd")
