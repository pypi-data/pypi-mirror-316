...
# IEC 61850-7-3 6.5 PulseConfig
class PulseConfig(BaseModel, validate_assignment = True):
    cmd_qual: OutputSignalKind = Field(default = OutputSignalKind.pulse, serialization_alias = "cmdQual")
    on_dur:   INT32U           = Field(default = 0,                      serialization_alias = "onDur")
    off_dur:  INT32U           = Field(default = 0,                      serialization_alias = "offDur")
    num_pls:  INT32U           = Field(default = 0,                      serialization_alias = "numPls")
