# py_iec61850_cdc attributes/lcblogentryoptions.py
...
# IEC 61850-7-2 6.2.3.14 LCBLogEntryOptions
class LCBLogEntryOptions(BaseModel, validate_assignment = True):
    reason_for_inclusion: BOOLEAN = Field(default=False,
                                          serialization_alias="reason-for-inclusion")
