# py_iec61850_cdc attributes/reasonforinclusioninlog.py
...
# IEC 61850-7-2 6.3.3.4 ReasonForInclusionInLog
class ReasonForInclusionInLog(BaseModel, validate_assignment = True):
    ...
    application_trigger:   BOOLEAN = Field(default=False,
                                           serialization_alias="application-trigger")
