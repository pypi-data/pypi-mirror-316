# py_iec61850_cdc attributes/checkconditions.py
...
# IEC 61850-7-2 6.2.3.16 CheckConditions
class CheckConditions(BaseModel, validate_assignment = True):
    synchrocheck:    BOOLEAN = Field(default = False, serialization_alias = "synchrocheck")
    interlock_check: BOOLEAN = Field(default = False, serialization_alias = "interlockCheck")
