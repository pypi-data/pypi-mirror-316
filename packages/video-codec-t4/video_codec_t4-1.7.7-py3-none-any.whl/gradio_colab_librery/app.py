...
with gr.Blocks() as demo:
    ...
    with gr.Tabs():
        ...
        with gr.Tab("Image+Audio to Video Avatar"):
            with gr.Row():
                with gr.Column(scale=1):
                    img1 = gr.Image(type="pil", label="Drag image here or select image", interactive=True, elem_id="img1", width=200, height=200)
            ...
            load_button.click(fn=safe_execution(handle_video_output_tts), inputs=[], outputs=[video_outputs, output_textbox])
