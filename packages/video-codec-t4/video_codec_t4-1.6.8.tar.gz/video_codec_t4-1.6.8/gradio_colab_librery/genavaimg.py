...
def process_audio_files(folder_path, image_path, ruta_videos, aspect_ratio, prompt, seed_input, seed, continue_fragment, process_multiple):
    ...
    for file_name in file_list:
        # Si no hay más archivos que procesar, detenemos el bucle
        if len(file_list) == 0:
            print("No hay más archivos para procesar. Deteniendo el bucle.")
            break  # Finaliza el bucle for pero la función continuará
    ...
    # El proceso continuará después del bucle
    print("El bucle for terminó. Continuando con el resto del código...")
