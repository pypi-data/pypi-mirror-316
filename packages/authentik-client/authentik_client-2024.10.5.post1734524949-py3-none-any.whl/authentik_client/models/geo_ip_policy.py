...
class GeoIPPolicy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "execution_logging", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "bound_to", "asns", "countries", "countries_obj"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.countries_obj:
            for _item in self.countries_obj:
                if _item:
