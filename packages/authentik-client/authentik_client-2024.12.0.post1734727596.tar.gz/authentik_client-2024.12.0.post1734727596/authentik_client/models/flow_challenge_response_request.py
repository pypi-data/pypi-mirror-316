...
class FlowChallengeResponseRequest(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, PromptChallengeResponseRequest):
            ...
            match += 1
        # validate data type: RedirectChallengeResponseRequest
        if not isinstance(v, RedirectChallengeResponseRequest):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RedirectChallengeResponseRequest`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into RedirectChallengeResponseRequest
        try:
            instance.actual_instance = RedirectChallengeResponseRequest.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
