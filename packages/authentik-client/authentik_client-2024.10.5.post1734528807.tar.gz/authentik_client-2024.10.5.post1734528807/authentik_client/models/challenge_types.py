...
class ChallengeTypes(BaseModel):
    ...
    oneof_schema_15_validator: Optional[FrameChallenge] = None
    # data type: IdentificationChallenge
    oneof_schema_16_validator: Optional[IdentificationChallenge] = None
    # data type: OAuthDeviceCodeChallenge
    oneof_schema_17_validator: Optional[OAuthDeviceCodeChallenge] = None
    # data type: OAuthDeviceCodeFinishChallenge
    oneof_schema_18_validator: Optional[OAuthDeviceCodeFinishChallenge] = None
    # data type: PasswordChallenge
    oneof_schema_19_validator: Optional[PasswordChallenge] = None
    # data type: PlexAuthenticationChallenge
    oneof_schema_20_validator: Optional[PlexAuthenticationChallenge] = None
    # data type: PromptChallenge
    oneof_schema_21_validator: Optional[PromptChallenge] = None
    # data type: RedirectChallenge
    oneof_schema_22_validator: Optional[RedirectChallenge] = None
    # data type: SessionEndChallenge
    oneof_schema_23_validator: Optional[SessionEndChallenge] = None
    # data type: ShellChallenge
    oneof_schema_24_validator: Optional[ShellChallenge] = None
    # data type: UserLoginChallenge
    oneof_schema_25_validator: Optional[UserLoginChallenge] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, FlowErrorChallenge):
            ...
            match += 1
        # validate data type: FrameChallenge
        if not isinstance(v, FrameChallenge):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FrameChallenge`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into FrameChallenge
        try:
            instance.actual_instance = FrameChallenge.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
