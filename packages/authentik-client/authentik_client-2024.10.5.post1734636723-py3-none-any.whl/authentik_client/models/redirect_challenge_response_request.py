...
class RedirectChallengeResponseRequest(BaseModel):
    """
    Redirect challenge response
    """ # noqa: E501
    component: Optional[Annotated[str, Field(min_length=1, strict=True)]] = 'xak-flow-redirect'
    to: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["component", "to"]
