...
class ConsentChallenge(BaseModel):
    ...
    token: StrictStr
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "pending_user", "pending_user_avatar", "header_text", "permissions", "additional_permissions", "token"]
