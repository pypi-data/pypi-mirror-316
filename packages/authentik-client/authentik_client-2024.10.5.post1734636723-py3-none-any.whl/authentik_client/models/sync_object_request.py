...
class SyncObjectRequest(BaseModel):
    ...
    sync_object_id: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["sync_object_model", "sync_object_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sync_object_model": obj.get("sync_object_model"),
            "sync_object_id": obj.get("sync_object_id")
        })
        return _obj
