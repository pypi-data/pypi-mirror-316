...
class DataModel:
    ...
    def __init__(
        self, data: pl.LazyFrame, data_step_size: int, scaling: float, **params
    ):
        ...
        # Statistics
        if "p" in self._cols:
            # self.data_p = self.data_p * self.scaling
    ...
    def step(self):
        ...
        if self.p_calculated:
            self.p_mw = compute_p(self.q_mvar, self.cos_phi)
