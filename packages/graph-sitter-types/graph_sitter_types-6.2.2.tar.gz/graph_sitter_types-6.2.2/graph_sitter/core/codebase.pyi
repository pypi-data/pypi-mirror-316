...
from codegen.utils.ai import AbstractAIHelper
...
class Codebase(Generic[TSourceFile, TDirectory, TSymbol, TClass, TFunction, TImport, TGlobalVar, TInterface, TTypeAlias, TParameter, TCodeBlock]):
    ...
    @overload
    def get_file(self, filepath: str, *, optional: Literal[False] = ...) -> TSourceFile:
        ...
    
    @overload
    def get_file(self, filepath: str, *, optional: Literal[True]) -> TSourceFile | None:
        ...
    
    def get_file(self, filepath: str, *, optional: bool = ...) -> TSourceFile | None:
    ...
    def get_directory(self, dir_path: str, optional: bool = ...) -> TDirectory | None:
    ...
    @noapidoc
    def git_push(self, *args, **kwargs): # -> None:
        """Git push."""
        ...
