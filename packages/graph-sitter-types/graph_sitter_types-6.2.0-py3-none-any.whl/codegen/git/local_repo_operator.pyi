...
class LocalRepoOperator(RepoOperator):
    """RepoOperator that does not depend on Github or the db.
    It is useful for:
    ...
    def __init__(self, repo_path: str, default_branch: str, bot_commit: bool = ..., repo_config: BaseRepoConfig = ...) -> None:
        ...
    ...
    @override
    def validate_and_push_changes(self, db: Session, remote: Remote | None = ..., refspec: str | None = ..., force: bool = ...):
        ...
    
    @override
    def push_changes(self, remote: Remote | None = ..., refspec: str | None = ..., force: bool = ...):
        ...
