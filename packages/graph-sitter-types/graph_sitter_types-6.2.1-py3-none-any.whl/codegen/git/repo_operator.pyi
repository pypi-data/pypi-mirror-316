...
class RepoOperator(ABC):
    ...
    bot_commit: bool = ...
    def __init__(self, config: BaseRepoConfig, base_dir: str = ..., bot_commit: bool = ...) -> None:
        ...
    ...
    @abstractmethod
    def validate_and_push_changes(self, db: Session, remote: Remote | None = ..., refspec: str | None = ..., force: bool = ...): # -> None:
        """Validates permission to push changes based on branch before pushing changes to the remote."""
        ...
    
    @abstractmethod
    def push_changes(self, remote: Remote | None = ..., refspec: str | None = ..., force: bool = ...): # -> None:
    ...
    def iter_files(self, subdirs: list[str] | None = ..., extensions: list[str] | None = ..., ignore_list: list[str] | None = ...) -> Generator[tuple[str, str]]:
        ...
        ----
            ...
            codeowners (list[str], optional): List of codeowners to iter files for. Defaults to None. Ex: if codeowners=["@suma"], only files owned by @suma will be included.
