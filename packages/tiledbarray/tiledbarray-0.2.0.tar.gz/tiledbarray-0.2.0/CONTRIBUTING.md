...
Welcome to `tiledbarray` contributor's guide.
...
If you experience bugs or general issues with `tiledbarray`, please have a look
...
You can help improve `tiledbarray` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`tiledbarray` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `tiledbarray`'s files. While this mechanism can
...
```
conda create -n tiledbarray python=3 six virtualenv pytest pytest-cov
conda activate tiledbarray
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/tiledbarray.git
   cd tiledbarray
   ```
...
5. Install [pre-commit]:
   ...
   `tiledbarray` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/tiledbarray
[issue tracker]: https://github.com/<USERNAME>/tiledbarray/issues
