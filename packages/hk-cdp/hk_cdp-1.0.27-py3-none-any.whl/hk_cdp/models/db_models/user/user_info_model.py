...
@LastEditTime: 2024-11-21 14:56:39
...
class UserInfo:
    ...
    def get_field_list(cls):
        return [
            'id', 'user_id', 'user_nick', 'avatar', 'business_id', 'store_id', 'platform_id', 'one_id','omid', 'ouid', 'telephone', 'encrypt_telephone', 'new_telephone', 'one_id_telephone', 'one_id_encrypt_telephone',
