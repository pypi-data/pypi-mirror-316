...
@LastEditTime: 2024-11-22 16:56:44
...
class AssetBaseModel():
    ...
    def update_member_asset(self,
        ...
        try:
            ...
            if old_user_asset_id != 0:
                member_asset_model.update_entity(member_asset, "asset_value,asset_check_code,modify_date")
            else:
    ...
    def get_member_asset_list(self, one_ids, business_id, asset_type=0):
        ...
        member_asset_model = MemberAssetModel(db_config_dict=self.db_config_dict, context=self.context).set_sub_table(str(asset_type))
    ...
    def get_asset_log_list(self,
        ...
        member_asset_log_model = MemberAssetLogModel(db_config_dict=self.db_config_dict,context=self.context).set_sub_table(str(asset_type))
