...
from .FefferyGithubColorPicker import FefferyGithubColorPicker as GithubColorPicker
from .FefferyHexColorPicker import FefferyHexColorPicker as HexColorPicker
