...
- loading_state (dict; optional)
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, key=Component.UNDEFINED, detectInterval=Component.UNDEFINED, strategy=Component.UNDEFINED, jsString=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'key', 'detectInterval', 'strategy', 'jsString', 'loading_state']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'key', 'detectInterval', 'strategy', 'jsString', 'loading_state']
