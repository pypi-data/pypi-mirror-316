...
class ListCertificatesResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def certificates(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.iam.v1.saml.certificate_pb2.Certificate]:
        """List of certificates."""

    def __init__(
        self,
        *,
        certificates: collections.abc.Iterable[yandex.cloud.iam.v1.saml.certificate_pb2.Certificate] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
