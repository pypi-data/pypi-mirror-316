...
from datasphere.yandex.cloud.iam.v1.awscompatibility import access_key_service_pb2 as yandex_dot_cloud_dot_iam_dot_v1_dot_awscompatibility_dot_access__key__service__pb2
