...
from datasphere.yandex.cloud.datasphere.v2 import community_service_pb2 as yandex_dot_cloud_dot_datasphere_dot_v2_dot_community__service__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in yandex/cloud/datasphere/v2/community_service_pb2_grpc.py depends on'
