...
from datasphere.yandex.cloud.iam.v1.workload.oidc import federation_service_pb2 as yandex_dot_cloud_dot_iam_dot_v1_dot_workload_dot_oidc_dot_federation__service__pb2
