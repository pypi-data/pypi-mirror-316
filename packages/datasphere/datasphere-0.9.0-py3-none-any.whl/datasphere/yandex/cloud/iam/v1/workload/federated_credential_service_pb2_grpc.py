...
from datasphere.yandex.cloud.iam.v1.workload import federated_credential_service_pb2 as yandex_dot_cloud_dot_iam_dot_v1_dot_workload_dot_federated__credential__service__pb2
