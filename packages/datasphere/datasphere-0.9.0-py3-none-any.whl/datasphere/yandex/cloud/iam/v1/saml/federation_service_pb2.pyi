...
import datasphere.yandex.cloud.iam.v1.user_account_pb2
...
class ListFederationsResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def federations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.iam.v1.saml.federation_pb2.Federation]:
        """List of federations."""

    def __init__(
        self,
        *,
        federations: collections.abc.Iterable[yandex.cloud.iam.v1.saml.federation_pb2.Federation] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class CreateFederationRequest(google.protobuf.message.Message):
    ...
    """
    sso_binding: yandex.cloud.iam.v1.saml.federation_pb2.BindingType.ValueType
    ...
    @property
    def security_settings(self) -> yandex.cloud.iam.v1.saml.federation_pb2.FederationSecuritySettings:
    ...
    def __init__(
        ...
        *,
        ...
        sso_binding: yandex.cloud.iam.v1.saml.federation_pb2.BindingType.ValueType = ...,
        sso_url: builtins.str = ...,
        security_settings: yandex.cloud.iam.v1.saml.federation_pb2.FederationSecuritySettings | None = ...,
        case_insensitive_name_ids: builtins.bool = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["auto_create_account_on_login", b"auto_create_account_on_login", "case_insensitive_name_ids", b"case_insensitive_name_ids", "cookie_max_age", b"cookie_max_age", "description", b"description", "folder_id", b"folder_id", "issuer", b"issuer", "name", b"name", "security_settings", b"security_settings", "sso_binding", b"sso_binding", "sso_url", b"sso_url"]) -> None: ...
...
class AddFederatedUserAccountsResponse(google.protobuf.message.Message):
    ...
    @property
    def user_accounts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.iam.v1.user_account_pb2.UserAccount]:
        """List of users created by [FederationService.AddUserAccounts] request."""

    def __init__(
        self,
        *,
        user_accounts: collections.abc.Iterable[yandex.cloud.iam.v1.user_account_pb2.UserAccount] | None = ...,
    ) -> None: ...
