...
router.register(r"qualification_levels", api.QualificationLevelViewSet)
...
urlpatterns += [
    ...
    path(
        ...
        shadowing_verification.create_shadowing_verification_request,
        name="create_shadowing_verification",
    ),
    path(
        "edit_shadowing_verification/<int:request_id>/",
        shadowing_verification.create_shadowing_verification_request,
        name="edit_shadowing_verification",
    ),
    path("export_shadowing_verification/", shadowing_verification.csv_export, name="export_shadowing_verification"),
    path(
        "delete_shadowing_verification/<int:request_id>/",
        shadowing_verification.delete_shadowing_verification_request,
        name="delete_shadowing_verification",
    ),
    # Tasks:
    ...
    path("calendar/create_training_event/", calendar.create_training_event, name="create_training_event_calendar"),
    ...
    path("calendar/resize_training_event/", calendar.resize_training_event, name="resize_training_event"),
    ...
    path("calendar/move_training_event/", calendar.move_training_event, name="move_training_event"),
    ...
    path(
        "event_details/training/<int:training_id>/", event_details.training_event_details, name="training_event_details"
    ),
    # Qualifications:
    ...
    path(
        "validate_charge/<int:item_type_id>/<int:item_id>/", charge_validation.validate_charge, name="validate_charge"
    ),
    # Status dashboard:
    ...
    path(
        ...
        include(
            [
                path("requests/", training_new.requests, name="training_requests"),
                path(
                    "requests/<int:training_request_id>/withdraw/",
                    training_new.withdraw_request,
                    name="withdraw_training_request",
                ),
                path(
                    "requests/<int:training_request_id>/review/",
                    training_new.review_request,
                    name="review_training_request",
                ),
                path(
                    "requests/<int:training_request_id>/decline/",
                    training_new.decline_request,
                    name="decline_training_request",
                ),
                path("requests/create/", training_new.create_request, name="create_training_request"),
                path(
                    "requests/create/<int:tool_id>/",
                    training_new.create_request,
                    name="create_training_request_for_tool",
                ),
                path(
                    "invitations/<int:training_invitation_id>/accept/",
                    training_new.accept_invitation,
                    name="accept_training_invitation",
                ),
                path(
                    "invitations/<int:training_invitation_id>/decline/",
                    training_new.decline_invitation,
                    name="decline_training_invitation",
                ),
                path(
                    "invitations/<int:training_invitation_id>/review/",
                    training_new.review_invitation,
                ...
                path(
                    "events/create/tool/<int:tool_id>/",
                    training_new.create_event,
                    name="create_training_event_for_tool",
                ),
                path(
                    "events/create/time/<int:request_time_id>/",
                    training_new.create_event,
                    name="create_training_event_for_time",
                ),
                path(
                    "events/create/request/<int:training_request_id>/",
                    training_new.create_event,
                    name="create_training_event_for_training_request",
                ),
                path("events/<int:training_event_id>/edit/", training_new.create_event, name="edit_training_event"),
                path(
                    "events/<int:training_event_id>/cancel/", training_new.cancel_training, name="cancel_training_event"
                ),
                path(
                    "events/<int:training_event_id>/register/",
                    training_new.register_for_training,
