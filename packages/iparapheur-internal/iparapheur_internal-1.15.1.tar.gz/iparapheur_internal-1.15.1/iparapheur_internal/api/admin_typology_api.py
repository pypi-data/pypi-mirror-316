...
class AdminTypologyApi:
    ...
    def get_typology_hierarchy(
        ...
        collapse_all: Annotated[Optional[StrictBool], Field(description="Collapse (or expand) subtypes in the tree hierarchy.")] = None,
        ...
        search_term: Annotated[Optional[StrictStr], Field(description="Searching for a specific typology name")] = None,
        ...
        Sorting properties are restricted to: NAME

        :param tenant_id: Tenant id (required)
        :type tenant_id: str
        :param collapse_all: Collapse (or expand) subtypes in the tree hierarchy.
        ...
        :type sort: List[str]
        :param search_term: Searching for a specific typology name
        ...
        _param = self._get_typology_hierarchy_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_typology_hierarchy_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        collapse_all: Annotated[Optional[StrictBool], Field(description="Collapse (or expand) subtypes in the tree hierarchy.")] = None,
        reverse_id_list: Annotated[Optional[List[StrictStr]], Field(description="Reversed ID list. * If `collapseAll` is `true`, children of given desk IDs will be retrieved. * If `collapseAll` is `false`, children of given desk IDs won't be retrieved. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageTypologyRepresentation]:
        """Get typology list, sorted by hierarchy.
    ...
    @validate_call
    def get_typology_hierarchy_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant id")],
        collapse_all: Annotated[Optional[StrictBool], Field(description="Collapse (or expand) subtypes in the tree hierarchy.")] = None,
        reverse_id_list: Annotated[Optional[List[StrictStr]], Field(description="Reversed ID list. * If `collapseAll` is `true`, children of given desk IDs will be retrieved. * If `collapseAll` is `false`, children of given desk IDs won't be retrieved. ")] = None,
    ...
    def _get_typology_hierarchy_serialize(
        self,
        tenant_id,
        collapse_all,
        reverse_id_list,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/internal/admin/tenant/{tenantId}/typology',
