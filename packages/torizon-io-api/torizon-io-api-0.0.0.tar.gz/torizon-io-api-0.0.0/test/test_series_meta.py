...
class TestSeriesMeta(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SeriesMeta:
        """Test SeriesMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesMeta`
        """
        model = SeriesMeta()
        if include_optional:
            return SeriesMeta(
