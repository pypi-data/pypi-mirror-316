...
class TestJsonSignedPayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonSignedPayload:
        """Test JsonSignedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonSignedPayload`
        """
        model = JsonSignedPayload()
        if include_optional:
    ...
    def testJsonSignedPayload(self):
        """Test JsonSignedPayload"""
