...
class TestBadRequestRepr(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BadRequestRepr:
        """Test BadRequestRepr
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadRequestRepr`
        """
        model = BadRequestRepr()
        if include_optional:
            return BadRequestRepr(
                msg = '',
                description = None,
                code = '',
                cause = None,
