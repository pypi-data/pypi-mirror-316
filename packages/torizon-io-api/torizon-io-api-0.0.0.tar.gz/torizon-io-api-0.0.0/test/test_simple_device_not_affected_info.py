...
class TestSimpleDeviceNotAffectedInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleDeviceNotAffectedInfo:
        """Test SimpleDeviceNotAffectedInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDeviceNotAffectedInfo`
        """
        model = SimpleDeviceNotAffectedInfo()
        if include_optional:
            return SimpleDeviceNotAffectedInfo(
                device_uuid = '',
                device_id = '',
                name = '',
                ecu_errors = {
    ...
    def testSimpleDeviceNotAffectedInfo(self):
        """Test SimpleDeviceNotAffectedInfo"""
