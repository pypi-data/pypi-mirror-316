...
class TestPaginationResultFleet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginationResultFleet:
        """Test PaginationResultFleet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationResultFleet`
        """
        model = PaginationResultFleet()
        if include_optional:
    ...
    def testPaginationResultFleet(self):
        """Test PaginationResultFleet"""
