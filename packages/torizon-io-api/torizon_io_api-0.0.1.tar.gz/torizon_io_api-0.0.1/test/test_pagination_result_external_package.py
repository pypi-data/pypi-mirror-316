...
class TestPaginationResultExternalPackage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginationResultExternalPackage:
        """Test PaginationResultExternalPackage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationResultExternalPackage`
        """
        model = PaginationResultExternalPackage()
        if include_optional:
    ...
    def testPaginationResultExternalPackage(self):
        """Test PaginationResultExternalPackage"""
