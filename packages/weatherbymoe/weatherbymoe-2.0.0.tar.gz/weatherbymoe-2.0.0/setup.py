...
setup(
    name='weatherbymoe',  # Your package will have this name
    packages=['weatherbymoe'],  # Name the package again
    ...
    author='Moe ElTahech',  # Your name
    author_email='Mohamed.tahech10@outlook.com',  # Your email
    url='https://github.com/MoeTahech',  # Homepage of your library (e.g. github or your website)
