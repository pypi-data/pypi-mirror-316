...
/* harmony import */ var _pallettes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pallettes */ "./lib/pallettes/dark-pallette-setter.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./lib/utils.js");




(0,_utils__WEBPACK_IMPORTED_MODULE_1__.initiAppFaviconAndTitle)();
/**
...
const plugin = {
    ...
    activate: (app, manager) => {
        ...
        const pallettesSetters = [
            ...
            _pallettes__WEBPACK_IMPORTED_MODULE_4__.DarkPalletteSetter
        ];
...
class LightPalletteSetter {
    ...
    setColorPallette() {
        ...
        document.documentElement.style.setProperty('--jp-layout-color3', '--md-grey-400');
...
/* harmony export */ });
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./configuration */ "./lib/configuration.js");
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons */ "./lib/icons.js");
/* harmony import */ var _style_apple_touch_icon_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../style/apple-touch-icon.png */ "./style/apple-touch-icon.png");
/* harmony import */ var _style_favicon_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../style/favicon.png */ "./style/favicon.png");
...
const initiAppFaviconAndTitle = () => {
    ...
    linkIcon.href = _style_favicon_png__WEBPACK_IMPORTED_MODULE_0__;
    linkIcon.setAttribute('sizes', '32x32');
    head.appendChild(linkIcon);
    const linkShortCut = document.createElement('link');
    linkShortCut.rel = 'shortcut icon';
    linkShortCut.type = 'image/png';
    linkShortCut.href = _style_favicon_png__WEBPACK_IMPORTED_MODULE_0__;
    ...
    linkAppleTouch.href = _style_apple_touch_icon_png__WEBPACK_IMPORTED_MODULE_1__;
    linkAppleTouch.setAttribute('sizes', '180x180');
    head.appendChild(linkAppleTouch);
    const svgDataUrl = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(_icons__WEBPACK_IMPORTED_MODULE_2__.Icons.CGILogo)}`;
    ...
    Object.defineProperty(document, 'title', {
        set(_arg) {
            ...
            )) === null || _a === void 0 ? void 0 : _a.set) === null || _b === void 0 ? void 0 : _b.call(document, _configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.appName);
        },
        configurable: true
    });
};
    ...
    try {
        ...
        if (userData) {
            ...
            if (user && user.name) {
                ...
                if (_configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.header.insulaAppsMenuLinks) {
                    const icon1 = document.createElement('span');
                    icon1.innerHTML = _icons__WEBPACK_IMPORTED_MODULE_2__.Icons.AppsIcon;
                    icon1.id = 'insulaAppsMenuLinks';
                    icon1.addEventListener('click', () => {
                        showHeaderMenu(_configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.header.insulaAppsMenuLinks, icon1.id, true);
                    });
                    iconsContainerEl.appendChild(icon1);
                }
                if (_configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.header.otherInfoMenuLinks) {
                    const icon2 = document.createElement('span');
                    icon2.innerHTML = _icons__WEBPACK_IMPORTED_MODULE_2__.Icons.InfoIcon;
                    icon2.id = 'otherInfoMenuLinks';
                    icon2.addEventListener('click', () => {
                        showHeaderMenu(_configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.header.otherInfoMenuLinks, icon2.id, false);
                    });
                ...
                iconEl.innerHTML = _icons__WEBPACK_IMPORTED_MODULE_2__.Icons.UserIcon;
...
const initAppLogo = () => {
    ...
    logoSectionEL.forEach(el => {
        if (el) {
            ...
            spanEl.innerHTML = _configuration__WEBPACK_IMPORTED_MODULE_3__.appConfig.appName;
    ...
    if (currentOpenMenuId) {
        ...
        if (menuDivEl && menuDivEl.style.display !== 'none') {
            if (!menuDivEl.contains(event.target) &&
                !((_a = document
                    .getElementById('cgi-header-container')) === null || _a === void 0 ? void 0 : _a.contains(event.target))) {
...
//# sourceMappingURL=lib_index_js.c6a4d41132a17819e1b7.js.map