...
__all__ = ['ArmCommandBuilder', 'ArmCommandFeedback', 'BatteryInfo', 'BatteryState', 'BodyCommandBuilder', 'BodyCommandFeedback', 'BodyComponentBasedCommandBuilder', 'BodyComponentBasedCommandFeedback', 'CartesianCommandBuilder', 'CartesianCommandFeedback', 'CommandFeedback', 'CommandHeaderBuilder', 'CommandHeaderFeedback', 'ComponentBasedCommandBuilder', 'ComponentBasedCommandFeedback', 'ControlManagerState', 'EMOInfo', 'EMOState', 'FTSensorData', 'Feedback', 'GravityCompensationCommandBuilder', 'GravityCompensationCommandFeedback', 'HeadCommandBuilder', 'HeadCommandFeedback', 'ImpedanceControlCommandBuilder', 'ImpedanceControlCommandFeedback', 'JogCommandBuilder', 'JogCommandFeedback', 'JointInfo', 'JointPositionCommandBuilder', 'JointPositionCommandFeedback', 'JointState', 'JointVelocityCommandBuilder', 'JointVelocityCommandFeedback', 'Log', 'MobilityCommandBuilder', 'MobilityCommandFeedback', 'Model_A', 'OptimalControlCommandBuilder', 'OptimalControlCommandFeedback', 'PIDGain', 'PowerInfo', 'PowerState', 'RobotCommandBuilder', 'RobotCommandFeedback', 'RobotInfo', 'RobotState_A', 'Robot_A', 'Robot_A_CommandHandler', 'Robot_A_CommandStreamHandler', 'Robot_A_ControlInput', 'Robot_A_ControlState', 'SE2VelocityCommandBuilder', 'SE2VelocityCommandFeedback', 'StopCommandBuilder', 'StopCommandFeedback', 'SystemStat', 'ToolFlangeState', 'TorsoCommandBuilder', 'TorsoCommandFeedback', 'WholeBodyCommandBuilder', 'WholeBodyCommandFeedback', 'create_robot', 'create_robot_a', 'dynamics']
...
class CartesianCommandBuilder:
    ...
    def add_joint_position_target(self, joint_name: str, target_position: float, velocity_limit: float | None = None, acceleration_limit: float | None = None) -> CartesianCommandBuilder:
        ...
    def add_target(self, arg0: str, arg1: str, arg2: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], arg3: float, arg4: float, arg5: float) -> CartesianCommandBuilder:
        ...
...
class ImpedanceControlCommandBuilder:
    ...
    def set_reference_link_name(self, arg0: str) -> ImpedanceControlCommandBuilder:
        ...
    def set_rotation_weight(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> ImpedanceControlCommandBuilder:
        ...
    def set_transformation(self, arg0: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> ImpedanceControlCommandBuilder:
        ...
    def set_translation_weight(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> ImpedanceControlCommandBuilder:
        ...
...
class JointPositionCommandBuilder:
    def __init__(self) -> None:
        ...
    def set_acceleration_limit(self, arg0: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> JointPositionCommandBuilder:
        ...
    ...
    def set_minimum_time(self, arg0: float) -> JointPositionCommandBuilder:
        ...
    def set_position(self, arg0: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> JointPositionCommandBuilder:
        ...
    def set_velocity_limit(self, arg0: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> JointPositionCommandBuilder:
        ...
...
class JointState:
    ...
    class InitializationState:
        ...
        __members__: typing.ClassVar[dict[str, JointState.InitializationState]]  # value = {'Unknown': <InitializationState.Unknown: 0>, 'kInitialized': <InitializationState.kInitialized: 1>, 'kUninitialized': <InitializationState.kUninitialized: 2>}
        kInitialized: typing.ClassVar[JointState.InitializationState]  # value = <InitializationState.kInitialized: 1>
        kUninitialized: typing.ClassVar[JointState.InitializationState]  # value = <InitializationState.kUninitialized: 2>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
...
class JointVelocityCommandBuilder:
    def __init__(self) -> None:
        ...
    def set_acceleration_limit(self, arg0: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> JointVelocityCommandBuilder:
        ...
    ...
    def set_minimum_time(self, arg0: float) -> JointVelocityCommandBuilder:
        ...
    def set_velocity(self, arg0: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> JointVelocityCommandBuilder:
        ...
...
class OptimalControlCommandBuilder:
    def __init__(self) -> None:
        ...
    def add_cartesian_target(self, arg0: str, arg1: str, arg2: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], arg3: float, arg4: float) -> OptimalControlCommandBuilder:
        ...
    def add_joint_position_target(self, arg0: str, arg1: float, arg2: float) -> OptimalControlCommandBuilder:
        ...
    def set_center_of_mass_target(self, arg0: str, arg1: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], arg2: float) -> OptimalControlCommandBuilder:
        ...
...
class SE2VelocityCommandBuilder:
    def __init__(self) -> None:
        ...
    def set_acceleration_limit(self, arg0: numpy.ndarray[tuple[typing.Literal[2], typing.Literal[1]], numpy.dtype[numpy.float64]], arg1: float) -> SE2VelocityCommandBuilder:
        ...
    ...
    def set_minimum_time(self, arg0: float) -> SE2VelocityCommandBuilder:
        ...
    def set_velocity(self, arg0: numpy.ndarray[tuple[typing.Literal[2], typing.Literal[1]], numpy.dtype[numpy.float64]], arg1: float) -> SE2VelocityCommandBuilder:
        ...
...
class WholeBodyCommandFeedback(CommandFeedback):
    ...
    def stop_command(self) -> StopCommandFeedback:
        ...
def create_robot(model: typing.Any, address: str) -> typing.Any:
    """
