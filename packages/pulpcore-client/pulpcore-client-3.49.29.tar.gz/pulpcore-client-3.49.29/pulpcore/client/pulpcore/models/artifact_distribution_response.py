...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, hidden=False, pulp_last_updated=None, base_url=None, name=None, base_path=None, pulp_labels=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
