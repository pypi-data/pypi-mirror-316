...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/powerlogic/idl/PowerLogicConfig.idl"
#
...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/powerlogic/idl/PowerLogicPowerMeter.idl"
#
...
class PowerMeter(raritan.rpc.modbus.Device):
    idlType = "powerlogic.PowerMeter:1.2.4"

    # structure
    class MinMaxReading(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.MinMaxReading:1.0.0"
    ...
    class L2N_N_Avg(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2N_N_Avg:1.0.0"
    ...
    class L2L_Avg(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2L_Avg:1.0.0"
    ...
    class L2N_Avg(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2N_Avg:1.0.0"
    ...
    # structure
    class L2N(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2N:1.0.0"
        elements = ["l1", "l2", "l3"]
    ...
    # structure
    class L2L(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2L:1.0.0"
    ...
    class L2N_plain_total(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.L2N_plain_total:1.0.0"
    ...
    class Sensors(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.Sensors:1.0.0"
    ...
    class Setup(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.Setup:1.0.0"
    ...
    class ErrorStatus(Structure):
        idlType = "powerlogic.PowerMeter_1_2_4.ErrorStatus:1.0.0"
    ...
    class SetupChangedEvent(raritan.rpc.idl.Event):
        idlType = "powerlogic.PowerMeter_1_2_4.SetupChangedEvent:1.0.0"
    ...
    class ErrorStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "powerlogic.PowerMeter_1_2_4.ErrorStatusChangedEvent:1.0.0"
