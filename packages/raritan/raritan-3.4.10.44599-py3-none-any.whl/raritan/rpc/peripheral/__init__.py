...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/peripheral/idl/PeripheralDeviceSlot.idl"
#
...
class DeviceID(Structure):
    idlType = "peripheral.DeviceID:3.0.1"
...
class Address(Structure):
    idlType = "peripheral.Address:3.0.1"
...
class Device(ValueObject):
    idlType = "peripheral.Device:3.0.1"
...
class DeviceSlot(Interface):
    idlType = "peripheral.DeviceSlot:2.0.2"
    ...
    class Location(Structure):
        idlType = "peripheral.DeviceSlot_2_0_2.Location:1.0.0"
        elements = ["x", "y", "z"]
    ...
    class Settings(Structure):
        idlType = "peripheral.DeviceSlot_2_0_2.Settings:1.0.0"
    ...
    class DeviceChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceSlot_2_0_2.DeviceChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceSlot_2_0_2.SettingsChangedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/peripheral/idl/PeripheralDevicePackage.idl"
#
...
class Package(Interface):
    idlType = "peripheral.Package:1.0.0"
...
class DoorHandleControllerPackage(Package):
    idlType = "peripheral.DoorHandleControllerPackage:1.0.0"
...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/peripheral/idl/PeripheralDeviceManager.idl"
#
...
class DeviceManager(Interface):
    idlType = "peripheral.DeviceManager:3.0.0"

    ERR_INVALID_PARAMS = 1

    # enumeration
    class ZCoordMode(Enumeration):
        idlType = "peripheral.DeviceManager_3_0_0.ZCoordMode:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "peripheral.DeviceManager_3_0_0.Settings:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "peripheral.DeviceManager_3_0_0.MetaData:1.0.0"
    ...
    class DeviceTypeInfo(Structure):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceTypeInfo:1.0.0"
    ...
    class FirmwareUpdateState(Structure):
        idlType = "peripheral.DeviceManager_3_0_0.FirmwareUpdateState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceManager_3_0_0.SettingsChangedEvent:1.0.0"
    ...
    class DeviceEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceEvent:2.0.0"
    ...
    class DeviceAddedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_3_0_0.DeviceEvent_2_0_0
                devices = [ValueObject.decode(x0, agent) for x0 in json['devices']],
                allDevices = [ValueObject.decode(x0, agent) for x0 in json['allDevices']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class DeviceRemovedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceRemovedEvent:2.0.0"
    ...
    class UnknownDeviceAttachedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_0.UnknownDeviceAttachedEvent:1.0.0"
    ...
    class DeviceFirmwareUpdateState(Enumeration):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceFirmwareUpdateState:1.0.0"
    ...
    class DeviceFirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_0.DeviceFirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class FirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_0.FirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class PackageEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_0.PackageEvent:2.0.0"
    ...
    class PackageAddedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_3_0_0.PackageAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_3_0_0.PackageEvent_2_0_0
                packageInfos = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['packageInfos']],
                allPackages = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['allPackages']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class PackageRemovedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_3_0_0.PackageRemovedEvent:2.0.0"
    ...
    class Statistics(Structure):
        idlType = "peripheral.DeviceManager_3_0_0.Statistics:1.0.0"
        elements = ["cSumErrCnt"]
...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/peripheral/idl/PeripheralG2Production.idl"
#
