...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/cardreader/idl/CardReader.idl"
#
...
class CardReader(Interface):
    idlType = "smartcard.CardReader:1.0.1"
    ...
    class MetaData(Structure):
        idlType = "smartcard.CardReader_1_0_1.MetaData:1.0.0"
        elements = ["manufacturer", "product", "serialNumber", "channel"]

        def __init__(self, manufacturer, product, serialNumber, channel):
    ...
    class CardInformation(Structure):
        idlType = "smartcard.CardReader_1_0_1.CardInformation:1.0.0"
        elements = ["type", "uid"]
    ...
    class CardEvent(raritan.rpc.idl.Event):
        idlType = "smartcard.CardReader_1_0_1.CardEvent:1.0.0"
    ...
    class CardInsertedEvent(CardEvent):
        idlType = "smartcard.CardReader_1_0_1.CardInsertedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for smartcard.CardReader_1_0_1.CardEvent
                cardInfo = raritan.rpc.smartcard.CardReader.CardInformation.decode(json['cardInfo'], agent),
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
    ...
    class CardRemovedEvent(CardEvent):
        idlType = "smartcard.CardReader_1_0_1.CardRemovedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/cardreader/idl/CardReaderManager.idl"
#
...
class CardReaderManager(Interface):
    idlType = "smartcard.CardReaderManager:1.0.1"

    # value object
    class CardReaderEvent(raritan.rpc.idl.Event):
        idlType = "smartcard.CardReaderManager_1_0_1.CardReaderEvent:1.0.0"
    ...
    class CardReaderAttachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_1.CardReaderAttachedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for smartcard.CardReaderManager_1_0_1.CardReaderEvent
                cardReader = Interface.decode(json['cardReader'], agent),
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
    ...
    class CardReaderDetachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_1.CardReaderDetachedEvent:1.0.0"
