...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/Sensor.idl"
#
...
class Sensor(Interface):
    ...
    class OnOffState(Enumeration):
        idlType = "sensors.Sensor_4_0_2.OnOffState:1.0.0"
        values = ["OFF", "ON"]
    ...
    class OpenClosedState(Enumeration):
        idlType = "sensors.Sensor_4_0_2.OpenClosedState:1.0.0"
        values = ["OPEN", "CLOSED"]
    ...
    class NormalAlarmedState(Enumeration):
        idlType = "sensors.Sensor_4_0_2.NormalAlarmedState:1.0.0"
    ...
    class OkFaultState(Enumeration):
        idlType = "sensors.Sensor_4_0_2.OkFaultState:1.0.0"
        values = ["OK", "FAULT"]
    ...
    class TypeSpec(Structure):
        idlType = "sensors.Sensor_4_0_2.TypeSpec:1.0.0"
    ...
    class TypeSpecChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Sensor_4_0_2.TypeSpecChangedEvent:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/AlertedSensorManager.idl"
#
...
class AlertedSensorManager(Interface):
    idlType = "sensors.AlertedSensorManager:1.0.0"

    # enumeration
    class AlertState(Enumeration):
        idlType = "sensors.AlertedSensorManager.AlertState:1.0.0"
    ...
    class SensorCounts(Structure):
        idlType = "sensors.AlertedSensorManager.SensorCounts:1.0.0"
    ...
    class SensorData(Structure):
        idlType = "sensors.AlertedSensorManager.SensorData:1.0.0"
    ...
    class MonitoredSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager.MonitoredSensorsChangedEvent:1.0.0"
    ...
    class AlertedSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager.AlertedSensorsChangedEvent:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/NumericSensor.idl"
#
...
class NumericSensor(Sensor):
    idlType = "sensors.NumericSensor:4.0.2"
    ...
    class Range(Structure):
        idlType = "sensors.NumericSensor_4_0_2.Range:1.0.0"
    ...
    class ThresholdCapabilities(Structure):
        idlType = "sensors.NumericSensor_4_0_2.ThresholdCapabilities:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "sensors.NumericSensor_4_0_2.MetaData:1.0.0"
    ...
    class Thresholds(Structure):
        idlType = "sensors.NumericSensor_4_0_2.Thresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "sensors.NumericSensor_4_0_2.Reading:1.0.0"
        ...
        class Status(Structure):
            idlType = "sensors.NumericSensor_4_0_2.Reading.Status:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_2.ReadingChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_2.StateChangedEvent:1.0.0"
    ...
    class MetaDataChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_2.MetaDataChangedEvent:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_2.ThresholdsChangedEvent:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/StateSensor.idl"
#
...
class StateSensor(Sensor):
    idlType = "sensors.StateSensor:4.0.2"

    # structure
    class State(Structure):
        idlType = "sensors.StateSensor_4_0_2.State:1.0.0"
    ...
    # value object
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.StateSensor_4_0_2.StateChangedEvent:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/SensorLogger.idl"
#
...
class Logger(Interface):
    idlType = "sensors.Logger:2.1.5"

    # structure
    class Settings(Structure):
        idlType = "sensors.Logger_2_1_5.Settings:1.0.0"
    ...
    class SensorSet(Structure):
        idlType = "sensors.Logger_2_1_5.SensorSet:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_1_5.SettingsChangedEvent:1.0.0"
    ...
    class LoggedSensorsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_1_5.LoggedSensorsChangedEvent:1.0.0"
    ...
    class Record(Structure):
        idlType = "sensors.Logger_2_1_5.Record:1.0.0"
    ...
    class TimedRecord(Structure):
        idlType = "sensors.Logger_2_1_5.TimedRecord:1.0.0"
    ...
    class LogRow(Structure):
        idlType = "sensors.Logger_2_1_5.LogRow:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/AccumulatingNumericSensor.idl"
#
...
class AccumulatingNumericSensor(NumericSensor):
    idlType = "sensors.AccumulatingNumericSensor:2.0.2"

    # value object
    class ResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.AccumulatingNumericSensor_2_0_2.ResetEvent:1.0.0"
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/Switch.idl"
#
...
class Switch(StateSensor):
    ...
    class SwitchEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Switch_2_0_4.SwitchEvent:1.0.0"
