...
#
# Section generated from "/home/builds/gitlab/builds/9885d43b/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/DateTime.idl"
#
...
class DateTime(Interface):
    idlType = "datetime.DateTime:3.0.1"

    # structure
    class ZoneInfo(Structure):
        idlType = "datetime.DateTime_3_0_1.ZoneInfo:1.0.0"
    ...
    class ZoneCfg(Structure):
        idlType = "datetime.DateTime_3_0_1.ZoneCfg:1.0.0"
    ...
    class Protocol(Enumeration):
        idlType = "datetime.DateTime_3_0_1.Protocol:1.0.0"
        values = ["STATIC", "NTP"]
    ...
    class NtpCfg(Structure):
        idlType = "datetime.DateTime_3_0_1.NtpCfg:1.0.0"
    ...
    # structure
    class Cfg(Structure):
        idlType = "datetime.DateTime_3_0_1.Cfg:1.0.0"
