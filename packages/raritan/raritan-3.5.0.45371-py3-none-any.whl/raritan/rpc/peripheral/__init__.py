...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/PeripheralDeviceSlot.idl"
#
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/PeripheralDevicePackage.idl"
#
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/PeripheralDeviceManager.idl"
#
...
class DeviceManager(Interface):
    idlType = "peripheral.DeviceManager:3.0.1"

    ERR_INVALID_PARAMS = 1

    # enumeration
    class ZCoordMode(Enumeration):
        idlType = "peripheral.DeviceManager_3_0_1.ZCoordMode:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "peripheral.DeviceManager_3_0_1.Settings:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "peripheral.DeviceManager_3_0_1.MetaData:1.0.0"
    ...
    class DeviceTypeInfo(Structure):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceTypeInfo:1.0.0"
    ...
    class FirmwareUpdateState(Structure):
        idlType = "peripheral.DeviceManager_3_0_1.FirmwareUpdateState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceManager_3_0_1.SettingsChangedEvent:1.0.0"
    ...
    class DeviceEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceEvent:2.0.0"
    ...
    class DeviceAddedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_3_0_1.DeviceEvent_2_0_0
                devices = [ValueObject.decode(x0, agent) for x0 in json['devices']],
                allDevices = [ValueObject.decode(x0, agent) for x0 in json['allDevices']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class DeviceRemovedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceRemovedEvent:2.0.0"
    ...
    class UnknownDeviceAttachedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_1.UnknownDeviceAttachedEvent:1.0.0"
    ...
    class DeviceFirmwareUpdateState(Enumeration):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceFirmwareUpdateState:1.0.0"
    ...
    class DeviceFirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_1.DeviceFirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class FirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_1.FirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class PackageEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_3_0_1.PackageEvent:2.0.0"
    ...
    class PackageAddedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_3_0_1.PackageAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_3_0_1.PackageEvent_2_0_0
                packageInfos = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['packageInfos']],
                allPackages = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['allPackages']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class PackageRemovedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_3_0_1.PackageRemovedEvent:2.0.0"
    ...
    class Statistics(Structure):
        idlType = "peripheral.DeviceManager_3_0_1.Statistics:1.0.0"
        elements = ["cSumErrCnt"]
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/PeripheralG2Production.idl"
#
