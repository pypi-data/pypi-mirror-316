...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/Fitness.idl"
#
...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/install_root/share/idl/HardwareHealth.idl"
#
...
class HardwareHealth(Interface):
    idlType = "fitness.HardwareHealth:1.0.0"
    ...
    class Failure(Structure):
        idlType = "fitness.HardwareHealth.Failure:1.0.0"
        elements = ["componentId", "type", "description", "isAsserted", "lastAssertTimeStamp", "lastDeassertTimeStamp", "assertCount"]

        def __init__(self, componentId, type, description, isAsserted, lastAssertTimeStamp, lastDeassertTimeStamp, assertCount):
    ...
    class FailureStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "fitness.HardwareHealth.FailureStatusChangedEvent:1.0.0"
