...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.3.x-branch-20160831-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libisys/src/idl/DateTime.idl"
#
...
class DateTime(Interface):
    idlType = "datetime.DateTime:3.0.0"

    # structure
    class ZoneInfo(Structure):
        idlType = "datetime.DateTime_3_0_0.ZoneInfo:1.0.0"
    ...
    class ZoneCfg(Structure):
        idlType = "datetime.DateTime_3_0_0.ZoneCfg:1.0.0"
    ...
    class Protocol(Enumeration):
        idlType = "datetime.DateTime_3_0_0.Protocol:1.0.0"
        values = ["STATIC", "NTP"]
    ...
    class NtpCfg(Structure):
        idlType = "datetime.DateTime_3_0_0.NtpCfg:1.0.0"
    ...
    # structure
    class Cfg(Structure):
        idlType = "datetime.DateTime_3_0_0.Cfg:1.0.0"
