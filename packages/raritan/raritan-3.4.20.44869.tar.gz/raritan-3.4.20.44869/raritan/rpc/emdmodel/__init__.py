...
#
# Section generated from "/home/builds/gitlab/builds/1da4124e/0/gitlab/main/firmware/mkdist/tmp/build-pdu-px2-final/libidl_client/topofw/emd/idl/Emd.idl"
#
...
# interface
class Emd(Interface):
    idlType = "emdmodel.Emd:2.2.6"

    ERR_INVALID_PARAMS = 1

    # structure
    class MetaData(Structure):
        idlType = "emdmodel.Emd_2_2_6.MetaData:1.0.0"
    ...
    class Settings(Structure):
        idlType = "emdmodel.Emd_2_2_6.Settings:1.0.0"
        elements = ["name"]
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "emdmodel.Emd_2_2_6.SettingsChangedEvent:1.0.0"
