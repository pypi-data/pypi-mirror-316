...
def root(context, missing=missing):
    ...
    if t_6((undefined(name='router_pim_sparse_mode') if l_0_router_pim_sparse_mode is missing else l_0_router_pim_sparse_mode)):
        ...
        for event in template.root_render_func(template.new_context(context.get_all(), True, {'any_ipv4_ip_addresses': l_0_any_ipv4_ip_addresses})):
            yield event
        yield '```\n'

blocks = {}
debug_info = '7=50&12=53&14=56&15=58&17=61&19=63&25=66&26=70&27=72&28=74&29=76&30=78&31=81&34=94&40=97&41=100&42=104&43=107&48=115&52=118&55=122&56=125&57=129&59=136&63=139&64=142&65=144&66=148&67=150&68=152&69=154&70=156&71=159&81=176'