...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-budgets)](https://pypistats.org/packages/mypy-boto3-budgets)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Budgets 1.35.84](https://pypi.org/project/boto3/)
...
`mypy-boto3-budgets` dependency in production. However, there is an issue in
