...
for epoch in range(1000):
    outputs = model(tokens,0) # outputs: [batch_size * tgt_len, tgt_vocab_size]
    # outputs: [batch_size * tgt_len, tgt_vocab_size], dec_outputs: [batch_size, tgt_len]
    loss = criterion(outputs, torch.tensor([1, 1]))  # 将dec_outputs展平成一维张量
