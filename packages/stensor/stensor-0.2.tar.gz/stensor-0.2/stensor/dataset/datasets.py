...
from stensor.dataset.utils import get_file, cache_dir, save_cache_npz, load_cache_npz
from stensor.dataset.transforms import Compose, Flatten, ToFloat, Normalize
...
class MNIST(Dataset):
    ...
    def prepare(self):
        ...
        url = 'https://github.com/petar/GoMNIST/blob/master/data/'
