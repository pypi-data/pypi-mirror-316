...
def call_descriptor(descriptor):
    ...
    if func is Nothing:
        ...
        raise TypeError(
            ...
            f'may be you use primitive @pin.attr instead full-featured @pin?')
...
class MixedProperty(Property):
    klass = None
    def __get__(self, instance, klass):
        return self.call(instance or klass)


class ClassPin(Property, Cached):
    ...
