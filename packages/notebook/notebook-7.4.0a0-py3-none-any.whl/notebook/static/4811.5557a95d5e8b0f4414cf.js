"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[4811],{
...
;// CONCATENATED MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/erDiagram-6RL3IURR.mjs



// src/diagrams/er/parser/erDiagram.jison
var parser = function() {
  var o = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 1:
          break;
    ...
    parseError: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function parse(input) {
      ...
      (0,chunk_6DBFFHIP/* __name */.eW)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,chunk_6DBFFHIP/* __name */.eW)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
      ...
      less: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,chunk_6DBFFHIP/* __name */.eW)(Parser, "Parser");
...
var addEntity = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(name, alias = void 0) {
  if (!entities.has(name)) {
    entities.set(name, { attributes: [], alias });
    chunk_6DBFFHIP/* log */.cM.info("Added new entity :", name);
  } else if (!entities.get(name).alias && alias) {
    entities.get(name).alias = alias;
    chunk_6DBFFHIP/* log */.cM.info(`Add alias '${alias}' to entity '${name}'`);
  }
  return entities.get(name);
}, "addEntity");
var getEntities = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => entities, "getEntities");
var addAttributes = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(entityName, attribs) {
  let entity = addEntity(entityName);
  let i;
  for (i = attribs.length - 1; i >= 0; i--) {
    entity.attributes.push(attribs[i]);
    chunk_6DBFFHIP/* log */.cM.debug("Added attribute ", attribs[i].attributeName);
  }
}, "addAttributes");
var addRelationship = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(entA, rolA, entB, rSpec) {
  let rel = {
    entityA: entA,
    roleA: rolA,
    entityB: entB,
  ...
  chunk_6DBFFHIP/* log */.cM.debug("Added new relationship :", rel);
}, "addRelationship");
var getRelationships = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => relationships, "getRelationships");
var clear2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
  entities = /* @__PURE__ */ new Map();
  relationships = [];
  (0,chunk_6DBFFHIP/* clear */.ZH)();
}, "clear");
var erDb_default = {
  Cardinality,
  Identification,
  getConfig: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => (0,chunk_6DBFFHIP/* getConfig2 */.nV)().er, "getConfig"),
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
  getRelationships,
  clear: clear2,
  setAccTitle: chunk_6DBFFHIP/* setAccTitle */.GN,
  getAccTitle: chunk_6DBFFHIP/* getAccTitle */.eu,
  setAccDescription: chunk_6DBFFHIP/* setAccDescription */.U$,
  getAccDescription: chunk_6DBFFHIP/* getAccDescription */.Mx,
  setDiagramTitle: chunk_6DBFFHIP/* setDiagramTitle */.g2,
  getDiagramTitle: chunk_6DBFFHIP/* getDiagramTitle */.Kr
};
...
var insertMarkers = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(elem, conf2) {
  let marker;
...
var setConf = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(cnf) {
  const keys = Object.keys(cnf);
  for (const key of keys) {
    conf[key] = cnf[key];
  }
}, "setConf");
var drawAttributes = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,chunk_6DBFFHIP/* parseGenericTypes */.UO)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
var drawEntities = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", conf.fontSize + "px").text(entities2.get(entityName).alias ?? entityName);
...
var adjustEntities = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(svgNode, graph) {
...
var getEdgeName = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(rel) {
  return (rel.entityA + rel.roleA + rel.entityB).replace(/\s/g, "");
}, "getEdgeName");
var addRelationships = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(relationships2, g) {
...
var relCnt = 0;
var drawRelationshipFromLayout = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(svg, rel, g, insert, diagObj) {
  relCnt++;
  const edge = g.edge(
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,chunk_6DBFFHIP/* getConfig2 */.nV)().fontFamily).style("font-size", conf.fontSize + "px");
...
var draw = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(text, id, _version, diagObj) {
  conf = (0,chunk_6DBFFHIP/* getConfig2 */.nV)().er;
  chunk_6DBFFHIP/* log */.cM.info("Drawing ER diagram");
  const securityLevel = (0,chunk_6DBFFHIP/* getConfig2 */.nV)().securityLevel;
  let sandboxElement;
  ...
  chunk_7DKRZKHE/* utils_default */.w8.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,chunk_6DBFFHIP/* configureSvgSize */.v2)(svg, height, width, conf.useMaxWidth);
...
(0,chunk_6DBFFHIP/* __name */.eW)(generateId, "generateId");
function strWithHyphen(str = "") {
  return str.length > 0 ? `${str}-` : "";
}
(0,chunk_6DBFFHIP/* __name */.eW)(strWithHyphen, "strWithHyphen");
...
var getStyles = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((options) => `
  .entityBox {
...
//# sourceMappingURL=4811.5557a95d5e8b0f4414cf.js.map?v=5557a95d5e8b0f4414cf