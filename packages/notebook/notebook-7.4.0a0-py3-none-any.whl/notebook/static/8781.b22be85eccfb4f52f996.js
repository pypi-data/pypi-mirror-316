...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30295);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(61775),
    __webpack_require__(92608),
    __webpack_require__(60798),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(3989),
  __webpack_require__(83332),
  __webpack_require__(69487),
  __webpack_require__(83997),
  __webpack_require__(30867),
  __webpack_require__(5332),
  __webpack_require__(74577),
  
      (__webpack_require__(56079)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(5384)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(32102),
  
      (__webpack_require__(34855)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(44002)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(72601),
  
      (__webpack_require__(72381)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(31012)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(33037)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(80039)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(29976)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(20820),
  __webpack_require__(71207),
  __webpack_require__(24439),
  
      (__webpack_require__(28104)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(34561),
  __webpack_require__(23572),
  __webpack_require__(45658),
  
      (__webpack_require__(20205)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(12433),
  __webpack_require__(55453),
  __webpack_require__(75636),
  __webpack_require__(98976),
  __webpack_require__(29673),
  __webpack_require__(92847),
  __webpack_require__(71532),
  __webpack_require__(6524),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(19357)["default"].filter)(({id}) => [
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(54722),
  __webpack_require__(13855),
  
      (__webpack_require__(13951)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(56055)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(18737)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(68621).NotebookApp);
...
//# sourceMappingURL=8781.b22be85eccfb4f52f996.js.map?v=b22be85eccfb4f52f996