"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[654],{
...
var getDiagramElement = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((id, securityLevel) => {
  let sandboxElement;
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((svg, padding, cssDiagram, useMaxWidth) => {
  svg.attr("class", cssDiagram);
  const { width, height, x, y } = calculateDimensionsWithPadding(svg, padding);
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .v2)(svg, height, width, useMaxWidth);
  const viewBox = createViewBox(x, y, width, height, padding);
  svg.attr("viewBox", viewBox);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.debug(`viewBox configured: ${viewBox} with padding: ${padding}`);
}, "setupViewPortForSVG");
var calculateDimensionsWithPadding = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((svg, padding) => {
...
var createViewBox = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((x, y, width, height, padding) => {
...
/* harmony export */ });
/* harmony import */ var _chunk_5HRBRIJM_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51102);
/* harmony import */ var _chunk_S3SWNSAA_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(64614);
...
var vertexCounter = 0;
var config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
...
var version;
var funs = [];
var sanitizeText = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((txt) => _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .common_default */ .SY.sanitizeText(txt, config), "sanitizeText");
var lookUpDomId = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id) {
...
var addVertex = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id, textObj, type, style, classes2, dir, props = {}, shapeData) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
  ...
  if (shapeData !== void 0) {
    ...
    const doc = (0,_chunk_S3SWNSAA_mjs__WEBPACK_IMPORTED_MODULE_1__/* .load */ .z)(yamlData, { schema: _chunk_S3SWNSAA_mjs__WEBPACK_IMPORTED_MODULE_1__/* .JSON_SCHEMA */ .A });
    if (doc.shape) {
      if (doc.shape !== doc.shape.toLowerCase() || doc.shape.includes("_")) {
        throw new Error(`No such shape: ${doc.shape}. Shape names should be lowercase.`);
      } else if (!(0,_chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_4__/* .isValidShape */ .dW)(doc.shape)) {
...
var addSingleLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(_start, _end, type) {
  const start = _start;
  const end = _end;
  const edge = { start, end, type: void 0, text: "", labelType: "text" };
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("abc78 Got edge...", edge);
  ...
  if (edges.length < (config.maxEdges ?? 500)) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("Pushing edge...");
    edges.push(edge);
  } else {
    throw new Error(
...
var addLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(_start, _end, type) {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("addLink", _start, _end, type);
...
var updateLinkInterpolate = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(positions, interpolate) {
...
var updateLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(positions, style) {
  positions.forEach(function(pos) {
...
var addClass = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ids, style) {
...
var setDirection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(dir) {
  direction = dir;
  if (/.*</.exec(direction)) {
    direction = "RL";
  }
...
var setClass = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ids, className) {
...
var setTooltip = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ids, tooltip) {
  if (tooltip === void 0) {
    return;
  }
...
var setClickFun = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id, functionName, functionArgs) {
  const domId = lookUpDomId(id);
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)().securityLevel !== "loose") {
    return;
  }
    ...
    funs.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ .w8.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
var setLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    const vertex = vertices.get(id);
    if (vertex !== void 0) {
      vertex.link = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ .w8.formatUrl(linkStr, config);
      vertex.linkTarget = target;
    }
  });
  setClass(ids, "clickable");
}, "setLink");
var getTooltip = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id) {
  return tooltips.get(id);
}, "getTooltip");
var setClickEvent = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
    setClickFun(id, functionName, functionArgs);
  });
  setClass(ids, "clickable");
}, "setClickEvent");
var bindFunctions = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(element) {
  funs.forEach(function(fun) {
    fun(element);
  });
}, "bindFunctions");
var getDirection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return direction.trim();
}, "getDirection");
var getVertices = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return vertices;
}, "getVertices");
var getEdges = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return edges;
}, "getEdges");
var getClasses = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return classes;
}, "getClasses");
var setupToolTips = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(element) {
  ...
  nodes.on("mouseover", function() {
    const el = (0,d3__WEBPACK_IMPORTED_MODULE_11__/* .select */ .Ys)(this);
...
var clear2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ver = "gen-1") {
  ...
  version = ver;
  config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .clear */ .ZH)();
}, "clear");
var setGen = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((ver) => {
  version = ver || "gen-2";
}, "setGen");
var defaultStyle = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return "fill:#ffa;stroke: #f66; stroke-width: 3px; stroke-dasharray: 5, 5;fill:#ffa;stroke: #666;";
}, "defaultStyle");
var addSubGraph = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(_id, list, _title) {
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(uniq, "uniq");
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  subGraph.nodes = makeUniq(subGraph, subGraphs).nodes;
  subGraphs.push(subGraph);
  subGraphLookup.set(id, subGraph);
  return id;
}, "addSubGraph");
var getPosForId = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id) {
...
var secCount = -1;
var posCrossRef = [];
var indexNodes2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(id, pos) {
...
var getDepthFirstPos = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(pos) {
  return posCrossRef[pos];
}, "getDepthFirstPos");
var indexNodes = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  secCount = -1;
  if (subGraphs.length > 0) {
    indexNodes2("none", subGraphs.length - 1);
  }
}, "indexNodes");
var getSubGraphs = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
  return subGraphs;
}, "getSubGraphs");
var firstGraph = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(() => {
  if (firstGraphFlag) {
...
var destructStartLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((_str) => {
  let str = _str.trim();
  let type = "arrow_open";
  switch (str[0]) {
    case "<":
...
var countChar = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((char, str) => {
...
var destructEndLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((_str) => {
  const str = _str.trim();
...
var destructLink = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((_str, _startStr) => {
...
var exists = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((allSgs, _id) => {
...
var makeUniq = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((sg, allSubgraphs) => {
  const res = [];
...
var getTypeFromVertex = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((vertex) => {
  if (vertex.img) {
    return "imageSquare";
  }
  if (vertex.icon) {
...
var findNode = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((nodes, id) => nodes.find((node) => node.id === id), "findNode");
var destructEdgeType = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((type) => {
...
var addNodeFromVertex = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((vertex, nodes, parentDB, subGraphDB, config2, look) => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(getCompiledStyles, "getCompiledStyles");
var getData = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(() => {
  const config2 = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
  const nodes = [];
  const edges2 = [];
  ...
  e.forEach((rawEdge, index) => {
    ...
    const edge = {
      id: (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_9__/* .getEdgeId */ .Ln)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }),
      start: rawEdge.start,
      end: rawEdge.end,
...
var flowDb_default = {
  defaultConfig: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(() => _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .defaultConfig2 */ .Fy.flowchart, "defaultConfig"),
  setAccTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccTitle */ .GN,
  getAccTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccTitle */ .eu,
  getAccDescription: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getAccDescription */ .Mx,
  getData,
  setAccDescription: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setAccDescription */ .U$,
  addVertex,
  lookUpDomId,
  addLink,
  updateLinkInterpolate,
  ...
  exists,
  makeUniq,
  setDiagramTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setDiagramTitle */ .g2,
  getDiagramTitle: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getDiagramTitle */ .Kr
};

// src/diagrams/flowchart/flowRenderer-v3-unified.ts

var getClasses2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("REF0:");
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.info("Drawing state diagram (v2)", id);
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .getConfig2 */ .nV)();
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_11__/* .select */ .Ys)("#i" + id);
  }
  const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.debug("Data: ", data4Layout);
  const svg = (0,_chunk_5HRBRIJM_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .q)(id, securityLevel);
  const direction2 = getDirection();
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_BO7VGL7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getRegisteredLayoutAlgorithm */ ._b)(layout);
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.warn(
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .cM.debug("REF1:", data4Layout);
  await (0,_chunk_BO7VGL7K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */ .sY)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default */ .w8.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_5HRBRIJM_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .j)(svg, padding, "flowchart", conf?.useMaxWidth || false);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 2:
          this.$ = [];
    ...
    defaultActions: {},
    parseError: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function parse(input) {
      ...
      (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(popStack, "popStack");
      function lex2() {
        var token;
      ...
      (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(lex2, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function lex2() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)(Parser, "Parser");
...
var fade = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((color, opacity) => {
...
var getStyles = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((options) => `.label {
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .eW)((cnf) => {
    ...
    if (cnf.layout) {
      (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setConfig2 */ .Y4)({ layout: cnf.layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_10__/* .setConfig2 */ .Y4)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
...
//# sourceMappingURL=654.4cde6cc75377ee14c2a6.js.map?v=4cde6cc75377ee14c2a6