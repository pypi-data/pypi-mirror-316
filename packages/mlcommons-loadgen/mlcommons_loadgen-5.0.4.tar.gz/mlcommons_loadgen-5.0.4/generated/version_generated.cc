...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.4";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-12-19T06:37:24.742907";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-12-19T06:37:24.742928";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "6af0288cd0";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-12-19T06:36:54Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(6af0288cd09c3abac9a1ba397c5b35df0d46045c Increment version to 5.0.4)LGVG_RSLD";
  return str;
}
...
6e3b3fc66be67844ebb7a04b716d090b151076d1 /VERSION.txt
...
d7e6b5752638a29cd357a53f7aa92f0bcaa0215e /mlperf.conf
c998626f6b94c1e068b9da7f5be9ba15e5d2d58f /mlperf_conf.h
