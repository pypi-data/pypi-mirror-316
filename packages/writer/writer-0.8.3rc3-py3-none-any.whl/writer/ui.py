...
WorkflowsRootProps = TypedDict('WorkflowsRootProps', {
}, total=False)

WorkflowsRootEventHandlers = TypedDict('WorkflowsRootEventHandlers', {
}, total=False)

WorkflowProps = TypedDict('WorkflowProps', {
    "key": str
}, total=False)

WorkflowEventHandlers = TypedDict('WorkflowEventHandlers', {
}, total=False)
...
class WriterUIManager(WriterUI):
    ...
    @staticmethod
    def WorkflowsRoot(
            content: WorkflowsRootProps = {},
            *,
            id: Optional[str] = None,
            position: Optional[int] = None,
            parentId: Optional[str] = None,
            handlers: Optional[WorkflowsRootEventHandlers] = None,
            visible: Optional[Union[bool, str]] = None,
            ) -> Component:
        """
        The root component of the application, which serves as the starting point of the component hierarchy.
    ...
    @staticmethod
    def Workflow(
            content: WorkflowProps = {},
            *,
            id: Optional[str] = None,
            position: Optional[int] = None,
            parentId: Optional[str] = None,
            handlers: Optional[WorkflowEventHandlers] = None,
            visible: Optional[Union[bool, str]] = None,
            ) -> Component:
        """
