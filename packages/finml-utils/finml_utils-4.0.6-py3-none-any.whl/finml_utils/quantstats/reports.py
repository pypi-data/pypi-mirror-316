...
def html(  # noqa
    ...
    **kwargs,
    ...
    if benchmark is not None:
        benchmark.name = None
        # (
        #     benchmark_title.split(")")[1]
        #     if benchmark_title and ")" in benchmark_title
        #     else benchmark_title
        # )
...
def _calculate_metrics(  # noqa
    ...
    **kwargs,
    ...
    ret_vol = (
        _stats.volatility(df["returns"], win_year, True, prepare_returns=False) * pct
    )
