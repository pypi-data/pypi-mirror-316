            ...
            try:
                ...
                if self.object.listOfFunction.currentWidget() == self.object.page_2:
                    ...
                    try:
                        ...
                        self.object.site.save(os.path.join(os.path.dirname(__file__), 'templates', 'base.html'))
                        self.object.webEngineView.setUrl(QUrl.fromLocalFile(os.path.join(os.path.dirname(__file__),
                                                                                         'templates', 'base.html')))
