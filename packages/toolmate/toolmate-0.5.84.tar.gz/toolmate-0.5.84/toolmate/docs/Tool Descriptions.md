...
`@ask_googleai` Ask GoogleAI Model to chat or provide information
...
`@ask_mistral` Ask Mistral to chat or provide information

`@ask_o1` Ask reasoning model o1 to chat or provide information

`@ask_o1_mini` Ask reasoning model o1-mini to chat or provide information

`@ask_ollama` Ask an Ollama model to chat or provide information

`@ask_palm2` Ask PaLM 2 to chat or provide information

`@ask_perplexica_chatgpt` Request Perplexica to conduct research or provide information through internet searches.

`@ask_perplexica_googleai` Request Perplexica to conduct research or provide information through internet searches.

`@ask_perplexica_groq` Request Perplexica to conduct research or provide information through internet searches.

`@ask_perplexica_xai` Request Perplexica to conduct research or provide information through internet searches.

`@ask_tavily` Ask internet for a short and direct answer

`@ask_xai` Ask X AI Model to chat or provide information
