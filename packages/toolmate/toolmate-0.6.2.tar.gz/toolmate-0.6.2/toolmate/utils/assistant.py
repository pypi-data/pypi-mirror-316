...
"""
    ...
    def changeGithubAPIkey(self):
        ...
        print1("Enter your Github API Key [optional]:")
        apikey = self.prompts.simplePrompt(style=self.prompts.promptStyle2, default=config.githubApi_key, is_password=True)
        if apikey and not apikey.strip().lower() in (config.cancel_entry, config.exit_entry):
