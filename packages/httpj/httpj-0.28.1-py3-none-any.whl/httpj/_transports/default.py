...
HTTPCORE_EXC_MAP: dict[type[Exception], type[httpj.HTTPError]] = {}


def _load_httpcore_exceptions() -> dict[type[Exception], type[httpj.HTTPError]]:
    import httpcore
