...
if TYPE_CHECKING:
    ...
    from web3tool.contract import (  # noqa: F401
        Contract,
    )
    from web3tool.providers import (  # noqa: F401
        BaseProvider,
    )
    from web3tool.types import (  # noqa: F401
        Middleware,
        TxParams,
    )
...
class ENS(BaseENS):
    ...
    def __init__(
        ...
        :type provider: instance of `web3tool.providers.base.BaseProvider`
    ...
    @classmethod
    def from_web3(cls, w3: "Web3tool", addr: ChecksumAddress = None) -> "ENS":
        """
        Generate an ENS instance from a Web3tool instance

        :param `web3tool.Web3tool` w3: to infer connection, middleware, and codec information
    ...
    def setup_address(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~web3tool.eth.Eth.send_transaction`
        :raises InvalidName: if ``name`` has invalid syntax
    ...
    def setup_name(
        ...
        :param dict transact: the transaction configuration, like in
            :meth:`~web3tool.eth.send_transaction`
