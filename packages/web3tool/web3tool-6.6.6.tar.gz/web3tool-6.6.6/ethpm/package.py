...
from web3tool._utils.validation import (
    validate_address,
)
...
class Package(object):
    def __init__(
        self, manifest: Dict[str, Any], w3: "Web3tool", uri: Optional[str] = None
    ) -> None:
        """
    ...
    def update_w3(self, w3: "Web3tool") -> "Package":
        """
        Returns a new instance of `Package` containing the same manifest,
        but connected to a different web3tool instance.

        .. doctest::

           >>> new_w3 = Web3tool(Web3tool.EthereumTesterProvider())
    ...
    @classmethod
    def from_uri(cls, uri: URI, w3: "Web3tool") -> "Package":
        """
        Returns a Package object instantiated by a manifest located at a content-addressed URI.
        A valid ``Web3tool`` instance is also required.
    ...
    def get_contract_factory(self, name: ContractName) -> LinkableContract:
        ...
        ``web3tool.contract.Contract``, ``ethpm.contract.LinkableContract`` with a few extra
    ...
    def get_contract_instance(self, name: ContractName, address: Address) -> Contract:
        """
        Will return a ``Web3tool.contract`` instance generated from the contract type
