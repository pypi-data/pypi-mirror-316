...
def retrieve_blocking_method_call_fn(
    w3: "Web3tool", module: "Module", method: Method[Callable[..., TReturn]]
...
#  Module should no longer have access to the full web3tool api.
...
#  have web3tool access.
class Module:
    is_async = False

    def __init__(self, w3: Union["AsyncWeb3", "Web3tool"]) -> None:
        if self.is_async:
    ...
    def codec(self) -> ABICodec:
        # use codec set on the Web3tool instance
