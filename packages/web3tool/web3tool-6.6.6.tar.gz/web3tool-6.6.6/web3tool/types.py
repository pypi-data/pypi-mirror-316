...
if TYPE_CHECKING:
    from web3tool.contract.async_contract import AsyncContractFunction  # noqa: F401
    from web3tool.contract.contract import ContractFunction  # noqa: F401
...
# todo: move these to eth_typing once web3tool is type hinted
...
Middleware = Callable[[Callable[[RPCEndpoint, Any], RPCResponse], "Web3tool"], Any]
...
GasPriceStrategy = Union[
    Callable[["Web3tool", TxParams], Wei], Callable[["AsyncWeb3", TxParams], Wei]
]
