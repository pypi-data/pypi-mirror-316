...
def iter_latest_block(
    w3: "Web3tool", to_block: Optional[Union[BlockNumber, LatestBlockParam]] = None
...
class RequestBlocks:
    def __init__(self, w3: "Web3tool") -> None:
        self.w3 = w3
...
def block_hashes_in_range(
    w3: "Web3tool", block_range: Tuple[BlockNumber, BlockNumber]
) -> Iterable[Hash32]:
