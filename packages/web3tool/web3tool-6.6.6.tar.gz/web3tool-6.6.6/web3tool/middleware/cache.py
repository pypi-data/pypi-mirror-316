...
from web3tool._utils.caching import (
    generate_cache_key,
)
...
from web3tool.utils.caching import (
    SimpleCache,
)
...
def construct_simple_cache_middleware(
    ...
    def simple_cache_middleware(
        make_request: Callable[[RPCEndpoint, Any], RPCResponse], _w3: "Web3tool"
        ...
        # important for compatibility with multiple ``Web3tool`` instances.
