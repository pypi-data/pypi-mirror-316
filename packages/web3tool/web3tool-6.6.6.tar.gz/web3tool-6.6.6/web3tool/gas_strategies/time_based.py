...
from web3tool._utils.math import (
    percentile,
)
...
def _get_avg_block_time(w3: Web3tool, sample_size: int) -> float:
...
def _get_weighted_avg_block_time(w3: Web3tool, sample_size: int) -> float:
...
def construct_time_based_gas_price_strategy(
    ...
    def time_based_gas_price_strategy(w3: Web3tool, transaction_params: TxParams) -> Wei:
        if weighted:
