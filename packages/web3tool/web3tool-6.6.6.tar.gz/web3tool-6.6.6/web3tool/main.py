...
from web3tool._utils.encoding import (
    hex_encode_abi_type,
    to_hex,
    to_json,
)
...
from web3tool._utils.module import (
    attach_modules as _attach_modules,
)
from web3tool._utils.normalizers import (
    abi_ens_resolver,
)
from web3tool.eth import (
    AsyncEth,
    Eth,
)
from web3tool.geth import (
    AsyncGeth,
    AsyncGethAdmin,
    AsyncGethPersonal,
    AsyncGethTxPool,
...
from web3tool.manager import (
    RequestManager as DefaultRequestManager,
)
from web3tool.module import (
    Module,
)
from web3tool.net import (
    AsyncNet,
    Net,
)
from web3tool.providers import (
    AsyncBaseProvider,
    BaseProvider,
)
from web3tool.providers.eth_tester import (
    EthereumTesterProvider,
)
from web3tool.providers.ipc import (
    IPCProvider,
)
from web3tool.providers.async_rpc import (
    AsyncHTTPProvider,
)
from web3tool.providers.rpc import (
    HTTPProvider,
)
from web3tool.providers.websocket import (
    WebsocketProvider,
)
from web3tool.testing import (
    Testing,
)
from web3tool.tracing import (
    Tracing,
)
...
if TYPE_CHECKING:
    from web3tool.pm import PM  # noqa: F401
    from web3tool._utils.empty import Empty  # noqa: F401
...
class BaseWeb3:
    ...
    @property
    def api(self) -> str:
        from web3tool import __version__
    ...
    def attach_modules(
        ...
        """
        Attach modules to the `Web3tool` instance.
        """
    ...
    def enable_unstable_package_management_api(self) -> None:
        if not hasattr(self, "_pm"):
            warnings.warn(
                ...
                "deprecated with ``web3tool.py`` version 7",
                UserWarning,
            )
            from web3tool.pm import PM  # noqa: F811
