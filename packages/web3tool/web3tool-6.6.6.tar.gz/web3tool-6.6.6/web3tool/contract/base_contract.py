...
from web3tool.datastructures import (
    AttributeDict,
...
if TYPE_CHECKING:
    from web3tool import (  # noqa: F401
        AsyncWeb3,
        Web3tool,
    )
...
class BaseContractEvent:
    ...
    event_name: str = None
    w3: Union["Web3tool", "AsyncWeb3"] = None
...
class BaseContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <web3tool.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'web3tool._utils.datatypes.LogAnonymous'>
        ...
...
class BaseContract:
    ...
    :meth:`web3tool.eth.Eth.contract` that takes compiled Solidity contract
