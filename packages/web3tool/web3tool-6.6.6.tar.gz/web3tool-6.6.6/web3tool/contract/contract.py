...
from web3tool._utils.abi import (
...
from web3tool._utils.contracts import (
    parse_block_identifier,
)
from web3tool._utils.datatypes import (
    PropertyCheckingFactory,
)
from web3tool._utils.events import (
    EventFilterBuilder,
    get_event_data,
)
from web3tool._utils.filters import (
    LogFilter,
)
from web3tool._utils.function_identifiers import (
    FallbackFn,
    ReceiveFn,
)
from web3tool._utils.normalizers import (
    normalize_abi,
    normalize_address,
    normalize_bytecode,
)
from web3tool._utils.transactions import (
    fill_transaction_defaults,
)
from web3tool.contract.base_contract import (
    BaseContract,
    BaseContractCaller,
...
from web3tool.contract.utils import (
...
if TYPE_CHECKING:
    ...
    from web3tool import Web3tool  # noqa: F401
...
class ContractEvent(BaseContractEvent):
    ...
    def get_logs(
        ...
        .. code-block:: python
            ...
            from = max(mycontract.web3tool.eth.block_number - 10, 1)
            to = mycontract.web3tool.eth.block_number
        ...
        See also: :func:`web3tool.middleware.filter.local_filter_middleware`.
...
class ContractEvents(BaseContractEvents):
    def __init__(
        self, abi: ABI, w3: "Web3tool", address: Optional[ChecksumAddress] = None
    ) -> None:
...
class ContractFunction(BaseContractFunction):
    ...
    def call(
        ...
        :param transaction: Dictionary of transaction info for web3tool interface
...
class Contract(BaseContract):
    ...
    def __init__(self, address: Optional[ChecksumAddress] = None) -> None:
        ...
        if _w3 is None:
            raise AttributeError(
                ...
                "`web3tool.contract` interface to create your contract class."
            )
    ...
    @classmethod
    def factory(
        cls, w3: "Web3tool", class_name: Optional[str] = None, **kwargs: Any
    ) -> Type[Self]:
        kwargs["w3"] = w3
