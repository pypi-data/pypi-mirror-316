...
from web3tool.tools.pytest_ethereum.exceptions import (
    LinkerError,
)
...
def pluck_matching_uri(deployment_data: Dict[URI, Dict[str, str]], w3: Web3tool) -> URI:
    """
...
def contains_matching_uri(deployment_data: Dict[str, Dict[str, str]], w3: Web3tool) -> bool:
    """
