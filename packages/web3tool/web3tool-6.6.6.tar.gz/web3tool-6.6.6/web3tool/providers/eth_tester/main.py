...
from web3tool.middleware.attrdict import (
    async_attrdict_middleware,
    attrdict_middleware,
)
from web3tool.middleware.buffered_gas_estimate import (
    async_buffered_gas_estimate_middleware,
)
from web3tool.providers import (
    BaseProvider,
)
from web3tool.providers.async_base import (
    AsyncBaseProvider,
)
...
class AsyncEthereumTesterProvider(AsyncBaseProvider):
    ...
    def __init__(self) -> None:
        ...
        from web3tool.providers.eth_tester.defaults import (
            API_ENDPOINTS,
        )
