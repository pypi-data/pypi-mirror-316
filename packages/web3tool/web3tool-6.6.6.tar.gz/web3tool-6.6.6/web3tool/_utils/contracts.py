...
from web3tool._utils.blocks import (
...
def parse_block_identifier(
    w3: "Web3tool", block_identifier: BlockIdentifier
) -> BlockIdentifier:
...
def parse_block_identifier_int(w3: "Web3tool", block_identifier_int: int) -> BlockNumber:
...
def parse_block_identifier_no_extra_call(
    w3: Union["Web3tool", "AsyncWeb3"], block_identifier: BlockIdentifier
) -> BlockIdentifier:
    if block_identifier is None:
        return w3.eth.default_block
