...
class GoEthereumAdminModuleTest:
    def test_add_peer(self, w3: "Web3tool") -> None:
    ...
    def test_admin_datadir(self, w3: "Web3tool", datadir: str) -> None:
        result = w3.geth.admin.datadir()
        assert result == datadir

    def test_admin_node_info(self, w3: "Web3tool") -> None:
    ...
    def test_admin_peers(self, w3: "Web3tool") -> None:
        enode = w3.geth.admin.node_info()["enode"]
        w3.geth.admin.add_peer(enode)
        result = w3.geth.admin.peers()
        assert len(result) == 1

    def test_admin_start_stop_http(self, w3: "Web3tool") -> None:
    ...
    def test_admin_start_stop_ws(self, w3: "Web3tool") -> None:
