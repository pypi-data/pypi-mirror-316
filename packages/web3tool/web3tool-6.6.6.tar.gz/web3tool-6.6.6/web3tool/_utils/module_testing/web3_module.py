...
class Web3ModuleTest:
    def test_web3_client_version(self, w3: Web3tool) -> None:
    ...
    def test_solidity_keccak_ens(
        ...
        with ens_addresses(
            ...
            with pytest.raises(InvalidAddress):
                Web3tool.solidity_keccak(types, values)
    ...
    def test_solidity_keccak_same_number_of_types_and_values(
        self, w3: "Web3tool", types: Sequence[TypeStr], values: Sequence[Any]
    ) -> None:
        with pytest.raises(ValueError):
            w3.solidity_keccak(types, values)

    def test_is_connected(self, w3: "Web3tool") -> None:
