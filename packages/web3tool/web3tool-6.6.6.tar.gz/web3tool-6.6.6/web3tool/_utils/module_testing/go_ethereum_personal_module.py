...
class GoEthereumPersonalModuleTest:
    ...
    def test_personal_lock_account(
        self, w3: "Web3tool", unlockable_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    def test_personal_new_account(self, w3: "Web3tool") -> None:
    ...
    def test_personal_sign_and_ecrecover(
        ...
        message = "test-web3tool-geth-personal-sign"
