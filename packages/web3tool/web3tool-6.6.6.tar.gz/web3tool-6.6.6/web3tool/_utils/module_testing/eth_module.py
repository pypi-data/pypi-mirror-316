...
from web3tool._utils.contract_error_handling import (
    PANIC_ERROR_CODES,
)
from web3tool._utils.empty import (
    empty,
)
from web3tool._utils.ens import (
    ens_addresses,
)
from web3tool._utils.method_formatters import (
    to_hex_if_integer,
)
from web3tool._utils.module_testing.module_testing_utils import (
    assert_contains_log,
    async_mock_offchain_lookup_request_response,
    mine_pending_block,
    mock_offchain_lookup_request_response,
)
from web3tool._utils.type_conversion import (
    to_hex_if_bytes,
)
from web3tool.exceptions import (
    BlockNotFound,
    ContractCustomError,
    ContractLogicError,
    ContractPanicError,
...
from web3tool.middleware.fixture import (
...
if TYPE_CHECKING:
    ...
    from web3tool.contract import Contract  # noqa: F401
    from web3tool.main import (  # noqa: F401
        AsyncWeb3,
        Web3tool,
    )
...
def abi_encoded_offchain_lookup_contract_address(
    w3: Union["Web3tool", "AsyncWeb3"], offchain_lookup_contract: "Contract"
) -> HexAddress:
    return HexAddress(
        remove_0x_prefix(
            w3.to_hex(
...
class AsyncEthModuleTest:
    ...
    async def test_gas_price_strategy_middleware(
        ...
        def gas_price_strategy(w3: "Web3tool", txn: TxParams) -> Wei:
    ...
    async def test_gas_price_from_strategy_bypassed_for_dynamic_fee_txn_no_tip(
        ...
        def gas_price_strategy(_w3: "Web3tool", _txn: TxParams) -> Wei:
            return async_w3.to_wei(2, "gwei")
    ...
    async def test_eth_call_offchain_lookup(
        ...
        async_mock_offchain_lookup_request_response(
            monkeypatch,
            mocked_request_url=f"https://web3tool.py/gateway/{normalized_contract_address}/{OFFCHAIN_LOOKUP_TEST_DATA}.json",  # noqa: E501
    ...
    async def test_eth_call_offchain_lookup_tries_next_url_for_non_4xx_error_status_and_tests_POST(  # noqa: E501
        ...
        async_mock_offchain_lookup_request_response(
            monkeypatch,
            http_method="POST",
            mocked_request_url=f"https://web3tool.py/gateway/{normalized_contract_address}.json",  # noqa: E501
    ...
    async def test_eth_call_continuous_offchain_lookup_raises_with_too_many_requests(
        ...
        async_mock_offchain_lookup_request_response(
            monkeypatch,
            mocked_request_url=f"https://web3tool.py/gateway/{normalized_contract_address}/0x.json",  # noqa: E501
        )
...
class EthModuleTest:
    def test_eth_syncing(self, w3: "Web3tool") -> None:
    ...
    def test_eth_coinbase(self, w3: "Web3tool") -> None:
        coinbase = w3.eth.coinbase
        assert is_checksum_address(coinbase)

    def test_eth_mining(self, w3: "Web3tool") -> None:
        mining = w3.eth.mining
        assert is_boolean(mining)

    def test_eth_hashrate(self, w3: "Web3tool") -> None:
        hashrate = w3.eth.hashrate
        assert is_integer(hashrate)
        assert hashrate >= 0

    def test_eth_chain_id(self, w3: "Web3tool") -> None:
        chain_id = w3.eth.chain_id
        # chain id value from geth fixture genesis file
        assert chain_id == 131277322940537

    def test_eth_fee_history(self, w3: "Web3tool") -> None:
    ...
    def test_eth_fee_history_with_integer(
        self, w3: "Web3tool", empty_block: BlockData
    ) -> None:
    ...
    def test_eth_fee_history_no_reward_percentiles(self, w3: "Web3tool") -> None:
    ...
    def test_eth_gas_price(self, w3: "Web3tool") -> None:
        gas_price = w3.eth.gas_price
        assert is_integer(gas_price)
        assert gas_price > 0

    def test_eth_max_priority_fee(self, w3: "Web3tool") -> None:
    ...
    def test_eth_accounts(self, w3: "Web3tool") -> None:
    ...
    def test_eth_block_number(self, w3: "Web3tool") -> None:
        block_number = w3.eth.block_number
        assert is_integer(block_number)
        assert block_number >= 0

    def test_eth_get_block_number(self, w3: "Web3tool") -> None:
        block_number = w3.eth.get_block_number()
        assert is_integer(block_number)
        assert block_number >= 0

    def test_eth_get_balance(self, w3: "Web3tool") -> None:
        coinbase = w3.eth.coinbase
    ...
    def test_eth_get_balance_with_block_identifier(self, w3: "Web3tool") -> None:
    ...
    def test_eth_get_balance_with_ens_name(
        self, w3: "Web3tool", address: ChecksumAddress, expect_success: bool
    ) -> None:
    ...
    def test_eth_get_storage_at(self, w3: "Web3tool", storage_contract: "Contract") -> None:
        storage_contract_address = storage_contract.address
    ...
    def test_eth_get_storage_at_ens_name(
        self, w3: "Web3tool", storage_contract: "Contract"
    ) -> None:
        with ens_addresses(w3, {"storage.eth": storage_contract.address}):
            storage = w3.eth.get_storage_at(ENS("storage.eth"), 1)
            assert storage == HexBytes(f"0x{'00' * 31}01")

    def test_eth_get_storage_at_invalid_address(self, w3: "Web3tool") -> None:
        coinbase = w3.eth.coinbase
        with pytest.raises(InvalidAddress):
    ...
    def test_eth_get_transaction_count(
        self, w3: "Web3tool", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    def test_eth_get_transaction_count_invalid_address(self, w3: "Web3tool") -> None:
        coinbase = w3.eth.coinbase
        with pytest.raises(InvalidAddress):
    ...
    def test_eth_getBlockTransactionCountByHash_block_with_txn(
        self, w3: "Web3tool", block_with_txn: BlockData
    ) -> None:
    ...
    def test_eth_get_code(
        self, w3: "Web3tool", math_contract_address: ChecksumAddress
    ) -> None:
    ...
    def test_eth_get_code_invalid_address(
        self, w3: "Web3tool", math_contract: "Contract"
    ) -> None:
        with pytest.raises(InvalidAddress):
            w3.eth.get_code(
                ChecksumAddress(HexAddress(HexStr(math_contract.address.lower())))
    ...
    def test_eth_get_code_with_block_identifier(
        self, w3: "Web3tool", emitter_contract: "Contract"
    ) -> None:
    ...
    def test_eth_sign_typed_data(
        ...
        w3: "Web3tool",
        unlocked_account_dual_type: ChecksumAddress,
        skip_if_testrpc: Callable[["Web3tool"], None],
    ) -> None:
        validJSONMessage = """
            {
                "types": {
    ...
    def test_eth_sign_transaction_legacy(
        self, w3: "Web3tool", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
            "to": unlocked_account,
    ...
    def test_gas_price_from_strategy_bypassed_for_dynamic_fee_txn(
        self, w3: "Web3tool", unlocked_account_dual_type: ChecksumAddress, max_fee: Wei
    ) -> None:
    ...
    def test_eth_replace_transaction_gas_price_defaulting_strategy_higher(
        ...
        def higher_gas_price_strategy(w3: "Web3tool", txn: TxParams) -> Wei:
            return two_gwei_in_wei
    ...
    def test_eth_replace_transaction_gas_price_defaulting_strategy_lower(
        ...
        def lower_gas_price_strategy(w3: "Web3tool", txn: TxParams) -> Wei:
    ...
    def test_eth_call(self, w3: "Web3tool", math_contract: "Contract") -> None:
        coinbase = w3.eth.coinbase
        txn_params = math_contract._prepare_transaction(
            fn_name="add",
            fn_args=(7, 11),
    ...
    def test_eth_call_with_override_code(
        self, w3: "Web3tool", revert_contract: "Contract"
    ) -> None:
        coinbase = w3.eth.coinbase
        txn_params = revert_contract._prepare_transaction(
            fn_name="normalFunction",
    ...
    def test_eth_getBlockByHash(self, w3: "Web3tool", empty_block: BlockData) -> None:
    ...
    def test_eth_getBlockByHash_pending(self, w3: "Web3tool") -> None:
    ...
    def test_eth_getTransactionByHash(self, w3: "Web3tool", mined_txn_hash: HexStr) -> None:
    ...
    def test_eth_getTransactionByHash_contract_creation(
        self, w3: "Web3tool", math_contract_deploy_txn_hash: HexStr
    ) -> None:
    ...
    def test_eth_getTransactionByBlockHashAndIndex(
        self, w3: "Web3tool", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
    ...
    def test_eth_getUncleByBlockHashAndIndex(self, w3: "Web3tool") -> None:
        # TODO: how do we make uncles....
        pass

    def test_eth_getUncleByBlockNumberAndIndex(self, w3: "Web3tool") -> None:
        # TODO: how do we make uncles....
        pass

    def test_eth_new_filter(self, w3: "Web3tool") -> None:
    ...
    def test_eth_new_block_filter(self, w3: "Web3tool") -> None:
    ...
    def test_eth_new_pending_transaction_filter(self, w3: "Web3tool") -> None:
    ...
    def test_eth_get_logs_without_logs(
        self, w3: "Web3tool", block_with_txn_with_log: BlockData
    ) -> None:
        # Test with block range
    ...
    def test_eth_get_logs_with_logs_none_topic_args(self, w3: "Web3tool") -> None:
        # Test with None overflowing
        filter_params: FilterParams = {
            "fromBlock": BlockNumber(0),
            "topics": [None, None, None],
    ...
    def test_eth_call_old_contract_state(
        self, w3: "Web3tool", math_contract: "Contract", unlocked_account: ChecksumAddress
    ) -> None:
    ...
    def test_eth_uninstall_filter(self, w3: "Web3tool") -> None:
        filter = w3.eth.filter({})
        assert is_string(filter.filter_id)
    ...
    def test_eth_submit_hashrate(self, w3: "Web3tool") -> None:
    ...
    def test_eth_submit_work(self, w3: "Web3tool") -> None:
        nonce = 1
        pow_hash = HexStr(
    ...
    def test_eth_get_raw_transaction(self, w3: "Web3tool", mined_txn_hash: HexStr) -> None:
        raw_transaction = w3.eth.get_raw_transaction(mined_txn_hash)
        assert is_bytes(raw_transaction)

    def test_eth_get_raw_transaction_raises_error(self, w3: "Web3tool") -> None:
        with pytest.raises(
            TransactionNotFound, match=f"Transaction with hash: '{UNKNOWN_HASH}'"
        ):
    ...
    def test_eth_get_raw_transaction_by_block_raises_error(
        self, w3: "Web3tool", unknown_block_num_or_hash: Union[int, HexBytes]
    ) -> None:
        with pytest.raises(
            TransactionNotFound,
            match=(
