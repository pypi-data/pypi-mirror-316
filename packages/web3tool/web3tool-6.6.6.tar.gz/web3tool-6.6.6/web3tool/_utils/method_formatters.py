...
from web3tool._utils.formatters import (
    hex_to_integer,
    integer_to_hex,
    is_array_of_dicts,
    is_array_of_strings,
...
if TYPE_CHECKING:
    from web3tool.eth import AsyncEth  # noqa: F401
    from web3tool.eth import Eth  # noqa: F401
    from web3tool.module import Module  # noqa: F401
