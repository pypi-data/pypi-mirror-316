...
def AnalogDemo():
    ...
    # Create visualizers
    left_stick = StickVisualizer(20, 20, "Left Stick")
    right_stick = StickVisualizer(90, 20, "Right Stick")
    left_trigger = TriggerVisualizer(50, 70, "LT")
    right_trigger = TriggerVisualizer(120, 70, "RT")
    ...
    def draw():
        ...
        # Draw instructions
        pyxel.text(4, 110, "Press Q or START to quit", 7)
