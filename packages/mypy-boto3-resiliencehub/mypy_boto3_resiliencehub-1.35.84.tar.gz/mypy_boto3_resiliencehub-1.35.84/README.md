...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-resiliencehub)](https://pypistats.org/packages/mypy-boto3-resiliencehub)
...
`mypy-boto3-resiliencehub` dependency in production. However, there is an issue
