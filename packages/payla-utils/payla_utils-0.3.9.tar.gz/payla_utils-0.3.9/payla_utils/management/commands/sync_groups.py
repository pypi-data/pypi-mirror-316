...
class Command(BaseCommand):
    ...
    This command performs the following functions:
        ...
        4. Clearing User-Level Permissions: users should receive permissions only via their assigned groups.
    ...
    [
        {
            ...
            "envs": {
                "stage": {
                    ...
                    "is_staff": true,
                    "is_active": true,
                    "password": "pbkdf2_sha256$39....Z1lhtT70k="
                },
                "playground": {
                    "is_superuser": false,
                    "is_staff": true,
                    "is_active": true,
                    "password": "pbkdf2_sha256$39....ag6uYbrKE="
                },
                "prod": {
                    "is_superuser": false,
                    "is_staff": true,
                    "is_active": true,
                    "password": "pbkdf2_sha256$39....LSIu3L+O8="
                }
            },
            "groups": [
                "Backoffice",
    ...
    How to create the hash for the password:
    ...
    def update_or_create_user(self, user_config: UserConfig) -> AbstractUser:
        ...
        env_config = user_config.envs[self.current_env]
        ...
        if user_db:
            ...
            if env_config.password:
                user_db.password = env_config.password
            else:
