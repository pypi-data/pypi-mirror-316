...
class SFNClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client/#close)
        """
    ...
    async def describe_map_run(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client/#describe_map_run)
        """
    ...
    async def redrive_execution(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client/#redrive_execution)
        """
    ...
    async def update_map_run(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client/#update_map_run)
        """
    ...
    async def validate_state_machine_definition(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client/#validate_state_machine_definition)
        """
