...
rd = self.determine_grid_size(starting_x_size=600, starting_y_size=600, increment=100, min_size=800, max_size=1100)
self.process_save_results(remote, x_size, y_size, band_parameter_dict, time, feature, method, product_code, owner, aggregation_statistic, units, data_license, attribution, encoding, description, frequency_interval='T', utc_offset='0H', run_date=run_date, height=0, public_url=public_url, threads=30)
