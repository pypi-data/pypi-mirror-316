...
class FuncWrapper:
    ...
    # TODO: temporarily disable prompt because it doesn't support resources and secrets
    def make_prompt_not_in_use(
        self, **rtfv_kwargs: Any
    ) -> FeatureView:  # pragma: no cover
        ...
        # TODO: prompt FCO doesn't support secrets
        rtfv_kwargs.pop("secrets", None)
