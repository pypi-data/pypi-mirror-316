...
def analyze(
    ...
    if task == 'outcome':
        ...
        return policy.get_policy(inp, mode, platform)
    elif task == 'offensive':
        return offensive.get_offensive_label(inp, mode, platform)
    elif task == 'sentiment':
        return sentiment.get_sentiment(inp, mode, platform)
    elif task == 'stance':
        return stance.get_stance(inp, mode, platform)
    else:
