...
from ngcbase.environ import NGC_CLI_PROGRESS_BAR_STYLE, NGC_CLI_RICH_OUTPUT
...
class GeneralWrapper:
    ...
    def toJSON(self, pretty=False):  # noqa: D102
        return json.dumps(self._dict, sort_keys=True, indent=4 if pretty else None)
...
class NVPrettyPrint:  # noqa: D101
    ...
    def print_json(dictionary, ensure_ascii=True):  # noqa: D102
        print(json.dumps(dictionary, sort_keys=True, indent=4, ensure_ascii=ensure_ascii))
    ...
    def print_warning(self, string):  # noqa: D102
        ...
        if self.format_type != "json" and self.format_type != "csv":
