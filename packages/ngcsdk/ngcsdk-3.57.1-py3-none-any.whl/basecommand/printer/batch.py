...
class BatchPrinter(NVPrettyPrint):
    ...
    @staticmethod
    def __get_job_start_end_diff_in_min(job_created_date, job_start_date, job_end_date):
        start_diff = ""
        end_diff = ""

        if job_created_date and job_start_date:
            start_diff = "+{0}".format(diff_in_minutes(job_created_date, job_start_date))

        if job_created_date and job_end_date:
            end_diff = "+{0}".format(diff_in_minutes(job_created_date, job_end_date))
