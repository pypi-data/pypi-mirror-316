...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dsql/waiters/)
...
class ClusterActiveWaiter(AIOWaiter):
    ...
    async def wait(self, **kwargs: Unpack[GetClusterInputClusterActiveWaitTypeDef]) -> None:
        """
...
class ClusterNotExistsWaiter(AIOWaiter):
    ...
    async def wait(self, **kwargs: Unpack[GetClusterInputClusterNotExistsWaitTypeDef]) -> None:
        """
