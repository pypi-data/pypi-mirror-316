...
class CustomField(DataModel):
    ...
    def __init__(self, customfield_resp: CustomField):
        self._entityName                  = customfield_resp._entityName
        self._entityKey                   = customfield_resp._entityKey
        self._attributeName               = customfield_resp._attributeName
        self._attributeValue              = customfield_resp._attributeValue
        self._attributeSeq                = customfield_resp._attributeSeq
        self._attributeType               = customfield_resp._attributeType
        self._entityAttributeId           = customfield_resp._entityAttributeId
        self._attributeTypeCode           = customfield_resp._attributeTypeCode
        self._isConfidential              = customfield_resp._isConfidential
