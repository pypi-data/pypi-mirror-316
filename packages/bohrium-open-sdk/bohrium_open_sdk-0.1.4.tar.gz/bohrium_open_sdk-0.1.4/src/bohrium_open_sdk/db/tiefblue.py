...
class Tiefblue(BaseClient):
    ...
    def upload_file(
        ...
        self._upload_file(token.get("data"), file_path, overwrite)
    ...
    def upload_file_bytes(
        ...
        self._upload_file_bytes(token.get("data"), file_bytes, overwrite)
    ...
    def _upload_file_bytes(
        ...
        # 上传文件
        self.tiefblue.upload_from_byte_multi_part(
            object_key=path,
            custom_headers=headers,
            file_name=file_name,
