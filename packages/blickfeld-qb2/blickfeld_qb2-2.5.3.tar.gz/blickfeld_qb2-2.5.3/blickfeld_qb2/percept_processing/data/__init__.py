...
class DetectedObjectProperties(betterproto.Message):
    ...
    is preliminary implementation and might change its behaviour significantly
...
class StateObjectBasedSecurity(betterproto.Message):
    ...
    """
    Confidence that it is a real intrusion.  Calculates a moving average of the
    intrusion state. The moving average window size can be configured with the
    minimum intruding duration parameter.
    """
