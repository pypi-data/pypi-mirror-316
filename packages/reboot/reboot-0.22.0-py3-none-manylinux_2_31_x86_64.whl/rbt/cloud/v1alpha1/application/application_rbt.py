...
class ApplicationServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            state_type_name = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            service_names = [
                reboot.aio.types.ServiceName("rbt.cloud.v1alpha1.application.ApplicationMethods"),
            ],
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(rbt.cloud.v1alpha1.application.application_pb2.CreateRequest, task.request),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=reboot.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=reboot.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownTaskRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=reboot.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
    ...
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.CreateResponse]:
    ...
    async def _schedule_Up(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.UpResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_UpTask(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.UpTaskResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_Down(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.DownResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_DownTask(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.DownTaskResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    def _maybe_authorize(
        ...
        *,
        ...
        request: typing.Optional[ApplicationRequestTypes] = None,
    ) -> typing.Optional[typing.Callable[[typing.Optional[ApplicationStateType]], typing.Awaitable[None]]]:
        ...
        async def authorize(state: typing.Optional[ApplicationStateType]) -> None:
...
class _ApplicationStub(reboot.aio.stubs.Stub):

    __state_type_name__ = reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application')
    ...
    async def Create(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            service_name=reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationMethods'),
            method='Create',
            request=request,
            metadata=metadata,
            ...
            async with self._call(
                reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
                reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationMethods'),
                'Create',
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[attr-defined]
                    if key == reboot.aio.headers.TASK_ID_UUID:
                        return tasks_pb2.TaskId(
                            state_type=reboot.aio.types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
...
ApplicationStateType: typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.Application
ApplicationRequestTypes: typing.TypeAlias = \
...
class ApplicationAuthorizer(
    reboot.aio.auth.authorizers.Authorizer[ApplicationStateType, ApplicationRequestTypes],
):
    StateType: typing.TypeAlias = ApplicationStateType
    RequestTypes: typing.TypeAlias = ApplicationRequestTypes
    ...
    async def authorize(
        ...
        *,
        ...
        state: typing.Optional[ApplicationStateType] = None,
        request: typing.Optional[ApplicationRequestTypes] = None,
        ...
        if method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Create':
            return await self.Create(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.CreateRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Up':
            return await self.Up(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpRequest, request),
            )
            ...
            return await self.Down(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.DownTask':
            return await self.DownTask(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownTaskRequest, request),
            )
        else:
...
class ApplicationServicer(reboot.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = ApplicationAuthorizer
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: typing.Optional[ApplicationServicerMiddleware] = None
    ...
    class Effects(reboot.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
    ...
    class CreateEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
            assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.CreateResponse])
    ...
    class UpEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
            assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.UpResponse])
    ...
    class UpTaskEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
            assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.UpTaskResponse])
    ...
    class DownEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
            assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.DownResponse])
    ...
    class DownTaskEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [rbt.cloud.v1alpha1.application.application_pb2.Application])
            assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.DownTaskResponse])
    ...
    class _State:
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: ApplicationServicer.InlineWriterCallableResult = pickle.loads(response.value)
        ...
        @typing.overload
        def idempotently(self, *, key: uuid.UUID) -> ApplicationServicer._State._Idempotently:
            ...
...
Application_ScheduleTypeVar = typing.TypeVar('Application_ScheduleTypeVar', 'Application.WeakReference._Schedule', 'Application.WeakReference._WriterSchedule')
Application_IdempotentlyScheduleTypeVar = typing.TypeVar('Application_IdempotentlyScheduleTypeVar', 'Application.WeakReference._Schedule', 'Application.WeakReference._WriterSchedule')

class Application:

    Servicer: typing.TypeAlias = ApplicationServicer

    Effects: typing.TypeAlias = ApplicationServicer.Effects

    Authorizer: typing.TypeAlias = ApplicationAuthorizer

    State: typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.Application
    ...
    class CreateFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.CreateResponse]:
    ...
    class UpFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.UpResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    UpEffects: typing.TypeAlias = Servicer.UpEffects

    class UpAborted(reboot.aio.aborted.Aborted):
    ...
    class UpTaskFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.UpTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    UpTaskEffects: typing.TypeAlias = Servicer.UpTaskEffects

    class UpTaskAborted(reboot.aio.aborted.Aborted):
    ...
    class DownFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.DownResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    DownEffects: typing.TypeAlias = Servicer.DownEffects

    class DownAborted(reboot.aio.aborted.Aborted):
    ...
    class DownTaskFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.DownTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    DownTaskEffects: typing.TypeAlias = Servicer.DownTaskEffects

    class DownTaskAborted(reboot.aio.aborted.Aborted):
    ...
    class WeakReference(typing.Generic[Application_ScheduleTypeVar]):
        ...
        def __init__(
            ...
            *,
            ...
            self._reader_stub: typing.Optional[ApplicationReaderStub] = None
            self._writer_stub: typing.Optional[ApplicationWriterStub] = None
            self._workflow_stub: typing.Optional[ApplicationWorkflowStub] = None
            self._tasks_stub: typing.Optional[ApplicationTasksStub] = None
        ...
        class _Idempotently(typing.Generic[Application_IdempotentlyScheduleTypeVar]):
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext | reboot.aio.external.ExternalContext], ApplicationTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[reboot.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Up(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> reboot.aio.tasks.TaskEffect | Application.UpFuture:
            ...
            async def UpTask(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> reboot.aio.tasks.TaskEffect | Application.UpTaskFuture:
                if container_image_name is not None and not isinstance(
                    container_image_name,
                    str,
                ):
            ...
            async def Down(
                ...
                __context__: reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext | reboot.aio.external.ExternalContext,
                __options__: typing.Optional[reboot.aio.call.Options] = None,
            ) -> reboot.aio.tasks.TaskEffect | Application.DownFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.cloud.v1alpha1.application.application_pb2.DownRequest(
            ...
            async def DownTask(
                ...
                __context__: reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext | reboot.aio.external.ExternalContext,
                __options__: typing.Optional[reboot.aio.call.Options] = None,
            ) -> reboot.aio.tasks.TaskEffect | Application.DownTaskFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = rbt.cloud.v1alpha1.application.application_pb2.DownTaskRequest(
        ...
        async def Up(
            ...
            *,
            ...
            return await self._writer(__context__).Up(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
        ...
        async def UpTask(
            ...
            *,
            ...
            return await self._writer(__context__).UpTask(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
        ...
        async def Down(
            ...
            return await self._writer(__context__).Down(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
        ...
        async def DownTask(
            ...
            return await self._writer(__context__).DownTask(
                request,
                idempotency=idempotency,
                metadata=metadata,
                bearer_token=bearer_token,
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self, alias: typing.Optional[str] = None, *, each_iteration: bool = False) -> Application._ConstructIdempotently:
            ...

        @typing.overload
        def idempotently(self, *, key: uuid.UUID) -> Application._ConstructIdempotently:
            ...
