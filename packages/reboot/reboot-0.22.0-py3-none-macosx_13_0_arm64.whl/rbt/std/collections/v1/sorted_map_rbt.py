...
class SortedMapServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            state_type_name = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            service_names = [
                reboot.aio.types.ServiceName("rbt.std.collections.v1.SortedMapMethods"),
            ],
        ...
        if method == 'Insert':
            ...
            async with self._state_manager.reactively(
                ...
                async for (state, idempotency_keys) in states:
                    ...
                    @maybe_run_function_twice_to_validate_effects
                    async def run__Get(validating_effects: bool) -> google.protobuf.message.Message:
            ...
            async with self._state_manager.reactively(
                ...
                async for (state, idempotency_keys) in states:
                    ...
                    # see https://github.com/reboot-dev/respect/issues/2636.
                    @maybe_run_function_twice_to_validate_effects
                    async def run__ReverseRange(validating_effects: bool) -> google.protobuf.message.Message:
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
    ...
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.InsertResponse]:
    ...
    async def _schedule_Remove(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.RemoveResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_Get(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_Range(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    async def _schedule_ReverseRange(
        ...
        *,
        ...
        headers: reboot.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[reboot.aio.contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
        context: reboot.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            context_type=reboot.aio.contexts.WriterContext,
    ...
    def _maybe_authorize(
        ...
        *,
    ...
    ) -> typing.Optional[typing.Callable[[typing.Optional[SortedMapStateType]], typing.Awaitable[None]]]:
        ...
        async def authorize(state: typing.Optional[SortedMapStateType]) -> None:
...
class _SortedMapStub(reboot.aio.stubs.Stub):

    __state_type_name__ = reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap')
    ...
    async def Get(
        ...
        *,
        ...
        async with self._call(
            reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            reboot.aio.types.ServiceName('rbt.std.collections.v1.SortedMapMethods'),
            'Get',
    ...
    async def Insert(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            service_name=reboot.aio.types.ServiceName('rbt.std.collections.v1.SortedMapMethods'),
            method='Insert',
            request=request,
            metadata=metadata,
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[attr-defined]
                    if key == reboot.aio.headers.TASK_ID_UUID:
                        return tasks_pb2.TaskId(
                            state_type=reboot.aio.types.StateTypeName('rbt.std.collections.v1.SortedMap'),
...
class SortedMapAuthorizer(
    reboot.aio.auth.authorizers.Authorizer[SortedMapStateType, SortedMapRequestTypes],
):
        ...
        *,
        ...
        if method_name == 'rbt.std.collections.v1.SortedMapMethods.Insert':
            ...
            return await self.Get(
                context,
                typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, request),
            )
            ...
            return await self.ReverseRange(
                context,
                typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, request),
            )
        else:
...
class SortedMapServicer(reboot.aio.servicers.Servicer):
    ...
    class _State:
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: SortedMapServicer.InlineWriterCallableResult = pickle.loads(response.value)
        ...
        @typing.overload
        def idempotently(self, *, key: uuid.UUID) -> SortedMapServicer._State._Idempotently:
            ...
...
class SortedMap:
    ...
    Servicer: typing.TypeAlias = SortedMapServicer
    ...
    InsertEffects: typing.TypeAlias = Servicer.InsertEffects

    class InsertAborted(reboot.aio.aborted.Aborted):
    ...
    RemoveEffects: typing.TypeAlias = Servicer.RemoveEffects

    class RemoveAborted(reboot.aio.aborted.Aborted):
    ...
    class GetFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class GetAborted(reboot.aio.aborted.Aborted):
    ...
    class RangeAborted(reboot.aio.aborted.Aborted):
    ...
    class ReverseRangeFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class ReverseRangeAborted(reboot.aio.aborted.Aborted):
    ...
    class WeakReference(typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            ) -> typing.AsyncIterator[rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
            ...
            async def ReverseRange(
                ...
                *,
                ...
                end_key: typing.Optional[str] = None,
                limit: typing.Optional[int] = None,
            ) -> typing.AsyncIterator[rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext | reboot.aio.external.ExternalContext], SortedMapTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[reboot.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Insert(
                ...
                *,
                entries: typing.Optional[dict[str, bytes]] = None,
            ) -> reboot.aio.tasks.TaskEffect | SortedMap.InsertFuture:
            ...
            async def Remove(
                ...
                *,
                keys: typing.Optional[list[str]] = None,
            ) -> reboot.aio.tasks.TaskEffect | SortedMap.RemoveFuture:
            ...
            async def Get(
                ...
                *,
                key: typing.Optional[str] = None,
            ) -> reboot.aio.tasks.TaskEffect | SortedMap.GetFuture:
            ...
            async def Range(
                ...
                *,
                ...
                end_key: typing.Optional[str] = None,
                limit: typing.Optional[int] = None,
            ) -> reboot.aio.tasks.TaskEffect | SortedMap.RangeFuture:
            ...
            async def ReverseRange(
                ...
                *,
                ...
                end_key: typing.Optional[str] = None,
                limit: typing.Optional[int] = None,
            ) -> reboot.aio.tasks.TaskEffect | SortedMap.ReverseRangeFuture:
                if start_key is not None and not isinstance(
                    start_key,
                    str,
                ):
                ...
                return SortedMap.ReverseRangeFuture(
                    __context__,
                    task_id=task_id,
                )
        ...
        async def Get(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    bearer_token = __options__.bearer_token
            return await self._reader(__context__).Get(
                request,
                metadata=metadata,
                bearer_token=bearer_token,
            )
        ...
        async def ReverseRange(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    bearer_token = __options__.bearer_token
            return await self._reader(__context__).ReverseRange(
                request,
                metadata=metadata,
                bearer_token=bearer_token,
            )
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self, alias: typing.Optional[str] = None, *, each_iteration: bool = False) -> SortedMap._ConstructIdempotently:
            ...
