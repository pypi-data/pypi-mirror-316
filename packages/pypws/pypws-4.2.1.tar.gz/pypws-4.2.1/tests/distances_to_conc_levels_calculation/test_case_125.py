...
from pypws.enums import AtmosphericStabilityClass, ResultCode, SurfaceType
...
def test_case_125():
    ...
    # Set up the entities required by the distances to conc levels calculation.
