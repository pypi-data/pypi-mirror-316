...
def test_case_118():
    ...
    dispersion_output_config = DispersionOutputConfig(concentration = end_point_concentration, downwind_distance= 10)
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs(concentration_at_point_calculation.concentration -0.0037570678698867137)/0.0037570678698867137 > 1e-3):
