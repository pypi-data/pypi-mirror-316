...
def test_case_119():
    ...
    dispersion_output_config = DispersionOutputConfig(concentration = end_point_concentration, downwind_distance=140, time = 5, elevation = 1)
    ...
    if resultCode == resultCode.SUCCESS:
        if (abs(concentration_at_point_calculation.concentration -1.0877193779420193e-05)/1.0877193779420193e-05 > 1e-3):
