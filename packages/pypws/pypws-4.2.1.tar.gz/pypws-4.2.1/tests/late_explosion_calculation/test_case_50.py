...
def test_50():
    ...
    explosion_output_configs = [ExplosionOutputConfig(overpressure_level = 1034), ExplosionOutputConfig(overpressure_level = 2068), ExplosionOutputConfig(overpressure_level = 8272)]
