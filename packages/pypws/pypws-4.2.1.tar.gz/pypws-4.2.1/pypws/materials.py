...
# Version:   4.2.1
# Date/time: 18 Dec 2024 17:26:31
...
def get_material_by_cas_id(cas_id: str) -> Material:
    """
    ...
    url = f'{get_materials_api_target()}materials/casid={cas_id}?clientId={get_client_alias_id()}'
