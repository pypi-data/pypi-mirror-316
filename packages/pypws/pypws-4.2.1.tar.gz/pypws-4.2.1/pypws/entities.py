...
# Version:   4.2.1
# Date/time: 18 Dec 2024 17:26:33
...
class MaterialComponentData(EntityBase):
    ...
    def __init__(self, name: str, dippr_version: int, cas_id: int, data_item: List[MaterialComponentDataItem], non_standard: bool):
    ...
    def initialise_from_dictionary(self, data: dict):
        ...
        self.non_standard = bool(data.get('non_standard', self.non_standard))
    ...
    def __str__(self):
        parts = [
            ...
            f'Non Standard:       {self.non_standard}',
        ]
        return '\n'.join(parts)
