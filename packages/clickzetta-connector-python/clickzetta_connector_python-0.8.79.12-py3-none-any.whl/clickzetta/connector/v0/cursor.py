...
class Cursor(object):
    ...
    def is_job_finished(self, job_id: str = None, retry_times=1):
        ...
        if is_finished:
            self._query_result = QueryResult(result, self.connection._pure_arrow_decoding, timezone_hint=_client.timezone_hint)
        return is_finished
    ...
    def executemany(self, operation: str, seqparams: Union[Sequence[Any], dict, None] = None, parameters=None):
        ...
        batch_size = 1024
        base_sql = operation.replace("value", "VALUES").split("VALUES")[0].strip()
