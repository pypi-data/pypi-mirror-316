...
enum [[deprecated]] : int {
    ...
    SBK_QSHAREDPOINTER_QT3DRENDER_QTEXTUREIMAGEDATA_IDX      = 360, // QSharedPointer<Qt3DRender::QTextureImageData>
    SBK_QSHAREDPOINTER_CONSTQT3DRENDER_QTEXTUREIMAGEDATA_IDX = 360, // (const)
    ...
    SBK_QSHAREDPOINTER_QT3DRENDER_PROPERTYREADERINTERFACE_IDX = 364, // QSharedPointer<Qt3DRender::PropertyReaderInterface>
    SBK_QSHAREDPOINTER_CONSTQT3DRENDER_PROPERTYREADERINTERFACE_IDX = 364, // (const)
...
enum : int {
    ...
    SBK_QSharedPointer_Qt3DRender_QTextureImageData_IDX      = 180, // QSharedPointer<Qt3DRender::QTextureImageData>
    SBK_QSharedPointer_constQt3DRender_QTextureImageData_IDX = 180, // (const)
    ...
    SBK_QSharedPointer_Qt3DRender_PropertyReaderInterface_IDX = 182, // QSharedPointer<Qt3DRender::PropertyReaderInterface>
    SBK_QSharedPointer_constQt3DRender_PropertyReaderInterface_IDX = 182, // (const)
...
enum [[deprecated]] : int {
    ...
    SBK_QT3DRENDER_QLIST_QT3DCORE_QENTITYPTR_IDX             = 2, // QList<Qt3DCore::QEntity*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QRAYCASTERHIT_IDX        = 4, // QList<Qt3DRender::QRayCasterHit>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QLAYERPTR_IDX            = 6, // QList<Qt3DRender::QLayer*>
    SBK_QT3DRENDER_QLIST_QOBJECTPTR_IDX                      = 8, // QList<QObject*>
    SBK_QT3DRENDER_QLIST_QBYTEARRAY_IDX                      = 10, // QList<QByteArray>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QABSTRACTTEXTUREIMAGEPTR_IDX = 12, // QList<Qt3DRender::QAbstractTextureImage*>
    SBK_QT3DRENDER_QLIST_QT3DCORE_QNODEPTR_IDX               = 14, // QList<Qt3DCore::QNode*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QFILTERKEYPTR_IDX        = 16, // QList<Qt3DRender::QFilterKey*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QPARAMETERPTR_IDX        = 18, // QList<Qt3DRender::QParameter*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QRENDERSTATEPTR_IDX      = 20, // QList<Qt3DRender::QRenderState*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX = 22, // QList<Qt3DRender::QSortPolicy::SortType>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QRENDERTARGETOUTPUTPTR_IDX = 24, // QList<Qt3DRender::QRenderTargetOutput*>
    SBK_QT3DRENDER_QLIST_QT3DCORE_QCOMPONENTPTR_IDX          = 26, // QList<Qt3DCore::QComponent*>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QTECHNIQUEPTR_IDX        = 28, // QList<Qt3DRender::QTechnique*>
    SBK_QT3DRENDER_QLIST_QREAL_IDX                           = 30, // QList<qreal>
    SBK_QT3DRENDER_STD_VECTOR_QSHAREDPOINTER_QT3DCORE_QASPECTJOB_IDX = 32, // std::vector<QSharedPointer<Qt3DCore::QAspectJob>>
    SBK_QT3DRENDER_QLIST_QT3DRENDER_QRENDERPASSPTR_IDX       = 34, // QList<Qt3DRender::QRenderPass*>
    SBK_QT3DRENDER_QLIST_QSHAREDPOINTER_QT3DRENDER_QTEXTUREIMAGEDATA_IDX = 36, // QList<QSharedPointer<Qt3DRender::QTextureImageData>>
    SBK_QT3DRENDER_QLIST_QVARIANT_IDX                        = 38, // QList<QVariant>
    SBK_QT3DRENDER_QLIST_QSTRING_IDX                         = 40, // QList<QString>
    SBK_QT3DRENDER_QMAP_QSTRING_QVARIANT_IDX                 = 42, // QMap<QString,QVariant>
    SBK_QT3DRENDER_CONVERTERS_IDX_COUNT                      = 44,
};
