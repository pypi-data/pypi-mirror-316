...
pyside_library_soversion = str(6.8)

version = "6.8.1.1"
version_info = (6, 8, 1.1, "", "")

__build_date__ = '2024-12-19T10:28:45+00:00'




__setup_py_package_version__ = '6.8.1.1'
__qt_macos_min_deployment_target__ = '12'
