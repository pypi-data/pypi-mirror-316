...
from livewrapped_sdk import LivewrappedSDK, AsyncLivewrappedSDK, APIResponseValidationError
from livewrapped_sdk._types import Omit
from livewrapped_sdk._models import BaseModel, FinalRequestOptions
from livewrapped_sdk._constants import RAW_RESPONSE_HEADER
from livewrapped_sdk._exceptions import APIStatusError, APITimeoutError, LivewrappedSDKError, APIResponseValidationError
from livewrapped_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: LivewrappedSDK | AsyncLivewrappedSDK) -> int:
...
class TestLivewrappedSDK:
    client = LivewrappedSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "livewrapped_sdk/_legacy_response.py",
                        "livewrapped_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "livewrapped_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LivewrappedSDKError):
            with update_env(**{"BEARER_TOKEN": Omit()}):
                client2 = LivewrappedSDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: LivewrappedSDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(LIVEWRAPPED_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = LivewrappedSDK(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: LivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: LivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: LivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = LivewrappedSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = LivewrappedSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("livewrapped_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/Account/login").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/Account/login",
                body=cast(object, dict(email="x", password="x")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/Account/login").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/Account/login").mock(side_effect=retry_handler)

        response = client.account.with_raw_response.login(email="x", password="x")
    ...
    def test_omit_retry_count_header(
        self, client: LivewrappedSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.account.with_raw_response.login(
            email="x", password="x", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.account.with_raw_response.login(
            email="x", password="x", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncLivewrappedSDK:
    client = AsyncLivewrappedSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LivewrappedSDKError):
            with update_env(**{"BEARER_TOKEN": Omit()}):
                client2 = AsyncLivewrappedSDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncLivewrappedSDK) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(LIVEWRAPPED_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLivewrappedSDK(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLivewrappedSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLivewrappedSDK(
        ...
        client = AsyncLivewrappedSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncLivewrappedSDK,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.account.with_raw_response.login(email="x", password="x")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLivewrappedSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.account.with_raw_response.login(
            email="x", password="x", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from livewrapped_sdk._utils import asyncify
        from livewrapped_sdk._base_client import get_platform 
