...
class TestPublishers:
    ...
    def test_method_retrieve(self, client: LivewrappedSDK) -> None:
        publisher = client.stats_inventory.publishers.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PublisherMinimal, publisher, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: LivewrappedSDK) -> None:
        response = client.stats_inventory.publishers.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        publisher = response.parse()
        assert_matches_type(PublisherMinimal, publisher, path=["response"])

    @parametrize
    def test_streaming_response_retrieve(self, client: LivewrappedSDK) -> None:
        with client.stats_inventory.publishers.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: LivewrappedSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `publisher_id` but received ''"):
            client.stats_inventory.publishers.with_raw_response.retrieve(
                "",
            )


class TestAsyncPublishers:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_retrieve(self, async_client: AsyncLivewrappedSDK) -> None:
        publisher = await async_client.stats_inventory.publishers.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PublisherMinimal, publisher, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLivewrappedSDK) -> None:
        response = await async_client.stats_inventory.publishers.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        publisher = await response.parse()
        assert_matches_type(PublisherMinimal, publisher, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncLivewrappedSDK) -> None:
        async with async_client.stats_inventory.publishers.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLivewrappedSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `publisher_id` but received ''"):
            await async_client.stats_inventory.publishers.with_raw_response.retrieve(
                "",
            )
