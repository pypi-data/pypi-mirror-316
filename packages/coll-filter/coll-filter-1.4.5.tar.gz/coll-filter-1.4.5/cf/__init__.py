...
class CollFilter(Generic[U, T]):
    ...
    def __init__(self, data: Iterable[Tuple[U, T, float]], n_jobs=os.cpu_count(), row_unique=False, num_user_items=128, 
                 num_item_users=128, similar_fn=default_similar_func, cache_similar: bool = False, verbose: bool = False):
        """
        初始化协作过滤推荐系统。
