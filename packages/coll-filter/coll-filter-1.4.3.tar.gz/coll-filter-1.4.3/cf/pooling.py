...
class PoolCollFilter(BaseCollFilter):
    ...
    def __init__(self, data: Iterable[Tuple[U, T, float]], n_jobs=0, row_unique=False, num_item_users=128,
                 similar_fn=default_similar_func, cache_similar: bool = False, verbose: bool = False):
        super().__init__(data, row_unique, num_item_users, similar_fn, cache_similar, verbose)
