...
class RunCompletedWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[GetRunRequestRunCompletedWaitTypeDef]) -> None:
        """
...
class RunRunningWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[GetRunRequestRunRunningWaitTypeDef]) -> None:
        """
...
class TaskCompletedWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[GetRunTaskRequestTaskCompletedWaitTypeDef]) -> None:
        """
...
class TaskRunningWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[GetRunTaskRequestTaskRunningWaitTypeDef]) -> None:
        """
...
class VariantStoreCreatedWaiter(AIOWaiter):
    ...
    """
    async def wait(
        self, **kwargs: Unpack[GetVariantStoreRequestVariantStoreCreatedWaitTypeDef]
    ) -> None:
        """
...
class VariantStoreDeletedWaiter(AIOWaiter):
    ...
    """
    async def wait(
        self, **kwargs: Unpack[GetVariantStoreRequestVariantStoreDeletedWaitTypeDef]
    ) -> None:
        """
...
class WorkflowActiveWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[GetWorkflowRequestWorkflowActiveWaitTypeDef]) -> None:
        """
