...
class DataRetrieval(BaseSDK):
    def list_snapshots(
        ...
        *,
        ...
        :param filter_: A CEL string to filter results; See the [CEL Search](https://developer.apexclearing.com/apex-fintech-solutions/docs/cel-search) page in Guides for more information; Filter options include:  `snapshot_id`  `process_date`
        :param page_size: The number of snapshots to be returned per page. Defaults to 500. Maximum is 1000.
        :param page_token: The token used to retrieve a page of snapshots.
        ...
        if utils.match_response(http_res, ["403", "500"], "application/json"):
