...
class ContributionSummaryTypedDict(TypedDict):
    ...
    r"""Retirement account id these contribution amounts are for"""
...
class ContributionSummary(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["name", "regular_amount", "rollover_amount", "tax_year"]
        nullable_fields = ["regular_amount", "rollover_amount"]
        null_default_fields = []
