...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-account)](https://pypistats.org/packages/mypy-boto3-account)
...
`mypy-boto3-account` dependency in production. However, there is an issue in
