...
#ifndef CHACHA_PORTABLE
#define CHACHA_PORTABLE
...
#define CHACHA_DEFAULT_WTOW

#ifdef CHACHA_LITTLE_ENDIAN
...
#define CHACHA_DEFAULT_BTOW

#if (!defined(CHACHA_UNKNOWN) && defined(CHACHA_I8T_IS_BYTE))
