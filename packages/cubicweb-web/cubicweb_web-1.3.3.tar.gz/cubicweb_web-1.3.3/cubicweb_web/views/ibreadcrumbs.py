...
class BreadCrumbEntityVComponent(basecomponents.HeaderComponent):
    ...
    __select__ = (
        basecomponents.HeaderComponent.__select__
        & one_line_rset()
    ...
    def open_breadcrumbs(self, w):
        w('<span id="breadcrumbs" class="pathbar">')
    ...
    def wpath_part(
        self, w, part, contextentity, last=False
    ):  # XXX deprecates last argument?
...
class BreadCrumbView(EntityView):
    ...
    def cell_call(self, row, col, **kwargs):
        ...
        self.w(
            tags.a(
                entity.view("breadcrumbtext"), href=entity.absolute_url(), title=desc
            )
        )
