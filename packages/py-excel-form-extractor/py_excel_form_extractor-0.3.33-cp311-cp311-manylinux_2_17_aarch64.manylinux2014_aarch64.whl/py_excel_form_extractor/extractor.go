...
gopy build -no-make -dynamic-link=True -rename=True -output /project/build/lib.linux-aarch64-cpython-311/py_excel_form_extractor -vm /opt/python/cp311-cp311/bin/python ./pkg/extractor ./pkg/utils
*/
