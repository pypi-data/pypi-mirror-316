...
gopy build -no-make -dynamic-link=True -rename=True -output /project/build/lib.linux-aarch64-cpython-313/py_excel_form_extractor -vm /opt/python/cp313-cp313/bin/python ./pkg/extractor ./pkg/utils
*/
