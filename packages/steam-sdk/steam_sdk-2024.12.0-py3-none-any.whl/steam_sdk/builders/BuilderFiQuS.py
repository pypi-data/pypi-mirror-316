...
class BuilderFiQuS:
    ...
    def __init__(self,
        ...
        if flag_build:
            ...
            ins_type = {'1': 'G10', '1.0': 'G10', 'G10': 'G10', 1: 'G10', '2': 'kapton', '2.0': 'kapton', 'Kapton': 'kapton', 2: 'kapton'}
    ...
    def buildDataCWS(self, model_data):
        ...
        for key, value in model_data.Options_FiQuS.cws.solve.model_dump().items():       # for keys that are present in the FiQUS Options model data (but not all keys in data FiQuS)
            if key not in ['conductors']:
                ...
                self.data_FiQuS.magnet.solve.conductors.excitation.function.initials = [model_data.Power_Supply.I_initial] * len(model_data.Options_FiQuS.cws.solve.conductors.excitation.multips)
