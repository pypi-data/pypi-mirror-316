...
_REPO_LINK = "https://github.com/keeweb/keeweb-badges-ghcr"
        ...
        return jsonify(
            {
                ...
                "example_paths": [
                    "/",
                    "/keeweb/keeweb-badges-ghcr/tags",
                    "/keeweb/keeweb-badges-ghcr/latest_tag",
                    "/keeweb/keeweb-badges-ghcr/size",
...
def get_tags(package_owner: str, package_name: str) -> Response:
    ...
    ----------
    package_owner : str
        package owner name, e.g. 'keeweb'
    package_name : str
        package name, e.g. 'keeweb'
