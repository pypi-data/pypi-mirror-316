...
class EntityResolutionClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_entityresolution/client/#close)
        """
    ...
    async def put_policy(
        self, **kwargs: Unpack[PutPolicyInputRequestTypeDef]
    ) -> PutPolicyOutputTypeDef:
        """
