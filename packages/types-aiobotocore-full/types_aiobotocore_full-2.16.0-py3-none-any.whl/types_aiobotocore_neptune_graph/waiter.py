...
class ExportTaskCancelledWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#exporttaskcancelledwaiter)
    """

    async def wait(
        self, **kwargs: Unpack[GetExportTaskInputExportTaskCancelledWaitTypeDef]
    ) -> None:
        """
...
class ExportTaskSuccessfulWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#exporttasksuccessfulwaiter)
    """

    async def wait(
        self, **kwargs: Unpack[GetExportTaskInputExportTaskSuccessfulWaitTypeDef]
    ) -> None:
        """
...
class GraphAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#graphavailablewaiter)
    """

    async def wait(self, **kwargs: Unpack[GetGraphInputGraphAvailableWaitTypeDef]) -> None:
        """
...
class GraphDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#graphdeletedwaiter)
    """

    async def wait(self, **kwargs: Unpack[GetGraphInputGraphDeletedWaitTypeDef]) -> None:
        """
...
class GraphSnapshotAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#graphsnapshotavailablewaiter)
    """
...
class GraphSnapshotDeletedWaiter(AIOWaiter):
    ...
    async def wait(
        self, **kwargs: Unpack[GetGraphSnapshotInputGraphSnapshotDeletedWaitTypeDef]
    ) -> None:
        """
...
class ImportTaskCancelledWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#importtaskcancelledwaiter)
    """

    async def wait(
        self, **kwargs: Unpack[GetImportTaskInputImportTaskCancelledWaitTypeDef]
    ) -> None:
        """
...
class ImportTaskSuccessfulWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#importtasksuccessfulwaiter)
    """

    async def wait(
        self, **kwargs: Unpack[GetImportTaskInputImportTaskSuccessfulWaitTypeDef]
    ) -> None:
        """
...
class PrivateGraphEndpointAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#privategraphendpointavailablewaiter)
    """
...
class PrivateGraphEndpointDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_neptune_graph/waiters/#privategraphendpointdeletedwaiter)
    """
