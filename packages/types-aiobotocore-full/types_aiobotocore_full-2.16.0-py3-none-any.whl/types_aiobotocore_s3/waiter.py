...
class BucketExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3/waiters/#bucketexistswaiter)
    """

    async def wait(self, **kwargs: Unpack[HeadBucketRequestBucketExistsWaitTypeDef]) -> None:
        """
...
class BucketNotExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3/waiters/#bucketnotexistswaiter)
    """

    async def wait(self, **kwargs: Unpack[HeadBucketRequestBucketNotExistsWaitTypeDef]) -> None:
        """
...
class ObjectExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3/waiters/#objectexistswaiter)
    """

    async def wait(self, **kwargs: Unpack[HeadObjectRequestObjectExistsWaitTypeDef]) -> None:
        """
...
class ObjectNotExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3/waiters/#objectnotexistswaiter)
    """

    async def wait(self, **kwargs: Unpack[HeadObjectRequestObjectNotExistsWaitTypeDef]) -> None:
        """
