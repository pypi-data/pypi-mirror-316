...
class WorkDocsClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workdocs/client/close.html)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_workdocs/client/#close)
        """
    ...
    async def create_labels(
        self, **kwargs: Unpack[CreateLabelsRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    async def delete_labels(
        self, **kwargs: Unpack[DeleteLabelsRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
