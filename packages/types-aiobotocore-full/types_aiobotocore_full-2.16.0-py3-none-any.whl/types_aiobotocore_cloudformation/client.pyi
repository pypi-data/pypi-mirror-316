...
class CloudFormationClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudformation/client/close.html)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client/#close)
        """
    ...
    async def list_types(
        self, **kwargs: Unpack[ListTypesInputRequestTypeDef]
    ) -> ListTypesOutputTypeDef:
        """
    ...
    async def test_type(
        self, **kwargs: Unpack[TestTypeInputRequestTypeDef]
    ) -> TestTypeOutputTypeDef:
        """
