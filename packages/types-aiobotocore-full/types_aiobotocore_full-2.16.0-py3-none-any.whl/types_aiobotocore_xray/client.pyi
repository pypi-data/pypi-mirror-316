...
class XRayClient(AioBaseClient):
    ...
    async def cancel_trace_retrieval(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#cancel_trace_retrieval)
        """
    ...
    async def get_indexing_rules(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#get_indexing_rules)
        """
    ...
    async def get_retrieved_traces_graph(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#get_retrieved_traces_graph)
        """
    ...
    async def get_trace_segment_destination(self) -> GetTraceSegmentDestinationResultTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#get_trace_segment_destination)
        """
    ...
    async def list_retrieved_traces(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#list_retrieved_traces)
        """
    ...
    async def start_trace_retrieval(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#start_trace_retrieval)
        """
    ...
    async def update_indexing_rule(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#update_indexing_rule)
        """
    ...
    async def update_trace_segment_destination(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client/#update_trace_segment_destination)
        """
