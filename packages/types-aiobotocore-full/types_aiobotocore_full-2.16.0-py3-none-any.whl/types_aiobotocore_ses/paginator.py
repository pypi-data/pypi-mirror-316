...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/)
...
class ListConfigurationSetsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/#listconfigurationsetspaginator)
    """
...
class ListCustomVerificationEmailTemplatesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/#listcustomverificationemailtemplatespaginator)
    """
...
class ListIdentitiesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/#listidentitiespaginator)
    """
...
class ListReceiptRuleSetsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/#listreceiptrulesetspaginator)
    """
...
class ListTemplatesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ses/paginators/#listtemplatespaginator)
    """
