...
class DocDBElasticClient(AioBaseClient):
    ...
    async def apply_pending_maintenance_action(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_docdb_elastic/client/#apply_pending_maintenance_action)
        """
    ...
    async def get_pending_maintenance_action(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_docdb_elastic/client/#get_pending_maintenance_action)
        """
    ...
    async def list_pending_maintenance_actions(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_docdb_elastic/client/#list_pending_maintenance_actions)
        """
