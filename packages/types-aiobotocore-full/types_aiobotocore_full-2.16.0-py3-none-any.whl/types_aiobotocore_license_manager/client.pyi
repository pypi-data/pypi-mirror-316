...
class LicenseManagerClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_license_manager/client/#close)
        """
    ...
    async def get_grant(
        self, **kwargs: Unpack[GetGrantRequestRequestTypeDef]
    ) -> GetGrantResponseTypeDef:
        """
