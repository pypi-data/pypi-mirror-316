...
class VaultExistsWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeVaultInputVaultExistsWaitTypeDef]) -> None:
        """
...
class VaultNotExistsWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeVaultInputVaultNotExistsWaitTypeDef]) -> None:
        """
