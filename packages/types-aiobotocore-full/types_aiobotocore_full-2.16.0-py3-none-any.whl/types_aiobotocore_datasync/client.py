...
class DataSyncClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_datasync/client/#close)
        """
    ...
    async def delete_task(
        self, **kwargs: Unpack[DeleteTaskRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
