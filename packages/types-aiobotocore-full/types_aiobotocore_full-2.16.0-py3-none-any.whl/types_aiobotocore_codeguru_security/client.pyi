...
class CodeGuruSecurityClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codeguru_security/client/#close)
        """
    ...
    async def get_scan(
        self, **kwargs: Unpack[GetScanRequestRequestTypeDef]
    ) -> GetScanResponseTypeDef:
        """
