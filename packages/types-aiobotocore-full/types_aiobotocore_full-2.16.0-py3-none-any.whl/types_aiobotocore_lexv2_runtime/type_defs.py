...
class StartConversationResponseTypeDef(TypedDict):
    responseEventStream: "AioEventStream[StartConversationResponseEventStreamTypeDef]"
    ResponseMetadata: ResponseMetadataTypeDef
...
class StartConversationRequestRequestTypeDef(TypedDict):
    ...
    localeId: str
    sessionId: str
    requestEventStream: "AioEventStream[StartConversationRequestEventStreamTypeDef]"
