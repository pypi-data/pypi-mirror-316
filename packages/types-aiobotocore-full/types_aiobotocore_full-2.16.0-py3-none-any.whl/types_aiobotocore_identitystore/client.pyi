...
class IdentityStoreClient(AioBaseClient):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/identitystore.html#IdentityStore.Client)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#can_paginate)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#generate_presigned_url)
        """

    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/identitystore/client/close.html)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#close)
        """
    ...
    async def create_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#create_group)
        """
    ...
    async def create_group_membership(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#create_group_membership)
        """
    ...
    async def create_user(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#create_user)
        """
    ...
    async def delete_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#delete_group)
        """
    ...
    async def delete_group_membership(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#delete_group_membership)
        """
    ...
    async def delete_user(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#delete_user)
        """
    ...
    async def describe_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#describe_group)
        """
    ...
    async def describe_group_membership(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#describe_group_membership)
        """
    ...
    async def describe_user(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#describe_user)
        """
    ...
    async def get_group_id(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#get_group_id)
        """
    ...
    async def get_group_membership_id(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#get_group_membership_id)
        """
    ...
    async def get_user_id(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#get_user_id)
        """
    ...
    async def is_member_in_groups(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#is_member_in_groups)
        """
    ...
    async def list_group_memberships(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#list_group_memberships)
        """
    ...
    async def list_group_memberships_for_member(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#list_group_memberships_for_member)
        """
    ...
    async def list_groups(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#list_groups)
        """
    ...
    async def list_users(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#list_users)
        """
    ...
    async def update_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#update_group)
        """
    ...
    async def update_user(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#update_user)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_identitystore/client/#get_paginator)
        """
