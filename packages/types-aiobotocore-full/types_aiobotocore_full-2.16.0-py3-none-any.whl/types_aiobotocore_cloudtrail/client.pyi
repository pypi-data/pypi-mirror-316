...
class CloudTrailClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudtrail/client/close.html)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cloudtrail/client/#close)
        """

    async def add_tags(self, **kwargs: Unpack[AddTagsRequestRequestTypeDef]) -> Dict[str, Any]:
        """
    ...
    async def delete_trail(
        self, **kwargs: Unpack[DeleteTrailRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Deletes a trail.
    ...
    async def get_trail(
        self, **kwargs: Unpack[GetTrailRequestRequestTypeDef]
    ) -> GetTrailResponseTypeDef:
        """
    ...
    async def start_logging(
        self, **kwargs: Unpack[StartLoggingRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    async def stop_logging(
        self, **kwargs: Unpack[StopLoggingRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
