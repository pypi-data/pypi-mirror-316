...
class AppStreamClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#close)
        """
    ...
    async def start_fleet(
        self, **kwargs: Unpack[StartFleetRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    async def stop_fleet(self, **kwargs: Unpack[StopFleetRequestRequestTypeDef]) -> Dict[str, Any]:
        """
