...
class StorageGatewayClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_storagegateway/client/#close)
        """
    ...
    async def add_cache(
        self, **kwargs: Unpack[AddCacheInputRequestTypeDef]
    ) -> AddCacheOutputTypeDef:
        """
    ...
    async def list_tapes(
        self, **kwargs: Unpack[ListTapesInputRequestTypeDef]
    ) -> ListTapesOutputTypeDef:
        """
