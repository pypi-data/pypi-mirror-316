...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_connectcampaignsv2/type_defs/)
...
class ListConnectInstanceIntegrationsRequestListConnectInstanceIntegrationsPaginateTypeDef(
    TypedDict
):
    connectInstanceId: str
