...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/)
...
class AppExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#appexistswaiter)
    """

    async def wait(self, **kwargs: Unpack[DescribeAppsRequestAppExistsWaitTypeDef]) -> None:
        """
...
class DeploymentSuccessfulWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#deploymentsuccessfulwaiter)
    """
...
class InstanceOnlineWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#instanceonlinewaiter)
    """

    async def wait(
        self, **kwargs: Unpack[DescribeInstancesRequestInstanceOnlineWaitTypeDef]
    ) -> None:
        """
...
class InstanceRegisteredWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#instanceregisteredwaiter)
    """

    async def wait(
        self, **kwargs: Unpack[DescribeInstancesRequestInstanceRegisteredWaitTypeDef]
    ) -> None:
        """
...
class InstanceStoppedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#instancestoppedwaiter)
    """
...
class InstanceTerminatedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opsworks/waiters/#instanceterminatedwaiter)
    """
