...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_security_ir/paginators/)
...
class ListCaseEditsPaginator(AioPaginator):
    """
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_security_ir/paginators/#listcaseeditspaginator)
    """
    def paginate(
        self, **kwargs: Unpack[ListCaseEditsRequestListCaseEditsPaginateTypeDef]
    ) -> AsyncIterator[ListCaseEditsResponseTypeDef]:
        """
...
class ListCasesPaginator(AioPaginator):
    """
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_security_ir/paginators/#listcasespaginator)
    """
    def paginate(
        self, **kwargs: Unpack[ListCasesRequestListCasesPaginateTypeDef]
    ) -> AsyncIterator[ListCasesResponseTypeDef]:
        """
...
class ListCommentsPaginator(AioPaginator):
    """
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_security_ir/paginators/#listcommentspaginator)
    """
    def paginate(
        self, **kwargs: Unpack[ListCommentsRequestListCommentsPaginateTypeDef]
    ) -> AsyncIterator[ListCommentsResponseTypeDef]:
        """
...
class ListMembershipsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_security_ir/paginators/#listmembershipspaginator)
    """
    def paginate(
        self, **kwargs: Unpack[ListMembershipsRequestListMembershipsPaginateTypeDef]
    ) -> AsyncIterator[ListMembershipsResponseTypeDef]:
        """
