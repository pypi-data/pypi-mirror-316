...
class AppSyncClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/appsync/client/close.html)
    ...
    async def create_api(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#create_api)
        """
    ...
    async def create_channel_namespace(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#create_channel_namespace)
        """
    ...
    async def delete_api(self, **kwargs: Unpack[DeleteApiRequestRequestTypeDef]) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#delete_api)
        """
    ...
    async def delete_channel_namespace(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#delete_channel_namespace)
        """
    ...
    async def get_api(self, **kwargs: Unpack[GetApiRequestRequestTypeDef]) -> GetApiResponseTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#get_api)
        """
    ...
    async def get_channel_namespace(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#get_channel_namespace)
        """
    ...
    async def list_apis(
        self, **kwargs: Unpack[ListApisRequestRequestTypeDef]
    ) -> ListApisResponseTypeDef:
        """
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#list_apis)
        """
    ...
    async def list_channel_namespaces(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#list_channel_namespaces)
        """
    ...
    async def update_api(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#update_api)
        """
    ...
    async def update_channel_namespace(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appsync/client/#update_channel_namespace)
        """
    ...
    @overload
    def get_paginator(self, operation_name: Literal["list_apis"]) -> ListApisPaginator:
        """
        Create a paginator for an operation.
