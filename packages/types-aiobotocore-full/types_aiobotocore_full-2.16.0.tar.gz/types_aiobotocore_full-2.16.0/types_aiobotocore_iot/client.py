...
class IoTClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_iot/client/#close)
        """
    ...
    async def delete_stream(
        self, **kwargs: Unpack[DeleteStreamRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Deletes a stream.
    ...
    async def delete_thing(
        self, **kwargs: Unpack[DeleteThingRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    async def update_thing(
        self, **kwargs: Unpack[UpdateThingRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
