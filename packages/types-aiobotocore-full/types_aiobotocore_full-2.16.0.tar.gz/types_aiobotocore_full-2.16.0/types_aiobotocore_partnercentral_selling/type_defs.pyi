...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_partnercentral_selling/type_defs/)
...
class ListEngagementByAcceptingInvitationTasksRequestListEngagementByAcceptingInvitationTasksPaginateTypeDef(
    TypedDict
):
    Catalog: str
    EngagementInvitationIdentifier: NotRequired[Sequence[str]]
...
class ListEngagementFromOpportunityTasksRequestListEngagementFromOpportunityTasksPaginateTypeDef(
    TypedDict
):
    Catalog: str
    EngagementIdentifier: NotRequired[Sequence[str]]
...
class ListEngagementResourceAssociationsRequestListEngagementResourceAssociationsPaginateTypeDef(
    TypedDict
):
    Catalog: str
    CreatedBy: NotRequired[str]
