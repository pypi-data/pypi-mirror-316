...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/)
...
class ShieldClient(AioBaseClient):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/shield.html#Shield.Client)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#can_paginate)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#generate_presigned_url)
        """
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#close)
        """
    ...
    async def associate_drt_log_bucket(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_drt_log_bucket)
        """
    ...
    async def associate_drt_role(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_drt_role)
        """
    ...
    async def associate_health_check(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_health_check)
        """
    ...
    async def associate_proactive_engagement_details(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#associate_proactive_engagement_details)
        """
    ...
    async def create_protection(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#create_protection)
        """
    ...
    async def create_subscription(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#create_subscription)
        """
    ...
    async def delete_protection(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#delete_protection)
        """
    ...
    async def delete_subscription(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#delete_subscription)
        """
    ...
    async def describe_attack(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_attack)
        """
    ...
    async def describe_attack_statistics(self) -> DescribeAttackStatisticsResponseTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_attack_statistics)
        """
    ...
    async def describe_drt_access(self) -> DescribeDRTAccessResponseTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_drt_access)
        """
    ...
    async def describe_emergency_contact_settings(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_emergency_contact_settings)
        """
    ...
    async def describe_protection(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_protection)
        """
    ...
    async def describe_protection_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_protection_group)
        """
    ...
    async def describe_subscription(self) -> DescribeSubscriptionResponseTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#describe_subscription)
        """
    ...
    async def disable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disable_proactive_engagement)
        """
    ...
    async def disassociate_drt_role(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disassociate_drt_role)
        """
    ...
    async def disassociate_health_check(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#disassociate_health_check)
        """
    ...
    async def enable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#enable_proactive_engagement)
        """
    ...
    async def get_subscription_state(self) -> GetSubscriptionStateResponseTypeDef:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#get_subscription_state)
        """
    ...
    async def list_attacks(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_attacks)
        """
    ...
    async def list_protection_groups(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_protection_groups)
        """
    ...
    async def list_protections(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_protections)
        """
    ...
    async def list_resources_in_protection_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#list_resources_in_protection_group)
        """
    ...
    async def untag_resource(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#untag_resource)
        """
    ...
    async def update_application_layer_automatic_response(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_application_layer_automatic_response)
        """
    ...
    async def update_emergency_contact_settings(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_emergency_contact_settings)
        """
    ...
    async def update_protection_group(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_protection_group)
        """
    ...
    async def update_subscription(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#update_subscription)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_attacks"]) -> ListAttacksPaginator:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_shield/client/#get_paginator)
        """
