...
class ScraperActiveWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeScraperRequestScraperActiveWaitTypeDef]) -> None:
        """
...
class ScraperDeletedWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeScraperRequestScraperDeletedWaitTypeDef]) -> None:
        """
...
class WorkspaceActiveWaiter(AIOWaiter):
    ...
    """
    async def wait(
        self, **kwargs: Unpack[DescribeWorkspaceRequestWorkspaceActiveWaitTypeDef]
    ) -> None:
        """
...
class WorkspaceDeletedWaiter(AIOWaiter):
    ...
    """
    async def wait(
        self, **kwargs: Unpack[DescribeWorkspaceRequestWorkspaceDeletedWaitTypeDef]
    ) -> None:
        """
