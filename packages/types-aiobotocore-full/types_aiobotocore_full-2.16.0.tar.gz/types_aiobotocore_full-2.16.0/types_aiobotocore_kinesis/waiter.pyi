...
class StreamExistsWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeStreamInputStreamExistsWaitTypeDef]) -> None:
        """
...
class StreamNotExistsWaiter(AIOWaiter):
    ...
    """
    async def wait(self, **kwargs: Unpack[DescribeStreamInputStreamNotExistsWaitTypeDef]) -> None:
        """
