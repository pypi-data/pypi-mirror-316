...
class ProjectVersionRunningWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_rekognition/waiters/#projectversionrunningwaiter)
    """
    async def wait(
...
class ProjectVersionTrainingCompletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_rekognition/waiters/#projectversiontrainingcompletedwaiter)
    """
    async def wait(
        self,
