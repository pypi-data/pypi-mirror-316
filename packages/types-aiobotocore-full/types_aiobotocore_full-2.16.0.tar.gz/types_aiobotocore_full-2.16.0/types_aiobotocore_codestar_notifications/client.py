...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_notifications/client/)
...
class CodeStarNotificationsClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/codestar-notifications/client/close.html)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_notifications/client/#close)
        """
    ...
    async def delete_target(
        self, **kwargs: Unpack[DeleteTargetRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
    ...
    async def subscribe(
        self, **kwargs: Unpack[SubscribeRequestRequestTypeDef]
    ) -> SubscribeResultTypeDef:
        """
    ...
    async def __aenter__(self) -> "CodeStarNotificationsClient":
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/codestar-notifications.html#CodeStarNotifications.Client)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_notifications/client/)
        """
