...
class SSMContactsClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client/#close)
        """

    async def accept_page(
        self, **kwargs: Unpack[AcceptPageRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
