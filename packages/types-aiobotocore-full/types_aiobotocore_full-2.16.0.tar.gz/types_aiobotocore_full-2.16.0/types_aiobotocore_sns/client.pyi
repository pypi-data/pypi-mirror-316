...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sns/client/)
...
class SNSClient(AioBaseClient):
    ...
    async def close(self) -> None:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sns/client/#close)
        """
    ...
    async def publish(self, **kwargs: Unpack[PublishInputRequestTypeDef]) -> PublishResponseTypeDef:
        """
    ...
    async def subscribe(
        self, **kwargs: Unpack[SubscribeInputRequestTypeDef]
    ) -> SubscribeResponseTypeDef:
        """
