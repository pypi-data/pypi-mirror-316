import unittest
import ihook
from tests.utils import unimport, scramble_case, ISensitiveConfigMixin
...
class TestSimpleCases(unittest.TestCase, ISensitiveConfigMixin):
    ...
    def test_no_trigger_on_non_existent_module(self):
        ...
        @self.on_import_helper('does_not_exist')
    ...
    def test_trigger_on_import_ctypes_util(self):
        ...
        @self.on_import_helper('ctypes.util')
    ...
    def test_exceptions_handling(self):
        ...
        with self.assertRaises(TypeError, msg='`func` must be callable'):
            self.on_import_helper('hashlib', 'not_callable')  # noqa
