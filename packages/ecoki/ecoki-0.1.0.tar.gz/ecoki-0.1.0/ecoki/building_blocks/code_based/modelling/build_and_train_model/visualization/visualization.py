...
class Visualization(BuildingBlock):
    def __init__(self, name, settings):

        super().__init__(name, settings)
        self.architecture = "EcoKI"
        self.version = "1"
        self.category = "DataVisualizer"
        self.description = "Building block for visualizing results from model prediction on a dashboard."
    ...
    def execute(self):
        ...
        self.app = dashboard.create_view().show(threaded=True, port=5600)