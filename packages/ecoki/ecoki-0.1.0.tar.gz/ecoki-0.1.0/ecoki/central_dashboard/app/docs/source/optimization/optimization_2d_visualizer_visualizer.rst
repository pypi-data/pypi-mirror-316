Optimization2DVisualizerVisualizer
===================================

.. automodule:: ecoki.building_blocks.code_based.optimization.interpret_results.optimization_2d_visualizer.optimization_2d_visualizer_visualizer
   :members:

Overview
--------

The `Optimization2DVisualizerVisualizer` module is designed to provide a comprehensive visualization of 2D optimization results. This module includes classes and functions that facilitate the creation of interactive 2D plots, allowing users to explore model predictions for labels and ratings based on optimized parameters. It aids in understanding the decision-making process of the optimization algorithm in adjusting process parameters.

Key Components
--------------

1. **Optimization2DVisualizerVisualizer**: The main class that handles the visualization of 2D optimization results.
...
The Optimization2DVisualizerVisualizer can be used as follows:
...
.. code-block:: python
    ...
    from ecoki.building_blocks.code_based.optimization.interpret_results.optimization_2d_visualizer.optimization_2d_visualizer_visualizer import Optimization2DVisualizerVisualizer

    # Initialize the visualizer
    visualizer = Optimization2DVisualizerVisualizer(settings=settings)
