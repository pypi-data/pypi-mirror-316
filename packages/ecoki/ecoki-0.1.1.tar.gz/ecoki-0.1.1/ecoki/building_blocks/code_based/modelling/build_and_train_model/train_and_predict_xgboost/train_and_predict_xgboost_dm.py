...
class TrainAndPredictXGBoost(BuildingBlock):
    ...
    def execute(self, input_data):
        ...
        label_column = pd.DataFrame(input_data[3]).columns[0]
        ...
        results[f"True_components_{label_column}"] = y_valid[label_column].values
        results[f"Predicted_components_{label_column}"] = y_pred

        return {"output_data_preds": results}
