...
<div style="border: 2px solid #005f99; padding: 15px; background-color: #e6f3ff; color: #003d66; font-weight: bold; font-size: 1.2em;">
  ℹ️ <strong>IMPORTANT NOTICE:</strong>  
  This project is <strong>NOT</strong> the official Pydantic package. It is a reupload of the original Pydantic repository at commit <a href="https://github.com/pydantic/pydantic/commit/d9c2af3" style="color: #003d66; text-decoration: underline;">d9c2af3</a>.  
  The purpose of this package is to allow Pydantic 1.x to coexist with Pydantic 2.x, by renaming the package to <strong>pydantic1</strong>.  
  All functionality remains the same as the original Pydantic 1.x, and this fork introduces no new features or changes, other than renaming the imports to avoid version conflicts.  
</div>
