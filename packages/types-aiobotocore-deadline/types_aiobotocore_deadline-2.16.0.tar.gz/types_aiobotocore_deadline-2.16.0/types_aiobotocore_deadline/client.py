...
class DeadlineCloudClient(AioBaseClient):
    ...
    async def close(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline/client/close.html)
    ...
    async def delete_farm(
        self, **kwargs: Unpack[DeleteFarmRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Deletes a farm.
    ...
    async def delete_worker(
        self, **kwargs: Unpack[DeleteWorkerRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Deletes a worker.
    ...
    async def get_farm(
        self, **kwargs: Unpack[GetFarmRequestRequestTypeDef]
    ) -> GetFarmResponseTypeDef:
        """
        Get a farm.
    ...
    async def get_step(
        self, **kwargs: Unpack[GetStepRequestRequestTypeDef]
    ) -> GetStepResponseTypeDef:
        """
        Gets a step.
    ...
    async def get_task(
        self, **kwargs: Unpack[GetTaskRequestRequestTypeDef]
    ) -> GetTaskResponseTypeDef:
        """
        Gets a task.
    ...
    async def list_job_parameter_definitions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_deadline/client/#list_job_parameter_definitions)
        """
    ...
    async def update_farm(
        self, **kwargs: Unpack[UpdateFarmRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Updates a farm.
    ...
    async def update_step(
        self, **kwargs: Unpack[UpdateStepRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Updates a step.
    ...
    async def update_task(
        self, **kwargs: Unpack[UpdateTaskRequestRequestTypeDef]
    ) -> Dict[str, Any]:
        """
        Updates a task.
