r'''
# CDKTF prebuilt bindings for Snowflake-Labs/snowflake provider version 1.0.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/1.0.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/1.0.0)
