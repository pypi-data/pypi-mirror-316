...
Welcome to `bioRAT` contributor's guide.
...
If you experience bugs or general issues with `bioRAT`, please have a look
...
You can help improve `bioRAT` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`bioRAT` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `bioRAT`'s files. While this mechanism can
...
```
conda create -n bioRAT python=3 six virtualenv pytest pytest-cov
conda activate bioRAT
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/bioRAT.git
   cd bioRAT
   ```
...
5. Install [pre-commit]:
   ...
   `bioRAT` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/bioRAT
[issue tracker]: https://github.com/<USERNAME>/bioRAT/issues
