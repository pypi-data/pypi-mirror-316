...
cdef class ModbusDevice():
    ...
    cdef uint8_t[4]           _ip
    cdef uint8_t[4]           _netmask
    cdef uint8_t[4]           _gw

    cdef bytes                _vendor_name
    cdef bytes                _product_code
    cdef bytes                _major_minor_revision
...
cdef class Slot:
    cdef up_slot_t _obj
    cdef bytes   _name
    cdef Signals _inputs
    cdef Signals _outputs
    cdef Params  _params
