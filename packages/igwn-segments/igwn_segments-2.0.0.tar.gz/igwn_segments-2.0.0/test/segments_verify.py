...
if __name__ == "__main__":
	...
	suite.addTest(loadTests(test_infinity))
	suite.addTest(loadTests(test_segment))
	suite.addTest(loadTests(test_segmentlist))
	suite.addTest(loadTests(test_segmentlistdict))
