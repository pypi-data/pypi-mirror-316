...
LOG_KEY_ABS_ERROR_CODE = "abs_error_code"
LOG_KEY_ABS_ERROR_MSG = "abs_error_message"
LOG_KEY_ABS_EXEC_TIME = "abs_exec_time"
LOG_KEY_ABS_MEM_USAGE = "abs_mem_usage"
LOG_KEY_ABS_MEM_PEAK = "abs_mem_peak"
LOG_KEY_ABS_PLATFORM_CODE = "abs_platform_code"
LOG_KEY_ABS_RESPONSE_CODE = "abs_response_code"

LOG_KEY_EXC_TYPE = "exc_type"
LOG_KEY_EXC_MSG = "exc_message"
LOG_KEY_EXC_TRACEBACK = "exc_traceback"
...
# --- Log Values.
# -----------------------------------------------------------------------------
LOG_VAL_STATUS_SUCCESS = "success"
LOG_VAL_STATUS_FAILURE = "failure"
