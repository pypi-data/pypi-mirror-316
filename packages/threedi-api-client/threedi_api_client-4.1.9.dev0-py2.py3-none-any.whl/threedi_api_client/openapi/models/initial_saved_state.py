...
class InitialSavedState(object):
    ...
    def __init__(self, url=None, simulation=None, saved_state=None, id=None, uuid=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def saved_state(self, saved_state):
        ...
        if self.local_vars_configuration.client_side_validation and saved_state is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `saved_state`, must not be `None`")  # noqa: E501
