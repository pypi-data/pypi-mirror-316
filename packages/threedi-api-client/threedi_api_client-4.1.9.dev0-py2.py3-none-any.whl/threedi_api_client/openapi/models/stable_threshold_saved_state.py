...
class StableThresholdSavedState(object):
    ...
    def __init__(self, url=None, name=None, simulation=None, created=None, tags=None, expiry=None, thresholds=None, file=None, uuid=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
