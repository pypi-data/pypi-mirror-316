...
class Timeout(object):
    ...
    def __init__(self, timeout=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def timeout(self, timeout):
        ...
        if self.local_vars_configuration.client_side_validation and timeout is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `timeout`, must not be `None`")  # noqa: E501
