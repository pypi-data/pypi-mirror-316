...
class BreachGraphRequest(object):
    ...
    def __init__(self, start_time=None, history_points_limit=None, subscribe=None, subscribe_rate_limit=None, line_id=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def line_id(self, line_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `line_id`, must be a value greater than or equal to `1`")  # noqa: E501
