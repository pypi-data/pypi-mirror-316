...
class SimulationStatusStatistics(object):
    ...
    def __init__(self, name=None, total=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def total(self, total):
        ...
        if self.local_vars_configuration.client_side_validation and total is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `total`, must not be `None`")  # noqa: E501
