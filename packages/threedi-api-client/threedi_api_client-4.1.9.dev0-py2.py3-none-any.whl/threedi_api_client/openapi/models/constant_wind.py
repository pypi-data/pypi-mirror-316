...
class ConstantWind(object):
    ...
    def __init__(self, id=None, uid=None, url=None, simulation=None, offset=None, duration=None, values=None, units=None, speed_interpolate=None, speed_constant=None, direction_interpolate=None, direction_constant=None, speed_value=None, direction_value=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def speed_value(self, speed_value):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `speed_value`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def direction_value(self, direction_value):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `direction_value`, must be a value less than or equal to `360`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                direction_value is not None and direction_value < 0):  # noqa: E501
            self.__handle_validation_error("Invalid value for `direction_value`, must be a value greater than or equal to `0`")  # noqa: E501
