...
class UpdateTemplate(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
        """UpdateTemplate - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UpdateTemplate.  # noqa: E501


        :return: The name of this UpdateTemplate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateTemplate.


        :param name: The name of this UpdateTemplate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTemplate):
            return False
