...
class ResultFile(object):
    ...
    def __init__(self, url=None, simulation=None, filename=None, description=None, created=None, file=None, id=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
