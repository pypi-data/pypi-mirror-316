...
class Usage(object):
    ...
    def __init__(self, id=None, simulation=None, started=None, finished=None, total_time=None, status=None, simulation_type=None, user_name=None, organisation_uuid=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def total_time(self, total_time):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `total_time`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                total_time is not None and total_time < 0):  # noqa: E501
            self.__handle_validation_error("Invalid value for `total_time`, must be a value greater than or equal to `0`")  # noqa: E501
