...
class OneDWaterLevelFile(object):
    ...
    def __init__(self, url=None, simulation=None, initial_waterlevel=None, initial_waterlevel_id=None, uid=None, id=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
