...
class RainGraphRequest(object):
    ...
    def __init__(self, start_time=None, history_points_limit=None, subscribe=None, subscribe_rate_limit=None, node_id=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
        """RainGraphRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def start_time(self):
        """Gets the start_time of this RainGraphRequest.  # noqa: E501

        simulation time in seconds  # noqa: E501

        :return: The start_time of this RainGraphRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this RainGraphRequest.

        simulation time in seconds  # noqa: E501

        :param start_time: The start_time of this RainGraphRequest.  # noqa: E501
        :type: int
        """
    ...
    def history_points_limit(self):
        """Gets the history_points_limit of this RainGraphRequest.  # noqa: E501

        Maximum number of points of history to return  # noqa: E501

        :return: The history_points_limit of this RainGraphRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def history_points_limit(self, history_points_limit):
        """Sets the history_points_limit of this RainGraphRequest.

        Maximum number of points of history to return  # noqa: E501

        :param history_points_limit: The history_points_limit of this RainGraphRequest.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def subscribe(self):
        """Gets the subscribe of this RainGraphRequest.  # noqa: E501

        Subscribe for new results during simulation  # noqa: E501

        :return: The subscribe of this RainGraphRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def subscribe(self, subscribe):
        """Sets the subscribe of this RainGraphRequest.

        Subscribe for new results during simulation  # noqa: E501

        :param subscribe: The subscribe of this RainGraphRequest.  # noqa: E501
        :type: bool
        """
    ...
    def subscribe_rate_limit(self):
        """Gets the subscribe_rate_limit of this RainGraphRequest.  # noqa: E501

        Max number of items per second for subscription  # noqa: E501

        :return: The subscribe_rate_limit of this RainGraphRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def subscribe_rate_limit(self, subscribe_rate_limit):
        """Sets the subscribe_rate_limit of this RainGraphRequest.

        Max number of items per second for subscription  # noqa: E501

        :param subscribe_rate_limit: The subscribe_rate_limit of this RainGraphRequest.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def node_id(self):
        """Gets the node_id of this RainGraphRequest.  # noqa: E501


        :return: The node_id of this RainGraphRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def node_id(self, node_id):
        """Sets the node_id of this RainGraphRequest.


        :param node_id: The node_id of this RainGraphRequest.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and node_id is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `node_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                node_id is not None and node_id < 1):  # noqa: E501
            self.__handle_validation_error("Invalid value for `node_id`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RainGraphRequest):
            return False
