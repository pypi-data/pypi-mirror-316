...
class FileMeta(object):
    ...
    def __init__(self, values_reference=None, units=None, timestamps=None, offset=None, duration=None, geotransform=None, epsg_code=None, interval=None, error=None, fill_value=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def duration(self, duration):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `duration`, must be a value greater than or equal to `0`")  # noqa: E501
