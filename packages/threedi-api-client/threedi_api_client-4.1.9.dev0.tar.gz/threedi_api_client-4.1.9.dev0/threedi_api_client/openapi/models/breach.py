...
class Breach(object):
    ...
    def duration_till_max_depth(self, duration_till_max_depth):
        ...
        if self.local_vars_configuration.client_side_validation and duration_till_max_depth is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `duration_till_max_depth`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                duration_till_max_depth is not None and duration_till_max_depth > 2147483647):  # noqa: E501
            self.__handle_validation_error("Invalid value for `duration_till_max_depth`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                duration_till_max_depth is not None and duration_till_max_depth < 0):  # noqa: E501
            self.__handle_validation_error("Invalid value for `duration_till_max_depth`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def initial_width(self, initial_width):
        ...
        if self.local_vars_configuration.client_side_validation and initial_width is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `initial_width`, must not be `None`")  # noqa: E501
