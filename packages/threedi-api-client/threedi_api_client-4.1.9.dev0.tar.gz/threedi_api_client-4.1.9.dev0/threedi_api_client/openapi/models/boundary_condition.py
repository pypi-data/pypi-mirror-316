...
class BoundaryCondition(object):
    ...
    def __init__(self, id=None, url=None, boundary_id=None, threedimodel=None, type=None, dimension=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def boundary_id(self, boundary_id):
        ...
        if self.local_vars_configuration.client_side_validation and boundary_id is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `boundary_id`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                boundary_id is not None and boundary_id > 2147483647):  # noqa: E501
            self.__handle_validation_error("Invalid value for `boundary_id`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                boundary_id is not None and boundary_id < -2147483648):  # noqa: E501
            self.__handle_validation_error("Invalid value for `boundary_id`, must be a value greater than or equal to `-2147483648`")  # noqa: E501
