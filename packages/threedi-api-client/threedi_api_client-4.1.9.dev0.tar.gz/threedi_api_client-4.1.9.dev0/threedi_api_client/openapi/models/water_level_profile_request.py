...
class WaterLevelProfileRequest(object):
    ...
    def points_limit(self, points_limit):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `points_limit`, must be a value less than or equal to `200`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                points_limit is not None and points_limit < 1):  # noqa: E501
            self.__handle_validation_error("Invalid value for `points_limit`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def subscribe_rate_limit(self, subscribe_rate_limit):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            self.__handle_validation_error("Invalid value for `subscribe_rate_limit`, must be a value less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
