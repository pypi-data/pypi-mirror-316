...
class Result(object):
    ...
    def __init__(self, basic=None, damage_estimation=None, arrival_time=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
    ...
    def basic(self, basic):
        ...
        if self.local_vars_configuration.client_side_validation and basic is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `basic`, must not be `None`")  # noqa: E501
    ...
    def damage_estimation(self, damage_estimation):
        ...
        if self.local_vars_configuration.client_side_validation and damage_estimation is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `damage_estimation`, must not be `None`")  # noqa: E501
    ...
    def arrival_time(self, arrival_time):
        ...
        if self.local_vars_configuration.client_side_validation and arrival_time is None:  # noqa: E501
            self.__handle_validation_error("Invalid value for `arrival_time`, must not be `None`")  # noqa: E501
