...
class ThreediModelSavedState(object):
    ...
    def __init__(self, id=None, url=None, name=None, created=None, type=None, tags=None, used_in_simulation=None, expiry=None, time=None, variables=None, thresholds=None, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
