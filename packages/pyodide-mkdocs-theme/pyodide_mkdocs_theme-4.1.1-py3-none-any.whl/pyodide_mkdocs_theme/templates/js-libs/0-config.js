...
const CONFIG = {
  ...
  PYTHON_KEYWORDS: {
    ...
    And: ["and"],
    Assert: ["assert"],
    AsyncFunctionDef: ["def", "async", "async_def"],
    AsyncFor: ["for", "async", "async_for"],
    AsyncWith: ["with", "async", "async_with"],
    Await: ["await"],
    Break: ["break"],
    ClassDef: ["class"],
    comprehension: ["for", "async", "async_for", "if", "for_comp"],
    Constant: ["False", "True", "None"],
    Continue: ["continue"],
    Delete: ["del"],
    ExceptHandler: ["except","as","except_as"],
    For: ["for", "else", "for_else", "for_inline"],
    FunctionDef: ["def"],
    Global: ["global"],
    If: ["if","elif","else"],
    IfExp: ["if","else"],
    Import: ["import"],
    ImportFrom: ["import","from","from_import"],
    Is: ["is"],
    IsNot: ["is","not","is_not"],
    In: ["in"],
    JoinedStr: ["f_str","f_string"],
    Lambda: ["lambda"],
    Match: ["match"],
    match_case: ["case"],
    Nonlocal: ["nonlocal"],
    ...
    Or: ["or"],
    Pass: ["pass"],
    Raise: ["raise","from","raise_from"],
    Return: ["return"],
    Try: ["try","else","try_else","finally"],
    While: ["while", "else", "while_else"],
    With: ["with"],
    withitem: ["as"],
    Yield: ["yield"],
    YieldFrom: ["yield","from", "yield_from"],
}
}
