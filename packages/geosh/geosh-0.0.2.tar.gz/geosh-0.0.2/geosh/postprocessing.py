...
def plot_azimuthal_contour_2d(hvsr,
    ...
    # contourf plot
    default_contourf_kwargs = dict(cmap=cm.turbo, levels=10)
...
def plot_azimuthal_summary(hvsr,
    ...
    gs = fig.add_gridspec(nrows=1, ncols=1, wspace=0.3, hspace=0.4)

    # Define the single axis with a 3D projection
    ax0 = fig.add_subplot(gs[0, 0], projection='3d')

    # Plot 3D contour on ax0
    plot_azimuthal_contour_3d(
        hvsr,
        distribution_mc=distribution_mc,
        ax=ax0,
