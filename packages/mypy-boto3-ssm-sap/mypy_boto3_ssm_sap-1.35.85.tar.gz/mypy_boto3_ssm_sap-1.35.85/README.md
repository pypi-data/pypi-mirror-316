...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ssm-sap)](https://pypistats.org/packages/mypy-boto3-ssm-sap)
...
`mypy-boto3-ssm-sap` dependency in production. However, there is an issue in
