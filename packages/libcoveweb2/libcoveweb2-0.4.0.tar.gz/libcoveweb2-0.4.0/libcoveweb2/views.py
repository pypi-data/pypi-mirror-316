...
class ExploreDataView(View):
    ...
    def view_has_expired(self, request, supplied_data):
        ...
        Return a view to show the user."""
        return render(
            request,
            self.error_template,
            {
                ...
                "msg": _(
                    ...
                    "This is because all data supplied to this website is "
                    "automatically deleted after 7 days, and therefore "
    ...
    def view_being_processed(self, request, supplied_data):
        """Called if the data is currently being processed.
        Return a view to show the user."""
        return render(
            request,
    ...
    def default_explore_context(self, supplied_data) -> dict:
        """Called if the data is ready to show to the user.
        Return a dict of the context to pass to the template."""
        return {}
