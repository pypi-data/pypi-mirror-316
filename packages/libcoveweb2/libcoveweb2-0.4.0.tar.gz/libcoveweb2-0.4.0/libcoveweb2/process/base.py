...
class ProcessDataTask:
    ...
    def is_processing_applicable(self) -> bool:
        """Should return True if this task may ever
        need to do anything far this supplied data.
    ...
    def process(self, process_data: dict) -> dict:
        ...
        Tasks at the start of the pipeline may add useful information that tasks
        at the end of the pipeline can use.

        Note this is always called when processing data even if is_processing_needed
        returns False.
    ...
    def get_context(self):
        ...
        This is called on a user request on the web, so no long processing work
        should be done here.
