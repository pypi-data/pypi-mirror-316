...
import typing
__all__ = ['AprilTag', 'ApriltagFamilies', 'BarCode', 'Blob', 'COLOR_BLACK', 'COLOR_BLUE', 'COLOR_GRAY', 'COLOR_GREEN', 'COLOR_ORANGE', 'COLOR_PURPLE', 'COLOR_RED', 'COLOR_WHITE', 'COLOR_YELLOW', 'Circle', 'Color', 'CornerDetector', 'DataMatrix', 'Displacement', 'EdgeDetector', 'Fit', 'FlipDir', 'Format', 'HaarCascade', 'Histogram', 'Image', 'KPTMatch', 'KeyPoint', 'LBPKeyPoint', 'Line', 'LineGroup', 'LineType', 'ORBKeyPoint', 'Percentile', 'QRCode', 'QRCodeDecoderType', 'QRCodeDetector', 'Rect', 'ResizeMethod', 'Size', 'Statistics', 'TemplateMatch', 'Threshold', 'cv2image', 'fmt_names', 'fmt_size', 'fonts', 'from_bytes', 'image2cv', 'load', 'load_font', 'resize_map_pos', 'resize_map_pos_reverse', 'set_default_font', 'string_size']
class AprilTag:
...
class Image:
    ...
    def save(self, path: str, quality: int = 95) -> maix._maix.err.Err:
        ...
        """
    def search_line_path(self, thresholds: list[list[int]] = [], detect_pixel_size: int = 30, point_merge_size: int = 15, connection_max_size: int = 51, connection_max_distance: int = 20, connection_max_angle: int = 20) -> list[LineGroup]:
        """
...
class LineGroup:
    ...
    def lines(self) -> list[Line]:
        ...
        """
    def points(self) -> list[list[list[int]]]:
        """
...
class QRCodeDecoderType:
    ...
    __members__: typing.ClassVar[dict[str, QRCodeDecoderType]]  # value = {'QRCODE_DECODER_TYPE_ZBAR': <QRCodeDecoderType.QRCODE_DECODER_TYPE_ZBAR: 0>, 'QRCODE_DECODER_TYPE_QUIRC': <QRCodeDecoderType.QRCODE_DECODER_TYPE_QUIRC: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
fmt_names: list = ['RGB888', 'BGR888', 'RGBA8888', 'BGRA8888', 'RGB565', 'BGR565', 'YUV422SP', 'YUV422P', 'YVU420SP', 'YUV420SP', 'YVU420P', 'YUV420P', 'GRAYSCALE', 'BGGR6', 'GBRG6', 'GRBG6', 'RG6B6', 'BGGR8', 'GBRG8', 'GRBG8', 'RG6B8', 'BGGR10', 'GBRG10', 'GRBG10', 'RG6B10', 'BGGR12', 'GBRG12', 'GRBG12', 'RG6B12', 'UNCOMPRESSED_MAX', 'COMPRESSED_MIN', 'JPEG', 'PNG', 'COMPRESSED_MAX', 'INVALID']
