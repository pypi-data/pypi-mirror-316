...
__all__ = ['DateTime', 'FPS', 'fps', 'fps_set_buff_len', 'fps_start', 'gmtime', 'list_timezones', 'localtime', 'now', 'ntp_sync_sys_time', 'ntp_sync_sys_time_with_config', 'ntp_timetuple', 'ntp_timetuple_with_config', 'sleep', 'sleep_ms', 'sleep_us', 'strptime', 'ticks_diff', 'ticks_ms', 'ticks_s', 'ticks_us', 'time', 'time_diff', 'time_ms', 'time_s', 'time_us', 'timezone']
class DateTime:
    day: int
    hour: int
    microsecond: int
