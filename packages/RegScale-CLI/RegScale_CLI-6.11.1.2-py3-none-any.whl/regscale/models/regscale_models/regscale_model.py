...
class RegScaleModel(BaseModel, ABC):
    ...
    def get_object_id(self) -> int:
        ...
        :rtype: int
        """
        logger.debug(f"Getting object ID for {self.__class__.__name__}")
        return self.id
    ...
    def create_or_update(
        ...
        :param Dict[str, Any] defaults: Dictionary of default values to apply to the instance if it is created, defaults to {}
    ...
    @classmethod
    def batch_create(
        cls, items: List[T], progress_context: Optional[Progress] = None, remove_progress: Optional[bool] = False
    ) -> List[T]:
        """
