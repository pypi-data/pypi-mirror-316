...
class Component(RegScaleModel):
    ...
    componentOwnerId: str = Field(default_factory=RegScaleModel._api_handler.get_user_id)
    ...
    def get_list(cls) -> List[ComponentList]:  # type: ignore
        ...
        """
        response = cls._api_handler.get(endpoint=cls.get_endpoint("get_list").format(model_slug=cls.get_module_slug()))
    ...
    def get_enum_values(cls, field_name: str) -> list:
        ...
        if (field_name == "isPublic") | (field_name == "cmmcExclusion"):
            return ["TRUE", "FALSE"]
        return []
