...
from regscale.core.app.public.fedramp.xml_utils import extract_markup_content
from regscale.core.app.utils.XMLIR import XMLIR, XMLIRTraversal
from regscale.models.regscale_models import (
    StakeHolder,
    SystemRoleExternalAssignment,
    SystemRole,
)
...
def parse_metadata(trv: FedrampTraversal, app: Application) -> None:
    ...
    if len(metadatas) == 0:
        ...
        for role in roles:
            ...
            try:
                system_role = SystemRole(
                    ...
                    privilegeDescription=role.get(
                        "description", "Not Found -imported by CLI-defaulting to Non-Privileged"
                    ),
                    functions="Not Found",
        ...
        logger.debug("responsible_parties: ", json.dumps(responsible_parties, indent=2))
