"""
Nome do Módulo: etl_sap_business_partner_customer_contact.py
...
def run_pipeline(**kwargs):
    ...
    sap_api_request = SPR(
        SAM.GET, 
        "BusinessPartners",
        api_filter=f"CardType eq 'C' and (CreateDate ge '{load_base_date}' or UpdateDate ge '{load_base_date}')",
