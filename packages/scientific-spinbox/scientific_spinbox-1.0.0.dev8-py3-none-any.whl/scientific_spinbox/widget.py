...
class ScientificSpinBox(QtWidgets.QDoubleSpinBox):
    ...
    Args:
        ...
        default_decimals (int): number of decimals to show by default.
            Defaults to 2.
        default_value (PintInterface.ValueType): default value of the widget.
            Defaults to 0.
    ...
    def setupWidget(self):
        ...
        self._value = self._backend.getQuantityValueFloat(self._quantity)
        self._lastBaseValue = self._backend.getQuantityValueFloat(self._baseQuantity)
    ...
    def baseValue(self) -> PintInterface.ValueType:
        ...
        self._baseQuantity = self._backend.changeQuantityUnit(self._quantity, self._baseUnit)
        return self._backend.getQuantityValueFloat(self._baseQuantity)
    ...
    def onEditingFinished(self) -> None:
        """Execute necessary actions after editing finished.
        
        Corrects the number of decimals, formats the text, updates the base quantity.
        """        
        self.blockSignals(True)
    ...
    def setDisplayUnit(self, new_unit: str):
        ...
        if not self._enablePreferredUnits:
            ...
            self.setValue(self.backend.getQuantityValueFloat(self._quantity))
            if not self.signalsBlocked():
    ...
    def setBaseValue(self, value: PintInterface.ValueType | float, from_setvalue = False) -> None:
        ...
        display_value = self.backend.getQuantityValueFloat(self._quantity)

        new_basevalue = self._backend.getQuantityValueFloat(self._baseQuantity)
        if not self.signalsBlocked():
    ...
    def stepBy(self, step: float):
        ...
        Side effects:
            - sets the text, value and quantity, propagating the step.
    ...
    def textFromValue(self, value: Decimal) -> str:
        ...
        Args:
            value (float): the current numeric value of the widget.
