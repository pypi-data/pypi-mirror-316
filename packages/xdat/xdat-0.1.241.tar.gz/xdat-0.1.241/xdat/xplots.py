...
def post_plot(title='', legend=True, legend_loc='best', legend_title=None, xlim=None, ylim=None, xlabel=None, ylabel=None, x_rotation=None, tight_layout=True, show=True, y_auc=False, x_axis_fmt=None, y_axis_fmt=None, add_date=False, desc='', as_xpptx=None, square=False):
    """
    ...
    for df_p, keys, plot_title in xpd.x_iter_groups(df, plot_on):
        ...
        for df_g, _, group_title in xpd.x_iter_groups(df_p, group_on):
            ...
            if kind in ['scatter', 'reg']:
                ...
                if len(_y.unique()) == 1:
                    plt.scatter(_y[0], _y[0], label="Can't create KDE with 1 unique value")
                else:
