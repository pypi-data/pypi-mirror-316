...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash */ "webpack/sharing/consume/default/lodash/lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _FireflyCommonUtils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./FireflyCommonUtils.js */ "./lib/FireflyCommonUtils.js");
/* harmony import */ var _style_fftools_logo_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../style/fftools-logo.svg */ "./style/fftools-logo.svg");
...
function activateSlateCommandExt(app, palette, launcher) {
    (0,_FireflyCommonUtils_js__WEBPACK_IMPORTED_MODULE_6__.findFirefly)().then((ffConfig) => {
        const { firefly } = ffConfig;
        firefly.util.addActionListener(['StartLabWindow'], (action) => {
            var _a;
            openSlateSingleOnly(app, TAB_ID, (_a = action.payload) === null || _a === void 0 ? void 0 : _a.fireflyHtmlFile);
        });
    ...
    const icon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_4__.LabIcon({
        ...
        svgstr: _style_fftools_logo_svg__WEBPACK_IMPORTED_MODULE_7__
    });
...
class SlateRootWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    ...
    startViewer(firefly, id, fireflyURL, fireflyHtmlFile) {
        ...
        if (fireflyURL.endsWith('irsaviewer')) {
            ...
            (0,lodash__WEBPACK_IMPORTED_MODULE_5__.set)(props, 'slotProps.banner.slotProps.tabs.pl', 0);
            (0,lodash__WEBPACK_IMPORTED_MODULE_5__.set)(props, 'slotProps.banner.slotProps.icon.style.marginTop', 0);
            (0,lodash__WEBPACK_IMPORTED_MODULE_5__.set)(props, 'slotProps.banner.slotProps.icon.sx', { height: 'auto', '.MuiSvgIcon-root': { height: '3rem', width: '3rem' } });
        }
...
//# sourceMappingURL=lib_index_js.19e7549918ea5856f4db.js.map