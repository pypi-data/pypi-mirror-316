...
class SlateRootWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    ...
    startViewer(firefly, id, fireflyURL, fireflyHtmlFile) {
        ...
        if (fireflyURL.endsWith('irsaviewer')) {
            ...
            (0,lodash__WEBPACK_IMPORTED_MODULE_5__.set)(props, 'slotProps.banner.slotProps.icon.sx', { '.MuiSvgIcon-root': { height: '3rem', width: '3rem' } });
        }
...
//# sourceMappingURL=lib_index_js.78e107400eacbdbe2755.js.map