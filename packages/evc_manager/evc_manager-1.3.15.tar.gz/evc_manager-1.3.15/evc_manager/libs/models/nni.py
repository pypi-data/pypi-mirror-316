...
class NNI(object):
    ...
    def __init__(self, **kwargs):
        self._device_a = kwargs.get("device_a")
        self._interface_a = kwargs.get("interface_a")
        self._device_z = kwargs.get("device_z")
        self._interface_z = kwargs.get("interface_z")
        self._name = kwargs.get("name")

    def __repr__(self):
        return (
            f"NNI({self.device_a}, {self.interface_a}, {self.device_z}, {self.interface_z},"
            + f" name={self.name})"
        )
