...
function eu(e, t, n) {
  ...
  const d = fs(() => import("./button-gysBCls5.js"));
  let {
    gradio: g
  } = t, {
    props: _ = {}
  ...
  return be(e, Ue, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Oe(Oe({}, t), Ds(h)), n(19, o = yt(t, r)), "gradio" in h && n(6, g = h.gradio), "props" in h && n(7, _ = h.props), "_internal" in h && n(8, u = h._internal), "value" in h && n(9, p = h.value), "as_item" in h && n(10, l = h.as_item), "visible" in h && n(11, m = h.visible), "elem_id" in h && n(12, w = h.elem_id), "elem_classes" in h && n(13, L = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(17, c = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && b.update((h) => ({
      ...h,
