...
class Agent(BaseModel):
    ...
    agent_to_pass_to: "Agent | None" = Field(default=None, description="The agent to pass the torch to.")
    ...
    def to_dict(self):
        return {
            ...
            "agent_to_pass_to": self.agent_to_pass_to.name if self.agent_to_pass_to else None,
        }
