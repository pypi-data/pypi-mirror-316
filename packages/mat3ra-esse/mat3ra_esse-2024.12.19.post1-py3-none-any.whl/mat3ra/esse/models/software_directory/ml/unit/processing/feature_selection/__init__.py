...
#   filename:  software_directory/ml/unit/processing/feature_selection.json
#   version:   0.25.5
...
class ESSE(RootModel[FilterBasedFeatureSelectionUnitSchema]):
    root: FilterBasedFeatureSelectionUnitSchema
