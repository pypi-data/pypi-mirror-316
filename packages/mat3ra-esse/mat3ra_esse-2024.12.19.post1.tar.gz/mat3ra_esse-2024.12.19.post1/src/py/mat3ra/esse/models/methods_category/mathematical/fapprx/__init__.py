...
#   filename:  methods_category/mathematical/fapprx.json
#   version:   0.25.5
...
class UnstructuredMeshingCategoryFapprxSchema(BaseModel):
    tier1: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug]] = Field(None, title="slugified entry or slug")
    """
