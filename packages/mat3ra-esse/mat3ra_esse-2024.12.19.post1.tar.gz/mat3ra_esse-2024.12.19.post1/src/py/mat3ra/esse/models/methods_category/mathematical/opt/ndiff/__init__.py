...
#   filename:  methods_category/mathematical/opt/ndiff.json
#   version:   0.25.5
...
class OptimizationMethodsForNonDifferentiableFunctionsCategorySchema(BaseModel):
    tier2: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
    tier1: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug160]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
