...
#   filename:  methods_category/mathematical/opt/ndiff/pop.json
#   version:   0.25.5
...
class PopulationAlgorithmsForTheOptmizationOfNonDifferentiableFunctionsCategorySchema(BaseModel):
