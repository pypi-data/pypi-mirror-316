...
#   filename:  methods_category/mathematical/intgr/numquad.json
#   version:   0.25.5
...
class SlugifiedEntryOrSlug168(Enum):
    intgr = "intgr"


class MethodsForTheNumericalQuadratureSchema(BaseModel):
    tier2: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
    tier1: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug168]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
