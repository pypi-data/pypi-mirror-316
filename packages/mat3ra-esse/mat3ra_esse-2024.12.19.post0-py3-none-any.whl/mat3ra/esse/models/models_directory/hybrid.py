...
#   filename:  models_directory/hybrid.json
#   version:   0.25.5
...
class ModelHybridFunctional(BaseModel):
    categories: DFTHybridFunctionalCategorySchema = Field(..., title="DFT hybrid functional category schema")
    """
    ...
    parameters: Union[SpinOrbitCouplingMixin, DispersionCorrectionMixin, SpinPolarizationMixin, HubbardModelMixin] = (
        Field(..., title="Hybrid functional mixin")
    )
    """
