...
#   filename:  methods_category/mathematical/opt/ndiff/direct.json
#   version:   0.25.5
...
class DirectAlgorithmsForTheOptimizationOfNonDifferentiableFunctionsCategorySchema(BaseModel):
