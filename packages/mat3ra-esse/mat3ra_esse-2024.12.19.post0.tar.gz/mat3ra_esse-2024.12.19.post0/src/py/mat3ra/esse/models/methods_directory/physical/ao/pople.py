...
#   filename:  methods_directory/physical/ao/pople.json
#   version:   0.25.5
...
class PopleBasisSetCategorySchema(BaseModel):
    ...
    """
    type: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug201]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
...
class UnitMethodAoPople(BaseModel):
    categories: PopleBasisSetCategorySchema = Field(..., title="Pople basis set category schema")
    """
