...
BOOST_PYTHON_MODULE(_gameplayfootball) {
  ...
  class_<std::vector<std::vector<float> > >("FloatVec2D")
  ...
  class_<PlayerInfo>("PlayerInfo")
      ...
      .def_readonly("actions", &PlayerInfo::actions);
      /*.def_readonly("directions", &PlayerInfo::directions)
      .def_readonly("powerlist", &PlayerInfo::powerlist)
      .def_readonly("speedlist", &PlayerInfo::speedlist);*/

  class_<ControllerInfo>("ControllerInfo", init<int>())
      .add_property("controlled_player", &ControllerInfo::controlled_player);
      //.def_readonly ("direction", &ControllerInfo::direction)
      //.def_readonly("actions", &ControllerInfo::actions);
