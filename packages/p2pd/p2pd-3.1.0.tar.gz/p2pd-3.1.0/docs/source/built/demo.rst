...
program such as connecting to another peer. You can use the same
software to spin up another node to connect to.

Or run the software on another machine, get its address, and try that.
