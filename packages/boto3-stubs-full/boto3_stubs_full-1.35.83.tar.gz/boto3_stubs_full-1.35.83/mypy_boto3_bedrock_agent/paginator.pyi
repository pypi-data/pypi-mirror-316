...
class ListAgentCollaboratorsPaginator(Paginator):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agent/paginators/#listagentcollaboratorspaginator)
    """
    def paginate(
...
class ListKnowledgeBaseDocumentsPaginator(Paginator):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agent/paginators/#listknowledgebasedocumentspaginator)
    """
    def paginate(
        self,
        **kwargs: Unpack[
