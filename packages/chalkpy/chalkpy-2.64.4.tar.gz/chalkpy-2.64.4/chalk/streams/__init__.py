...
from chalk.streams._windows import Windowed, get_name_with_duration, group_by_windowed, windowed
...
def stream(
    *,
    ...
    keys
        ...
        See more at https://docs.chalk.ai/docs/windowed-streaming#keys
    timestamp
        An optional string specifying an input attribute as the timestamp used for windowed aggregations.
        See more at https://docs.chalk.ai/docs/windowed-streaming#custom-event-timestamping
