...
def _even_split_pyarrow(spine: pyarrow.Table, join_keys: List[str], split_count: int) -> List[pyarrow.Table]:
    ...
    split_tables = [spine_sorted.slice(start, end - start) for start, end in split_indices]
