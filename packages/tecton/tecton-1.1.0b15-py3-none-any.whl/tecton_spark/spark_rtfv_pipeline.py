    ...
    def _context_node_to_value(self, pipeline_node: PipelineNode) -> RealtimeContext:
        ...
        if self.is_python_mode or self.is_no_transformation_mode:
            ...
            return RealtimeContext(
                request_timestamp=request_timestamp, _mode=TransformationMode.TRANSFORMATION_MODE_PYTHON
            )
            ...
            return RealtimeContext(row_level_data=df, _mode=TransformationMode.TRANSFORMATION_MODE_PANDAS)
