...
@pytest.mark.asyncio
async def test_standalone_image_metadata_custom_ecr():
    test_image_ecr_uri = (
...
@pytest.mark.asyncio
async def test_standalone_image_metadata_default():
    test_image_arn = (
...
@patch("builtins.open", new_callable=mock_open, read_data=MOCK_INTERNAL_METADATA)
@patch(
    "amazon_sagemaker_jupyter_scheduler.providers.studio_image_metadata.get_sagemaker_client"
)
@patch(
    "amazon_sagemaker_jupyter_scheduler.providers.studio_image_metadata.get_user_profile_name"
)
