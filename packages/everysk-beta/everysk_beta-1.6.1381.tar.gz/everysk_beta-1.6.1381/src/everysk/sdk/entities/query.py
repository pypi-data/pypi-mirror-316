...
class Query(BaseDict, BaseSDK):
    ...
    def where(self, *args) -> Self:
        ...
        if property_name == 'tags':
            if isinstance(value, list):
                ...
                raise SDKValueError('The tags value must be a string or a list of strings') # TODO: raise a SDKTypeError since the tags value is not the correct instance
    ...
    def set_projection(self, projection: list | str) -> Self:
        ...
        entity_properties: set = set(self._klass.__attributes__.keys()) # pylint: disable=protected-access
