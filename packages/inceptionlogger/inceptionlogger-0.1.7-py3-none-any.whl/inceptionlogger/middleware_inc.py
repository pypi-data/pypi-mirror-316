...
from inceptionlogger.settings_inc import get_logging_settings
...
async def add_server_info_to_response(response: Response, correlation_id: str):
    ...
    response.headers["x-response-server-application-name"] = logging_settings.application_name
    response.headers["x-response-server-application-version"] = logging_settings.application_version
