...
def interpolate(
    ...
    extent: Union[Tuple[float, float, float, float], None],
    crs: Union[int, CRS],
    cell_size: Union[Tuple[float, float], float, None],
):
    coord_array = []
    value_array = []
    ...
    if cell_size is None:
        cell_size = (xmax - xmin) / 1000, (ymax - ymin) / 1000
...
def interp_linear(
    ...
    return interpolate(f, points, extent, crs, cell_size)
