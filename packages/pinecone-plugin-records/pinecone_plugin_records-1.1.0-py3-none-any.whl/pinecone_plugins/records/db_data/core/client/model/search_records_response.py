...
def lazy_import():
    ...
    from pinecone_plugins.records.db_data.core.client.model.search_usage import (
        SearchUsage,
    )
...
class SearchRecordsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, result, usage, *args, **kwargs):  # noqa: E501
        """SearchRecordsResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, result, usage, *args, **kwargs):  # noqa: E501
        """SearchRecordsResponse - a model defined in OpenAPI
