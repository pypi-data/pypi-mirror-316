...
from pinecone_plugins.records.db_data.core.client import rest
from pinecone_plugins.records.db_data.core.client.configuration import Configuration
from pinecone.exceptions import (
    PineconeApiTypeError,
    PineconeApiValueError,
    PineconeApiException,
)
from pinecone_plugins.records.db_data.core.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BulkOperationsApi()
        api_instance.cancel_bulk_import  # this is an instance of the class Endpoint
        api_instance.cancel_bulk_import()  # this invokes api_instance.cancel_bulk_import.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_bulk_import.callable or self.callable in this class
