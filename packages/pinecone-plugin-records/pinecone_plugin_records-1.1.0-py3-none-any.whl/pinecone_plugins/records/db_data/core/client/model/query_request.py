...
def lazy_import():
    from pinecone_plugins.records.db_data.core.client.model.query_vector import (
        QueryVector,
    )
...
class QueryRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, top_k, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filter ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The filter to apply. You can use vector metadata to limit your search. See [Understanding metadata](https://docs.pinecone.io/guides/data/understanding-metadata).. [optional]  # noqa: E501
