...
class Configuration(object):
    ...
    conf = pinecone_plugins.records.db_data.core.client.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://unknown" if host is None else host
        """Default Base url
        """
        ...
        self.logger["package_logger"] = logging.getLogger(
            "pinecone_plugins.records.db_data.core.client"
        )
