...
def lazy_import():
    ...
    from pinecone_plugins.records.db_control.core.client.model.index_tags import (
        IndexTags,
    )
...
class CreateIndexForModelRequest(ModelNormal):
    ...
    def _from_openapi_data(
        cls, name, cloud, region, embed, *args, **kwargs
    ):  # noqa: E501
        """CreateIndexForModelRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, cloud, region, embed, *args, **kwargs):  # noqa: E501
        """CreateIndexForModelRequest - a model defined in OpenAPI
