...
class ModelIndexEmbed(ModelNormal):
    ...
    def _from_openapi_data(cls, model, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            field_map ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Identifies the name of the text field from your document model that is embedded.. [optional]  # noqa: E501
