...
def lazy_import():
    ...
    from pinecone_plugins.records.db_control.core.client.model.index_spec import (
        IndexSpec,
    )
...
class CreateIndexRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, spec, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, spec, *args, **kwargs):  # noqa: E501
        """CreateIndexRequest - a model defined in OpenAPI
