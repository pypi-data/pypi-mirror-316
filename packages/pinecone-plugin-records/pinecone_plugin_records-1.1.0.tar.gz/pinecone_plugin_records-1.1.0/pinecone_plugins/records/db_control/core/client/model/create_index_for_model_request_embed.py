...
from pinecone_plugins.records.db_control.core.client.model_utils import (  # noqa: F401
...
class CreateIndexForModelRequestEmbed(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, model, field_map, *args, **kwargs):  # noqa: E501
        """CreateIndexForModelRequestEmbed - a model defined in OpenAPI

        Args:
            model (str): The name of the embedding model to use for the index.
            field_map ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Identifies the name of the text field from your document model that will be embedded.
        ...
        Keyword Args:
            ...
            read_parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The read parameters for the embedding model.. [optional]  # noqa: E501
            write_parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The write parameters for the embedding model.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, model, field_map, *args, **kwargs):  # noqa: E501
        """CreateIndexForModelRequestEmbed - a model defined in OpenAPI
