...
class SearchUsage(ModelNormal):
    ...
    attribute_map = {
        "read_units": "read_units",  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, read_units, *args, **kwargs):  # noqa: E501
        """SearchUsage - a model defined in OpenAPI

        Args:
            read_units (int): The number of read units consumed by this operation.
    ...
    @convert_js_args_to_python_args
    def __init__(self, read_units, *args, **kwargs):  # noqa: E501
        """SearchUsage - a model defined in OpenAPI
