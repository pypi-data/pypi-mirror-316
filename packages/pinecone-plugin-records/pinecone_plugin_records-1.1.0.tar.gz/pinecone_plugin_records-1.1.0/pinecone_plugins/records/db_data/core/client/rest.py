        ...
        try:
            ...
            if method in ["POST", "PUT", "PATCH", "OPTIONS", "DELETE"]:
                ...
                if ("Content-Type" not in headers) or (
                    ...
                    request_body = None
                    is_x_ndjson = headers["Content-Type"] == "application/x-ndjson"
                    if body is not None and not is_x_ndjson:
                        request_body = json.dumps(body)
                    elif body is not None and is_x_ndjson:
                        # for x-ndjson requests, we are expecting an array of elements
                        # that need to be converted to a newline separated string
                        request_body = "\n".join(
                            json.dumps(element) for element in body
                        )
