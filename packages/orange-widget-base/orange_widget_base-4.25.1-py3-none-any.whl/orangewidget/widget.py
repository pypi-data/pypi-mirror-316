...
class OWBaseWidget(QDialog, OWComponent, Report, ProgressBarMixin,
    ...
    def __new__(cls, *args, captionTitle=None, **kwargs):
        ...
        self.__help_action = QAction(
            _tr.m[10, "Help"], self, objectName="action-help", toolTip=_tr.m[11, "Show help"],
            enabled=False, shortcut=QKeySequence(Qt.Key_F1)
        )
        self.__report_action = QAction(
            _tr.m[12, "Report"], self, objectName="action-report",
            toolTip=_tr.m[13, "Create and display a report"],
        ...
        self.__save_image_action = QAction(
            _tr.m[14, "Save Image"], self, objectName="action-save-image",
            toolTip=_tr.m[15, "Save image"],
        ...
        self.__reset_action = QAction(
            _tr.m[16, "Reset"], self, objectName="action-reset-settings",
            toolTip=_tr.m[17, "Reset settings to default state"],
            enabled=False, visible=False,
        )
        ...
        self.__visual_settings_action = QAction(
            _tr.m[18, "Show View Options"], self, objectName="action-visual-settings",
            toolTip=_tr.m[19, "Show View Options"],
            enabled=False, visible=False,
        )
        ...
        self.__copy_action = QAction(
            _tr.m[20, "Copy to Clipboard"], self, objectName="action-copy-to-clipboard",
        ...
        if not nativemb:
            ...
            self.__menubar_action = QAction(
                _tr.m[24, "Show Menu Bar"],  self, objectName="action-show-menu-bar",
                checkable=True,
        ...
        fileaction = mb.addMenu(_Menu(_tr.m[25, "&File"], mb, objectName="menu-file"))
        ...
        editaction = mb.addMenu(_Menu(_tr.m[26, "&Edit"], mb, objectName="menu-edit"))
        ...
        if sys.platform == "darwin" and mb.isNativeMenuBar():
            ...
            editaction.menu().addAction(
                QAction(
                    _tr.m[27, "Cut"], self, enabled=False,
                    shortcut=QKeySequence(QKeySequence.Cut),
            ))
            editaction.menu().addAction(
                QAction(
                    _tr.m[28, "Copy"], self, enabled=False,
                    shortcut=QKeySequence(QKeySequence.Copy),
            ))
            editaction.menu().addAction(
                QAction(
                    _tr.m[29, "Paste"], self, enabled=False,
                    shortcut=QKeySequence(QKeySequence.Paste),
            ))
            editaction.menu().addAction(
                QAction(
                    _tr.m[30, "Select All"], self, enabled=False,
                    shortcut=QKeySequence(QKeySequence.SelectAll),
            ))

        viewaction = mb.addMenu(_Menu(_tr.m[31, "&View"], mb, objectName="menu-view"))
        viewaction.setVisible(False)
        viewaction.menu().addAction(self.__visual_settings_action)
        windowaction = mb.addMenu(_Menu(_tr.m[32, "&Window"], mb, objectName="menu-window"))
        ...
        helpaction = mb.addMenu(_Menu(_tr.m[33, "&Help"], mb, objectName="help-menu"))
        ...
        self.__quick_help_action = QAction(
            _tr.m[34, "Quick Help Tip"], self, objectName="action-quick-help-tip",
        ...
        if self.__splitter is not None and self.__splitter.count() > 1:
            action = QAction(
                _tr.m[35, "Show Control Area"], self,
    ...
    def __init_subclass__(cls, **_):
        for base in cls.__bases__:
            if hasattr(base, "_final_class"):
                warnings.warn(
                    ("subclassing of widget classes is deprecated and will be " + ("disabled in the future.\n" + (f"Extract code from {base.__name__} or explicitly open it " + "by adding `openclass=True` to class definition."))),
