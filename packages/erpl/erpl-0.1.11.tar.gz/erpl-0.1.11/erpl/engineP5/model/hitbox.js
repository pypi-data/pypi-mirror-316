...
class HitboxPolygon extends Hitbox {
...
class HitboxTriangle extends Hitbox {
...
class HitboxArc extends Hitbox {
...
class HitboxLine extends Hitbox {
...
class HitboxEllipse extends Hitbox {
    constructor(id,x,y,w,h){
        super(id);
        this.x = x;
        this.y = y;
