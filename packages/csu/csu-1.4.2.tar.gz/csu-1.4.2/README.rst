...
.. |commits-since| image:: https://img.shields.io/github/commits-since/ionelmc/python-csu/v1.4.2.svg
    :alt: Commits since latest release
    :target: https://github.com/ionelmc/python-csu/compare/v1.4.2...main
