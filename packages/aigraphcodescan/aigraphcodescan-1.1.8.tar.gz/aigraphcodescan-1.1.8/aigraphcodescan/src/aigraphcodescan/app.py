...
def get_logger():
    ...
    parser.add_argument('--directory', type=str, help='Directory to scan recursively for files', default=os.getcwd())
...
DIRECTORY_PATH = args.directory  # Set directory path from argument or default to current working directory
WORKING_DIR = os.getenv("WORKING_DIR", "neo4jdb")  # Default to "neo4jdb" if not set in environment
