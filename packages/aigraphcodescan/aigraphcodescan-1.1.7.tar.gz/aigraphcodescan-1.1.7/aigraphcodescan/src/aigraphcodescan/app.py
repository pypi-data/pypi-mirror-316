...
def get_logger():
    ...
    parser.add_argument('--directory', type=str, help='Directory to scan recursively for files', default="../badcode/")
...
DIRECTORY_PATH = args.directory  # Set directory path from argument or default to '../badcode/'
