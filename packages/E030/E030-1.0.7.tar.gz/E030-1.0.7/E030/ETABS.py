...
def SistemaEstructural(LoadName:str, resultado:str):
    ...
    try:
        ...
        Tabla_Shears = pd.DataFrame(Data_Table)
        Tabla_Shears
...
def ZUCSR(Zona:int, Uso:int, Suelo:int, R_x:float, R_y:float, ZUCSR_X:float, ZUCSR_Y):
    ...
    try:
        ...
        Tabla_Parametros_Sismicos = pd.DataFrame(Data_Table)
        Tabla_Parametros_Sismicos

        return ZUCSR_X, ZUCSR_Y
