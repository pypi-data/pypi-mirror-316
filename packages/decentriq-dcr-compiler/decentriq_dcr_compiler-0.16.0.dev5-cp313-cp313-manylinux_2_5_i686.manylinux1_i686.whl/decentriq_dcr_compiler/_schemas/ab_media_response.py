...
class AbMediaCompute10(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    v1: AbMediaComputeV1
...
class AbMediaCompute8(
    RootModel[Union[AbMediaCompute, AbMediaCompute10, AbMediaCompute11]]
):
    root: Union[AbMediaCompute, AbMediaCompute10, AbMediaCompute11]


class AbMediaComputeOrUnknown(RootModel[Optional[AbMediaCompute8]]):
    root: Optional[AbMediaCompute8]
