...
class ComputationNodeKind14(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ComputationNodeKind15(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ComputationNodeKind11(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class ComputationNodeKind12(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataLabCompute8(
    RootModel[Union[DataLabCompute, DataLabCompute10, DataLabCompute11]]
):
    root: Union[DataLabCompute, DataLabCompute10, DataLabCompute11]


class DataLabComputeOrUnknown(RootModel[Optional[DataLabCompute8]]):
    root: Optional[DataLabCompute8]
...
class ComputationNodeKind13(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class LeafNodeKind(RootModel[Union[LeafNodeKind5, LeafNodeKind6]]):
    root: Union[LeafNodeKind5, LeafNodeKind6]
...
class DataScienceDataRoomV23(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV33(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class NodeKind(RootModel[Union[NodeKind5, NodeKind6]]):
    root: Union[NodeKind5, NodeKind6]
...
class DataScienceDataRoomV24(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV2(
    RootModel[Union[DataScienceDataRoomV23, DataScienceDataRoomV24]]
):
    root: Union[DataScienceDataRoomV23, DataScienceDataRoomV24]


class DataScienceDataRoomV34(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV3(
    RootModel[Union[DataScienceDataRoomV33, DataScienceDataRoomV34]]
):
    root: Union[DataScienceDataRoomV33, DataScienceDataRoomV34]
...
class DataScienceCommitKind4(RootModel[DataScienceCommitKind]):
...
class DataScienceDataRoomV03(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV04(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class DataScienceDataRoomV0(
    RootModel[Union[DataScienceDataRoomV03, DataScienceDataRoomV04]]
):
    root: Union[DataScienceDataRoomV03, DataScienceDataRoomV04]
