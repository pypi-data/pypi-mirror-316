...
class AbMediaCompute4(
    RootModel[Union[AbMediaCompute, AbMediaCompute6, AbMediaCompute7]]
):
    root: Union[AbMediaCompute, AbMediaCompute6, AbMediaCompute7]


class AbMediaComputeOrUnknown(RootModel[Optional[AbMediaCompute4]]):
    root: Optional[AbMediaCompute4]
