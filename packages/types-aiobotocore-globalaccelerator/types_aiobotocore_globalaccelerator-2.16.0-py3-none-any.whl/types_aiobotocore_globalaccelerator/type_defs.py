...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_globalaccelerator/type_defs/)
...
class ListCustomRoutingEndpointGroupsRequestListCustomRoutingEndpointGroupsPaginateTypeDef(
    TypedDict
):
    ListenerArn: str
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
