...
setup(
    name='ia-planner-jerson-gpt',
    version='0.1',
    packages=['danilo_planner'],
    description='Planificador de tareas con IA implementando diferentes modelos - 2024',
    author='Jerson Danilo Florez Parra',
    author_email='jerchiton.97@gmail.com',
    url='https://pypi.org/project/ia-planner-jerson/',
    install_requires=[
