...
class DistMult(Recommender):
    ...
    def name(self):
        text = "DistMult based model + cosine similarity"
        text += f";embedding_dim={self.embedding_dim};entity_initializer={self.entity_initializer};entity_constrainer={self.entity_constrainer};relation_initializer={self.relation_initializer};regularizer={self.regularizer};epochs={self.epochs};seed={self.seed};triples={self.triples}"
        return text
