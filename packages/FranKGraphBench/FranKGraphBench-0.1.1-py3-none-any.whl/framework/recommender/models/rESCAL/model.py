...
class RESCAL(Recommender):
    ...
    def name(self):
        text = "RESCAL based model + cosine similarity"
        text += f";embedding_dim={self.embedding_dim};entity_initializer={self.entity_initializer};relation_initializer={self.relation_initializer};regularizer={self.regularizer};epochs={self.epochs};seed={self.seed};triples={self.triples}"
        return text
