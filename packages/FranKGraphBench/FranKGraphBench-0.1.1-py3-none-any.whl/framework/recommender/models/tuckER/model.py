...
class TuckER(Recommender):
    ...
    def name(self):
        ...
        text += f";embedding_dim={self.embedding_dim};relation_dim={self.relation_dim};dropout_0={self.dropout_0};dropout_1={self.dropout_1};dropout_2={self.dropout_2};apply_batch_normalization={self.apply_batch_normalization};relation_initializer={self.relation_initializer};core_tensor_initializer={self.core_tensor_initializer};epochs={self.epochs};seed={self.seed};triples={self.triples}"
        return text
