...
class ComplEx(Recommender):
    ...
    def name(self):
        text = "ComplEx based model + cosine similarity"
        text += f";embedding_dim={self.embedding_dim};entity_initializer={self.entity_initializer};relation_initializer={self.relation_initializer};regularizer={self.regularizer};epochs={self.epochs};seed={self.seed}"
        return text
