...
class DAIEngineProfileServiceApi(object):
    ...
    def d_ai_engine_profile_service_delete_dai_engine_profile(
        ...
        **kwargs
        ...
        Args:
            name (str): DAIEngine resource name. Format: workspaces/{workspace}/daiEngineProfiles/{dai_engine_profile}
    ...
    def d_ai_engine_profile_service_get_dai_engine_profile(
        ...
        **kwargs
        ...
        Args:
            name_2 (str): DAIEngineProfile resource name. Format: workspaces/{workspace}/daiEngineProfiles/{dai_engine_profile}
