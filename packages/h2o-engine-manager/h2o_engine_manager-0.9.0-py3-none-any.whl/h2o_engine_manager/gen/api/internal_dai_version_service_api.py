...
class InternalDAIVersionServiceApi(object):
    ...
    def internal_dai_version_service_delete_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_delete_internal_dai_version(name_5, async_req=True)
        >>> result = thread.get()

        Args:
            name_5 (str): InternalDAIVersion resource name.
    ...
    def internal_dai_version_service_get_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_get_internal_dai_version(name_12, async_req=True)
        >>> result = thread.get()

        Args:
            name_12 (str): InternalDAIVersion resource name.
