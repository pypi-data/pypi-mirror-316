...
class V1H2OEngine(ModelNormal):
    ...
    def _from_openapi_data(cls, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            profile (str): Optional. The resource name of the H2OEngineProfile that is used by this H2OEngine. Format is `workspaces/*/h2oEngineProfiles/*`.. [optional]  # noqa: E501
