...
class H2OEngineProfileServiceApi(object):
    ...
    def h2_o_engine_profile_service_delete_h2_o_engine_profile(
        ...
        **kwargs
        ...
        Args:
            name_3 (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngineProfiles/{h2o_engine_profile}
    ...
    def h2_o_engine_profile_service_get_h2_o_engine_profile(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_profile_service_get_h2_o_engine_profile(name_9, async_req=True)
        >>> result = thread.get()

        Args:
            name_9 (str): H2OEngineProfile resource name. Format: workspaces/{workspace}/h2oEngineProfiles/{h2o_engine_profile}
