...
class DAIProfileServiceApi(object):
    ...
    def d_ai_profile_service_delete_dai_profile(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_profile_service_delete_dai_profile(name_2, async_req=True)
        >>> result = thread.get()

        Args:
            name_2 (str): DAIProfile resource name.
    ...
    def d_ai_profile_service_get_dai_profile(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_profile_service_get_dai_profile(name_4, async_req=True)
        >>> result = thread.get()

        Args:
            name_4 (str): DAIProfile resource name.
