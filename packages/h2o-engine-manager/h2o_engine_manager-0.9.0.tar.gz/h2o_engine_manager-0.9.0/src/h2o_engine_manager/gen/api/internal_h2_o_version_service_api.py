...
class InternalH2OVersionServiceApi(object):
    ...
    def internal_h2_o_version_service_delete_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_delete_internal_h2_o_version(name_6, async_req=True)
        >>> result = thread.get()

        Args:
            name_6 (str): InternalH2OVersion resource name.
    ...
    def internal_h2_o_version_service_get_internal_h2_o_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_h2_o_version_service_get_internal_h2_o_version(name_13, async_req=True)
        >>> result = thread.get()

        Args:
            name_13 (str): InternalH2OVersion resource name.
