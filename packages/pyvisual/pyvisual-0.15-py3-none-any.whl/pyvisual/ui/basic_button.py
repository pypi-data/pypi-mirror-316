...
class BasicButton:
    ...
    def __init__(self, window, x, y, width=140, height=50, text="CLICK ME", visibility= True,
                 ...
                 on_hover=None, on_click=None, on_release=None, tag=None):  # New parameter to force window binding
        ...
        # Add the image to the window if not visibility
