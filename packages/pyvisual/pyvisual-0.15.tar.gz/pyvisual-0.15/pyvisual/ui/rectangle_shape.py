...
class RectangleShape(Widget):
    def __init__(self, window, x, y, width, height, radius=0, color=(1, 1, 1, 1), border_color=None, border_width=1, visibility=True, tag=None):
        ...
        with self.canvas:
            ...
            if self.border_color:
                ...
                self.border_line = Line(rounded_rectangle=(self.x, self.y, self.width, self.height, self.radius), width=self.border_width)
