...
[aiobotocore Mediapackagev2 2.16.0](https://pypi.org/project/aiobotocore/)
...
```python
from types_aiobotocore_mediapackagev2.type_defs import CancelHarvestJobRequestRequestTypeDef
