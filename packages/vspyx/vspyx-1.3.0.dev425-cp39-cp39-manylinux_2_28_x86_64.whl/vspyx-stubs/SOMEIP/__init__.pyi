...
class SomeIpMessage:
	...
	def Serialize(self) -> vspyx.Core.BytesView: ...
...
class Service:
	...
	def DecodeMessage(self, header: vspyx.SOMEIP.SomeIpHeaderInfo_t, buffer: vspyx.Core.BytesView, source: vspyx.SOMEIP.EndpointOption, dest: vspyx.SOMEIP.EndpointOption) -> vspyx.SOMEIP.SomeIpMessage: ...
...
class Event:
	...
	EventId: int
	Name: str
	OnSignalValueUpdated: vspyx.Core.Callback_272ba1bf00
	OnValueChanged: vspyx.Core.Function_82dd974354
...
class EventService(vspyx.SOMEIP.Service, vspyx.Core.Object):
	...
	MinorVersion: int
	OfferEnabled: bool
	OnError: vspyx.Core.Callback_55b5aeda56
	OnNotification: vspyx.Core.Callback_55b5aeda56
	OnRequest: vspyx.Core.Function_cb1dca765b
	OnResponse: vspyx.Core.Callback_fc7b63d830
	OnSending: vspyx.Core.Callback_55b5aeda56
	TTL: int
