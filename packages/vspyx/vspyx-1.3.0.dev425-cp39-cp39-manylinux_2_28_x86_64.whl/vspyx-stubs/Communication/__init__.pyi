...
from . import Processors, ISO11898
...
class ConsumedEventGroup(vspyx.Core.ResolverObject):
	"""ConsumedEventGroup
	"""
	OnConfigurationMutation: vspyx.Core.Callback_634bd5c449
...
class EventHandler(vspyx.Core.ResolverObject):
	...
	"""
	OnConfigurationMutation: vspyx.Core.Callback_634bd5c449
	def EventGroupId(self) -> typing.Any: ...

	def MulticastThreshold(self) -> typing.Any: ...


	@staticmethod
	def New(config: typing.Any) -> vspyx.Communication.EventHandler: ...
...
class InitialSDDelayConfig(vspyx.Core.Object):
	...
	InitialRepetitionsBaseDelay: float
...
class SDServerConfig(vspyx.Core.Object):
	"""SDServerConfig
	"""
	MajorVersion: int
	MinorVersion: int
	OfferCyclicDelay: float
	TTL: int
...
class ProvidedServiceInstance(vspyx.Communication.ServiceInstance):
	...
	"""
	OnConfigurationMutation: vspyx.Core.Callback_634bd5c449
	def ServerConfig(self) -> vspyx.Communication.SDServerConfig: ...

	def ServiceIdentifier(self) -> int: ...

	def InstanceIdentifier(self) -> int: ...
...
class ConsumedServiceInstance(vspyx.Communication.ServiceInstance):
	...
	"""
	OnConfigurationMutation: vspyx.Core.Callback_634bd5c449
	def ProvidedServiceInstanceRef(self) -> vspyx.Communication.ProvidedServiceInstance: ...
...
class ApplicationEndpoint(vspyx.Core.ResolverObject):
	...
	OnConfigurationMutation: vspyx.Core.Callback_634bd5c449
	Port: typing.Any
	def ProvidedServiceInstances(self) -> typing.List[vspyx.Communication.ProvidedServiceInstance]: ...

	def ConsumedServiceInstances(self) -> typing.List[vspyx.Communication.ConsumedServiceInstance]: ...
