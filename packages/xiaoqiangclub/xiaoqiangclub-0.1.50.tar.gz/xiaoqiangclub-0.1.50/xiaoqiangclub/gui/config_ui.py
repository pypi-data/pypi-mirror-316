...
def generate_config_ui(config_file: str, data_dir: str = None, app: FastAPI = None, route_path: str = "/") -> FastAPI:
    """
    向现有 FastAPI 应用中添加应用配置页面路由，也可直接使用。
    说明文档：xiaoqiangclub/templates/html/config_template/config_readme.md

    :param config_file: 配置文件路径
    :param data_dir: 数据目录路径，如果为 None，则自动创建当前目录下的 "data" 目录
