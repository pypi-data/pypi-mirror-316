...
def train(
    ...
    '''
    Train scAdam model using parameters tuned by scparadise.scadam.tune function
...
def warm_start(
    ...
    '''
    Fine-tune pretrained scAdam model. 
    Fine-tuning refers to the adjustment of a pre-trained model's parameters to enhance its performance on a particular task. 
...
def download_model(
    ...
    save_path : str, path object
        Path to save tuned pretrained scAdam model.
