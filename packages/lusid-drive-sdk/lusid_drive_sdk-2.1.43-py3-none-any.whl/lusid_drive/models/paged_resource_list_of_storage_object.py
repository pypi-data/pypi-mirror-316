...
class PagedResourceListOfStorageObject(BaseModel):
    ...
    values: conlist(StorageObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfStorageObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfStorageObject:
        """Create an instance of PagedResourceListOfStorageObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfStorageObject.parse_obj(obj)

        _obj = PagedResourceListOfStorageObject.parse_obj({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [StorageObject.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
