...
class CreateFolder(BaseModel):
    ...
    """
    path: constr(strict=True) = Field(...,alias="path", description="Path of the created folder") 
    name: constr(strict=True) = Field(...,alias="name", description="Name of the created folder") 
