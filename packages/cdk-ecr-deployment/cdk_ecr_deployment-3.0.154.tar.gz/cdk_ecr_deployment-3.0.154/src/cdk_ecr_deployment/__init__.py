...
class ECRDeployment(
    ...
    def __init__(
        ...
        *,
        ...
        lambda_handler: typing.Optional[builtins.str] = None,
        ...
        :param lambda_handler: The name of the lambda handler. Default: - bootstrap
        :param lambda_runtime: The lambda function runtime environment. Default: - lambda.Runtime.PROVIDED_AL2023
...
class ECRDeploymentProps:
    def __init__(
        ...
        *,
        ...
        if lambda_handler is not None:
            self._values["lambda_handler"] = lambda_handler
    ...
    @builtins.property
    def lambda_handler(self) -> typing.Optional[builtins.str]:
        '''The name of the lambda handler.

        :default: - bootstrap
        '''
        result = self._values.get("lambda_handler")
        return typing.cast(typing.Optional[builtins.str], result)
