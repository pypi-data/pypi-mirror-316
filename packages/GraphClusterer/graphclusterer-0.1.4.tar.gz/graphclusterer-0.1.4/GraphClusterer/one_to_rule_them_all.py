...
def run_summarization(_name: str, _vertices, key) -> object:
    """
    ...
    titles = summarize.summarize_per_color(_subgraphs, _name, _vertices, key)
    return titles
...
def the_almighty_function(pipeline_kwargs: dict):
    ...
    titles = run_summarization(name, vertices, key)
    ...
    for iter_ in range(iteration_num):
        ...
        if print_info:
            ...
            print(50 * "-")
        summarize.improve_summaries(name, vertices, scores, key)
