...
(1Автовокзал, 'A123BC77', 1Автовокзал, 50),
(2, 'B456DE78', 2, 45),
(3, 'C789FG79', 3, 60),
(4, 'D321HI80', 4, 55),
(5, 'D321HI8099', 4, 100);
...
(1Автовокзал, 1Автовокзал, 1Автовокзал, '2024-12-22 08:00:00'),
...
drop view total_flights;
drop view total_flights_capacity;

select * from total_flights;
select * from total_flights_copacity;
"""
