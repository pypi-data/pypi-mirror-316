...
from torch_model_hub.model.layer import CNNLayer
...
class TextCNN2D(nn.Module):
	...
	def __init__(self, embed_dim: int, in_features: int, out_features: int, hidden_size: int = 128, 
		...
		self.cnn = TextCNN(embed_dim, kernel_sizes, cnn_channels, out_features, activation, num_hidden_layer, 
