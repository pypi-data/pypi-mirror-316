...
#if [ -z "$CONDA_EXE" ]; then
#  CONDA_EXE="conda"
#  CONDA_EXE="/home/markus/.local/share/kiara-dev/micromamba/envs/kiara-conda-build/bin/conda"
#fi

eval $(/home/markus/.cache/kiara-dev/bin/micromamba shell activate "/home/markus/.local/share/kiara-dev/micromamba/envs/kiara-conda-build")
...
build_package(){
    ...
    $CONDA_EXE mambabuild --py ${PYTHON_VERSION} ${CHANNEL_ARGS} --output-folder "${build_folder}" .
