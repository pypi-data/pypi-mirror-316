...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloudfront)](https://pypistats.org/packages/mypy-boto3-cloudfront)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 CloudFront 1.35.83](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-cloudfront` dependency in production. However, there is an issue in
