...
[Open documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_notificationscontacts/type_defs/)

Usage::

    ```python
    from types_aiobotocore_notificationscontacts.type_defs import ActivateEmailContactRequestRequestTypeDef
