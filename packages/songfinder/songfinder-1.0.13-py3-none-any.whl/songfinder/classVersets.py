    ...
    def affiche_text(self, event=None):  # pylint: disable=unused-argument
        ...
        if self.chap1 == self.chap2:
            for i, text in enumerate(
                ...
                self.text.insert(tk.INSERT, f"  {str(self.vers1 + i + 1)}  {text.text}")
        else:
            self.text.insert(tk.INSERT, f"  Chapitre {str(self.chap1 + 1)}\n")
            ...
            for i, text in enumerate(
                ...
                self.text.insert(tk.INSERT, f"  {str(i + 1)}  {text.text}")
