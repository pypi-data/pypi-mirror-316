...
class Mater(_MaterProcessNonPhysical):
    ...
    def run_from_excel(
        ...
        The variavle outputs are stored in a `run_name` directory in folders containing `Parquet <https://parquet.apache.org/docs/overview/>`_ files.
        ...
        :type run_name: str
        :param input_file: The name of the input Excel file
        :type input_file: str
        ...
        :type simulation_start_time: int
        :param simulation_end_time: The simulation final time
        :type simulation_end_time: int
        """
        # Inputs loading
        ...
        params.simulation_start_time = simulation_start_time
        params.simulation_end_time = simulation_end_time
    ...
    def run(self, params: Parameter):
        ...
        self.simulation_start_time = params.simulation_start_time
        self.simulation_end_time = params.simulation_end_time
        self.sampling_period = 1  # in time
        ...
        self._outputs_setup()
        pbar = trange(self.simulation_start_time, self.simulation_end_time + 1, self.sampling_period, disable=False)
        for k in pbar:
