<a id="types-boto3-m2"></a>

# types-boto3-m2

[![PyPI - types-boto3-m2](https://img.shields.io/pypi/v/types-boto3-m2.svg?color=blue)](https://pypi.org/project/types-boto3-m2/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-m2.svg?color=blue)](https://pypi.org/project/types-boto3-m2/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-m2)](https://pypistats.org/packages/types-boto3-m2)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 MainframeModernization 1.35.83](https://pypi.org/project/boto3/)
...
[types-boto3-m2 docs](https://youtype.github.io/types_boto3_docs/types_boto3_m2/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-m2](#types-boto3-m2)
...
- Install `types-boto3[m2]` in your environment:
...
- Install `types-boto3[m2]` with services you use in your environment:
...
`types-boto3-m2` dependency in production. However, there is an issue in
...
from types_boto3_m2 import MainframeModernizationClient
...
`types_boto3_m2.paginator` module contains type annotations for all paginators.
...
`types_boto3_m2.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `MainframeModernization` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_m2/literals/).
...
`types_boto3_m2.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `MainframeModernization` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_m2/type_defs/).
...
`types-boto3-m2` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_m2/)
