...
class DedicatedChatStreamBodyLogitBiasTypedDict(TypedDict):
...
class DedicatedChatStreamBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""


class DedicatedChatStreamBodyStreamOptionsTypedDict(TypedDict):
...
class DedicatedChatStreamBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
DedicatedChatStreamBodyToolChoiceType = Literal["function"]
r"""The type of the tool. Currently, only `function` is supported."""


class DedicatedChatStreamBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class DedicatedChatStreamBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class DedicatedChatStreamBodyToolChoiceObjectTypedDict(TypedDict):
    type: DedicatedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: DedicatedChatStreamBodyToolChoiceFunctionTypedDict


class DedicatedChatStreamBodyToolChoiceObject(BaseModel):
    type: DedicatedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""

    function: DedicatedChatStreamBodyToolChoiceFunction


DedicatedChatStreamBodyToolChoiceTypedDict = TypeAliasType(
    "DedicatedChatStreamBodyToolChoiceTypedDict",
    Union[DedicatedChatStreamBodyToolChoiceObjectTypedDict, str],
)
...
DedicatedChatStreamBodyToolChoice = TypeAliasType(
    "DedicatedChatStreamBodyToolChoice",
    Union[DedicatedChatStreamBodyToolChoiceObject, str],
)
r"""Determines the tool calling behavior of the model.
When set to `none`, the model will bypass tool execution and generate a response directly.
In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
...
class DedicatedChatStreamBodyTypedDict(TypedDict):
    model: str
    ...
    logit_bias: NotRequired[Nullable[DedicatedChatStreamBodyLogitBiasTypedDict]]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Important***
    ...
    stream_options: NotRequired[Nullable[DedicatedChatStreamBodyStreamOptionsTypedDict]]
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: NotRequired[DedicatedChatStreamBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class DedicatedChatStreamBody(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""
    ...
    logit_bias: OptionalNullable[DedicatedChatStreamBodyLogitBias] = UNSET
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Important***
    ...
    stream_options: OptionalNullable[DedicatedChatStreamBodyStreamOptions] = UNSET
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: Optional[DedicatedChatStreamBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
