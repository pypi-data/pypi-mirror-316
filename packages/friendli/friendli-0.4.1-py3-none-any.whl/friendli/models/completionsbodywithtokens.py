...
class CompletionsBodyWithTokensStreamOptionsTypedDict(TypedDict):
...
class CompletionsBodyWithTokensStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class CompletionsBodyWithTokensTypedDict(TypedDict):
    ...
    ***Important***
    ...
    stream_options: NotRequired[
        Nullable[CompletionsBodyWithTokensStreamOptionsTypedDict]
    ]
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class CompletionsBodyWithTokens(BaseModel):
    ...
    ***Important***
    ...
    stream_options: OptionalNullable[CompletionsBodyWithTokensStreamOptions] = UNSET
    r"""Options related to stream.
    It can only be used when `stream: true`.
