...
class CompletionsBodyWithTokensDedicatedCompletionsCompleteBodyStreamOptionsTypedDict(
    TypedDict
):
...
class CompletionsBodyWithTokensDedicatedCompletionsCompleteBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class DedicatedCompletionsCompleteBodyCompletionsBodyWithTokens(BaseModel):
    tokens: List[int]
    r"""The tokenized prompt (i.e., input tokens). Either `prompt` or `tokens` field is required."""
...
CompletionsBodyWithPromptDedicatedCompletionsCompleteBodyPrompt = TypeAliasType(
...
class CompletionsBodyWithPromptDedicatedCompletionsCompleteBodyStreamOptionsTypedDict(
    TypedDict
):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class CompletionsBodyWithPromptDedicatedCompletionsCompleteBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class DedicatedCompletionsCompleteBodyCompletionsBodyWithPromptTypedDict(TypedDict):
    prompt: CompletionsBodyWithPromptDedicatedCompletionsCompleteBodyPromptTypedDict
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""
    bad_word_tokens: NotRequired[Nullable[List[TokenSequenceTypedDict]]]
...
class DedicatedCompletionsCompleteBodyCompletionsBodyWithPrompt(BaseModel):
    prompt: CompletionsBodyWithPromptDedicatedCompletionsCompleteBodyPrompt
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
