...
class ServerlessToolAssistedChatStreamBodyLogitBiasTypedDict(TypedDict):
...
class ServerlessToolAssistedChatStreamBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""


class ServerlessToolAssistedChatStreamBodyStreamOptionsTypedDict(TypedDict):
...
class ServerlessToolAssistedChatStreamBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
ServerlessToolAssistedChatStreamBodyToolChoiceType = Literal["function"]
r"""The type of the tool. Currently, only `function` is supported."""


class ServerlessToolAssistedChatStreamBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class ServerlessToolAssistedChatStreamBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class ServerlessToolAssistedChatStreamBodyToolChoiceObjectTypedDict(TypedDict):
    type: ServerlessToolAssistedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: ServerlessToolAssistedChatStreamBodyToolChoiceFunctionTypedDict


class ServerlessToolAssistedChatStreamBodyToolChoiceObject(BaseModel):
    type: ServerlessToolAssistedChatStreamBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""

    function: ServerlessToolAssistedChatStreamBodyToolChoiceFunction


ServerlessToolAssistedChatStreamBodyToolChoiceTypedDict = TypeAliasType(
    "ServerlessToolAssistedChatStreamBodyToolChoiceTypedDict",
    Union[ServerlessToolAssistedChatStreamBodyToolChoiceObjectTypedDict, str],
)
...
ServerlessToolAssistedChatStreamBodyToolChoice = TypeAliasType(
    "ServerlessToolAssistedChatStreamBodyToolChoice",
    Union[ServerlessToolAssistedChatStreamBodyToolChoiceObject, str],
)
r"""Determines the tool calling behavior of the model.
When set to `none`, the model will bypass tool execution and generate a response directly.
In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
...
class ServerlessToolAssistedChatStreamBodyTypedDict(TypedDict):
    model: str
    ...
    logit_bias: NotRequired[
        Nullable[ServerlessToolAssistedChatStreamBodyLogitBiasTypedDict]
    ]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Tip***
    ...
    stream_options: NotRequired[
        Nullable[ServerlessToolAssistedChatStreamBodyStreamOptionsTypedDict]
    ]
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: NotRequired[ServerlessToolAssistedChatStreamBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class ServerlessToolAssistedChatStreamBody(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""
    ...
    logit_bias: OptionalNullable[ServerlessToolAssistedChatStreamBodyLogitBias] = UNSET
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Tip***
    ...
    tool_choice: Optional[ServerlessToolAssistedChatStreamBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
