...
class DedicatedChatCompleteBodyLogitBiasTypedDict(TypedDict):
...
class DedicatedChatCompleteBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""


class DedicatedChatCompleteBodyStreamOptionsTypedDict(TypedDict):
...
class DedicatedChatCompleteBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
DedicatedChatCompleteBodyToolChoiceType = Literal["function"]
r"""The type of the tool. Currently, only `function` is supported."""


class DedicatedChatCompleteBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class DedicatedChatCompleteBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class DedicatedChatCompleteBodyToolChoiceObjectTypedDict(TypedDict):
    type: DedicatedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: DedicatedChatCompleteBodyToolChoiceFunctionTypedDict


class DedicatedChatCompleteBodyToolChoiceObject(BaseModel):
    type: DedicatedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""

    function: DedicatedChatCompleteBodyToolChoiceFunction


DedicatedChatCompleteBodyToolChoiceTypedDict = TypeAliasType(
    "DedicatedChatCompleteBodyToolChoiceTypedDict",
    Union[DedicatedChatCompleteBodyToolChoiceObjectTypedDict, str],
)
...
DedicatedChatCompleteBodyToolChoice = TypeAliasType(
    "DedicatedChatCompleteBodyToolChoice",
    Union[DedicatedChatCompleteBodyToolChoiceObject, str],
)
r"""Determines the tool calling behavior of the model.
When set to `none`, the model will bypass tool execution and generate a response directly.
In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
...
class DedicatedChatCompleteBodyTypedDict(TypedDict):
    model: str
    ...
    logit_bias: NotRequired[Nullable[DedicatedChatCompleteBodyLogitBiasTypedDict]]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Important***
    ...
    stream_options: NotRequired[
        Nullable[DedicatedChatCompleteBodyStreamOptionsTypedDict]
    ]
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: NotRequired[DedicatedChatCompleteBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class DedicatedChatCompleteBody(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""
    ...
    logit_bias: OptionalNullable[DedicatedChatCompleteBodyLogitBias] = UNSET
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Important***
    ...
    stream_options: OptionalNullable[DedicatedChatCompleteBodyStreamOptions] = UNSET
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: Optional[DedicatedChatCompleteBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
