...
class ServerlessToolAssistedChatCompleteBodyLogitBiasTypedDict(TypedDict):
...
class ServerlessToolAssistedChatCompleteBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""


class ServerlessToolAssistedChatCompleteBodyStreamOptionsTypedDict(TypedDict):
...
class ServerlessToolAssistedChatCompleteBodyStreamOptions(BaseModel):
    r"""Options related to stream.
    It can only be used when `stream: true`.
...
class ServerlessToolAssistedChatCompleteBodyToolChoiceFunctionTypedDict(TypedDict):
    name: str
...
class ServerlessToolAssistedChatCompleteBodyToolChoiceFunction(BaseModel):
    name: str
    r"""The name of the function to be called. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64."""


class ServerlessToolAssistedChatCompleteBodyToolChoiceObjectTypedDict(TypedDict):
    type: ServerlessToolAssistedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
    function: ServerlessToolAssistedChatCompleteBodyToolChoiceFunctionTypedDict


class ServerlessToolAssistedChatCompleteBodyToolChoiceObject(BaseModel):
    type: ServerlessToolAssistedChatCompleteBodyToolChoiceType
    r"""The type of the tool. Currently, only `function` is supported."""
...
class ServerlessToolAssistedChatCompleteBodyTypedDict(TypedDict):
    model: str
    ...
    logit_bias: NotRequired[
        Nullable[ServerlessToolAssistedChatCompleteBodyLogitBiasTypedDict]
    ]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Tip***
    ...
    stream_options: NotRequired[
        Nullable[ServerlessToolAssistedChatCompleteBodyStreamOptionsTypedDict]
    ]
    r"""Options related to stream.
    It can only be used when `stream: true`.
    ...
    tool_choice: NotRequired[ServerlessToolAssistedChatCompleteBodyToolChoiceTypedDict]
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
...
class ServerlessToolAssistedChatCompleteBody(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""
    ...
    logit_bias: OptionalNullable[ServerlessToolAssistedChatCompleteBodyLogitBias] = (
        UNSET
    )
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
    ...
    ***Tip***
    ...
    tool_choice: Optional[ServerlessToolAssistedChatCompleteBodyToolChoice] = None
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
    In `auto` mode (the default), the model dynamically decides whether to call a tool or respond with a message.
    Alternatively, setting `required` ensures that the model invokes at least one tool before responding to the user.
