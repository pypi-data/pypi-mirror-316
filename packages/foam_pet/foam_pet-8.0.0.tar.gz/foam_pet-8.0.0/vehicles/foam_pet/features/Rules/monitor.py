...
''''
	Python3 PyPI pips:
		...
		include LICENSE with pip:
			...
			pip-licenses --with-license-file --format=json > /Metro/vehicles/foam_pet/Rules/Laboratory/PyPI_tenets_full.json
			pip-licenses > /Metro/vehicles/foam_pet/Rules/Laboratory/PyPI_tenets_outline.txt
