"""cenclave.home.command.sgx_operator.spawn module."""
...
from cenclave.command.helpers import (
...
from cenclave.command.sgx_operator.evidence import (
    collect_evidence_and_certificate,
    guess_pccs_url,
)
from cenclave.core.bootstrap import wait_for_conf_server
...
from cenclave.core.spinner import Spinner
from cenclave.error import AppContainerAlreadyRunning, AppContainerError, PortBusy
from cenclave.log import LOGGER as LOG
from cenclave.model.package import CodePackage


def add_subparser(subparsers):
    """Define the subcommand."""
    parser = subparsers.add_parser(
        "spawn", help="spawn container with specified web app"
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="tarball containing the container images and the code",
    )
