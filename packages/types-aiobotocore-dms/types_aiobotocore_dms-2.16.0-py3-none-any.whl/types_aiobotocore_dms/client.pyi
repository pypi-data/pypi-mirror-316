...
class DatabaseMigrationServiceClient(AioBaseClient):
    ...
    async def create_data_migration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#create_data_migration)
        """
    ...
    async def delete_data_migration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#delete_data_migration)
        """
    ...
    async def describe_data_migrations(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#describe_data_migrations)
        """
    ...
    async def modify_data_migration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#modify_data_migration)
        """
    ...
    async def start_data_migration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#start_data_migration)
        """
    ...
    async def stop_data_migration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_dms/client/#stop_data_migration)
        """
