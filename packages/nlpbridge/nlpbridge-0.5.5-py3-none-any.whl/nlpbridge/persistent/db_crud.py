...
from nlpbridge.persistent.mysql_dataschema import Template, Router, Node, Edge, RouterKnowledgeMapping
...
class CRUDCollection(CRUDBase):
    ...
    async def get_by_router_id(self, router_id: int, db_session: AsyncSession = None) -> Union[ModelType, None]:
