...
class DayAheadAuction(BaseModel):
    ...
    previous_auction_id: Optional[StrictStr] = Field(None, alias="previousAuctionId", description="Unique identifier for the record in UUID4 format")
    next_auction_id: Optional[StrictStr] = Field(None, alias="nextAuctionId", description="Unique identifier for the record in UUID4 format")
