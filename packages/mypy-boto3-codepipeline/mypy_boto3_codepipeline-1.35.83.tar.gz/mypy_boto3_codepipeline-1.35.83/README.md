...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codepipeline)](https://pypistats.org/packages/mypy-boto3-codepipeline)
...
`mypy-boto3-codepipeline` dependency in production. However, there is an issue
