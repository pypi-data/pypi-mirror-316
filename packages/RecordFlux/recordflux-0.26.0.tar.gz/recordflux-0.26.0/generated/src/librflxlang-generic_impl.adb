...
package body Librflxlang.Generic_Impl is
   ...
   function Node_Unit (Node : Internal_Node) return Internal_Unit is
      N : constant Implementation.Bare_R_F_L_X_Node := +Node;
   begin
      return +N.Unit;
   end Node_Unit;
   ...
   is
      R : Implementation.Bare_R_F_L_X_Node;
   begin
   ...
   function Node_Last_Attempted_Child (Node : Internal_Node) return Integer is
      N : Implementation.Bare_R_F_L_X_Node := +Node;
   begin
