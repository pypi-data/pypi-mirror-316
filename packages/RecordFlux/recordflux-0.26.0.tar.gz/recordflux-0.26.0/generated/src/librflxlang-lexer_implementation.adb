...
with Librflxlang.Lexer_State_Machine;
use Librflxlang.Lexer_State_Machine;


package body Librflxlang.Lexer_Implementation is
   ...
   is
      ...
      Token    : Lexed_Token;
      Token_Id : Token_Kind := Rflx_Termination;
      Symbol   : Thin_Symbol;
   ...
   begin
      ...
      while Has_Next (State) loop
         ...
         case Token_Id is
            ...
            when Rflx_Unqualified_Identifier =>
            ...
            when Rflx_Comment | Rflx_Lexing_Failure =>
               Append_Trivia ((Kind         => From_Token_Kind (Token_Id),
                               Source_First => Source_First,
                               Source_Last  => Source_Last,
                               Symbol       => No_Thin_Symbol));

               if Token_Id = Rflx_Lexing_Failure then
                  Append
                    (Diagnostics,
                     Make_Range
                       (Get_Sloc (TDH, Token.Text_First),
...
end Librflxlang.Lexer_Implementation;
