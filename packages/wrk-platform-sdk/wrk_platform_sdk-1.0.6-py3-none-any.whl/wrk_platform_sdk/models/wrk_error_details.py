...
class WrkErrorDetails(BaseModel):
    """
    WrkErrorDetails
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the error")
    message: StrictStr = Field(description="The error message")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Meta data associated with the error")
    __properties: ClassVar[List[str]] = ["name", "message", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WrkErrorDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WrkErrorDetails from a dict"""
        if obj is None:
            return None
