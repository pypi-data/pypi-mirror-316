...
class WrkError(BaseModel):
    """
    This object represents an Error containing the name and message of the error. Additionally, metadata might also be provided to assist in debugging the error.
    """ # noqa: E501
    error: WrkErrorDetails
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WrkError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WrkError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": WrkErrorDetails.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
