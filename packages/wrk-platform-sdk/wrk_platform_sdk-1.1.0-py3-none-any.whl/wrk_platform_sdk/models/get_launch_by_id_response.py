...
class GetLaunchByIdResponse(BaseModel):
    """
    GetLaunchByIdResponse
    """ # noqa: E501
    launch: Launch
    __properties: ClassVar[List[str]] = ["launch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLaunchByIdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLaunchByIdResponse from a dict"""
        if obj is None:
            return None
