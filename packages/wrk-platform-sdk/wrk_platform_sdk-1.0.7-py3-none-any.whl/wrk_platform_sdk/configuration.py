...
conf = wrk_platform_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://account.wrk.com/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("wrk_platform_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://account.wrk.com/api/v1",
