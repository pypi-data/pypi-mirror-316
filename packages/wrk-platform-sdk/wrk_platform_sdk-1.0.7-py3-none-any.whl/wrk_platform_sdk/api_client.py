...
from wrk_platform_sdk.api_response import ApiResponse, T as ApiResponseT
import wrk_platform_sdk.models
from wrk_platform_sdk import rest
from wrk_platform_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wrk_platform_sdk.models, klass)
