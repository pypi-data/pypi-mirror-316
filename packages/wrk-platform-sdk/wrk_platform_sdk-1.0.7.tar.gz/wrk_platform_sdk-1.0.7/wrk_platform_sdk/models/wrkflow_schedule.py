...
class WrkflowSchedule(BaseModel):
    """
    This object represents a schedule. It is used in Wrkflow object when the Wrkflow has been scheduled to launch at a set frequency.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="A human readable description of the schedule")
    schedule: Optional[StrictStr] = Field(default=None, description="CRON expression")
    __properties: ClassVar[List[str]] = ["description", "schedule"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WrkflowSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WrkflowSchedule from a dict"""
        if obj is None:
            return None
