...
class Launch(BaseModel):
    ...
    """ # noqa: E501
    id: Union[StrictFloat, StrictInt] = Field(description="The unique identifier of the Launch")
    wrkflow_uuid: StrictStr = Field(description="The associated Wrkflow identifier")
    name: StrictStr = Field(description="The given name of the Launch")
    start_date: Union[StrictFloat, StrictInt] = Field(description="The start date of the Launch in Unix format")
    state: LaunchState
    __properties: ClassVar[List[str]] = ["id", "wrkflow_uuid", "name", "start_date", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "wrkflow_uuid": obj.get("wrkflow_uuid"),
            "name": obj.get("name"),
            "start_date": obj.get("start_date"),
            "state": LaunchState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
