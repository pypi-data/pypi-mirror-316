...
class GetWrkflowByUuidResponse(BaseModel):
    """
    GetWrkflowByUuidResponse
    """ # noqa: E501
    wrkflow: Wrkflow
    __properties: ClassVar[List[str]] = ["wrkflow"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWrkflowByUuidResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of wrkflow
        if self.wrkflow:
            _dict['wrkflow'] = self.wrkflow.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWrkflowByUuidResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "wrkflow": Wrkflow.from_dict(obj["wrkflow"]) if obj.get("wrkflow") is not None else None
        })
        return _obj
