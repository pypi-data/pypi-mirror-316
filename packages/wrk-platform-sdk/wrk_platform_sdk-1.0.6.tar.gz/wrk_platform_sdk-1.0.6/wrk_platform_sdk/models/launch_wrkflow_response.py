...
class LaunchWrkflowResponse(BaseModel):
    """
    LaunchWrkflowResponse
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the Launch")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LaunchWrkflowResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LaunchWrkflowResponse from a dict"""
        if obj is None:
            return None
