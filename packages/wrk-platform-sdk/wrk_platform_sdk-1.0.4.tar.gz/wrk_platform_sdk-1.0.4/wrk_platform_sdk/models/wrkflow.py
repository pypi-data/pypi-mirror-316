...
class Wrkflow(BaseModel):
    ...
    launch_parameters_json_schema: Optional[Dict[str, Any]] = Field(default=None, description="A JSON object with properties containing the launch parameters required to launch the Wrkflow. The property required contains the minimum required properties to launch the Wrkflow.")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "short_description", "long_description", "launch_parameters_json_schema", "webhook_url", "schedules"]
