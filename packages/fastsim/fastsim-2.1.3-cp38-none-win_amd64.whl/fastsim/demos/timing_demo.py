...
t0 = time.perf_counter()
cyc = fsim.fastsimrust.RustCycle.from_file(udds_path)
t1 = time.perf_counter()
...
t0 = time.perf_counter()
veh_python = fsim.vehicle.Vehicle.from_file(veh_csv_path, to_rust=True).to_rust()
print(
    'Time to load vehicle with\n' + 
...
t0 = time.perf_counter()
veh = fsim.fastsimrust.RustVehicle.from_file(veh_yaml_path)
print(
    'Time to load vehicle with\n' + 
