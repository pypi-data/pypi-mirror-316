...
def generate_tables_to_process(template_folder):
    ...
    for table in resources["tablas"]:
        table_entry = {
            ...
            "gcs_schema_avsc_path": f"{resources['dominio']}/{resources['subdominio']}/{resources['origen']}",
            "dominio": resources["dominio"],
            "subdominio": resources["subdominio"],
            "gcs_schema_json_path": f"{resources['dominio']}/{resources['subdominio']}/{resources['origen']}",
            "gcs_query": f"{resources['dominio']}/{resources['subdominio']}/{resources['origen']}",
            "gcs_ingest_path": f"data_ingest_{resources['origen']}/{resources['dominio']}/{resources['subdominio']}",
            "gcs_raw_path": f"{resources['dominio']}/{resources['subdominio']}",
            "origen": resources["origen"],
            "merge": bool(table["merge"]),
