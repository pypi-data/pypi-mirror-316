...
from .utils.generator import process_multiple_sql_files, generate_bigquery_table_scripts, generate_bigquery_store_procedures
...
def main():
    ...
    sp_procedures_parser.add_argument("--config-folder", default="sql/bigquery/config/", help="Carpeta con los archivos de configuración (predeterminado: sql/bigquery/config/)")
    sp_procedures_parser.add_argument("--output-folder", default="sql/scripts/store_procedure/", help="Carpeta de salida para los procedimientos almacenados (predeterminado: sql/scripts/store_procedure/)")
