...
def generate_bigquery_table_scripts(config_folder, config_file=None, output_folder="sql/bigquery/scripts/"):
    ...
    for file in config_files:
        ...
        tags = config.get("tags", [])  # Nuevo campo tags
        ...
        if not tags:
            raise ValueError(f"El archivo de configuración {file} no contiene el campo obligatorio 'tags'.")
        ...
        for zone in zones:
            ...
            if tags:
                ...
                script_lines.append(f"OPTIONS(tags=[{tag_list}])")
