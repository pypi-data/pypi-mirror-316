...
from .utils.generator import process_multiple_sql_files, generate_bigquery_table_scripts
...
def main():
    ...
    bq_tables_parser.add_argument("--output-folder", default="sql/bigquery/scripts/", help="Carpeta de salida para los scripts de creación de tablas (predeterminado: sql/bigquery/scripts/)")
