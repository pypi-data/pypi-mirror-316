    ...
    for file in config_files:
        ...
        for zone in zones:
            ...
            for column_name, column_type, is_not_null in fields:
                ...
                null_status = "NOT NULL" if is_not_null == "NOT NULL" else ""  # Solo agregar NOT NULL si está declarado explícitamente
            ...
            # Añadir llaves primarias si existen
            if primary_keys:
                pk_fields = ", ".join(primary_keys)
                script_lines.append(f"PRIMARY KEY ({pk_fields})")
