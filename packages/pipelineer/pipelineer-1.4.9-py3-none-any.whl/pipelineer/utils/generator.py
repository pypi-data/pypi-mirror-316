...
def generate_bigquery_store_procedures(config_folder, schema_folder, output_folder):
    ...
    for config_file in config_files:
        ...
        # Añadir campos fecha_creacion y fecha_actualizacion
        ...
        update_fields = all_fields.copy()
        update_fields.remove("fecha_creacion")  # No se actualiza 'fecha_creacion'

        update_clause = ",\n      ".join(
            [f"T.{field} = S.{field}" for field in update_fields if field != "fecha_actualizacion"]
        )
