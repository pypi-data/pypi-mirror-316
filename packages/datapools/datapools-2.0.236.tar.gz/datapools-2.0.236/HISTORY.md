...
(unreleased)
------------
- Session prefix fix. [sergpsu]
- Release: version 2.0.235 🚀 [sergpsu]


2.0.235 (2024-12-19)
--------------------
- Release: version 2.0.235 🚀 [sergpsu]
- Queue prefix config key name. [sergpsu]
- Queue prefix. [sergpsu]
- Settings fix. [sergpsu]
- Prefixed redis keys. [sergpsu]


2.0.234 (2024-12-07)
--------------------
- Release: version 2.0.234 🚀 [sergpsu]
- Logs. [sergpsu]
- Customizable session. [sergpsu]
- Merge remote-tracking branch 'origin/master' into sergpsu/dbg.
  [sergpsu]
- Merge pull request #291 from torrentsai/sergpsu/dbg. [S]

  2.0.233
- Merge pull request #290 from torrentsai/sergpsu/dbg. [S]

  S3Storage get -> read
- Merge pull request #289 from torrentsai/sergpsu/dbg. [S]

  bugfix
- Merge pull request #288 from torrentsai/sergpsu/dbg. [S]

  2.0.230
- Merge pull request #287 from torrentsai/sergpsu/dbg. [S]

  ignore_missing_license


2.0.233 (2024-12-02)
--------------------
- Release: version 2.0.233 🚀 [sergpsu]
- S3 reader read_to() [sergpsu]


2.0.232 (2024-11-27)
--------------------
- Release: version 2.0.232 🚀 [sergpsu]
- S3_storage get -> read. [sergpsu]


2.0.231 (2024-11-26)
--------------------
- Release: version 2.0.231 🚀 [sergpsu]
- Until_empty fix. [sergpsu]
- Rabbit 4-management. [sergpsu]
- . [sergpsu]
- Test logs. [sergpsu]
- . [sergpsu]
- Less queue size test. [sergpsu]
- 15672. [sergpsu]
- Rabbit test env. [sergpsu]
- . [sergpsu]
- Test fix. [sergpsu]
- New sessions storage init bugfix, 1 redirect on download allowed, sock
  read timeout= 3 -> 5. [sergpsu]


2.0.230 (2024-11-24)
--------------------
- Release: version 2.0.230 🚀 [sergpsu]
- Limit theg. [sergpsu]
- Reset postpone on restart. [sergpsu]
- . [sergpsu]
- Worker loop fix when session postponed. [sergpsu]
- Download check. [sergpsu]
- Postpone theg. [sergpsu]
- Fix. [sergpsu]


2.0.229 (2024-11-22)
--------------------
- Release: version 2.0.229 🚀 [sergpsu]
- Less logs. [sergpsu]
- Ignore_missing_license meta field. [sergpsu]
- AIO_PIKA too verbose since 9.5.0. [sergpsu]
- Merge remote-tracking branch 'origin/master' into sergpsu/dbg.
  [sergpsu]
- Merge pull request #286 from torrentsai/sergpsu/dbg. [S]

  linter
- Merge pull request #285 from torrentsai/sergpsu/dbg. [S]

  storage gen_id from bytes
- Merge pull request #284 from torrentsai/sergpsu/dbg. [S]

  2.0.227
- Merge pull request #283 from torrentsai/sergpsu/dbg. [S]

  2.0.225
- Merge pull request #282 from torrentsai/sergpsu/dbg. [S]

  Embedding/Embeddings
- Merge pull request #281 from torrentsai/sergpsu/dbg. [S]

  2.0.223 tests
- Merge pull request #280 from torrentsai/sergpsu/dbg. [S]

  2.0.223
- Merge pull request #279 from torrentsai/sergpsu/dbg. [S]

  2.0.222
- Theg fix. [sergpsu]
- Session cleanup on finish. [sergpsu]


2.0.228 (2024-11-18)
--------------------
- Release: version 2.0.228 🚀 [sergpsu]
- Linter. [sergpsu]
- Upd and cleanup. [sergpsu]


2.0.227 (2024-11-16)
--------------------
- Release: version 2.0.227 🚀 [sergpsu]


2.0.226 (2024-11-16)
--------------------
- Release: version 2.0.226 🚀 [sergpsu]
- Less logs. [sergpsu]
- Url parse fix. [sergpsu]


2.0.225 (2024-11-07)
--------------------
- Release: version 2.0.225 🚀 [sergpsu]
- Direc url fix. [sergpsu]
- Passing direct content url to producer. [sergpsu]
- Wiki soup fix. [sergpsu]
- Only alive sessions are processed. [sergpsu]
- Wikipedia soup. [sergpsu]
- Is_public_url check bugfx. [sergpsu]
- Less logs. [sergpsu]
- Dbg. [sergpsu]
...
2.0.224 (2024-11-04)
--------------------
- Release: version 2.0.224 🚀 [sergpsu]
- Embeddings type. [sergpsu]
- Less logs. [sergpsu]
- Fck. [sergpsu]
- Reduce session storage usage. [sergpsu]
- Producer max tasks restriction. [sergpsu]
- Qps stats for success nlny. [sergpsu]
- Dbg. [sergpsu]
- Metadata not put to file. [sergpsu]


2.0.223 (2024-10-31)
--------------------
- Release: version 2.0.223 🚀 [sergpsu]
- Tests. [sergpsu]
- No exception. [sergpsu]
- Do not copy file to producer storage. [sergpsu]
- Less logs. [sergpsu]
- Follow-redirects=false. [sergpsu]
- Worker storage cleanup strategy. [sergpsu]
- Simplified acknack. [sergpsu]
- Dbg. [sergpsu]
- Disabled storage size check. [sergpsu]
- Dbg. [sergpsu]
- Worker loop bugfix. [sergpsu]


2.0.222 (2024-10-29)
--------------------
- Release: version 2.0.222 🚀 [sergpsu]
...
- Merge pull request #277 from torrentsai/sergpsu/dbg. [S]
  ...
  2.0.220
- Merge pull request #276 from torrentsai/sergpsu/dbg. [S]

  backtasks improvements


2.0.220 (2024-10-26)
--------------------
- Release: version 2.0.220 🚀 [sergpsu]
- S3dtorage upload content_type. [sergpsu]


2.0.219 (2024-10-26)
--------------------
- Release: version 2.0.219 🚀 [sergpsu]


1.0.218 (2024-10-26)
--------------------
- Release: version 1.0.218 🚀 [sergpsu]


2.0.217 (2024-10-26)
--------------------
- Release: version 2.0.217 🚀 [sergpsu]
- Backtask improvements. [sergpsu]


1.0.216 (2024-10-24)
--------------------
- Release: version 1.0.216 🚀 [sergpsu]
- Merge pull request #275 from torrentsai/sergpsu/dbg. [S]

  s3 storage improvements
- Aiohttp. [sergpsu]
- S3 improvements. [sergpsu]
- Verify s3 path. [sergpsu]
- S3_storage optional content mime type. [sergpsu]
- Fck. [sergpsu]
- Lock on browser init. [sergpsu]
- Fix. [sergpsu]
- Remove line_profiler. [sergpsu]
- Browser start on demand. [sergpsu]
- Profinlg. [sergpsu]
- Profilng. [sergpsu]
- Aiohttp instead of httpx. [sergpsu]
- Base procuer removes from worker storage. [sergpsu]
- Producer removes from worker storage. [sergpsu]
- Exception. [sergpsu]
- Is_shared_ storage removed. [sergpsu]
- Reports loop exception catch. [sergpsu]
- Dbg storage. [sergpsu]
- Async storage size. [sergpsu]
- Producer reports to queue. [sergpsu]
- Storage limit fix. [sergpsu]
- Session storage size. [sergpsu]
- Session file storage size limit configuration. [sergpsu]
- Fck. [sergpsu]
- Config type fix. [sergpsu]
- Test config entry. [sergpsu]
- Ignore_invalid_data plugin config entry. [sergpsu]
- Test and debug storage. [sergpsu]
- Bugfix. [sergpsu]
- Fma marker. [sergpsu]
- Don't try queue if recently rejected. [sergpsu]
- Less logs. [sergpsu]
- Merge pull request #274 from torrentsai/sergpsu/1.0.215. [S]
...
- Merge pull request #251 from torrentsai/sergpsu/dbg. [S]
  ...
  worker_loop kill bugfix
- Merge pull request #250 from torrentsai/sergpsu/dbg. [S]

  max instances fix attempt
- Merge pull request #249 from torrentsai/sergpsu/dbg. [S]

  less logs
- Merge pull request #247 from torrentsai/sergpsu/dbg. [S]

  max instances are checked globally per sessions only
- Loop. [sergpsu]
- Looping sleep. [sergpsu]
- Theguardian title strip. [sergpsu]
- Scheduler load. [sergpsu]
- Ignore ack failures. [sergpsu]
- Debuging ack failures. [sergpsu]
- Less logs. [sergpsu]
- Bugfix. [sergpsu]
- Rabbitmq async task for ack/nack. [sergpsu]
- Logs. [sergpsu]
- Logs. [sergpsu]
- Les logs. [sergpsu]
- Time set_content_status. [sergpsu]
- Timing. [sergpsu]
- Theguardian title. [sergpsu]
- Report evaluation timing. [sergpsu]
- Rmq loop impr. [sergpsu]
- Less logs. [sergpsu]
- Rabbitmq speedup. [sergpsu]
- Logs and timer. [sergpsu]
- Atimer. [sergpsu]
- Process task timer. [sergpsu]
- Evaluation report fix. [sergpsu]
- Fck. [sergpsu]
- . [sergpsu]
- Messages qps. [sergpsu]
- Fck. [sergpsu]
- Stats. [sergpsu]
- Qps moving avg. [sergpsu]
- Qps reporting. [sergpsu]
- . [sergpsu]
- Time profilng. [sergpsu]
- . [sergpsu]
- . [sergpsu]
- Logs. [sergpsu]
- Fx. [sergpsu]
- Separate producer reports queue. [sergpsu]
- Ttl. [sergpsu]
- . [sergpsu]
- Bugfix. [sergpsu]
- Worker timeout=0. [sergpsu]
- Fck. [sergpsu]
- Sleep back. [sergpsu]
- Scheduler timeout= [sergpsu]
- . [sergpsu]
- Fck. [sergpsu]
- Counter cache for worker and scheduler. [sergpsu]
- Wiki: exclude some urls. [sergpsu]
- Scheduler prefetch size=100. [sergpsu]
- Fck. [sergpsu]
- Fck. [sergpsu]
- Linter. [sergpsu]
- Speed optim. [sergpsu]
- Less logs. [sergpsu]
- Storage attr. [sergpsu]
- Misc. [sergpsu]
...
- Merge pull request #222 from torrentsai/sergpsu/demo-user-logo. [S]
  ...
  imageshack logo, base_plugin bugfix
