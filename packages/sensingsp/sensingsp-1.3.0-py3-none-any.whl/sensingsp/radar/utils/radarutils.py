...
def addRadar(radarSensor=RadarSensorsCategory.TI_AWR1642,location_xyz=[0,0,0]):
    ...
    if radarSensor==RadarSensorsCategory.TI_IWR6843:
        radar = ssp.radar.utils.predefined_array_configs_TI_IWR6843(isuite=suiteIndex, iradar=radarIndex, location=Vector((location_xyz[0], location_xyz[1],location_xyz[1])), rotation=Vector((np.pi/2,0, -np.pi/2)), f0=76e9) 
        return radar
