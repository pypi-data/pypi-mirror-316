...
class DefaultImages(object):
    ...
    _DEFAULT_IMAGE_PREFIXES = {
        ...
        PythonVersion.PYTHON_3_11: "ghcr.io/flyteorg/flytekit:py3.11-",
        PythonVersion.PYTHON_3_11: "ghcr.io/flyteorg/flytekit:py3.12-",
        PythonVersion.PYTHON_3_11: "ghcr.io/flyteorg/flytekit:py3.13-",
    }
