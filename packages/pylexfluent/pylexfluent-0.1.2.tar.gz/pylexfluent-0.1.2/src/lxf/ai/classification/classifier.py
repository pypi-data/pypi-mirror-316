...
from lxf.ai.ocr.pdf import do_ocr
...
async def get_classification(file_name,max_pages:int=-1) -> Predictions :
    ...
    if result==None or result =='':
        ...
        result,_ = await try_safe_execute_async(logger,get_text_and_tables_from_pdf, filename=output_filename,extract_tables=False,max_pages=max_pages)
