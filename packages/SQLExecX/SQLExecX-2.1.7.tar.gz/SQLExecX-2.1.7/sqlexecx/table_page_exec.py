...
class ColumnPageExec:
    ...
    def to_df(self, df_type: str = "auto"):
        ...
        """
        return self.table_page_exec.load(*self.columns).to_df(df_type)
...
class ColumnWherePageExec:
    ...
    def to_df(self, df_type: str = "auto"):
        ...
        """
        return self.where_page_exec.load(*self.columns).to_df(df_type)
...
class ColumnOrderByPageExec:
    ...
    def to_df(self, df_type: str = "auto"):
        ...
        """
        return self._exec.load(*self.columns).to_df(df_type)
