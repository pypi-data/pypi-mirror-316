...
setup(
    ...
    version='0.1.7',     # The version of the package, update as needed.
    ...
    entry_points={
        'console_scripts': [
            'unicontract = __main__:main',  # When 'mycli' is run, it will call the main() function from 'unicontract.cli'.
        ],
    },
