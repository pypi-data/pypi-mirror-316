...
setup(
    ...
    version='0.1.10',     # The version of the package, update as needed.
    ...
    entry_points={
        'console_scripts': [
            'unicontract = __main__:main',  # When 'unicontract' is run, it will call the main() function from 'unicontract.__main__'.
        ],
    },
