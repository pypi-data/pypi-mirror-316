...
def value_transformation_latlon(
    ...
    @parameter handle_special_cases: Dictionary of the following 
                                     format containing 2 list of functions
                                    ...
                                    format as well except that values in
                                    constitudent data frames may be modified.
    @parameter handle_utm: Convert any UTM data with UnitStrValue in format
                           "utm zone_[zone number] hemisphere_[n/s]"
                           into decimal degrees.
    @parameter handle_nztm: Convert any NZTM data with UnitStrValue in format
