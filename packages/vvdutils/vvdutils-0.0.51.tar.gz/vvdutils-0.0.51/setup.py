...
if __name__ == '__main__':
    ...
    setup(
        ...
        packages=['vvdutils'],
        zip_safe=False,
        install_requires= ['numpy', 'opencv-python', 'numba', 'func_timeout', 'pypinyin','scikit-learn', 'pathlib2', 'tqdm', 'pytest', 'matplotlib', 'pandas', 'flask', 'shapely', 'pyproj', 'bson', 'scikit-image'],
        python_requires='>=3')