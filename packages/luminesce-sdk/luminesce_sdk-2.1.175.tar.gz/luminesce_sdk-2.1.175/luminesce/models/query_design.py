...
class QueryDesign(BaseModel):
    ...
    """
    table_name: constr(strict=True) = Field(...,alias="tableName", description="Name of the table being designed") 
    alias: constr(strict=True) = Field(None,alias="alias", description="Alias for the table in the generated SQL, if any") 
