...
def read_variables(input_variables_file):
    ...
    for i, item in enumerate(columns):
        if item != variables.columns[i]:
            warning='For column number: '+ str(i) + ' you input "'+ variables.columns[i] + '"\n'
            warning2='But it should be "' + item + '"\n'
            warning3 ='The column name has been updated to "' + item + '"'
            message(warning + warning2 + warning3, 'WARNING')
