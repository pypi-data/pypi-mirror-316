...
import getTheme from './copilot/theme';
import { OSAppletEnum } from '@pieces.app/pieces-os-client';
import ConnectorSingleton from '../../connection/connector_singleton';
import { Applet } from './applet';

export default class SnippetsApplet extends Applet {
	constructor() {
		super('pieces-snippets', 'snippets-tab');
	}
...
export const snippetApplet = new SnippetsApplet();
