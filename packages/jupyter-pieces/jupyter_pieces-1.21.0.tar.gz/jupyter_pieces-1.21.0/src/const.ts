...
export default class Constants {
  ...
  public static readonly SNIPPET_DELETE_FAILURE =
    'Failed to delete snippet. Please ensure that PiecesOS is up-to-date, installed and running. If the problem persists please reach out to support at support.';
  ...
  public static readonly LOGIN_TO_POS_CLOUD =
    'Please login to PiecesOS in order to connect to Pieces cloud.';
  ...
  public static readonly LOGIN_TO_POS = 'Please login to PiecesOS';
  ...
  public static readonly SEARCH_FAILURE =
    'Something went wrong while searching for your snippets, if the issue persists please reach out to support.';
  ...
  public static readonly UPDATE_OS =
    'In order to use the Pieces for Jupyter lab extension, you must have PiecesOS version 5.1.2 or greater! Please update your PiecesOS';
