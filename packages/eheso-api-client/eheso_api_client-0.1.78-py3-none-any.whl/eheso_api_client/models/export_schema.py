...
class ExportSchema(BaseModel):
    ...
    file_export: Optional[ExportSchemaAllOfFileExport] = Field(default=None, alias="fileExport")
    ...
    def from_dict(cls, obj: dict) -> ExportSchema:
        ...
        _obj = ExportSchema.parse_obj({
            ...
            "file_export": ExportSchemaAllOfFileExport.from_dict(obj.get("fileExport")) if obj.get("fileExport") is not None else None
        })
        return _obj
