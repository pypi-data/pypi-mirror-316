...
set_target_properties(patchworkpp::ground_seg_cores PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libground_seg_cores.a"
  )

list(APPEND _cmake_import_check_targets patchworkpp::ground_seg_cores )
list(APPEND _cmake_import_check_files_for_patchworkpp::ground_seg_cores "${_IMPORT_PREFIX}/lib/libground_seg_cores.a" )
