...
from ok import delete_if_exists, delete_folders_starts_with
...
from ok.update.python_env import create_venv, get_env_path, kill_exe
    ...
    def do_update_success(self):
        ...
        for item in os.listdir('repo'):
            ...
            if os.path.isdir(item_path) and item != current_version:
                ...
                kill_exe(item_path)
                try:
                    shutil.rmtree(item_path)  # Use rmtree to delete folders recursively
