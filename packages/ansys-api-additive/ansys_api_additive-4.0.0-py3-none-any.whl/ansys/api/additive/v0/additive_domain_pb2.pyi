...
class SimulationResponse(google.protobuf.message.Message):
    ...
    def progress(self) -> global___Progress: ...
    @property
    def melt_pool(self) -> global___MeltPool: ...
    @property
    def porosity_result(self) -> global___PorosityResult: ...
    @property
    def microstructure_result(self) -> global___MicrostructureResult: ...
    @property
    def thermal_history_result(self) -> global___ThermalHistoryResult: ...
    @property
    def thermal_strain_result(self) -> global___ThermalStrainResult: ...
    @property
    def microstructure_3d_result(self) -> global___Microstructure3DResult: ...
    @property
    def result(self) -> global___MaterialTuningResult: ...
    def __init__(self,
        *,
        id : typing.Text = ...,
        logs : builtins.bytes = ...,
        progress : typing.Optional[global___Progress] = ...,
        melt_pool : typing.Optional[global___MeltPool] = ...,
        porosity_result : typing.Optional[global___PorosityResult] = ...,
        microstructure_result : typing.Optional[global___MicrostructureResult] = ...,
        thermal_history_result : typing.Optional[global___ThermalHistoryResult] = ...,
        thermal_strain_result : typing.Optional[global___ThermalStrainResult] = ...,
        microstructure_3d_result : typing.Optional[global___Microstructure3DResult] = ...,
        result : typing.Optional[global___MaterialTuningResult] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["ResponseType",b"ResponseType","melt_pool",b"melt_pool","microstructure_3d_result",b"microstructure_3d_result","microstructure_result",b"microstructure_result","porosity_result",b"porosity_result","progress",b"progress","result",b"result","thermal_history_result",b"thermal_history_result","thermal_strain_result",b"thermal_strain_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ResponseType",b"ResponseType","id",b"id","logs",b"logs","melt_pool",b"melt_pool","microstructure_3d_result",b"microstructure_3d_result","microstructure_result",b"microstructure_result","porosity_result",b"porosity_result","progress",b"progress","result",b"result","thermal_history_result",b"thermal_history_result","thermal_strain_result",b"thermal_strain_result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["ResponseType",b"ResponseType"]) -> typing.Optional[typing_extensions.Literal["progress","melt_pool","porosity_result","microstructure_result","thermal_history_result","thermal_strain_result","microstructure_3d_result","result"]]: ...
