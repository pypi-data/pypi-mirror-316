...
class Femtodriver:
        ...
        if hwcfg is not None:
            if hwcfg == "spu1p3v1.dat":
                ...
                raise ValueError(
                    ...
                    "Must be spu1p2v1.dat or spu1p3v1.dat for TC2 or MP chip, respectively"
                )
        else:
    ...
    def _get_runner_metrics(self, runner, input_period: float | None = None) -> str:
        """
    ...
    def run(
        ...
        zynq_host:                      The ip address or hostname of the zynq board
        """
        if cleanup_docker:
