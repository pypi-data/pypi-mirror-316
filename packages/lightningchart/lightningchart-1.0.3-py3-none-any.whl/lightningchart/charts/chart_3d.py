...
from lightningchart.charts import GeneralMethods, ChartWithXYZAxis, TitleMethods, ChartWithSeries
...
from lightningchart.series.surface_scrolling_grid_series import SurfaceScrollingGridSeries
from lightningchart.series.mesh_model_3d import MeshModel3D


class Chart3D(GeneralMethods, TitleMethods, ChartWithXYZAxis, ChartWithSeries):
    ...
    def set_bounding_box_stroke(
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setBoundingBoxStrokeStyle', {
            'thickness': thickness,
            'color': color.get_hex()
        })
        return self
    ...
    def set_mouse_interaction_rotate(self, enabled: bool):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setMouseInteractionRotate', {'enabled': enabled})
        return self

    def set_mouse_interaction_zoom(self, enabled: bool):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setMouseInteractionZoom', {'enabled': enabled})
        return self
    ...
    def set_cursor_mode(self, mode: str):
        ...
        """
        cursor_modes = (
            "disabled", "show-all", "show-all-interpolated", "show-nearest",
            "show-nearest-interpolated", "show-pointed", "show-pointed-interpolated"
        )
...
class Chart3DDashboard(Chart3D):
    ...
    def __init__(
        ...
        ChartWithSeries.__init__(self, instance)
        self.instance.send(self.id, 'createChart3D', {
            'db': dashboard_id,
            'column': column,
            'row': row,
            'colspan': colspan,
