...
from lightningchart.charts import GeneralMethods, TitleMethods, ChartWithLUT, ChartWithLabelStyling, Chart
...
class PieChart(GeneralMethods, TitleMethods, ChartWithLUT, ChartWithLabelStyling):
    ...
    def __init__(
        ...
        self.instance.send(self.id, 'pieChart', {
            'theme': theme.value,
    ...
    def add_slice(self, name: str, value: int | float):
        ...
        """
        self.instance.send(self.id, 'addSlice', {
            'name': name,
            'value': value
        })
        return self
...
class PieChartDashboard(PieChart):
    ...
    def __init__(
            ...
            rowspan: int):
        Chart.__init__(self, instance)
        self.instance.send(self.id, 'createPieChart', {
            'db': dashboard_id,
            'column': column,
            'row': row,
            'colspan': colspan,
