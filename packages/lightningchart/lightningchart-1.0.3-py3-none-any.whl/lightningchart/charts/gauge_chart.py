...
class GaugeChart(GeneralMethods, TitleMethods, ChartWithLUT):
    ...
    def set_bar_color(self, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setGaugeBarColor', {'color': color.get_hex()})
        return self
    ...
    def set_bar_stroke(self, thickness: int | float, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setBarStroke', {'thickness': thickness, 'color': color.get_hex()})
        return self
    ...
    def set_color_animation(self, enabled: bool, speed_multiplier: float = None):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setColorAnimation', {'enabled': enabled, 'speedMultiplier': speed_multiplier})
        return self
    ...
    def set_glow_color(self, arg: None | lightningchart.Color | dict[str, any]):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        if isinstance(arg, lightningchart.Color):
            arg = arg.get_hex()
    ...
    def set_needle_color(self, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setNeedleColor', {'color': color.get_hex()})
        return self
    ...
    def set_needle_stroke(self, thickness: int | float, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setNeedleStroke', {'thickness': thickness, 'color': color.get_hex()})
        return self
    ...
    def set_tick_color(self, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setTickColor', {'color': color.get_hex()})
        return self
    ...
    def set_tick_font(
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setTickFont', {
            'family': family,
            'size': size,
            'weight': weight,
            'style': style
    ...
    def set_unit_label_color(self, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setUnitLabelColor', {'color': color.get_hex()})
        return self
    ...
    def set_unit_label_font(
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setUnitLabelFont', {
            'family': family,
            'size': size,
            'weight': weight,
            'style': style
    ...
    def set_value_animation(self, enabled: bool, speed_multiplier: float = None):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setValueAnimation', {'enabled': enabled, 'speedMultiplier': speed_multiplier})
        return self
    ...
    def set_value_indicators(self, indicators: list[dict[str, any]]):
        ...
        for i in indicators:
            if i['color'] and isinstance(i['color'], lightningchart.Color):
    ...
    def set_value_label_color(self, color: lightningchart.Color):
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setGaugeValueLabelColor', {'color': color.get_hex()})
        return self
    ...
    def set_value_label_font(
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setValueLabelFont', {
            'family': family,
            'size': size,
            'weight': weight,
            'style': style
