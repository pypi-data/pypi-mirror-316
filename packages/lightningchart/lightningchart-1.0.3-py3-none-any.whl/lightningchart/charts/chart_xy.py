...
class ChartXY(GeneralMethods, TitleMethods, ChartWithXYAxis, ChartWithSeries):
    ...
    def add_polygon_series(self):
        ...
        polygon_series = PolygonSeries(self)
        self.series_list.append(polygon_series)
        return polygon_series
    
    def add_segment_series(self):
        """Add an SegmentFigure to the Chart."""
        segment_series = SegmentSeries(self)
