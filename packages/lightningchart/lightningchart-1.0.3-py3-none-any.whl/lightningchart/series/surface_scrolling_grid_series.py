...
from lightningchart.series import ComponentWithPaletteColoring, SeriesWithWireframe, SeriesWithIntensityInterpolation, \
    SeriesWithCull, SeriesWithAddValues, SeriesWith3DShading, Series
...
class SurfaceScrollingGridSeries(
    ...
    def __init__(
        ...
        self.instance.send(self.id, 'surfaceScrollingGridSeries', {
            'chart': self.chart.id,
            'columns': columns,
            'rows': rows,
