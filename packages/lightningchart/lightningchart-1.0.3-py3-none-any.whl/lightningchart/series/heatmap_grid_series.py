...
from lightningchart.series import Series2D, ComponentWithPaletteColoring, SeriesWithInvalidateIntensity, \
    SeriesWithIntensityInterpolation, SeriesWithWireframe, Series
...
class HeatmapGridSeries(
    ...
    def __init__(
        ...
        self.instance.send(self.id, 'heatmapGridSeries', {
            'chart': self.chart.id,
            'columns': columns,
            'rows': rows,
