...
from lightningchart.series import Series2D, ComponentWithPaletteColoring, SeriesWithWireframe, SeriesWithPixelInterpolation, \
    SeriesWithDataCleaning, SeriesWithAddIntensityValues, Series
...
class HeatmapScrollingGridSeries(
    ...
    def __init__(
        ...
        self.instance.send(self.id, 'heatmapScrollingGridSeries', {
            'chart': self.chart.id,
