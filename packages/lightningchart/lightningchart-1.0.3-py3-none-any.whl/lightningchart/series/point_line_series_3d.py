...
from lightningchart.series import SeriesWithAddDataPoints, SeriesWithAddDataXYZ, SeriesWith3DPoints, SeriesWith3DLines, \
    SeriesWith3DShading, Series, ComponentWithLinePaletteColoring
...
class PointLineSeries3D(
    ...
    def __init__(
        ...
        self.instance.send(self.id, 'pointLineSeries3D', {
            'chart': self.chart.id,
