...
from lightningchart.series import ComponentWithPaletteColoring, SeriesWithInvalidateIntensity, SeriesWithWireframe, \
    SeriesWithInvalidateHeight, SeriesWithIntensityInterpolation, SeriesWithCull, SeriesWith3DShading, Series
...
class SurfaceGridSeries(
    ...
    def __init__(
        ...
        self.rows = rows
        self.instance.send(self.id, 'surfaceGridSeries', {
            'chart': self.chart.id,
            'columns': columns,
            'rows': rows,
