...
class TenantApi:
    ...
    async def blog_get(
        ...
        _param = self._blog_get_serialize(
            tenant=tenant,
            blog=blog,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def blog_get_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        blog: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The blog id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def blog_get_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        blog: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The blog id")],
        _request_timeout: Union[
    ...
    async def blog_get_posts(
        ...
        _param = self._blog_get_posts_serialize(
            tenant=tenant,
            blog=blog,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def blog_get_posts_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        blog: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="The blog id")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def blog_get_posts_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        blog: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="The blog id")] = None,
        _request_timeout: Union[
    ...
    async def tenant_get_blogs(
        ...
        _param = self._tenant_get_blogs_serialize(
            tenant=tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def tenant_get_blogs_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def tenant_get_blogs_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    def _tenant_get_blogs_serialize(
        self,
        tenant,
        _request_auth,
        _content_type,
    ...
    async def tenant_member_delete(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        member: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant member id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
