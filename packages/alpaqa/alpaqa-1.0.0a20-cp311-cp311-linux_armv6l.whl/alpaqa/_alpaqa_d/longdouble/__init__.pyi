...
class Problem:
    ...
    def eval_grad_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_hess_L(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], scale: float = 1.0) -> tuple[typing.Any, alpaqa._alpaqa_d.Symmetry]:
        """
    ...
    def eval_hess_L_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], scale: float, v: numpy.ndarray[numpy.longdouble[M, 1]], Hv: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    def eval_hess_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], scale: float = 1.0) -> tuple[typing.Any, alpaqa._alpaqa_d.Symmetry]:
        """
    ...
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]:
        ...
    def eval_jac_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[typing.Any, alpaqa._alpaqa_d.Symmetry]:
        """
