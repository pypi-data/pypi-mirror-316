...
class ALMSolver:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __call__(self, problem: Problem | ControlProblem, x: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, *, asynchronous: bool = True, suppress_interrupt: bool = False) -> tuple:
        """
        Solve.
...
class AndersonAccel:
    ...
    def __str__(self) -> str:
        ...
    @typing.overload
    def compute(self, g_k: numpy.ndarray[numpy.longdouble[M, 1]], r_k: numpy.ndarray[numpy.longdouble[M, 1]], x_k_aa: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def compute(self, g_k: numpy.ndarray[numpy.longdouble[M, 1]], r_k: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def initialize(self, g_0: numpy.ndarray[numpy.longdouble[M, 1]], r_0: numpy.ndarray[numpy.longdouble[M, 1]]) -> None:
        ...
    def reset(self) -> None:
        ...
    def resize(self, n: int) -> None:
        ...
    @property
    def Q(self) -> numpy.ndarray[numpy.longdouble[M, N]]:
        ...
    @property
    def R(self) -> numpy.ndarray[numpy.longdouble[M, N]]:
        ...
    @property
...
class Box:
    ...
    def __init__(self, n: int) -> None:
        ...
        """
    @typing.overload
    def __init__(self, *, lower: numpy.ndarray[numpy.longdouble[M, 1]], upper: numpy.ndarray[numpy.longdouble[M, 1]]) -> None:
        """
    ...
    def __setstate__(self, arg0: tuple) -> None:
        ...
    @property
    def lowerbound(self) -> numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]:
        ...
    @lowerbound.setter
    def lowerbound(self, arg1: numpy.ndarray[numpy.longdouble[M, 1]]) -> None:
        ...
    @property
    def upperbound(self) -> numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]:
        ...
    @upperbound.setter
    def upperbound(self, arg1: numpy.ndarray[numpy.longdouble[M, 1]]) -> None:
        ...
class BoxConstrProblem:
    ...
    def __setstate__(self, arg0: tuple) -> None:
        ...
    @typing.overload
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]], J: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]) -> int:
        ...
    @typing.overload
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]:
        ...
    @typing.overload
    def eval_proj_diff_g(self, z: numpy.ndarray[numpy.longdouble[M, 1]], e: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_proj_diff_g(self, z: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_proj_multipliers(self, y: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], M: float) -> None:
        ...
    @typing.overload
    def eval_prox_grad_step(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]], x_hat: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], p: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> float:
        ...
    @typing.overload
    def eval_prox_grad_step(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[numpy.ndarray[numpy.longdouble[M, 1]], numpy.ndarray[numpy.longdouble[M, 1]], float]:
        ...
    ...
    def D(self, arg0: Box) -> None:
        ...
    @property
    def l1_reg(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        :math:`\\ell_1` regularization on :math:`x`
        """
    @l1_reg.setter
    def l1_reg(self, arg0: numpy.ndarray[numpy.longdouble[M, 1]]) -> None:
        ...
    @property
    def m(self) -> int:
        """
...
class ControlProblemWithCounters:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    @property
    def evaluations(self) -> alpaqa._alpaqa.OCPEvalCounter:
        ...
    @property
...
class FISTAProgressInfo:
    ...
    def fpr(self) -> float:
        ...
        """
    @property
    def grad_ψ(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Gradient of objective :math:`\\nabla\\psi(x)`
        """
    @property
    def grad_ψ_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
    ...
    def norm_sq_p(self) -> float:
        ...
        """
    @property
    def p(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
    ...
    def t(self) -> float:
        ...
        """
    @property
    def x(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Decision variable :math:`x`
        """
    @property
    def x_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Decision variable after projected gradient step :math:`\\hat x`
        """
    @property
    def y(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Lagrange multipliers :math:`y`
        """
    @property
    def y_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Candidate updated multipliers at x̂ :math:`\\hat y(\\hat x)`
        """
    @property
    def Σ(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
...
class FISTASolver:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __call__(self, problem: Problem, opts: InnerSolveOptions = {}, x: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, Σ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, *, asynchronous: bool = True, suppress_interrupt: bool = False) -> tuple:
        """
...
class LBFGS:
    ...
    def __str__(self) -> str:
        ...
    def apply(self, q: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], γ: float) -> bool:
        ...
    def apply_masked(self, q: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], γ: float, J: list[int]) -> bool:
        ...
    def current_history(self) -> int:
        ...
    def reset(self) -> None:
    ...
    def resize(self, n: int) -> None:
        ...
    def s(self, i: int) -> numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]:
        ...
    def scale_y(self, factor: float) -> None:
        ...
    def update(self, xk: numpy.ndarray[numpy.longdouble[M, 1]], xkp1: numpy.ndarray[numpy.longdouble[M, 1]], pk: numpy.ndarray[numpy.longdouble[M, 1]], pkp1: numpy.ndarray[numpy.longdouble[M, 1]], sign: LBFGS.Sign = LBFGS.Sign.Positive, forced: bool = False) -> bool:
        ...
    def update_sy(self, sk: numpy.ndarray[numpy.longdouble[M, 1]], yk: numpy.ndarray[numpy.longdouble[M, 1]], pkp1Tpkp1: float, forced: bool = False) -> bool:
        ...
    def y(self, i: int) -> numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]:
        ...
...
class OCPEvaluator:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def Qk(self, k: int, u: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, μ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None) -> numpy.ndarray[numpy.longdouble[M, N]]:
        ...
    def Rk(self, k: int, u: numpy.ndarray[numpy.longdouble[M, 1]], mask: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]) -> numpy.ndarray[numpy.longdouble[M, N]]:
        ...
    def Sk(self, k: int, u: numpy.ndarray[numpy.longdouble[M, 1]], mask: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]) -> numpy.ndarray[numpy.longdouble[M, N]]:
        ...
    def __init__(self, problem: ControlProblem) -> None:
        ...
    def forward_backward(self, u: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, μ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None) -> tuple[float, numpy.ndarray[numpy.longdouble[M, 1]]]:
        """
        :return: * Cost
                 * Gradient
        """
    def lqr_factor_solve(self, u: numpy.ndarray[numpy.longdouble[M, 1]], γ: float, y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, μ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def lqr_factor_solve_QRS(self, u: numpy.ndarray[numpy.longdouble[M, 1]], γ: float, Q: list, R: list, S: list, y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, μ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, masked: bool = True) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
...
class PANOCOCPProgressInfo:
    ...
    def problem(self) -> ControlProblem:
        ...
        """
    @property
    def q(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
    ...
    def status(self) -> alpaqa._alpaqa.SolverStatus:
        ...
        """
    @property
    def u(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        Inputs
        """
    @property
    def u_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
    ...
    def x_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
        """
    @property
    def xu(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
        States :math:`x` and inputs :math:`u`
        """
    @property
    def xu_hat(self) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        """
...
class PANOCOCPSolver:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __call__(self, problem: ControlProblem, opts: InnerSolveOptions = {}, x: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, y: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, Σ: numpy.ndarray[numpy.longdouble[M, 1]] | None = None, *, asynchronous: bool = True, suppress_interrupt: bool = False) -> tuple:
        """
        Solve the given problem.
...
class Problem:
    ...
    def check(self) -> None:
        ...
    def eval_f(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> float:
        ...
    def eval_f_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]], g: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> float:
        ...
    @typing.overload
    def eval_f_grad_f(self, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_fx: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> float:
        ...
    @typing.overload
    def eval_f_grad_f(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple:
        ...
    @typing.overload
    def eval_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]], gx: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_grad_L(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], grad_L: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], work_n: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_f(self, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_fx: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_f(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_grad_f_grad_g_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], grad_f: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], grad_gxy: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_g_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], grad_gxy: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_g_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_grad_gi(self, x: numpy.ndarray[numpy.longdouble[M, 1]], i: int, grad_gi: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], work_n: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], work_m: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_grad_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[numpy.longdouble[M, 1]]:
        ...
    def eval_hess_L(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], scale: float = 1.0) -> tuple[typing.Any, alpaqa._alpaqa.Symmetry]:
        """
        Returns the Hessian of the Lagrangian and its symmetry.
        """
    def eval_hess_L_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], scale: float, v: numpy.ndarray[numpy.longdouble[M, 1]], Hv: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    def eval_hess_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], scale: float = 1.0) -> tuple[typing.Any, alpaqa._alpaqa.Symmetry]:
        """
        Returns the Hessian of the augmented Lagrangian and its symmetry.
        """
    def eval_hess_ψ_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], scale: float, v: numpy.ndarray[numpy.longdouble[M, 1]], Hv: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]], J: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]) -> int:
        ...
    ...
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]:
        ...
    def eval_jac_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[typing.Any, alpaqa._alpaqa.Symmetry]:
        """
    ...
    def eval_prox_grad_step(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[numpy.ndarray[numpy.longdouble[M, 1]], numpy.ndarray[numpy.longdouble[M, 1]], float]:
        ...
    @typing.overload
    def eval_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], ŷ: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> float:
        ...
    @typing.overload
    def eval_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[float, numpy.ndarray[numpy.longdouble[M, 1]]]:
        ...
    @typing.overload
    def eval_ψ_grad_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], work_n: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable], work_m: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> float:
        ...
    @typing.overload
    def eval_ψ_grad_ψ(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], Σ: numpy.ndarray[numpy.longdouble[M, 1]]) -> tuple[float, numpy.ndarray[numpy.longdouble[M, 1]]]:
        ...
    def get_box_C(self) -> Box:
        ...
    def get_box_D(self) -> Box:
...
class UnconstrProblem:
    ...
    def __setstate__(self, arg0: tuple) -> None:
        ...
    def eval_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]], g: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    def eval_grad_g_prod(self, x: numpy.ndarray[numpy.longdouble[M, 1]], y: numpy.ndarray[numpy.longdouble[M, 1]], grad_gxy: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    def eval_grad_gi(self, x: numpy.ndarray[numpy.longdouble[M, 1]], i: int, grad_gi: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
    ...
    def eval_inactive_indices_res_lna(self, γ: float, x: numpy.ndarray[numpy.longdouble[M, 1]], grad_ψ: numpy.ndarray[numpy.longdouble[M, 1]]) -> numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.int64]]:
        ...
    def eval_jac_g(self, x: numpy.ndarray[numpy.longdouble[M, 1]], J_values: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
    @typing.overload
    def eval_proj_diff_g(self, z: numpy.ndarray[numpy.longdouble[M, 1]], e: numpy.ndarray[numpy.longdouble[M, 1], numpy.ndarray.flags.writeable]) -> None:
        ...
...
class ZeroFPRSolver:
    ...
    def params(self) -> ZeroFPRParams:
        ...
def kkt_error(arg0: Problem, arg1: numpy.ndarray[numpy.longdouble[M, 1]], arg2: numpy.ndarray[numpy.longdouble[M, 1]]) -> KKTError:
    ...
...
def provided_functions(problem: Problem) -> str:
    ...
    """
@typing.overload
def prox(self: functions.NuclearNorm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1) -> float:
    """
    ...
    """
@typing.overload
def prox(self: functions.NuclearNorm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    ...
    """
@typing.overload
def prox(self: functions.L1Norm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox(self: functions.L1Norm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version returns the outputs as a tuple.
    ...
    """
@typing.overload
def prox(self: functions.L1NormElementwise, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox(self: functions.L1NormElementwise, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version returns the outputs as a tuple.
    ...
    """
@typing.overload
def prox(self: Box, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox(self: Box, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox`
    Compute the proximal mapping of ``self`` at ``in`` with step size ``γ``. This version returns the outputs as a tuple.
    ...
    """
@typing.overload
def prox_step(self: functions.NuclearNorm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], output_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> float:
    """
    ...
    """
@typing.overload
def prox_step(self: functions.NuclearNorm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]], numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    ...
    """
@typing.overload
def prox_step(self: functions.L1Norm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], output_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox_step(self: functions.L1Norm, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]], numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version returns the outputs as a tuple.
    ...
    """
@typing.overload
def prox_step(self: functions.L1NormElementwise, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], output_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox_step(self: functions.L1NormElementwise, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]], numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version returns the outputs as a tuple.
    ...
    """
@typing.overload
def prox_step(self: Box, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], output: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], output_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.writeable, numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> float:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version overwrites the given output arguments.
    ...
    """
@typing.overload
def prox_step(self: Box, input: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], input_step: numpy.ndarray[numpy.longdouble[M, N], numpy.ndarray.flags.f_contiguous], γ: float = 1, γ_step: float = -1) -> tuple[float, numpy.ndarray[numpy.longdouble[M, N]], numpy.ndarray[numpy.longdouble[M, N]]]:
    """
    C++ documentation: :cpp:var:`alpaqa::prox_step`
    Compute a generalized forward-backward step. This version returns the outputs as a tuple.
