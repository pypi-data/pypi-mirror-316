...
from bodosql.imported_java_classes import BodoGlueCatalogClass
...
def _create_java_glue_catalog(warehouse: str):
    ...
    """
    return BodoGlueCatalogClass(warehouse)
...
def overload_snowflake_catalog_constructor(warehouse: str):
