...
def buildMimeMessage(sender, subject, text, to_address, prio, text_type, logger, cc_address,bcc_address):
    try:
...
def sendEmail(CREDS, subject, text, to_address, prio, text_type, logger, cc_address=None, bcc_address=None):
    try:
        ...
        message = buildMimeMessage(CREDS["email_username"], subject, text, to_address, str(prio), text_type, logger, cc_address, bcc_address)
